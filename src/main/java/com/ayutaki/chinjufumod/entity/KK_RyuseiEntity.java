...
public class KK_RyuseiEntity extends AbstractKK_Entity {
	...
	private ItemStack projectile = new ItemStack(Items_Weapon.RYUSEI);
	private double baseDamage = 10.0D; /** 流星 雷装+10 **/
	
	public KK_RyuseiEntity(World worldIn) {
		super(worldIn);
	}

	public KK_RyuseiEntity(World worldIn, EntityLivingBase entity, ItemStack stack) {
