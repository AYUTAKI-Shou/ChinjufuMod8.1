...
public class KB_TypeZeroEntity extends AbstractKK_Entity {
	...
	public KB_TypeZeroEntity(EntityType<KB_TypeZeroEntity> type, World worldIn) {
		super(type, worldIn);
	}

	public KB_TypeZeroEntity(LivingEntity entity, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.TYPEZERO, entity, worldIn);
