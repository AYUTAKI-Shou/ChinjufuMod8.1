...
public class AmmoEntity_Large extends AbstractAmmo_Entity {
	...
	public AmmoEntity_Large(Level worldIn, double x, double y, double z, ItemStack stack) {
		super(EntityTypes_CM.AMMO_L.get(), x, y, z, worldIn, stack);
	}

	public AmmoEntity_Large(Level worldIn, LivingEntity shooter, ItemStack stack) {
		super(EntityTypes_CM.AMMO_L.get(), shooter, worldIn, stack);
	}
