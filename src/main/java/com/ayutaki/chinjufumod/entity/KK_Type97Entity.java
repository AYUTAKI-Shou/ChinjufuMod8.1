...
public class KK_Type97Entity extends AbstractKK_Entity {
	...
	private ItemStack projectile = new ItemStack(Items_Weapon.TYPE97KK.get());
	private double baseDamage = 5.0D; /** 97式 雷装 +5 **/
	
	public KK_Type97Entity(EntityType<KK_Type97Entity> type, Level worldIn) {
		super(type, worldIn);
	}

	public KK_Type97Entity(LivingEntity entityIn, Level world, ItemStack stack) {
		super(EntityTypes_CM.TYPE97.get(), entityIn, world, stack);
		this.projectile = stack.copy();
	}

	public KK_Type97Entity(Level wroldIn, double x, double y, double z, ItemStack stack) {
		super(EntityTypes_CM.TYPE97.get(), x, y, z, wroldIn, stack);
	}
