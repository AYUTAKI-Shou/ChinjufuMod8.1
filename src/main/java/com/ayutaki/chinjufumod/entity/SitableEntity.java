...
public class SitableEntity extends Entity {
	...
	public SitableEntity(World worldIn) {
		super(worldIn);
		this.noClip = true;
		this.height = 0.01F;
		this.width = 0.01F;
	...
	public SitableEntity(World worldIn, double x, double y, double z, double y0ffset) {
		this(worldIn);
	...
	public SitableEntity(World worldIn, double x, double y, double z, double y0ffset, int rotation, double rotationOffset) {
		this(worldIn);
		this.blockPosX = (int) x;
		this.blockPosY = (int) y;
		this.blockPosZ = (int) z;
