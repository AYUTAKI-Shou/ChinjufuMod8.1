...
public class SB_ZuiunEntity extends AbstractKK_Entity {
	...
	public SB_ZuiunEntity(EntityType<SB_ZuiunEntity> type, World world) {
		super(type, world);
	}

	public SB_ZuiunEntity(LivingEntity entityIn, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.ZUIUN, entityIn, worldIn);
