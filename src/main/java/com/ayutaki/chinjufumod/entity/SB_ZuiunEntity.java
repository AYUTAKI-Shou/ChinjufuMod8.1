...
public class SB_ZuiunEntity extends AbstractKK_Entity {
	...
	public SB_ZuiunEntity(EntityType<SB_ZuiunEntity> type, World worldIn) {
		super(type, worldIn);
	}

	public SB_ZuiunEntity(LivingEntity entity, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.ZUIUN, entity, worldIn);
