...
public class KK_TenzanEntity extends AbstractKK_Entity {
	...
	public KK_TenzanEntity(LivingEntity entityIn, Level world, ItemStack stack) {
		super(EntityTypes_CM.TENZAN.get(), entityIn, world, stack);
		this.projectile = stack.copy();
	}

	public KK_TenzanEntity(Level wroldIn, double x, double y, double z, ItemStack stack) {
		super(EntityTypes_CM.TENZAN.get(), x, y, z, wroldIn, stack);
	}
