...
public class KB_SBDEntity extends AbstractKK_Entity {
	...
	public KB_SBDEntity(EntityType<KB_SBDEntity> type, World worldIn) {
		super(type, worldIn);
	}

	public KB_SBDEntity(LivingEntity entity, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.SBD, entity, worldIn);
