...
public class KB_SBDEntity extends AbstractKK_Entity {
	...
	private ItemStack projectile = new ItemStack(Items_Weapon.SBD);
	private double baseDamage = 7.0D; /** SBD 火力+1,爆装+6 **/
	
	public KB_SBDEntity(EntityType<KB_SBDEntity> type, World world) {
		super(type, world);
	}

	public KB_SBDEntity(LivingEntity entityIn, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.SBD, entityIn, worldIn);
