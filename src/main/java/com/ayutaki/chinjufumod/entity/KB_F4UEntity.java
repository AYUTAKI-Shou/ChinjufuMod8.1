...
public class KB_F4UEntity extends AbstractKK_Entity {
	...
	private ItemStack projectile = new ItemStack(Items_Weapon.F4U);
	private double baseDamage = 11.0D; /** F4U-7 爆装+11 **/
	
	public KB_F4UEntity(EntityType<KB_F4UEntity> type, World world) {
		super(type, world);
	}

	public KB_F4UEntity(LivingEntity entityIn, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.F4U, entityIn, worldIn);
