...
public class KB_F4UEntity extends AbstractKK_Entity {
	...
	public KB_F4UEntity(EntityType<KB_F4UEntity> type, World worldIn) {
		super(type, worldIn);
	}

	public KB_F4UEntity(LivingEntity entity, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.F4U, entity, worldIn);
