...
public class AmmoEntity_Small extends AbstractAmmo_Entity {
	...
	public AmmoEntity_Small(Level worldIn, double x, double y, double z, ItemStack stack) {
		super(EntityTypes_CM.AMMO_S.get(), x, y, z, worldIn, stack);
	}

	public AmmoEntity_Small(Level worldIn, LivingEntity shooter, ItemStack stack) {
		super(EntityTypes_CM.AMMO_S.get(), shooter, worldIn, stack);
	}
