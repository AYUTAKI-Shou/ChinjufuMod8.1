...
public class KB_Re2001Entity extends AbstractKK_Entity {
	...
	public KB_Re2001Entity(EntityType<KB_Re2001Entity> type, World worldIn) {
		super(type, worldIn);
	}

	public KB_Re2001Entity(LivingEntity entity, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.RE2001, entity, worldIn);
