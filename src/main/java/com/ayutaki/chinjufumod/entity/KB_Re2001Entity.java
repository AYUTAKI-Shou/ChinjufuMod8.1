...
public class KB_Re2001Entity extends AbstractKK_Entity {
	...
	public KB_Re2001Entity(LivingEntity entityIn, Level world, ItemStack stack) {
		super(EntityTypes_CM.RE2001.get(), entityIn, world, stack);
		this.projectile = stack.copy();
	}

	public KB_Re2001Entity(Level wroldIn, double x, double y, double z, ItemStack stack) {
		super(EntityTypes_CM.RE2001.get(), x, y, z, wroldIn, stack);
	}
