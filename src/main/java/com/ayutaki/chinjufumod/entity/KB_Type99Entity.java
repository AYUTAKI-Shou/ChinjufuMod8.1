...
public class KB_Type99Entity extends AbstractKK_Entity {
	...
	public KB_Type99Entity(EntityType<KB_Type99Entity> type, World worldIn) {
		super(type, worldIn);
	}

	public KB_Type99Entity(LivingEntity entity, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.TYPE99, entity, worldIn);
