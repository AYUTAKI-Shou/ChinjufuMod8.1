...
public class KB_Type99Entity extends AbstractKK_Entity {
	...
	public KB_Type99Entity(EntityType<KB_Type99Entity> type, World world) {
		super(type, world);
	}

	public KB_Type99Entity(LivingEntity entityIn, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.TYPE99, entityIn, worldIn);
