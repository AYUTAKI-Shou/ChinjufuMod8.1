...
public class AmmoEntity_Kijyuu extends AbstractAmmo_Kijyuu {
	...
	public AmmoEntity_Kijyuu(Level worldIn, double x, double y, double z, ItemStack stack, @Nullable ItemStack stackS) {
		super(EntityTypes_CM.AMMO_K.get(), x, y, z, worldIn, stack, stackS);
	}

	public AmmoEntity_Kijyuu(Level worldIn, LivingEntity shooter, ItemStack stack, @Nullable ItemStack stackS) {
		super(EntityTypes_CM.AMMO_K.get(), shooter, worldIn, stack, stackS);
	}
