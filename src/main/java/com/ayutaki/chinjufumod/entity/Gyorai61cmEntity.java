...
public class Gyorai61cmEntity extends ThrowableProjectile implements ItemSupplier {
	...
	protected void onHitEntity(@Nonnull EntityHitResult result) {
		...
		result.getEntity().hurt(DamageSource.thrown(this, this.getOwner()), (float)dealDamage * criGYORAI);
		this.hitProcess();
		this.discard();
	}
	...
	public void hitProcess() {
		if (!this.level.isClientSide) {
			...
			this.createExplosion(this, this.getX(), this.getY(), this.getZ(), size, false, Explosion.BlockInteraction.NONE); }
