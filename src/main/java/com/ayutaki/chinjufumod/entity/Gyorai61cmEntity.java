...
public class Gyorai61cmEntity extends ThrowableEntity implements IRendersAsItem {
	...
	protected void onImpact(@Nonnull RayTraceResult result) {
		...
		case ENTITY: {
			...
			entityResult.getEntity().attackEntityFrom(DamageSource.causeThrownDamage(this, this.getThrower()), (float)dealDamage * criGYORAI);
	...
	public void hitProcess() {
		if (!this.world.isRemote) {
			...
			this.createExplosion(this, this.getPosX(), this.getPosY(), this.getPosZ(), size, false, Explosion.Mode.NONE); }
