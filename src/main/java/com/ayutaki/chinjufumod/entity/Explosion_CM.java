...
public class Explosion_CM extends Explosion {
	...
	public Explosion_CM (Level worldIn, @Nullable Entity entityIn, double xIn, double yIn, double zIn, float sizeIn, List<BlockPos> pos,
	...
	public Explosion_CM(Level worldIn, @Nullable Entity entityIn, double xIn, double yIn, double zIn, float sizeIn, boolean fireIn, Explosion.BlockInteraction mode, List<BlockPos> pos) {
	...
	public Explosion_CM(Level worldIn, @Nullable Entity entityIn, @Nullable DamageSource source, @Nullable ExplosionDamageCalculator context,
			...
			if (!entity.ignoreExplosion(this)) {
				...
				if (d11 <= 1.0) {
					...
					if (d12 != 0.0) {
						...
						d7 *= d10;
						d9 *= d10;
						Vec3 vec31 = new Vec3(d5, d7 * 0.8, d9);
