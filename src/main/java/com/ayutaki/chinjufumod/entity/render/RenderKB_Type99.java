...
public class RenderKB_Type99<T extends KB_Type99Entity> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public RenderKB_Type99(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
