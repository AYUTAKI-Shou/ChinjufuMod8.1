...
public class RenderAmmo_Medium<T extends AmmoEntity_Medium> extends Render<T> {
	...
	public RenderAmmo_Medium(RenderManager renderManagerIn) {
		super(renderManagerIn);
	}

	@Override
	protected ResourceLocation getEntityTexture(AmmoEntity_Medium entity) {
		return RESOURCE;
	}
