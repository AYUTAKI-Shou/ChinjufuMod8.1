...
public class RenderKB_Re2001<T extends KB_Re2001Entity> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public RenderKB_Re2001(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
