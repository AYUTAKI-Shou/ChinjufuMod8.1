...
public class RenderKB_Re2001 extends EntityRenderer<KB_Re2001Entity> {

	private final net.minecraft.client.renderer.ItemRenderer itemRenderer;

	public RenderKB_Re2001(EntityRendererManager renderManager, net.minecraft.client.renderer.ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KB_Re2001Entity entity, float entityYaw, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer buffer, int packedLight) {
		matrixStack.push();
	...
	@Override
	public ResourceLocation getEntityTexture(KB_Re2001Entity entity) { return null; }
}
