...
public class RenderKK_Ryusei<T extends KK_RyuseiEntity> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public RenderKK_Ryusei(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
