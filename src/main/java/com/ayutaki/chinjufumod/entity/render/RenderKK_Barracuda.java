...
public class RenderKK_Barracuda<T extends KK_BarracudaEntity> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public RenderKK_Barracuda(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
