...
public class RenderKK_Tenzan<T extends KK_TenzanEntity> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public RenderKK_Tenzan(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
