...
public class RenderKK_Type97<T extends KK_Type97Entity> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public RenderKK_Type97(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
