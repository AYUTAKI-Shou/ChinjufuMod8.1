...
public class RenderSB_Seiran<T extends SB_SeiranEntity> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public RenderSB_Seiran(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
