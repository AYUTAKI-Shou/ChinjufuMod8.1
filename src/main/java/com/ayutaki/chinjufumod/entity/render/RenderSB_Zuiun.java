...
public class RenderSB_Zuiun extends EntityRenderer<SB_ZuiunEntity> {
	...
	public RenderSB_Zuiun(EntityRendererProvider.Context renderManager, ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(SB_ZuiunEntity entity, float entityYaw, float partialTicks, PoseStack matrixStack, MultiBufferSource buffer, int packedLight) {
