...
public class RenderKB_SBD<T extends KB_SBDEntity> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public RenderKB_SBD(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
