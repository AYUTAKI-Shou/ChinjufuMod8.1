...
public class RenderKB_Ju87 extends EntityRenderer<KB_Ju87Entity> {
	...
	public RenderKB_Ju87(EntityRendererManager renderManager, net.minecraft.client.renderer.ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KB_Ju87Entity entity, float entityYaw, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer buffer, int packedLight) {
		matrixStack.push();
	...
	@Override
	public ResourceLocation getEntityTexture(KB_Ju87Entity entity) { return null; }
}
