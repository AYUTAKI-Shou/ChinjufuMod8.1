...
public class RenderKB_Ju87<T extends KB_Ju87Entity> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public RenderKB_Ju87(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
