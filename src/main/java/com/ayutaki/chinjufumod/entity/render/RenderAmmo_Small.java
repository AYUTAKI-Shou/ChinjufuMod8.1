...
public class RenderAmmo_Small<T extends AmmoEntity_Small> extends Render<T> {
	...
	public RenderAmmo_Small(RenderManager renderManagerIn) {
		super(renderManagerIn);
	}

	@Override
	protected ResourceLocation getEntityTexture(AmmoEntity_Small entity) {
		return RESOURCE;
	}
