...
public class RenderKK_TBF<T extends KK_TBFEntity> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public RenderKK_TBF(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
