...
public class RenderKB_F4U extends EntityRenderer<KB_F4UEntity> {

	private final net.minecraft.client.renderer.ItemRenderer itemRenderer;

	public RenderKB_F4U(EntityRendererManager renderManager, net.minecraft.client.renderer.ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KB_F4UEntity entity, float entityYaw, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer buffer, int packedLight) {
		matrixStack.push();
	...
	@Override
	public ResourceLocation getEntityTexture(KB_F4UEntity entity) { return null; }
}
