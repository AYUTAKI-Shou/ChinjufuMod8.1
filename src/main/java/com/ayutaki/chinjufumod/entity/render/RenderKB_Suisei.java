...
public class RenderKB_Suisei<T extends KB_SuiseiEntity> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public RenderKB_Suisei(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
