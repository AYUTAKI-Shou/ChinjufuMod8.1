...
public class RenderKK_Mosquito extends EntityRenderer<KK_MosquitoEntity> {
	...
	public RenderKK_Mosquito(EntityRendererManager renderManager, net.minecraft.client.renderer.ItemRenderer itemRenderer) {
		super(renderManager);
	...
	public void render(KK_MosquitoEntity entity, float entityYaw, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer buffer, int packedLight) {
		matrixStack.push();
	...
	@Override
	public ResourceLocation getEntityTexture(KK_MosquitoEntity entity) { return null; }
}
