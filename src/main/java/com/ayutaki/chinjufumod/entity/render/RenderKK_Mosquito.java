...
public class RenderKK_Mosquito<T extends KK_MosquitoEntity> extends Render<T> {

	protected final Item item;
	private final RenderItem itemRenderer;

	public RenderKK_Mosquito(RenderManager renderManagerIn, Item itemIn, RenderItem itemRendererIn) {
