...
public class KB_SuiseiEntity extends AbstractKK_Entity {
	...
	public KB_SuiseiEntity(EntityType<KB_SuiseiEntity> type, World worldIn) {
		super(type, worldIn);
	}

	public KB_SuiseiEntity(LivingEntity entity, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.SUISEI, entity, worldIn);
