...
public class KK_BarracudaEntity extends AbstractKK_Entity {
	...
	private ItemStack projectile = new ItemStack(Items_Weapon.BARRACUDA);
	private double baseDamage = 7.0D; /** Barracuda Mk.II 雷装+7 **/
	
	public KK_BarracudaEntity(EntityType<KK_BarracudaEntity> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_BarracudaEntity(LivingEntity entityIn, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.BARRACUDA, entityIn, worldIn);
