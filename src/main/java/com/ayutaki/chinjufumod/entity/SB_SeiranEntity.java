...
public class SB_SeiranEntity extends AbstractKK_Entity {
	...
	public SB_SeiranEntity(EntityType<SB_SeiranEntity> type, World world) {
		super(type, world);
	}

	public SB_SeiranEntity(LivingEntity entityIn, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.SEIRAN, entityIn, worldIn);
