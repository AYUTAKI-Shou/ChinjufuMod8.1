...
public class KK_MosquitoEntity extends AbstractKK_Entity {
	...
	public KK_MosquitoEntity(EntityType<KK_MosquitoEntity> type, World world) {
		super(type, world);
	}

	public KK_MosquitoEntity(LivingEntity entityIn, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.MOSQUITO, entityIn, worldIn);
