...
public class KK_MosquitoEntity extends AbstractKK_Entity {
	...
	public KK_MosquitoEntity(EntityType<KK_MosquitoEntity> type, World worldIn) {
		super(type, worldIn);
	}

	public KK_MosquitoEntity(LivingEntity entity, World worldIn, ItemStack stack) {
		super(EntityTypes_CM.MOSQUITO, entity, worldIn);
