...
public class JPChair_Blocks {
	...
	public static Block WARAZABUTON = register("block_wara_zabuton", new Zabuton(AbstractBlock.Properties.of(Material.WOOD).strength(1.0F, 1.0F)
			.sound(SoundType.GRASS).noOcclusion().isValidSpawn(JPChair_Blocks::neverEntity).isSuffocating(JPChair_Blocks::never)));
