...
import com.ayutaki.chinjufumod.blocks.season.Carpet_Leaf;
...
import com.ayutaki.chinjufumod.blocks.season.SnowMan_Bot;
import com.ayutaki.chinjufumod.blocks.season.SnowMan_BotDown;
import com.ayutaki.chinjufumod.blocks.season.SnowMan_Top1;
import com.ayutaki.chinjufumod.blocks.season.SnowMan_Top25;
...
public class Seasonal_Blocks {
	...
	public static Block WATAGASHI_block, WATAGASHI_apple, WATAGASHI_cherry, WATAGASHI_citrus, 
									WATAGASHI_grape, WATAGASHI_tea;
	public static Block KAKIGOURI_block, KAKIGOURI_apple, KAKIGOURI_cherry, KAKIGOURI_citrus, 
	...
	public static void init() {
		...
		SAKURA_FENCE = new WoodFence_CM("block_fence_sakura");
		KAEDE_FENCE = new WoodFence_CM("block_fence_kaede");
		ICHOH_FENCE = new WoodFence_CM("block_fence_ichoh");
		...
		WP_LOG_sakura = new WallPane_Stage3Wood("block_wp_log_sakura").setCreativeTab(ChinjufuModTabs.SEASONAL);
		WP_LOG_kaede = new WallPane_Stage3Wood("block_wp_log_kaede").setCreativeTab(ChinjufuModTabs.SEASONAL);
		WP_LOG_ichoh = new WallPane_Stage3Wood("block_wp_log_ichoh").setCreativeTab(ChinjufuModTabs.SEASONAL);

		WP_PLANK_sakura = new WallPane_Stage4Wood("block_wp_plank_sakura").setCreativeTab(ChinjufuModTabs.SEASONAL);
		WP_PLANK_kaede = new WallPane_Stage4Wood("block_wp_plank_kaede").setCreativeTab(ChinjufuModTabs.SEASONAL);
		WP_PLANK_ichoh = new WallPane_Stage4Wood("block_wp_plank_ichoh").setCreativeTab(ChinjufuModTabs.SEASONAL);
		...
		WATAGASHI_block = new Watagashi_block("block_watagashi");
		WATAGASHI_apple = new Watagashi_block("block_watagashi_yellow");
		WATAGASHI_cherry = new Watagashi_block("block_watagashi_pink");
		WATAGASHI_citrus = new Watagashi_block("block_watagashi_orange");
		WATAGASHI_grape = new Watagashi_block("block_watagashi_red");
		WATAGASHI_tea = new Watagashi_block("block_watagashi_green");
		
		KAKIGOURI_block = new Kakigouri("block_kakigouri_block1");
		KAKIGOURI_apple = new Kakigouri("block_kakigouri_yellow1");
		KAKIGOURI_cherry = new Kakigouri("block_kakigouri_pink1");
		KAKIGOURI_citrus = new Kakigouri("block_kakigouri_orange1");
		KAKIGOURI_grape = new Kakigouri("block_kakigouri_red1");
		KAKIGOURI_tea = new Kakigouri("block_kakigouri_green1");
		...
		SNOWMAN_TOP2 = new SnowMan_Top25("block_snowman_top2");
		SNOWMAN_TOP3 = new SnowMan_Top25("block_snowman_top3");
		SNOWMAN_TOP4 = new SnowMan_Top25("block_snowman_top4");
		SNOWMAN_TOP5 = new SnowMan_Top25("block_snowman_top5");
		
		SNOWMAN_BOT1 = new SnowMan_Bot("block_snowman_bot1");
		SNOWMAN_BOT2 = new SnowMan_Bot("block_snowman_bot2");
		SNOWMAN_BOT3 = new SnowMan_Bot("block_snowman_bot3");
		SNOWMAN_BOT4 = new SnowMan_Bot("block_snowman_bot4");
		SNOWMAN_BOT5 = new SnowMan_Bot("block_snowman_bot5");

		SNOWMAN_BOT1D = new SnowMan_BotDown("block_snowman_bot1d");
		SNOWMAN_BOT2D = new SnowMan_BotDown("block_snowman_bot2d");
		SNOWMAN_BOT3D = new SnowMan_BotDown("block_snowman_bot3d");
		SNOWMAN_BOT4D = new SnowMan_BotDown("block_snowman_bot4d");
		SNOWMAN_BOT5D = new SnowMan_BotDown("block_snowman_bot5d");
	...
	public static void register() {
		...
		registerBlock(WATAGASHI_apple);
		registerBlock(WATAGASHI_cherry);
		registerBlock(WATAGASHI_citrus);
		registerBlock(WATAGASHI_grape);
		registerBlock(WATAGASHI_tea);
		
		registerBlock(KAKIGOURI_block);
		registerBlock(KAKIGOURI_apple);
		registerBlock(KAKIGOURI_cherry);
		registerBlock(KAKIGOURI_citrus);
		registerBlock(KAKIGOURI_grape);
		registerBlock(KAKIGOURI_tea);
