...
public class Seasonal_Blocks {
	...
	public static Block WATAGASHI_block = register("block_watagashi", watagashi());
	public static Block WATAGASHI_apple = register("block_watagashi_yellow", watagashi());
	public static Block WATAGASHI_cherry = register("block_watagashi_pink", watagashi());
	public static Block WATAGASHI_citrus = register("block_watagashi_orange", watagashi());
	public static Block WATAGASHI_grape = register("block_watagashi_red", watagashi());
	public static Block WATAGASHI_tea = register("block_watagashi_green", watagashi());
	...
	public static Block KAKIGOURI_apple = register("block_kakigouri_yellow1", kakigouri());
	public static Block KAKIGOURI_cherry = register("block_kakigouri_pink1", kakigouri());
	public static Block KAKIGOURI_citrus = register("block_kakigouri_orange1", kakigouri());
	public static Block KAKIGOURI_grape = register("block_kakigouri_red1", kakigouri());
	public static Block KAKIGOURI_tea = register("block_kakigouri_green1", kakigouri());
	...
	private static Watagashi_block watagashi() {
		return new Watagashi_block(Block.Properties.create(Material.WOOD).hardnessAndResistance(1.0F, 1.0F).sound(SoundType.WOOD).notSolid());
	}
