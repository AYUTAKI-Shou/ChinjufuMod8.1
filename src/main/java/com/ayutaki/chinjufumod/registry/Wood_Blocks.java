...
public class Wood_Blocks {
	...
	public static Block SAKURA_carpet = register("block_carpet_sakura", carpetLeaf(MaterialColor.COLOR_PINK));
	public static Block KAEDE_carpet = register("block_carpet_kaede", carpetLeaf(MaterialColor.COLOR_RED));
	public static Block ICHOH_carpet = register("block_carpet_ichoh", carpetLeaf(MaterialColor.COLOR_YELLOW));
	public static Block OCHIBA_carpet = register("block_carpet_ochiba", carpetLeaf(MaterialColor.COLOR_BROWN));
	...
	private static Carpet_CM carpetLeaf(MaterialColor color) {
		return new Carpet_CM(AbstractBlock.Properties.of(Material.WOOD, color).strength(1.0F, 1.0F).sound(SoundType.GRASS)
				.noOcclusion().isValidSpawn(Wood_Blocks::neverEntity).isSuffocating(Wood_Blocks::never));
	}
