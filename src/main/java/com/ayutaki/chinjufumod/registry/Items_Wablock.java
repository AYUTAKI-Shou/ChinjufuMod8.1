...
import com.ayutaki.chinjufumod.items.jpblock.DirtWall_WT;
import com.ayutaki.chinjufumod.items.jpblock.ClayKawara_WT;
import com.ayutaki.chinjufumod.items.jpblock.Slakedlime_WT;
import com.ayutaki.chinjufumod.items.jpblock.Kawara_WT;
import com.ayutaki.chinjufumod.items.jpblock.NamakoB_WT;
import com.ayutaki.chinjufumod.items.jpblock.Namako_WT;
import com.ayutaki.chinjufumod.items.jpblock.Shikkui_WT;
import com.ayutaki.chinjufumod.items.jpblock.WallKawara_WT;
import com.ayutaki.chinjufumod.items.jpblock.WallNamakoB_WT;
import com.ayutaki.chinjufumod.items.jpblock.WallNamako_WT;
import com.ayutaki.chinjufumod.items.jpblock.WallPlaster_WT;
import com.ayutaki.chinjufumod.items.jpblock.Wall_DirtWall_WT;
...
public class Items_Wablock {
	...
	public static void init() {
		...
		CLAYKAWARA = new ClayKawara_WT("item_claykawara");
		SHOUSEKKAI = new Slakedlime_WT("item_shousekkai_c");

		KAWARA = new Kawara_WT("block_kawara");
		KAWARA_SH_white = new TabBlock_noFuel("block_ksh_white", JPBlock_Blocks.KAWARA_SH_white);
		KAWARA_SH_orange = new TabBlock_noFuel("block_ksh_orange", JPBlock_Blocks.KAWARA_SH_orange);
		KAWARA_SH_magenta = new TabBlock_noFuel("block_ksh_magenta", JPBlock_Blocks.KAWARA_SH_magenta);
		KAWARA_SH_lightb = new TabBlock_noFuel("block_ksh_lightb", JPBlock_Blocks.KAWARA_SH_lightb);
		KAWARA_SH_yellow = new TabBlock_noFuel("block_ksh_yellow", JPBlock_Blocks.KAWARA_SH_yellow);
		KAWARA_SH_lime = new TabBlock_noFuel("block_ksh_lime", JPBlock_Blocks.KAWARA_SH_lime);
		KAWARA_SH_pink = new TabBlock_noFuel("block_ksh_pink", JPBlock_Blocks.KAWARA_SH_pink);
		KAWARA_SH_gray = new TabBlock_noFuel("block_ksh_gray", JPBlock_Blocks.KAWARA_SH_gray);
		KAWARA_SH_lightg = new TabBlock_noFuel("block_ksh_lightg", JPBlock_Blocks.KAWARA_SH_lightg);
		KAWARA_SH_cyan = new TabBlock_noFuel("block_ksh_cyan", JPBlock_Blocks.KAWARA_SH_cyan);
		KAWARA_SH_purple = new TabBlock_noFuel("block_ksh_purple", JPBlock_Blocks.KAWARA_SH_purple);
		KAWARA_SH_blue = new TabBlock_noFuel("block_ksh_blue", JPBlock_Blocks.KAWARA_SH_blue);
		KAWARA_SH_brown = new TabBlock_noFuel("block_ksh_brown", JPBlock_Blocks.KAWARA_SH_brown);
		KAWARA_SH_green = new TabBlock_noFuel("block_ksh_green", JPBlock_Blocks.KAWARA_SH_green);
		KAWARA_SH_red = new TabBlock_noFuel("block_ksh_red", JPBlock_Blocks.KAWARA_SH_red);
		KAWARA_SH_black = new TabBlock_noFuel("block_ksh_black", JPBlock_Blocks.KAWARA_SH_black);
		KAWARA_ST_white = new TabBlock_noFuel("block_kst_white", JPBlock_Blocks.KAWARA_ST_white);
		KAWARA_ST_orange = new TabBlock_noFuel("block_kst_orange", JPBlock_Blocks.KAWARA_ST_orange);
		KAWARA_ST_magenta = new TabBlock_noFuel("block_kst_magenta", JPBlock_Blocks.KAWARA_ST_magenta);
		KAWARA_ST_lightb = new TabBlock_noFuel("block_kst_lightb", JPBlock_Blocks.KAWARA_ST_lightb);
		KAWARA_ST_yellow = new TabBlock_noFuel("block_kst_yellow", JPBlock_Blocks.KAWARA_ST_yellow);
		KAWARA_ST_lime = new TabBlock_noFuel("block_kst_lime", JPBlock_Blocks.KAWARA_ST_lime);
		KAWARA_ST_pink = new TabBlock_noFuel("block_kst_pink", JPBlock_Blocks.KAWARA_ST_pink);
		KAWARA_ST_gray = new TabBlock_noFuel("block_kst_gray", JPBlock_Blocks.KAWARA_ST_gray);
		KAWARA_ST_lightg = new TabBlock_noFuel("block_kst_lightg", JPBlock_Blocks.KAWARA_ST_lightg);
		KAWARA_ST_cyan = new TabBlock_noFuel("block_kst_cyan", JPBlock_Blocks.KAWARA_ST_cyan);
		KAWARA_ST_purple = new TabBlock_noFuel("block_kst_purple", JPBlock_Blocks.KAWARA_ST_purple);
		KAWARA_ST_blue = new TabBlock_noFuel("block_kst_blue", JPBlock_Blocks.KAWARA_ST_blue);
		KAWARA_ST_brown = new TabBlock_noFuel("block_kst_brown", JPBlock_Blocks.KAWARA_ST_brown);
		KAWARA_ST_green = new TabBlock_noFuel("block_kst_green", JPBlock_Blocks.KAWARA_ST_green);
		KAWARA_ST_red = new TabBlock_noFuel("block_kst_red", JPBlock_Blocks.KAWARA_ST_red);
		KAWARA_ST_black = new TabBlock_noFuel("block_kst_black", JPBlock_Blocks.KAWARA_ST_black);

		DIRTWALL = new DirtWall_WT("block_dirtwall");
		DIRTWALL_SH = new TabBlock_noFuel("block_dirtwall_sh", JPBlock_Blocks.DIRTWALL_SH);
		DIRTWALL_ST = new TabBlock_noFuel("block_dirtwall_st", JPBlock_Blocks.DIRTWALL_ST);

		SHIKKUI = new Shikkui_WT("block_plaster");
		SHIKKUI_SH_white = new Shikkui_Slab("block_psh_white", JPBlock_Blocks.SHIKKUI_SH_white);
		SHIKKUI_SH_orange = new Shikkui_Slab("block_psh_orange", JPBlock_Blocks.SHIKKUI_SH_orange);
		SHIKKUI_SH_magenta = new Shikkui_Slab("block_psh_magenta", JPBlock_Blocks.SHIKKUI_SH_magenta);
		SHIKKUI_SH_lightb = new Shikkui_Slab("block_psh_lightb", JPBlock_Blocks.SHIKKUI_SH_lightb);
		SHIKKUI_SH_yellow = new Shikkui_Slab("block_psh_yellow", JPBlock_Blocks.SHIKKUI_SH_yellow);
		SHIKKUI_SH_lime = new Shikkui_Slab("block_psh_lime", JPBlock_Blocks.SHIKKUI_SH_lime);
		SHIKKUI_SH_pink = new Shikkui_Slab("block_psh_pink", JPBlock_Blocks.SHIKKUI_SH_pink);
		SHIKKUI_SH_gray = new Shikkui_Slab("block_psh_gray", JPBlock_Blocks.SHIKKUI_SH_gray);
		SHIKKUI_SH_lightg = new Shikkui_Slab("block_psh_lightg", JPBlock_Blocks.SHIKKUI_SH_lightg);
		SHIKKUI_SH_cyan = new Shikkui_Slab("block_psh_cyan", JPBlock_Blocks.SHIKKUI_SH_cyan);
		SHIKKUI_SH_purple = new Shikkui_Slab("block_psh_purple", JPBlock_Blocks.SHIKKUI_SH_purple);
		SHIKKUI_SH_blue = new Shikkui_Slab("block_psh_blue", JPBlock_Blocks.SHIKKUI_SH_blue);
		SHIKKUI_SH_brown = new Shikkui_Slab("block_psh_brown", JPBlock_Blocks.SHIKKUI_SH_brown);
		SHIKKUI_SH_green = new Shikkui_Slab("block_psh_green", JPBlock_Blocks.SHIKKUI_SH_green);
		SHIKKUI_SH_red = new Shikkui_Slab("block_psh_red", JPBlock_Blocks.SHIKKUI_SH_red);
		SHIKKUI_SH_black = new Shikkui_Slab("block_psh_black", JPBlock_Blocks.SHIKKUI_SH_black);
		SHIKKUI_ST_white = new TabBlock_noFuel("block_pst_white", JPBlock_Blocks.SHIKKUI_ST_white);
		SHIKKUI_ST_orange = new TabBlock_noFuel("block_pst_orange", JPBlock_Blocks.SHIKKUI_ST_orange);
		SHIKKUI_ST_magenta = new TabBlock_noFuel("block_pst_magenta", JPBlock_Blocks.SHIKKUI_ST_magenta);
		SHIKKUI_ST_lightb = new TabBlock_noFuel("block_pst_lightb", JPBlock_Blocks.SHIKKUI_ST_lightb);
		SHIKKUI_ST_yellow = new TabBlock_noFuel("block_pst_yellow", JPBlock_Blocks.SHIKKUI_ST_yellow);
		SHIKKUI_ST_lime = new TabBlock_noFuel("block_pst_lime", JPBlock_Blocks.SHIKKUI_ST_lime);
		SHIKKUI_ST_pink = new TabBlock_noFuel("block_pst_pink", JPBlock_Blocks.SHIKKUI_ST_pink);
		SHIKKUI_ST_gray = new TabBlock_noFuel("block_pst_gray", JPBlock_Blocks.SHIKKUI_ST_gray);
		SHIKKUI_ST_lightg = new TabBlock_noFuel("block_pst_lightg", JPBlock_Blocks.SHIKKUI_ST_lightg);
		SHIKKUI_ST_cyan = new TabBlock_noFuel("block_pst_cyan", JPBlock_Blocks.SHIKKUI_ST_cyan);
		SHIKKUI_ST_purple = new TabBlock_noFuel("block_pst_purple", JPBlock_Blocks.SHIKKUI_ST_purple);
		SHIKKUI_ST_blue = new TabBlock_noFuel("block_pst_blue", JPBlock_Blocks.SHIKKUI_ST_blue);
		SHIKKUI_ST_brown = new TabBlock_noFuel("block_pst_brown", JPBlock_Blocks.SHIKKUI_ST_brown);
		SHIKKUI_ST_green = new TabBlock_noFuel("block_pst_green", JPBlock_Blocks.SHIKKUI_ST_green);
		SHIKKUI_ST_red = new TabBlock_noFuel("block_pst_red", JPBlock_Blocks.SHIKKUI_ST_red);
		SHIKKUI_ST_black = new TabBlock_noFuel("block_pst_black", JPBlock_Blocks.SHIKKUI_ST_black);

		NAMAKO = new Namako_WT("block_namako");
		NAMAKO_SH_white = new TabBlock_noFuel("block_nsh_white", JPBlock_Blocks.NAMAKO_SH_white);
		NAMAKO_SH_orange = new TabBlock_noFuel("block_nsh_orange", JPBlock_Blocks.NAMAKO_SH_orange);
		NAMAKO_SH_magenta = new TabBlock_noFuel("block_nsh_magenta", JPBlock_Blocks.NAMAKO_SH_magenta);
		NAMAKO_SH_lightb = new TabBlock_noFuel("block_nsh_lightb", JPBlock_Blocks.NAMAKO_SH_lightb);
		NAMAKO_SH_yellow = new TabBlock_noFuel("block_nsh_yellow", JPBlock_Blocks.NAMAKO_SH_yellow);
		NAMAKO_SH_lime = new TabBlock_noFuel("block_nsh_lime", JPBlock_Blocks.NAMAKO_SH_lime);
		NAMAKO_SH_pink = new TabBlock_noFuel("block_nsh_pink", JPBlock_Blocks.NAMAKO_SH_pink);
		NAMAKO_SH_gray = new TabBlock_noFuel("block_nsh_gray", JPBlock_Blocks.NAMAKO_SH_gray);
		NAMAKO_SH_lightg = new TabBlock_noFuel("block_nsh_lightg", JPBlock_Blocks.NAMAKO_SH_lightg);
		NAMAKO_SH_cyan = new TabBlock_noFuel("block_nsh_cyan", JPBlock_Blocks.NAMAKO_SH_cyan);
		NAMAKO_SH_purple = new TabBlock_noFuel("block_nsh_purple", JPBlock_Blocks.NAMAKO_SH_purple);
		NAMAKO_SH_blue = new TabBlock_noFuel("block_nsh_blue", JPBlock_Blocks.NAMAKO_SH_blue);
		NAMAKO_SH_brown = new TabBlock_noFuel("block_nsh_brown", JPBlock_Blocks.NAMAKO_SH_brown);
		NAMAKO_SH_green = new TabBlock_noFuel("block_nsh_green", JPBlock_Blocks.NAMAKO_SH_green);
		NAMAKO_SH_red = new TabBlock_noFuel("block_nsh_red", JPBlock_Blocks.NAMAKO_SH_red);
		NAMAKO_SH_black = new TabBlock_noFuel("block_nsh_black", JPBlock_Blocks.NAMAKO_SH_black);
		NAMAKO_ST_white = new TabBlock_noFuel("block_nst_white", JPBlock_Blocks.NAMAKO_ST_white);
		NAMAKO_ST_orange = new TabBlock_noFuel("block_nst_orange", JPBlock_Blocks.NAMAKO_ST_orange);
		NAMAKO_ST_magenta = new TabBlock_noFuel("block_nst_magenta", JPBlock_Blocks.NAMAKO_ST_magenta);
		NAMAKO_ST_lightb = new TabBlock_noFuel("block_nst_lightb", JPBlock_Blocks.NAMAKO_ST_lightb);
		NAMAKO_ST_yellow = new TabBlock_noFuel("block_nst_yellow", JPBlock_Blocks.NAMAKO_ST_yellow);
		NAMAKO_ST_lime = new TabBlock_noFuel("block_nst_lime", JPBlock_Blocks.NAMAKO_ST_lime);
		NAMAKO_ST_pink = new TabBlock_noFuel("block_nst_pink", JPBlock_Blocks.NAMAKO_ST_pink);
		NAMAKO_ST_gray = new TabBlock_noFuel("block_nst_gray", JPBlock_Blocks.NAMAKO_ST_gray);
		NAMAKO_ST_lightg = new TabBlock_noFuel("block_nst_lightg", JPBlock_Blocks.NAMAKO_ST_lightg);
		NAMAKO_ST_cyan = new TabBlock_noFuel("block_nst_cyan", JPBlock_Blocks.NAMAKO_ST_cyan);
		NAMAKO_ST_purple = new TabBlock_noFuel("block_nst_purple", JPBlock_Blocks.NAMAKO_ST_purple);
		NAMAKO_ST_blue = new TabBlock_noFuel("block_nst_blue", JPBlock_Blocks.NAMAKO_ST_blue);
		NAMAKO_ST_brown = new TabBlock_noFuel("block_nst_brown", JPBlock_Blocks.NAMAKO_ST_brown);
		NAMAKO_ST_green = new TabBlock_noFuel("block_nst_green", JPBlock_Blocks.NAMAKO_ST_green);
		NAMAKO_ST_red = new TabBlock_noFuel("block_nst_red", JPBlock_Blocks.NAMAKO_ST_red);
		NAMAKO_ST_black = new TabBlock_noFuel("block_nst_black", JPBlock_Blocks.NAMAKO_ST_black);

		NAMAKOB = new NamakoB_WT("block_namako_b");
		NAMAKOB_SH_white = new TabBlock_noFuel("block_nsh_b_white", JPBlock_Blocks.NAMAKOB_SH_white);
		NAMAKOB_SH_orange = new TabBlock_noFuel("block_nsh_b_orange", JPBlock_Blocks.NAMAKOB_SH_orange);
		NAMAKOB_SH_magenta = new TabBlock_noFuel("block_nsh_b_magenta", JPBlock_Blocks.NAMAKOB_SH_magenta);
		NAMAKOB_SH_lightb = new TabBlock_noFuel("block_nsh_b_lightb", JPBlock_Blocks.NAMAKOB_SH_lightb);
		NAMAKOB_SH_yellow = new TabBlock_noFuel("block_nsh_b_yellow", JPBlock_Blocks.NAMAKOB_SH_yellow);
		NAMAKOB_SH_lime = new TabBlock_noFuel("block_nsh_b_lime", JPBlock_Blocks.NAMAKOB_SH_lime);
		NAMAKOB_SH_pink = new TabBlock_noFuel("block_nsh_b_pink", JPBlock_Blocks.NAMAKOB_SH_pink);
		NAMAKOB_SH_gray = new TabBlock_noFuel("block_nsh_b_gray", JPBlock_Blocks.NAMAKOB_SH_gray);
		NAMAKOB_SH_lightg = new TabBlock_noFuel("block_nsh_b_lightg", JPBlock_Blocks.NAMAKOB_SH_lightg);
		NAMAKOB_SH_cyan = new TabBlock_noFuel("block_nsh_b_cyan", JPBlock_Blocks.NAMAKOB_SH_cyan);
		NAMAKOB_SH_purple = new TabBlock_noFuel("block_nsh_b_purple", JPBlock_Blocks.NAMAKOB_SH_purple);
		NAMAKOB_SH_blue = new TabBlock_noFuel("block_nsh_b_blue", JPBlock_Blocks.NAMAKOB_SH_blue);
		NAMAKOB_SH_brown = new TabBlock_noFuel("block_nsh_b_brown", JPBlock_Blocks.NAMAKOB_SH_brown);
		NAMAKOB_SH_green = new TabBlock_noFuel("block_nsh_b_green", JPBlock_Blocks.NAMAKOB_SH_green);
		NAMAKOB_SH_red = new TabBlock_noFuel("block_nsh_b_red", JPBlock_Blocks.NAMAKOB_SH_red);
		NAMAKOB_SH_black = new TabBlock_noFuel("block_nsh_b_black", JPBlock_Blocks.NAMAKOB_SH_black);
		NAMAKOB_ST_white = new TabBlock_noFuel("block_nst_b_white", JPBlock_Blocks.NAMAKOB_ST_white);
		NAMAKOB_ST_orange = new TabBlock_noFuel("block_nst_b_orange", JPBlock_Blocks.NAMAKOB_ST_orange);
		NAMAKOB_ST_magenta = new TabBlock_noFuel("block_nst_b_magenta", JPBlock_Blocks.NAMAKOB_ST_magenta);
		NAMAKOB_ST_lightb = new TabBlock_noFuel("block_nst_b_lightb", JPBlock_Blocks.NAMAKOB_ST_lightb);
		NAMAKOB_ST_yellow = new TabBlock_noFuel("block_nst_b_yellow", JPBlock_Blocks.NAMAKOB_ST_yellow);
		NAMAKOB_ST_lime = new TabBlock_noFuel("block_nst_b_lime", JPBlock_Blocks.NAMAKOB_ST_lime);
		NAMAKOB_ST_pink = new TabBlock_noFuel("block_nst_b_pink", JPBlock_Blocks.NAMAKOB_ST_pink);
		NAMAKOB_ST_gray = new TabBlock_noFuel("block_nst_b_gray", JPBlock_Blocks.NAMAKOB_ST_gray);
		NAMAKOB_ST_lightg = new TabBlock_noFuel("block_nst_b_lightg", JPBlock_Blocks.NAMAKOB_ST_lightg);
		NAMAKOB_ST_cyan = new TabBlock_noFuel("block_nst_b_cyan", JPBlock_Blocks.NAMAKOB_ST_cyan);
		NAMAKOB_ST_purple = new TabBlock_noFuel("block_nst_b_purple", JPBlock_Blocks.NAMAKOB_ST_purple);
		NAMAKOB_ST_blue = new TabBlock_noFuel("block_nst_b_blue", JPBlock_Blocks.NAMAKOB_ST_blue);
		NAMAKOB_ST_brown = new TabBlock_noFuel("block_nst_b_brown", JPBlock_Blocks.NAMAKOB_ST_brown);
		NAMAKOB_ST_green = new TabBlock_noFuel("block_nst_b_green", JPBlock_Blocks.NAMAKOB_ST_green);
		NAMAKOB_ST_red = new TabBlock_noFuel("block_nst_b_red", JPBlock_Blocks.NAMAKOB_ST_red);
		NAMAKOB_ST_black = new TabBlock_noFuel("block_nst_b_black", JPBlock_Blocks.NAMAKOB_ST_black);

		DIRTWALL_WALL = new Wall_DirtWall_WT("block_dirtwall_wall");
		SHIKKUI_WALL = new WallPlaster_WT("block_pwall");
		NAMAKO_WALL = new WallNamako_WT("block_nwall");
		NAMAKOB_WALL = new WallNamakoB_WT("block_nwall_b");
		
		DIRTWALL_SAMA = new TabBlock_noFuel("block_dirtwall_sama", JPBlock_Blocks.DIRTWALL_SAMA);
		SHIKKUI_SAMA_white = new TabBlock_noFuel("block_sama_white", JPBlock_Blocks.SHIKKUI_SAMA_white);
		SHIKKUI_SAMA_orange = new TabBlock_noFuel("block_sama_orange", JPBlock_Blocks.SHIKKUI_SAMA_orange);
		SHIKKUI_SAMA_magenta = new TabBlock_noFuel("block_sama_magenta", JPBlock_Blocks.SHIKKUI_SAMA_magenta);
		SHIKKUI_SAMA_lightb = new TabBlock_noFuel("block_sama_lightb", JPBlock_Blocks.SHIKKUI_SAMA_lightb);
		SHIKKUI_SAMA_yellow = new TabBlock_noFuel("block_sama_yellow", JPBlock_Blocks.SHIKKUI_SAMA_yellow);
		SHIKKUI_SAMA_lime = new TabBlock_noFuel("block_sama_lime", JPBlock_Blocks.SHIKKUI_SAMA_lime);
		SHIKKUI_SAMA_pink = new TabBlock_noFuel("block_sama_pink", JPBlock_Blocks.SHIKKUI_SAMA_pink);
		SHIKKUI_SAMA_gray = new TabBlock_noFuel("block_sama_gray", JPBlock_Blocks.SHIKKUI_SAMA_gray);
		SHIKKUI_SAMA_lightg = new TabBlock_noFuel("block_sama_lightg", JPBlock_Blocks.SHIKKUI_SAMA_lightg);
		SHIKKUI_SAMA_cyan = new TabBlock_noFuel("block_sama_cyan", JPBlock_Blocks.SHIKKUI_SAMA_cyan);
		SHIKKUI_SAMA_purple = new TabBlock_noFuel("block_sama_purple", JPBlock_Blocks.SHIKKUI_SAMA_purple);
		SHIKKUI_SAMA_blue = new TabBlock_noFuel("block_sama_blue", JPBlock_Blocks.SHIKKUI_SAMA_blue);
		SHIKKUI_SAMA_brown = new TabBlock_noFuel("block_sama_brown", JPBlock_Blocks.SHIKKUI_SAMA_brown);
		SHIKKUI_SAMA_green = new TabBlock_noFuel("block_sama_green", JPBlock_Blocks.SHIKKUI_SAMA_green);
		SHIKKUI_SAMA_red = new TabBlock_noFuel("block_sama_red", JPBlock_Blocks.SHIKKUI_SAMA_red);
		SHIKKUI_SAMA_black = new TabBlock_noFuel("block_sama_black", JPBlock_Blocks.SHIKKUI_SAMA_black);
		
		KAWARA_WALL = new WallKawara_WT("block_kwall");
	}
