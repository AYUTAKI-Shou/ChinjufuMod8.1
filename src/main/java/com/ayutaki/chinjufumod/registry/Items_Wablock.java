...
public class Items_Wablock {
	...
	public static Item CLAYKAWARA = register("item_claykawara", new AddInfo_NT(new Item.Properties().tab(ItemGroups_CM.WABLOCK)));
	public static Item SHOUSEKKAI = register("item_shousekkai_c", new AddInfo_NT(new Item.Properties().tab(ItemGroups_CM.WABLOCK)));
