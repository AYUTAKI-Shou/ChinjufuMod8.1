...
public final class Door_Blocks {
	...
	public static WoodFenceGate_CM SAKURA_FGATE;
	public static WoodFenceGate_CM KAEDE_FGATE;
	public static WoodFenceGate_CM ICHOH_FGATE;
	...
	public static void load(FMLPreInitializationEvent event) {
		...
		SAKURA_FGATE = new WoodFenceGate_CM("block_fencegate_sakura");
		KAEDE_FGATE = new WoodFenceGate_CM("block_fencegate_kaede");
		ICHOH_FGATE = new WoodFenceGate_CM("block_fencegate_ichoh");
