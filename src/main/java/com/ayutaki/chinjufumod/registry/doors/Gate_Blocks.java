...
public final class Gate_Blocks {
	...
	public static void load(FMLPreInitializationEvent event) {
		GATE_SPRUCE = new WoodenGate_1("block_gate_spruce");
		GATE_SPRUCE2 = new WoodenGate_2("block_gate_spruce2");
		GATE_SPRUCE_B = new WoodenGate_1("block_gate_spruce_b");
		GATE_SPRUCE_B2 = new WoodenGate_2("block_gate_spruce_b2");
		
		GATE_IRON = new IronGate_1("block_gate_iron");
		GATE_IRON2 = new IronGate_2("block_gate_iron2");
		GATE_IRONGRILL = new GrillGate_1("block_gate_irongrill");
		GATE_IRONGRILL2 = new GrillGate_2("block_gate_irongrill2");
	}
}
