...
public class Items_Weapon {
	...
	public static final RegistryObject<Item> ZUIUN = register("item_sb_zuiun", () -> new SB_Zuiun(new Item.Properties().durability(1100)));
	public static final RegistryObject<Item> SEIRAN = register("item_sb_seiran", () -> new SB_Seiran(new Item.Properties().durability(1600)));
	...
	public static final RegistryObject<Item> ANCHOR = register("item_anchor", () -> new Anchor(CMTiers.ANCHOR, (new Item.Properties().attributes(Anchor.createAttributes(CMTiers.ANCHOR, 3, -2.4F)))));
	...
	public static final RegistryObject<Item> DEVICE_RADER = register("item_device_radar", () -> new Device_Radar(new Item.Properties().stacksTo(1)));
	public static final RegistryObject<Item> DEVICE_SONAR = register("item_device_sonar", () -> new Device_Sonar(new Item.Properties().stacksTo(1)));
	...
	public static final RegistryObject<Item> SWORD_sakura = register("item_sword_sakura", () -> new Sword_CM(Tiers.WOOD, (new Item.Properties().attributes(Sword_CM.createAttributes(Tiers.WOOD, 3, -2.4F)))));
	public static final RegistryObject<Item> SWORD_ichoh = register("item_sword_ichoh", () -> new Sword_CM(Tiers.WOOD, (new Item.Properties().attributes(Sword_CM.createAttributes(Tiers.WOOD, 3, -2.4F)))));
	public static final RegistryObject<Item> SWORD_kaede = register("item_sword_kaede", () -> new Sword_CM(Tiers.WOOD, (new Item.Properties().attributes(Sword_CM.createAttributes(Tiers.WOOD, 3, -2.4F)))));
