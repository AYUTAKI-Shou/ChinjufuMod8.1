...
import com.ayutaki.chinjufumod.items.sakuteki.Bell_CM;
...
public class Items_Weapon {
	...
	public static Item AMMUNITION_L, AMMUNITION_M, AMMUNITION_S, AMMUNITION_K, KK_FUEL;
	...
	public static Item ZUIUN, SEIRAN, GYORAI_61cm;
	public static Item SHIELD_kuchiku, SHIELD_yura, SHIELD_mogami, SHIELD_kongou;

	public static Item ANCHOR, DAMECON, BELL, DEVICE_RADER, DEVICE_SONAR, SOUGANKYOU;
	...
	public static void init() {
		...
		ZUIUN = new SB_Zuiun("item_sb_zuiun", 1100);
		SEIRAN = new SB_Seiran("item_sb_seiran", 1600);
		...
		BELL = new Bell_CM("item_bell");
		DEVICE_RADER = new Device_Radar("item_device_radar"); 
		DEVICE_SONAR = new Device_Sonar("item_device_sonar");
	...
	public static void register() {
		...
		registerItem(BELL);
		registerItem(DEVICE_RADER);
		registerItem(DEVICE_SONAR);
	...
	public static void registerRenders() {
		...
		registerRender(ZUIUN);
		registerRender(SEIRAN);
		...
		registerRender(BELL);
		registerRender(DEVICE_RADER);
		registerRender(DEVICE_SONAR);
