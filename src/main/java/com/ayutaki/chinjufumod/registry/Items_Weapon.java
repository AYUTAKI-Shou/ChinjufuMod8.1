...
public class Items_Weapon {
	...
	public static Item TYPE97KK = register("item_kk_type97", new KK_Type97(new Item.Properties().durability(1100)));
	...
	public static Item ZUIUN = register("item_sb_zuiun", new SB_Zuiun(new Item.Properties().durability(1100)));
	public static Item SEIRAN = register("item_sb_seiran", new SB_Seiran(new Item.Properties().durability(1600)));
	...
	public static Item DEVICE_RADER = register("item_device_radar", new Device_Radar(new Item.Properties().stacksTo(1)));
	public static Item DEVICE_SONAR = register("item_device_sonar", new Device_Sonar(new Item.Properties().stacksTo(1)));
