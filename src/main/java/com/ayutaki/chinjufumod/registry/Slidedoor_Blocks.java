...
public class Slidedoor_Blocks {
	...
	public static final RegistryObject<Block> GARASUDO_MANGROVE = register("block_garasudo_mangrove", () -> glassdoor());
	public static final RegistryObject<Block> GARASUDO_CHERRY = register("block_garasudo_cherry", () -> glassdoor());
	...
	public static final RegistryObject<Block> GARASUDOB_MANGROVE = register("block_garasudob_mangrove", () -> glassdoor());
	public static final RegistryObject<Block> GARASUDOB_CHERRY = register("block_garasudob_cherry", () -> glassdoor());
	...
	public static final RegistryObject<Block> GARASUDOH_MANGROVE = register("block_garasudohalf_mangrove", () -> glassdoorHalf());
	public static final RegistryObject<Block> GARASUDOH_CHERRY = register("block_garasudohalf_cherry", () -> glassdoorHalf());
	...
	public static final RegistryObject<Block> SHOUJI_MANGROVE = register("block_shouji_mangrove", () -> shouji());
	public static final RegistryObject<Block> SHOUJI_CHERRY = register("block_shouji_cherry", () -> shouji());
	...
	public static final RegistryObject<Block> SHOUJIB_MANGROVE = register("block_shoujib_mangrove", () -> shouji());
	public static final RegistryObject<Block> SHOUJIB_CHERRY = register("block_shoujib_cherry", () -> shouji());
	...
	public static final RegistryObject<Block> SHOUJIH_MANGROVE = register("block_shoujihalf_mangrove", () -> shoujiHalf());
	public static final RegistryObject<Block> SHOUJIH_CHERRY = register("block_shoujihalf_cherry", () -> shoujiHalf());
	...
	public static final RegistryObject<Block> SHOUJI_WIN_MANGROVE = register("block_shoujih_mangrove", () -> shoujiWin());
	public static final RegistryObject<Block> SHOUJI_WIN_CHERRY = register("block_shoujih_cherry", () -> shoujiWin());
	...
	public static final RegistryObject<Block> SHOUJI_WINR_MANGROVE = register("block_shoujihr_mangrove", () -> shoujiWin());
	public static final RegistryObject<Block> SHOUJI_WINR_CHERRY = register("block_shoujihr_cherry", () -> shoujiWin());
