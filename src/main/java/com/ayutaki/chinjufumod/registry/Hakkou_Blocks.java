...
import com.ayutaki.chinjufumod.blocks.hakkou.Bin_Vanilla;
...
import com.ayutaki.chinjufumod.blocks.hakkou.Taru_Hakkou_sub;
...
public final class Hakkou_Blocks {
	...
	public static Block SHOUYU_bot, KOMEZU_bot, DASHI_bot, VANILLA_bot;

	public static Block HAKKOUTARU, HAKKOUTARU_sub, SHOUYUTARU, HAKUSAITARU;
	...
	public static void init() {
		...
		KOMEZU_bot = new Bin_KomezuOil("block_komezu_bot");
		DASHI_bot = new Bin_DashiMayoSauce("block_dashi_bot");
		VANILLA_bot = new Bin_Vanilla("block_vanilla_bot");
		
		HAKKOUTARU = new Taru_Hakkou("block_taru_hakkou");
		HAKKOUTARU_sub = new Taru_Hakkou_sub("block_taru_hakkou_sub");
	...
	public static void register() {
		...
		registerBlock(VANILLA_bot);
		
		registerBlock(HAKKOUTARU);
		registerBlock(HAKKOUTARU_sub);
