...
public class Hakkou_Blocks {
	...
	public static final RegistryObject<Block> KOUBOBOT_full = register("block_bin_koubo_f", () -> new Bot_KouboNyusan(stoneState().randomTicks()));
	public static final RegistryObject<Block> NYUSANBOT_full = register("block_bin_nyusan_f", () -> new Bot_KouboNyusan(stoneState().randomTicks()));
	...
	/* Barrel */
	public static final RegistryObject<Block> HAKKOU_TARU = register("block_taru_hakkou", () -> new Taru_Hakkou(BlockBehaviour.Properties.of(Material.WOOD).strength(1.0F, 4.2F)
	...
	public static final RegistryObject<Block> SHUBO_TARU = register("block_taru_shubo_f", () -> new Taru_ShuboMoromi(taruRandom()));
	public static final RegistryObject<Block> MOROMI_TARU = register("block_taru_moromi_f", () -> new Taru_ShuboMoromi(taruRandom()));
	public static final RegistryObject<Block> JUKUSEI_TARU = register("block_taru_jukusei_f", () -> new Taru_Jukusei(taruRandom()));

	public static final RegistryObject<Block> RINGOSHU_TARU = register("block_taru_ringoshu_f", () -> new TaruY_WineCiderMead(taruRandom()));
	public static final RegistryObject<Block> BUDOUSHU_TARU = register("block_taru_budoushu_f", () -> new TaruY_WineCiderMead(taruRandom()));
	public static final RegistryObject<Block> HACHIMITSU_TARU = register("block_taru_hachimitsushu_f", () -> new TaruY_WineCiderMead(taruRandom()));
	...
	public static final RegistryObject<Block> NABEAMAZAKE_nama = register("block_food_nabeaz_n", () -> new Nabe_NamaSoup(stoneState()));
	...
	public static final RegistryObject<Block> SHOUYU_TARU = register("block_taru_shouyu_f", () -> new TaruF_ShouyuKomezu(taruRandom()));
	public static final RegistryObject<Block> KOMEZU_TARU = register("block_taru_komezu_f", () -> new TaruF_ShouyuKomezu(taruRandom()));
	public static final RegistryObject<Block> KINOKO_TARU = register("block_taru_kinoko_f", () -> new Tana_KinokoKonbuVanilla(taruRandom().isSuffocating(Hakkou_Blocks::never)));
	public static final RegistryObject<Block> KONBU_TARU = register("block_taru_konbu_f", () -> new Tana_KinokoKonbuVanilla(taruRandom().isSuffocating(Hakkou_Blocks::never)));
	public static final RegistryObject<Block> NORI_TARU = register("block_taru_nori_f", () -> new Tana_ChaNoriPepper(taruRandom().isSuffocating(Hakkou_Blocks::never)));
	public static final RegistryObject<Block> KOUCHA_TARU = register("block_taru_koucha_f", () -> new Tana_ChaNoriPepper(taruRandom().isSuffocating(Hakkou_Blocks::never)));
	public static final RegistryObject<Block> PEPPER_TARU = register("block_taru_pepper_f", () -> new Tana_ChaNoriPepper(taruRandom().isSuffocating(Hakkou_Blocks::never)));
	public static final RegistryObject<Block> VANILLA_TARU = register("block_taru_vanilla_f", () -> new Tana_KinokoKonbuVanilla(taruRandom().isSuffocating(Hakkou_Blocks::never)));

	public static final RegistryObject<Block> SHOUYU_bot_14 = register("block_shouyu_bot", () -> new Bot_Shouyu(stoneState()));
	public static final RegistryObject<Block> SHOUYU_bot_24 = register("block_shouyu_bot_2", () -> new Bot_Shouyu(stoneState()));
	public static final RegistryObject<Block> SHOUYU_bot_34 = register("block_shouyu_bot_3", () -> new Bot_Shouyu(stoneState()));
	public static final RegistryObject<Block> SHOUYU_bot_44 = register("block_shouyu_bot_4", () -> new Bot_Shouyu(stoneState()));

	public static final RegistryObject<Block> KOMEZU_bot_12 = register("block_komezu_bot", () -> new Bot_Shouyu(stoneState()));
	public static final RegistryObject<Block> KOMEZU_bot_22 = register("block_komezu_bot_2", () -> new Bot_Shouyu(stoneState()));

	public static final RegistryObject<Block> DASHI_bot_14 = register("block_dashi_bot", () -> new Bot_Dashi(stoneState()));
	public static final RegistryObject<Block> DASHI_bot_24 = register("block_dashi_bot_2", () -> new Bot_Dashi(stoneState()));
	public static final RegistryObject<Block> DASHI_bot_34 = register("block_dashi_bot_3", () -> new Bot_Dashi(stoneState()));
	public static final RegistryObject<Block> DASHI_bot_44 = register("block_dashi_bot_4", () -> new Bot_Dashi(stoneState()));

	public static final RegistryObject<Block> VANILLA_bot_14 = register("block_vanilla_bot", () -> new Bot_Vanilla(stoneState()));
	public static final RegistryObject<Block> VANILLA_bot_24 = register("block_vanilla_bot_2", () -> new Bot_Vanilla(stoneState()));
	public static final RegistryObject<Block> VANILLA_bot_34 = register("block_vanilla_bot_3", () -> new Bot_Vanilla(stoneState()));
	public static final RegistryObject<Block> VANILLA_bot_44 = register("block_vanilla_bot_4", () -> new Bot_Vanilla(stoneState()));

	public static final RegistryObject<Block> COLD_MILK = register("block_zundou_coldmilk", 
			() -> new Zundou_ColdMilk(BlockBehaviour.Properties.of(Material.METAL).noCollission().strength(1.0F, 1.0F).sound(SoundType.METAL).noOcclusion().isValidSpawn(Hakkou_Blocks::neverEntity).isSuffocating(Hakkou_Blocks::never)));
	...
	private static Properties baseState() {
		return BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F, 1.0F).noOcclusion()
	...
	private static Properties taruRandom() {
		return BlockBehaviour.Properties.of(Material.WOOD).strength(1.0F, 4.2F).sound(SoundType.WOOD).noOcclusion()
				.isValidSpawn(Hakkou_Blocks::neverEntity).randomTicks();
	}

	private static Properties stoneState() {
		return BlockBehaviour.Properties.of(Material.STONE).noCollission().strength(1.0F, 1.0F).sound(SoundType.STONE).noOcclusion()
				.isValidSpawn(Hakkou_Blocks::neverEntity).isSuffocating(Hakkou_Blocks::never);
	}
