...
public class Hakkou_Blocks {
	...
	public static Block KOUBOBOT_full = register("block_bin_koubo_f", new Bot_KouboNyusan(stoneState().tickRandomly()));
	public static Block NYUSANBOT_full = register("block_bin_nyusan_f", new Bot_KouboNyusan(stoneState().tickRandomly()));

	public static Block MIZUOKE = register("block_mizuoke", new Mizuoke(baseState().sound(SoundType.WOOD).tickRandomly()));
	public static Block MIZUOKE_full = register("block_mizuoke_full", new Mizuoke_full(baseState().sound(SoundType.WOOD).tickRandomly()));
	...
	public static Block KOUJI_TARU = register("block_taru_kouji_f", new Tana_Kouji(taruRandom()));
	public static Block SHUBO_TARU = register("block_taru_shubo_f", new Taru_ShuboMoromi(taruRandom()));
	public static Block MOROMI_TARU = register("block_taru_moromi_f", new Taru_ShuboMoromi(taruRandom()));
	public static Block JUKUSEI_TARU = register("block_taru_jukusei_f", new Taru_Jukusei(taruRandom()));

	public static Block RINGOSHU_TARU = register("block_taru_ringoshu_f", new TaruY_WineCiderMead(taruRandom()));
	public static Block BUDOUSHU_TARU = register("block_taru_budoushu_f", new TaruY_WineCiderMead(taruRandom()));
	public static Block HACHIMITSU_TARU = register("block_taru_hachimitsushu_f", new TaruY_WineCiderMead(taruRandom()));
	...
	public static Block NABEAMAZAKE_nama = register("block_food_nabeaz_n", new Nabe_NamaSoup(stoneState()));
	...
	public static Block SHOUYU_TARU = register("block_taru_shouyu_f", new TaruF_ShouyuKomezu(taruRandom()));
	public static Block KOMEZU_TARU = register("block_taru_komezu_f", new TaruF_ShouyuKomezu(taruRandom()));
	public static Block KINOKO_TARU = register("block_taru_kinoko_f", new Tana_KinokoKonbuVanilla(taruRandom()));
	public static Block KONBU_TARU = register("block_taru_konbu_f", new Tana_KinokoKonbuVanilla(taruRandom()));
	public static Block NORI_TARU = register("block_taru_nori_f", new Tana_ChaNoriPepper(taruRandom()));
	public static Block KOUCHA_TARU = register("block_taru_koucha_f", new Tana_ChaNoriPepper(taruRandom()));
	public static Block PEPPER_TARU = register("block_taru_pepper_f", new Tana_ChaNoriPepper(taruRandom()));
	public static Block VANILLA_TARU = register("block_taru_vanilla_f", new Tana_KinokoKonbuVanilla(taruRandom()));

	public static Block SHOUYU_bot_14 = register("block_shouyu_bot", new Bot_Shouyu(stoneState()));
	public static Block SHOUYU_bot_24 = register("block_shouyu_bot_2", new Bot_Shouyu(stoneState()));
	public static Block SHOUYU_bot_34 = register("block_shouyu_bot_3", new Bot_Shouyu(stoneState()));
	public static Block SHOUYU_bot_44 = register("block_shouyu_bot_4", new Bot_Shouyu(stoneState()));

	public static Block KOMEZU_bot_12 = register("block_komezu_bot", new Bot_Shouyu(stoneState()));
	public static Block KOMEZU_bot_22 = register("block_komezu_bot_2", new Bot_Shouyu(stoneState()));

	public static Block DASHI_bot_14 = register("block_dashi_bot", new Bot_Dashi(stoneState()));
	public static Block DASHI_bot_24 = register("block_dashi_bot_2", new Bot_Dashi(stoneState()));
	public static Block DASHI_bot_34 = register("block_dashi_bot_3", new Bot_Dashi(stoneState()));
	public static Block DASHI_bot_44 = register("block_dashi_bot_4", new Bot_Dashi(stoneState()));

	public static Block VANILLA_bot_14 = register("block_vanilla_bot", new Bot_Vanilla(stoneState()));
	public static Block VANILLA_bot_24 = register("block_vanilla_bot_2", new Bot_Vanilla(stoneState()));
	public static Block VANILLA_bot_34 = register("block_vanilla_bot_3", new Bot_Vanilla(stoneState()));
	public static Block VANILLA_bot_44 = register("block_vanilla_bot_4", new Bot_Vanilla(stoneState()));
	...
	public static Block CHEESE_CURD = register("block_food_cheesecurd", new Cheese_Curd(baseState().sound(SoundType.SNOW).tickRandomly()));
	...
	private static Properties baseState() {
		return Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F, 1.0F).notSolid();
	}
	...
	private static Properties taruRandom() {
		return Block.Properties.create(Material.WOOD).hardnessAndResistance(1.0F, 4.2F)
				.sound(SoundType.WOOD).notSolid().tickRandomly();
	}

	private static Properties stoneState() {
		return Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F, 1.0F)
