...
public class Hakkou_Blocks {
	...
	public static Block KOUBOBOT_full = register("block_bin_koubo_f", new Bot_KouboNyusan(stoneState().randomTicks()));
	public static Block NYUSANBOT_full = register("block_bin_nyusan_f", new Bot_KouboNyusan(stoneState().randomTicks()));
	...
	public static Block KINOKO_TARU = register("block_taru_kinoko_f", new Tana_KinokoKonbuVanilla(taruRandom().isSuffocating(Hakkou_Blocks::never)));
	public static Block KONBU_TARU = register("block_taru_konbu_f", new Tana_KinokoKonbuVanilla(taruRandom().isSuffocating(Hakkou_Blocks::never)));
	public static Block NORI_TARU = register("block_taru_nori_f", new Tana_ChaNoriPepper(taruRandom().isSuffocating(Hakkou_Blocks::never)));
	public static Block KOUCHA_TARU = register("block_taru_koucha_f", new Tana_ChaNoriPepper(taruRandom().isSuffocating(Hakkou_Blocks::never)));
	public static Block PEPPER_TARU = register("block_taru_pepper_f", new Tana_ChaNoriPepper(taruRandom().isSuffocating(Hakkou_Blocks::never)));
	public static Block VANILLA_TARU = register("block_taru_vanilla_f", new Tana_KinokoKonbuVanilla(taruRandom().isSuffocating(Hakkou_Blocks::never)));
