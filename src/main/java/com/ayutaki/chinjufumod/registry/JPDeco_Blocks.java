...
public class JPDeco_Blocks {
	...
	private static BambooStairs bambooStairs() {
		return new BambooStairs(TAKECUBE.defaultBlockState(), woodState().noOcclusion().isValidSpawn(JPDeco_Blocks::neverEntityStairs).isSuffocating(JPDeco_Blocks::never));
	}
