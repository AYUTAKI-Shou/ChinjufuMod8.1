...
public class Chair_Blocks {
	...
	public static final RegistryObject<Block> DININGCHAIR_mangrove = register("block_diningchair_mangrove", () -> diningChair());
	public static final RegistryObject<Block> DININGCHAIR_cherry = register("block_diningchair_cherry", () -> diningChair());
	...
	public static final RegistryObject<Block> LOGCHAIR_mangrove = register("block_logchair_mangrove", () -> logChair());
	public static final RegistryObject<Block> LOGCHAIR_cherry = register("block_logchair_cherry", () -> logChair());
	...
	public static final RegistryObject<Block> BENCH_mangrove = register("block_bench_mangrove", () -> bench());
	public static final RegistryObject<Block> BENCH_cherry = register("block_bench_cherry", () -> bench());
