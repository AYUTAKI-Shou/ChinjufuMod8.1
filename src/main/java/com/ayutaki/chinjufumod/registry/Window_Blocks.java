...
public class Window_Blocks {
	...
	public static final RegistryObject<Block> WINDOW_mangrove = register("block_window_mangrove", () -> window());
	public static final RegistryObject<Block> WINDOW_cherry = register("block_window_cherry", () -> window());
	...
	public static final RegistryObject<Block> WINDOWB_mangrove = register("block_windowb_mangrove", () -> windowBtype());
	public static final RegistryObject<Block> WINDOWB_cherry = register("block_windowb_cherry", () -> windowBtype());
	...
	public static final RegistryObject<Block> WINDOWTALLBOT_mangrove = register("block_windowtallbot_mangrove", () -> windowTallBot());
	public static final RegistryObject<Block> WINDOWTALLBOT_cherry = register("block_windowtallbot_cherry", () -> windowTallBot());
	...
	public static final RegistryObject<Block> WINDOWTALLTOP_mangrove = register("block_windowtalltop_mangrove", () -> windowTallTop());
	public static final RegistryObject<Block> WINDOWTALLTOP_cherry = register("block_windowtalltop_cherry", () -> windowTallTop());
	...
	public static final RegistryObject<Block> WINDOWTALL_mangrove = register("block_windowtall_mangrove", () -> windowTall());
	public static final RegistryObject<Block> WINDOWTALL_cherry = register("block_windowtall_cherry", () -> windowTall());
