...
public class Window_Blocks {
	...
	private static Curtain curtain() {
		return new Curtain(Block.Properties.create(Material.WOOD).hardnessAndResistance(1.0F, 1.0F).sound(SoundType.CLOTH).doesNotBlockMovement().notSolid());
	}
	
	private static CurtainTall curtainTall() {
		return new CurtainTall(Block.Properties.create(Material.WOOD).hardnessAndResistance(1.0F, 1.0F).sound(SoundType.CLOTH).doesNotBlockMovement().notSolid());
	}
	
	private static CurtainLarge curtainLarge() {
		return new CurtainLarge(Block.Properties.create(Material.WOOD).hardnessAndResistance(1.0F, 1.0F).sound(SoundType.CLOTH).doesNotBlockMovement().notSolid());
	}
