...
public class WallPanel_JPBlocks {
	...
	public static void init() {
		...
		WP_BAMBOO = new WallPane_Stage3Wood("block_wp_bamboo").setCreativeTab(ChinjufuModTabs.WALLPANEL);
		WP_BAMBOO_Y = new WallPane_Stage3Wood("block_wp_bamboo_y").setCreativeTab(ChinjufuModTabs.WALLPANEL);
		WP_BAMBOO_K = new WallPane_Stage3Wood("block_wp_bamboo_k").setCreativeTab(ChinjufuModTabs.WALLPANEL);

		WP_DIRTWALL = new WallPane_Plaster("block_wp_dirtwall");
		WP_PLASTER_white = new WallPane_Plaster("block_wp_plaster_white");
		WP_PLASTER_orange = new WallPane_Plaster("block_wp_plaster_orange");
		WP_PLASTER_magenta = new WallPane_Plaster("block_wp_plaster_magenta");
		WP_PLASTER_lightb = new WallPane_Plaster("block_wp_plaster_lightb");
		WP_PLASTER_yellow = new WallPane_Plaster("block_wp_plaster_yellow");
		WP_PLASTER_lime = new WallPane_Plaster("block_wp_plaster_lime");
		WP_PLASTER_pink = new WallPane_Plaster("block_wp_plaster_pink");
		WP_PLASTER_gray = new WallPane_Plaster("block_wp_plaster_gray");
		WP_PLASTER_lightg = new WallPane_Plaster("block_wp_plaster_lightg");
		WP_PLASTER_cyan = new WallPane_Plaster("block_wp_plaster_cyan");
		WP_PLASTER_purple = new WallPane_Plaster("block_wp_plaster_purple");
		WP_PLASTER_blue = new WallPane_Plaster("block_wp_plaster_blue");
		WP_PLASTER_brown = new WallPane_Plaster("block_wp_plaster_brown");
		WP_PLASTER_green = new WallPane_Plaster("block_wp_plaster_green");
		WP_PLASTER_red = new WallPane_Plaster("block_wp_plaster_red");
		WP_PLASTER_black = new WallPane_Plaster("block_wp_plaster_black");

		WP_NAMAKO_white = new WallPane_Namako("block_wp_namako_white");
		WP_NAMAKO_orange = new WallPane_Namako("block_wp_namako_orange");
		WP_NAMAKO_magenta = new WallPane_Namako("block_wp_namako_magenta");
		WP_NAMAKO_lightb = new WallPane_Namako("block_wp_namako_lightb");
		WP_NAMAKO_yellow = new WallPane_Namako("block_wp_namako_yellow");
		WP_NAMAKO_lime = new WallPane_Namako("block_wp_namako_lime");
		WP_NAMAKO_pink = new WallPane_Namako("block_wp_namako_pink");
		WP_NAMAKO_gray = new WallPane_Namako("block_wp_namako_gray");
		WP_NAMAKO_lightg = new WallPane_Namako("block_wp_namako_lightg");
		WP_NAMAKO_cyan = new WallPane_Namako("block_wp_namako_cyan");
		WP_NAMAKO_purple = new WallPane_Namako("block_wp_namako_purple");
		WP_NAMAKO_blue = new WallPane_Namako("block_wp_namako_blue");
		WP_NAMAKO_brown = new WallPane_Namako("block_wp_namako_brown");
		WP_NAMAKO_green = new WallPane_Namako("block_wp_namako_green");
		WP_NAMAKO_red = new WallPane_Namako("block_wp_namako_red");
		WP_NAMAKO_black = new WallPane_Namako("block_wp_namako_black");

		WP_NAMAKOB_white = new WallPane_Namako_B("block_wp_namako_b_white");
		WP_NAMAKOB_orange = new WallPane_Namako_B("block_wp_namako_b_orange");
		WP_NAMAKOB_magenta = new WallPane_Namako_B("block_wp_namako_b_magenta");
		WP_NAMAKOB_lightb = new WallPane_Namako_B("block_wp_namako_b_lightb");
		WP_NAMAKOB_yellow = new WallPane_Namako_B("block_wp_namako_b_yellow");
		WP_NAMAKOB_lime = new WallPane_Namako_B("block_wp_namako_b_lime");
		WP_NAMAKOB_pink = new WallPane_Namako_B("block_wp_namako_b_pink");
		WP_NAMAKOB_gray = new WallPane_Namako_B("block_wp_namako_b_gray");
		WP_NAMAKOB_lightg = new WallPane_Namako_B("block_wp_namako_b_lightg");
		WP_NAMAKOB_cyan = new WallPane_Namako_B("block_wp_namako_b_cyan");
		WP_NAMAKOB_purple = new WallPane_Namako_B("block_wp_namako_b_purple");
		WP_NAMAKOB_blue = new WallPane_Namako_B("block_wp_namako_b_blue");
		WP_NAMAKOB_brown = new WallPane_Namako_B("block_wp_namako_b_brown");
		WP_NAMAKOB_green = new WallPane_Namako_B("block_wp_namako_b_green");
		WP_NAMAKOB_red = new WallPane_Namako_B("block_wp_namako_b_red");
		WP_NAMAKOB_black = new WallPane_Namako_B("block_wp_namako_b_black");
