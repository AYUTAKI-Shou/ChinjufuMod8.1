...
public class Crop_Blocks {
	...
	public static final RegistryObject<Block> SEEDSBOX = register("block_seedsbox", () -> new SeedsBox(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(0.5F).sound(SoundType.CROP)
			.noOcclusion().isValidSpawn(Crop_Blocks::neverEntity).isSuffocating(Crop_Blocks::never)));

	public static final RegistryObject<Block> AZUKI = register("block_vege_azuki", () -> new Azuki(cropRandom()));
	...
	public static final RegistryObject<Block> GREENONION = register("block_vege_greenonion", () -> new GreenOnion(cropRandom()));
	...
	public static final RegistryObject<Block> RICE_8 = register("block_vege_rice_8", () -> new Rice_8(BlockBehaviour.Properties.of(Material.PLANT).noCollission().strength(0.1F).sound(SoundType.CROP)
			.noOcclusion().isValidSpawn(Crop_Blocks::neverEntity).isSuffocating(Crop_Blocks::never)));
	...
	public static final RegistryObject<Block> PEPPER = register("block_spice_pepper", () -> new PepperVanilla(woodRandom()));
	...
	public static final RegistryObject<Block> VANILLA = register("block_spice_vanilla", () -> new PepperVanilla(woodRandom()));
	...
	public static final RegistryObject<Block> ENDEN = register("block_enden", () -> new Enden(sandRandom(MaterialColor.SNOW).noOcclusion().isValidSpawn(Crop_Blocks::neverEntity)));
	public static final RegistryObject<Block> ENDEN_k = register("block_enden_k", () -> new Enden_kara(sandRandom(MaterialColor.SNOW).noOcclusion().isValidSpawn(Crop_Blocks::neverEntity)));

	public static final RegistryObject<Block> TOAMI = register("item_toami", () -> new Block(BlockBehaviour.Properties.of(Material.WOOL)));
	...
	public static final RegistryObject<Block> HAMAGURI = register("block_hamaguri", 
			() -> new Hamaguri(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.SNOW).noOcclusion()
					.isValidSpawn(Crop_Blocks::neverEntity).isSuffocating(Crop_Blocks::never)));
	public static final RegistryObject<Block> KAINASHI = register("block_lostclam", () -> new LostClam(14406560, sandRandom(MaterialColor.SAND)));
	public static final RegistryObject<Block> TENGUSA = register("block_vege_tengusa", () -> new Tengusa(seaRandom()));
	public static final RegistryObject<Block> NORI = register("block_vege_nori", () -> new Nori(seaRandom()));
	...
	private static Properties cropRandom() {
		return BlockBehaviour.Properties.of(Material.PLANT).noCollission().strength(0.1F).sound(SoundType.CROP).noOcclusion()
				.isValidSpawn(Crop_Blocks::neverEntity).isSuffocating(Crop_Blocks::never).randomTicks();
	}
	
	private static Properties woodRandom() {
		return BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD).noOcclusion()
				.isValidSpawn(Crop_Blocks::neverEntity).isSuffocating(Crop_Blocks::never).randomTicks();
	}
	
	private static Properties plantRandom() {
		return BlockBehaviour.Properties.of(Material.PLANT).noCollission().strength(1.0F).sound(SoundType.WOOD).noOcclusion()
				.isValidSpawn(Crop_Blocks::neverEntity).isSuffocating(Crop_Blocks::never).randomTicks();
	}

	private static Properties sandRandom(MaterialColor color) {
		return BlockBehaviour.Properties.of(Material.SAND, color).strength(2.0F).sound(SoundType.SAND).randomTicks();
	}

	private static Properties woolRandom() {
		return BlockBehaviour.Properties.of(Material.WOOL).strength(1.0F).sound(SoundType.WOOL).noOcclusion()
				.isValidSpawn(Crop_Blocks::neverEntity).isSuffocating(Crop_Blocks::never).randomTicks();
	}
	
	private static Properties seaRandom() {
		return BlockBehaviour.Properties.of(Material.PLANT).noCollission().instabreak().sound(SoundType.WET_GRASS).noOcclusion()
				.isValidSpawn(Crop_Blocks::neverEntity).isSuffocating(Crop_Blocks::never).randomTicks();
	}
