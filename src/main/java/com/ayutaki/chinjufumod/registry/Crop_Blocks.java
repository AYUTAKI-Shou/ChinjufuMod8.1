...
public final class Crop_Blocks {
	...
	public static Block MIKAN, MIKAN_TOP, PEPPER, CUMIN, TURMERIC, CHILI, VANILLA;

	public static Block AZUKI, CABBAGE, HAKUSAI, CORN, CORN_TOP;
	...
	public static Block INAGI_BOT, INAGI_TOP, NORIAMI, ENDEN, ENDEN_k ,TOAMI_W, TENGUSA;
	public static Block HAMAGURI, KAINASHI;
	//public static Block TEST;

	public static void init() {

		SEEDSBOX = new SeedsBox("block_seedsbox");
		...
		PEPPER = new PepperVanilla("block_spice_pepper");
		CUMIN = new Cumin("block_spice_cumin");
		TURMERIC = new Turmeric("block_spice_turmeric");
		CHILI = new Chilipepper("block_spice_chilipepper");
		VANILLA = new PepperVanilla("block_spice_vanilla");
		
		AZUKI = new Azuki("block_vege_azuki");
		...
		GREENONION = new GreenOnion("block_vege_greenonion");
		...
		TENGUSA = new Tengusa("block_vege_tengusa");
