...
public class Crop_Blocks {
	...
	public static Block AZUKI = register("block_vege_azuki", new Azuki(cropRandom()));
	...
	public static Block GREENONION = register("block_vege_greenonion", new GreenOnion(cropRandom()));
	...
	public static Block PEPPER = register("block_spice_pepper", new PepperVanilla(woodRandom()));
	...
	public static Block VANILLA = register("block_spice_vanilla", new PepperVanilla(woodRandom()));
	...
	public static Block TENGUSA = register("block_vege_tengusa", new Tengusa(seaRandom()));
	public static Block NORI = register("block_vege_nori", new Nori(seaRandom()));
	...
	private static Properties seaRandom() {
		return AbstractBlock.Properties.of(Material.REPLACEABLE_WATER_PLANT).noCollission().instabreak().sound(SoundType.WET_GRASS)
				.noOcclusion().isValidSpawn(Crop_Blocks::neverEntity).isSuffocating(Crop_Blocks::never).randomTicks();
	}
