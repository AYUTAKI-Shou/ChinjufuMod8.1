...
public class Items_Seasonal {
	...
	public static Item ZUNDOU_AKU = register("block_zundou_aku", new Seasonal_noFuel(Dish_Blocks.ZUNDOU_AKU, new Item.Properties().containerItem(Items_Teatime.ZUNDOU)));
	...
	public static Item KURI_BOIL = register("item_chestnut_boil", new IG_Seasonal(new Item.Properties().containerItem(Items.BOWL)));
	public static Item KURI_MASH = register("item_chestnut_mash", new IG_Seasonal(new Item.Properties().containerItem(Items.BOWL)));
	...
	public static Item CHOCO_raw = register("item_choco_raw", new AddInfo_ST(new Item.Properties().containerItem(Items.BOWL)));
	...
	public static Item SNOWCORE = register("block_snowcore", new AddInfoBlock_NT(Seasonal_Blocks.SNOWCORE, new Item.Properties().group(ItemGroups_CM.SEASONAL)));
	public static Item SNOWMAN = register("block_snowman", new AddInfoBlock_NT(Seasonal_Blocks.SNOWMAN, new Item.Properties().group(ItemGroups_CM.SEASONAL)));
