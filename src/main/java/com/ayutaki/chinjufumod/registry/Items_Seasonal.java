...
public class Items_Seasonal {
	...
	public static final RegistryObject<Item> WARAHAI = register("item_warahai", () -> new Warahai_ST(new Item.Properties()));
	public static final RegistryObject<Item> ORIITO = register("item_oriito", () -> new IG_Seasonal(new Item.Properties()));
	public static final RegistryObject<Item> TANMONO = register("item_tanmono", () -> new IG_Seasonal(new Item.Properties()));

	public static final RegistryObject<Item> ZUNDOU_AKU = register("block_zundou_aku", () -> new Seasonal_noFuel(Dish_Blocks.ZUNDOU_AKU.get(), new Item.Properties().craftRemainder(Items_Teatime.ZUNDOU.get())));
	...
	public static final RegistryObject<Item> KURI = register("item_chestnut", () -> new AddInfo_ST(new Item.Properties()));
	public static final RegistryObject<Item> KURI_ROAST = register("item_food_chestnut", () -> new IG_Seasonal(new Item.Properties().food(FoodBuilders.KURI_ROAST)));
	public static final RegistryObject<Item> KURI_BOIL = register("item_chestnut_boil", () -> new IG_Seasonal(new Item.Properties().craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> KURI_MASH = register("item_chestnut_mash", () -> new IG_Seasonal(new Item.Properties().craftRemainder(Items.BOWL)));
	...
	public static final RegistryObject<Item> KURI_SWEET = register("item_food_chestnutsweet", () -> new AddInfo_ST(new Item.Properties().food(FoodBuilders.KURI_SWEET)));
	public static final RegistryObject<Item> KURI_CHOCO = register("item_food_chestnutchoco", () -> new AddInfo_ST(new Item.Properties().food(FoodBuilders.KURI_CHOCO)));
	...
	public static final RegistryObject<Item> TAKENOKO_ROAST = register("item_food_takenoko", () -> new IG_Seasonal(new Item.Properties().food(FoodBuilders.TAKENOKO_ROAST)));
	...
	public static final RegistryObject<Item> SNOWCORE = register("block_snowcore", () -> new AddInfoBlock_NT(Seasonal_Blocks.SNOWCORE.get(), new Item.Properties().tab(ItemGroups_CM.SEASONAL)));
	public static final RegistryObject<Item> SNOWMAN = register("block_snowman", () -> new AddInfoBlock_NT(Seasonal_Blocks.SNOWMAN.get(), new Item.Properties().tab(ItemGroups_CM.SEASONAL)));
	
	public static final RegistryObject<Item> COCOA_F = register("item_cocoa_ferm", () -> new AddInfo_ST(new Item.Properties()));
	public static final RegistryObject<Item> COCOA_R = register("item_cocoa_roast", () -> new AddInfo_ST(new Item.Properties()));
	public static final RegistryObject<Item> COCOA_M = register("item_cocoa_mass", () -> new AddInfo_ST(new Item.Properties()));
	public static final RegistryObject<Item> CHOCO_raw = register("item_choco_raw", () -> new AddInfo_ST(new Item.Properties().craftRemainder(Items.BOWL)));
	...
	public static final RegistryObject<Item> FOOD_CHOCO = register("item_food_choco", () -> new IG_Seasonal(new Item.Properties().food(FoodBuilders.CHOCO)));
	public static final RegistryObject<Item> FOOD_CHOCO_apple = register("item_food_choco_apple", () -> new IG_Seasonal(new Item.Properties().food(FoodBuilders.CHOCO_apple)));
	public static final RegistryObject<Item> FOOD_CHOCO_cherry = register("item_food_choco_cherry", () -> new IG_Seasonal(new Item.Properties().food(FoodBuilders.CHOCO_cherry)));
	public static final RegistryObject<Item> FOOD_CHOCO_citrus = register("item_food_choco_citrus", () -> new IG_Seasonal(new Item.Properties().food(FoodBuilders.CHOCO_citrus)));
	public static final RegistryObject<Item> FOOD_CHOCO_grape = register("item_food_choco_grape", () -> new IG_Seasonal(new Item.Properties().food(FoodBuilders.CHOCO_grape)));
	public static final RegistryObject<Item> FOOD_CHOCO_tea = register("item_food_choco_greentea", () -> new IG_Seasonal(new Item.Properties().food(FoodBuilders.CHOCO_tea)));
	public static final RegistryObject<Item> FOOD_CHOCO_heart = register("item_food_choco_heart", () -> new IG_Seasonal(new Item.Properties().food(FoodBuilders.CHOCO_heart)));
	...
	public static final RegistryObject<Item> FOOD_WATAGASHI = register("item_food_watagashi", () -> new Food_Watagashi(new Item.Properties()));
	public static final RegistryObject<Item> FOOD_WATAGASHI_apple = register("item_food_watagashi_y", () -> new Food_Watagashi(new Item.Properties()));
	public static final RegistryObject<Item> FOOD_WATAGASHI_cherry = register("item_food_watagashi_p", () -> new Food_Watagashi(new Item.Properties()));
	public static final RegistryObject<Item> FOOD_WATAGASHI_citrus = register("item_food_watagashi_o", () -> new Food_Watagashi(new Item.Properties()));
	public static final RegistryObject<Item> FOOD_WATAGASHI_grape = register("item_food_watagashi_r", () -> new Food_Watagashi(new Item.Properties()));
	public static final RegistryObject<Item> FOOD_WATAGASHI_tea = register("item_food_watagashi_g", () -> new Food_Watagashi(new Item.Properties()));
	...
	public static final RegistryObject<Item> WATAGASHI_apple = register("block_watagashi_yellow", () -> new Seasonal_noFuel(Seasonal_Blocks.WATAGASHI_apple.get(), new Item.Properties()));
	public static final RegistryObject<Item> WATAGASHI_cherry = register("block_watagashi_pink", () -> new Seasonal_noFuel(Seasonal_Blocks.WATAGASHI_cherry.get(), new Item.Properties()));
	public static final RegistryObject<Item> WATAGASHI_citrus = register("block_watagashi_orange", () -> new Seasonal_noFuel(Seasonal_Blocks.WATAGASHI_citrus.get(), new Item.Properties()));
	public static final RegistryObject<Item> WATAGASHI_grape = register("block_watagashi_red", () -> new Seasonal_noFuel(Seasonal_Blocks.WATAGASHI_grape.get(), new Item.Properties()));
	public static final RegistryObject<Item> WATAGASHI_tea = register("block_watagashi_green", () -> new Seasonal_noFuel(Seasonal_Blocks.WATAGASHI_tea.get(), new Item.Properties()));
