...
import com.ayutaki.chinjufumod.items.food.Food_Choco;
import com.ayutaki.chinjufumod.items.food.Food_STabName;
import com.ayutaki.chinjufumod.items.food.Food_Watagashi;
...
import com.ayutaki.chinjufumod.items.garden.Button_SN;
import com.ayutaki.chinjufumod.items.garden.FenceGate_SN;
import com.ayutaki.chinjufumod.items.garden.Fence_SN;
import com.ayutaki.chinjufumod.items.garden.Itabei_SN;
import com.ayutaki.chinjufumod.items.garden.Kido_SN;
import com.ayutaki.chinjufumod.items.ranma.Kanki_SN;
import com.ayutaki.chinjufumod.items.ranma.Ranma_SN;
import com.ayutaki.chinjufumod.items.seasonal.Bonsai_SN;
import com.ayutaki.chinjufumod.items.seasonal.Carpet_ST;
import com.ayutaki.chinjufumod.items.seasonal.ChocoRaw_ST;
import com.ayutaki.chinjufumod.items.seasonal.CocoaFerm_ST;
import com.ayutaki.chinjufumod.items.seasonal.CocoaMass_ST;
import com.ayutaki.chinjufumod.items.seasonal.CocoaRoast_ST;
import com.ayutaki.chinjufumod.items.seasonal.Dish_Kakigouri;
import com.ayutaki.chinjufumod.items.seasonal.DoorWood_ST;
import com.ayutaki.chinjufumod.items.seasonal.IkegakiLong_ST;
import com.ayutaki.chinjufumod.items.seasonal.IkegakiSmall_ST;
import com.ayutaki.chinjufumod.items.seasonal.Kanyou_ST;
import com.ayutaki.chinjufumod.items.seasonal.KuriBoil_ST;
import com.ayutaki.chinjufumod.items.seasonal.KuriIga_TB;
import com.ayutaki.chinjufumod.items.seasonal.KuriSweet_ST;
import com.ayutaki.chinjufumod.items.seasonal.NabeNamaKuri_ST;
import com.ayutaki.chinjufumod.items.seasonal.NewYearXmas_ST;
import com.ayutaki.chinjufumod.items.seasonal.PillarSlab_SN;
import com.ayutaki.chinjufumod.items.seasonal.Planks_ST;
import com.ayutaki.chinjufumod.items.seasonal.Plate_ST;
import com.ayutaki.chinjufumod.items.seasonal.PresentB_ST;
import com.ayutaki.chinjufumod.items.seasonal.Present_ST;
import com.ayutaki.chinjufumod.items.seasonal.ST_LocalizedName;
import com.ayutaki.chinjufumod.items.seasonal.SnowCore_TB;
import com.ayutaki.chinjufumod.items.seasonal.SnowMan_ST;
import com.ayutaki.chinjufumod.items.seasonal.Suiden_ST;
import com.ayutaki.chinjufumod.items.seasonal.Uchiwa_ST;
import com.ayutaki.chinjufumod.items.seasonal.Warahai_ST;
import com.ayutaki.chinjufumod.items.seasonal.ZundouAku_ST;
import com.ayutaki.chinjufumod.items.slidedoor.GarasudoHalf_SN;
import com.ayutaki.chinjufumod.items.slidedoor.Garasudo_SN;
import com.ayutaki.chinjufumod.items.slidedoor.ShoujiHalf_SN;
import com.ayutaki.chinjufumod.items.slidedoor.ShoujiWindow_SN;
import com.ayutaki.chinjufumod.items.slidedoor.Shouji_SN;
import com.ayutaki.chinjufumod.items.unitdesk.Chabudai_SN;
import com.ayutaki.chinjufumod.items.unitdesk.Kotatsu_SN;
...
public class Items_Seasonal {
	...
	public static Item KURI_IGA, KURI, KURI_ROAST, KURI_SWEET, KURI_BOIL, KURI_NABE;
	...
	public static Item WATAGASHI_block, WATAGASHI_apple, WATAGASHI_cherry, WATAGASHI_citrus, 
									WATAGASHI_grape, WATAGASHI_tea;
	public static Item KAKIGOURI_hata;
	public static Item KAKIGOURI_block, KAKIGOURI_apple, KAKIGOURI_cherry, KAKIGOURI_citrus, 
									KAKIGOURI_grape, KAKIGOURI_tea;
	...
	public static void init() {
		...
		WARAHAI = new Warahai_ST("item_warahai");
		ORIITO = new ST_LocalizedName("item_oriito");
		TANMONO = new ST_LocalizedName("item_tanmono");
		AKUNABE = new ZundouAku_ST("block_zundou_aku");
		FALL_LEAF = new TabBlock_noFuel("block_fall_leaf", Seasonal_Blocks.FALL_LEAF);
		SUIDEN = new Suiden_ST("block_suiden"); //default の meta が 0 ではない為, ItemBlockのクラスを書いて対応

		SAKURA_flow = new TabBlock_noFuel("block_tree_sakura_flow", Seasonal_Blocks.SAKURA_flow);
		KAEDE_leaf = new TabBlock_noFuel("block_tree_kaede_leaf", Seasonal_Blocks.KAEDE_leaf);
		ICHOH_leaf = new TabBlock_noFuel("block_tree_ichoh_leaf", Seasonal_Blocks.ICHOH_leaf);
		OAKKARE_leaf = new TabBlock_noFuel("block_tree_oakkare_leaf", Seasonal_Blocks.OAKKARE_leaf);
		SAKURA_log = new TabBlock_Fuel300("block_tree_sakura_log", Seasonal_Blocks.SAKURA_log);
		KAEDE_log = new TabBlock_Fuel300("block_tree_kaede_log", Seasonal_Blocks.KAEDE_log);
		ICHOH_log = new TabBlock_Fuel300("block_tree_ichoh_log", Seasonal_Blocks.ICHOH_log);
		SAKURA_nae = new TabBlock_Fuel100("block_tree_sakura_nae", Seasonal_Blocks.SAKURA_nae);
		KAEDE_nae = new TabBlock_Fuel100("block_tree_kaede_nae", Seasonal_Blocks.KAEDE_nae);
		ICHOH_nae = new TabBlock_Fuel100("block_tree_ichoh_nae", Seasonal_Blocks.ICHOH_nae);
		OAKKARE_nae = new TabBlock_Fuel100("block_tree_oakkare_nae", Seasonal_Blocks.OAKKARE_nae);

		KURI_IGA = new KuriIga_TB("block_chestnuts", Seasonal_Blocks.KURIIGA_FALL);
		KURI = new ST_LocalizedName("item_chestnut");
		KURI_ROAST= new Food_STabName("item_food_chestnut", 2, 0.4F, false);
		KURI_SWEET= new KuriSweet_ST("item_food_chestnutsweet", 4, 0.6F, false);
		KURI_BOIL = new KuriBoil_ST("item_chestnut_boil");
		KURI_NABE = new NabeNamaKuri_ST("block_food_nabekuri_n");
		TAKENOKO= new TabBlock_noFuel("block_takenoko", Seasonal_Blocks.TAKENOKO);
		TAKENOKO_ROAST= new Food_STabName("item_food_takenoko", 4, 0.6F, false);
		TAKE = new ST_LocalizedName("block_take");
		
		PLANKS_sakura = new Planks_ST("block_planks_sakura");
		PLANKS_kaede = new Planks_ST("block_planks_kaede");
		PLANKS_ichoh = new Planks_ST("block_planks_ichoh");
		SAKURA_slabhalf = new Seasonal_Slab150("block_slabhalf_sakura", Seasonal_Blocks.SAKURA_slabhalf);
		KAEDE_slabhalf = new Seasonal_Slab150("block_slabhalf_kaede", Seasonal_Blocks.KAEDE_slabhalf);
		ICHOH_slabhalf = new Seasonal_Slab150("block_slabhalf_ichoh", Seasonal_Blocks.ICHOH_slabhalf);
		SAKURA_stairs = new TabBlock_Fuel300("block_stairs_sakura", Seasonal_Blocks.SAKURA_stairs);
		KAEDE_stairs = new TabBlock_Fuel300("block_stairs_kaede", Seasonal_Blocks.KAEDE_stairs);
		ICHOH_stairs = new TabBlock_Fuel300("block_stairs_ichoh", Seasonal_Blocks.ICHOH_stairs);
		PILLAR_saku = new TabBlock_Fuel300("block_pillar_sakura", Seasonal_Blocks.PILLAR_saku);
		PILLAR_kae = new TabBlock_Fuel300("block_pillar_kaede", Seasonal_Blocks.PILLAR_kae);
		PILLAR_ich = new TabBlock_Fuel300("block_pillar_ichoh", Seasonal_Blocks.PILLAR_ich);
		PILLARSLAB_s = new PillarSlab_SN("block_kamoi_s").setCreativeTab(ChinjufuModTabs.SEASONAL);

		S_FENCE = new Fence_SN("block_fence_s").setCreativeTab(ChinjufuModTabs.SEASONAL);
		S_FGATE = new FenceGate_SN("block_fencegate_s").setCreativeTab(ChinjufuModTabs.SEASONAL);
		S_DOOR = new DoorWood_ST("block_door_s");
		SAKURA_TRAPDOOR = new TabBlock_Fuel300("block_trapdoor_sakura", Seasonal_Blocks.SAKURA_TRAPDOOR);
		KAEDE_TRAPDOOR = new TabBlock_Fuel300("block_trapdoor_kaede", Seasonal_Blocks.KAEDE_TRAPDOOR);
		ICHOH_TRAPDOOR = new TabBlock_Fuel300("block_trapdoor_ichoh", Seasonal_Blocks.ICHOH_TRAPDOOR);
		S_PLATE = new Plate_ST("block_plate_s");
		S_BUTTON = new Button_SN("block_button_s").setCreativeTab(ChinjufuModTabs.SEASONAL);
		S_CARPET = new Carpet_ST("block_carpet_s");

		WP_LOG_sakura = new TabBlock_noFuel("block_wp_log_sakura", Seasonal_Blocks.WP_LOG_sakura);
		WP_LOG_kaede = new TabBlock_noFuel("block_wp_log_kaede", Seasonal_Blocks.WP_LOG_kaede);
		WP_LOG_ichoh = new TabBlock_noFuel("block_wp_log_ichoh", Seasonal_Blocks.WP_LOG_ichoh);
		WP_PLANK_sakura = new TabBlock_noFuel("block_wp_plank_sakura", Seasonal_Blocks.WP_PLANK_sakura);
		WP_PLANK_kaede = new TabBlock_noFuel("block_wp_plank_kaede", Seasonal_Blocks.WP_PLANK_kaede);
		WP_PLANK_ichoh = new TabBlock_noFuel("block_wp_plank_ichoh", Seasonal_Blocks.WP_PLANK_ichoh);

		SGARASUDO_item = new Garasudo_SN("block_garasudo_s").setCreativeTab(ChinjufuModTabs.SEASONAL);
		SGARASUDOH_item = new GarasudoHalf_SN("block_garasudohalf_s").setCreativeTab(ChinjufuModTabs.SEASONAL);
		SSHOUJI_item = new Shouji_SN("block_shouji_s").setCreativeTab(ChinjufuModTabs.SEASONAL);
		SSHOUJIH_item = new ShoujiHalf_SN("block_shoujihalf_s").setCreativeTab(ChinjufuModTabs.SEASONAL);
		SSHOUJIWIN_item = new ShoujiWindow_SN("block_shoujih_s").setCreativeTab(ChinjufuModTabs.SEASONAL);

		SRANMA_item = new Ranma_SN("block_ranma_s").setCreativeTab(ChinjufuModTabs.SEASONAL);
		SKANKI_item = new Kanki_SN("block_kanki_s").setCreativeTab(ChinjufuModTabs.SEASONAL);

		SBONSAI_item = new Bonsai_SN("block_bonsai_s").setCreativeTab(ChinjufuModTabs.SEASONAL);
		SKANYOU_BOT = new Kanyou_ST("block_kanyousakura_bot");
		SIKEGAKI = new IkegakiSmall_ST("block_low_sakura");
		SIKEGAKILONG_BOT = new IkegakiLong_ST("block_longsakura_bot");

		SITABEI_item = new Itabei_SN("block_itabei_sakura").setCreativeTab(ChinjufuModTabs.SEASONAL);
		SKIDO_item = new Kido_SN("block_kido_sakura").setCreativeTab(ChinjufuModTabs.SEASONAL);
				
		CHABUDAI = new Chabudai_SN("block_chabudai").setCreativeTab(ChinjufuModTabs.SEASONAL);
		KOTATSU = new Kotatsu_SN("block_kotatsu").setCreativeTab(ChinjufuModTabs.SEASONAL);

		KUSATABA = new TabBlock_Fuel200("block_tabakusa", Seasonal_Blocks.KUSATABA);
		WARATABA = new TabBlock_Fuel200("block_tabawara", Seasonal_Blocks.WARATABA);
		KAYATABA = new TabBlock_Fuel200("block_tabakaya", Seasonal_Blocks.KAYATABA);
		KUSATABA_RF = new TabBlock_Fuel100("block_tabakusa_roof", Seasonal_Blocks.KUSATABA_RF);
		WARATABA_RF = new TabBlock_Fuel100("block_tabawara_roof", Seasonal_Blocks.WARATABA_RF);
		KAYATABA_RF = new TabBlock_Fuel100("block_tabakaya_roof", Seasonal_Blocks.KAYATABA_RF);
		KUSATABA_STAIRS = new TabBlock_Fuel200("block_tabakusa_stairs", Seasonal_Blocks.KUSATABA_STAIRS);
		WARATABA_STAIRS = new TabBlock_Fuel200("block_tabawara_stairs", Seasonal_Blocks.WARATABA_STAIRS);
		KAYATABA_STAIRS = new TabBlock_Fuel200("block_tabakaya_stairs", Seasonal_Blocks.KAYATABA_STAIRS);

		SHIMENAWA = new TabBlock_Fuel100("block_shimenawa", Seasonal_Blocks.SHIMENAWA);
		NEWYEAR_XMAS = new NewYearXmas_ST("block_kadomatsu");
		PRESENT = new Present_ST("block_present");
		PRESENT_B = new PresentB_ST("block_present_b");
		SNOWCORE = new SnowCore_TB("block_snowcore", Seasonal_Blocks.SNOWCORE);
		SNOWMAN = new SnowMan_ST("block_snowman_bot1");
		
		HINAKAZARI = new TabBlock_noFuel("block_hinakazari", Seasonal_Blocks.HINAKAZARI);
		HINADAN = new TabBlock_noFuel("block_hinadan", Seasonal_Blocks.HINADAN);

		COCOA_F = new CocoaFerm_ST("item_cocoa_ferm");
		COCOA_R= new CocoaRoast_ST("item_cocoa_roast");
		COCOA_M= new CocoaMass_ST("item_cocoa_mass");
		CHOCO_raw = new ChocoRaw_ST("item_choco_raw");
		COCOA_TARU = new TabBlock_noFuel("block_taru_cocoa_f", Hakkou_Blocks.COCOA_TARU);
		FOOD_CHOCO = new Food_Choco("item_food_choco", 1, 0.3F, false);

		UCHIWA_item = new Uchiwa_ST("block_uchiwa");
		FOOD_WATAGASHI = new Food_Watagashi("item_food_watagashi", 1, 0.3F, false);
		WATAGASHI_block = new TabBlock_noFuel("block_watagashi", Seasonal_Blocks.WATAGASHI_block);
		WATAGASHI_apple = new TabBlock_noFuel("block_watagashi_yellow", Seasonal_Blocks.WATAGASHI_apple);
		WATAGASHI_cherry = new TabBlock_noFuel("block_watagashi_pink", Seasonal_Blocks.WATAGASHI_cherry);
		WATAGASHI_citrus = new TabBlock_noFuel("block_watagashi_orange", Seasonal_Blocks.WATAGASHI_citrus);
		WATAGASHI_grape = new TabBlock_noFuel("block_watagashi_red", Seasonal_Blocks.WATAGASHI_grape);
		WATAGASHI_tea = new TabBlock_noFuel("block_watagashi_green", Seasonal_Blocks.WATAGASHI_tea);

		KAKIGOURI_hata = new TabBlock_noFuel("block_kakigouri_hata", Seasonal_Blocks.KAKIGOURI_hata);
		KAKIGOURI_block = new Dish_Kakigouri("block_kakigouri_block1", 0, 0.0F, false);
		KAKIGOURI_apple = new Dish_Kakigouri("block_kakigouri_yellow1", 0, 0.0F, false);
		KAKIGOURI_cherry = new Dish_Kakigouri("block_kakigouri_pink1", 0, 0.0F, false);
		KAKIGOURI_citrus = new Dish_Kakigouri("block_kakigouri_orange1", 0, 0.0F, false);
		KAKIGOURI_grape = new Dish_Kakigouri("block_kakigouri_red1", 0, 0.0F, false);
		KAKIGOURI_tea = new Dish_Kakigouri("block_kakigouri_green1", 0, 0.0F, false);
	...
	public static void register() {
		...
		registerItem(WATAGASHI_apple);
		registerItem(WATAGASHI_cherry);
		registerItem(WATAGASHI_citrus);
		registerItem(WATAGASHI_grape);
		registerItem(WATAGASHI_tea);

		registerItem(KAKIGOURI_hata);
		registerItem(KAKIGOURI_block);
		registerItem(KAKIGOURI_apple);
		registerItem(KAKIGOURI_cherry);
		registerItem(KAKIGOURI_citrus);
		registerItem(KAKIGOURI_grape);
		registerItem(KAKIGOURI_tea);
	...
	public static void registerRenders() {
		...
		registerRenderMeta(FOOD_CHOCO, 7, "item_food_choco_citrus");
		...
		registerRenderMeta(FOOD_WATAGASHI, 6, "item_food_watagashi_o");
		...
		registerRender(WATAGASHI_apple);
		registerRender(WATAGASHI_cherry);
		registerRender(WATAGASHI_citrus);
		registerRender(WATAGASHI_grape);
		registerRender(WATAGASHI_tea);

		registerRender(KAKIGOURI_hata);
		registerRender(KAKIGOURI_block);
		registerRender(KAKIGOURI_apple);
		registerRender(KAKIGOURI_cherry);
		registerRender(KAKIGOURI_citrus);
		registerRender(KAKIGOURI_grape);
		registerRender(KAKIGOURI_tea);
