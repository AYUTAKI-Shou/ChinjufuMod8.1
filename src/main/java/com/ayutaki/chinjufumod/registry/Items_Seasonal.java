...
import com.ayutaki.chinjufumod.items.addinfo.AddInfo_ST;
...
import com.ayutaki.chinjufumod.items.foods.Food_Watagashi;
...
import com.ayutaki.chinjufumod.items.teatime.Warahai_ST;
...
public class Items_Seasonal {
	...
	public static Item WARAHAI = register("item_warahai", new Warahai_ST(new Item.Properties()));
	public static Item ORIITO = register("item_oriito", new IG_Seasonal(new Item.Properties()));
	public static Item TANMONO = register("item_tanmono", new IG_Seasonal(new Item.Properties()));

	public static Item ZUNDOU_AKU = register("block_zundou_aku", new Seasonal_noFuel(Dish_Blocks.ZUNDOU_AKU, new Item.Properties().craftRemainder(Items_Teatime.ZUNDOU)));
	...
	public static Item KURI_IGA = register("block_chestnuts", new Seasonal_noFuel(Wood_Blocks.KURIIGA_FALL, new Item.Properties().craftRemainder(Items_NoTab.IGA)));
	public static Item KURI = register("item_chestnut", new AddInfo_ST(new Item.Properties()));
	public static Item KURI_ROAST = register("item_food_chestnut", new IG_Seasonal(new Item.Properties().food(FoodBuilders.KURI_ROAST)));
	public static Item KURI_BOIL = register("item_chestnut_boil", new IG_Seasonal(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item KURI_MASH = register("item_chestnut_mash", new IG_Seasonal(new Item.Properties().craftRemainder(Items.BOWL)));
	...
	public static Item KURI_SWEET = register("item_food_chestnutsweet", new AddInfo_ST(new Item.Properties().food(FoodBuilders.KURI_SWEET)));
	public static Item KURI_CHOCO = register("item_food_chestnutchoco", new AddInfo_ST(new Item.Properties().food(FoodBuilders.KURI_CHOCO)));
	public static Item TAKENOKO = register("block_takenoko", new Seasonal_noFuel(Wood_Blocks.TAKENOKO, new Item.Properties()));
	public static Item TAKENOKO_ROAST = register("item_food_takenoko", new IG_Seasonal(new Item.Properties().food(FoodBuilders.TAKENOKO_ROAST)));
	...
	public static Item SAKURA_slabhalf = register("block_slabhalf_sakura", new Seasonal_Slab150(Wood_Blocks.SAKURA_slabhalf, new Item.Properties()));
	public static Item KAEDE_slabhalf = register("block_slabhalf_kaede", new Seasonal_Slab150(Wood_Blocks.KAEDE_slabhalf, new Item.Properties()));
	public static Item ICHOH_slabhalf = register("block_slabhalf_ichoh", new Seasonal_Slab150(Wood_Blocks.ICHOH_slabhalf, new Item.Properties()));
	...
	public static Item DOOR_SAKURA = register("block_door_sakura", new Seasonal_noFuel(Wood_Blocks.DOOR_SAKURA, new Item.Properties()));
	public static Item DOOR_KAEDE = register("block_door_kaede", new Seasonal_noFuel(Wood_Blocks.DOOR_KAEDE, new Item.Properties()));
	public static Item DOOR_ICHOH = register("block_door_ichoh", new Seasonal_noFuel(Wood_Blocks.DOOR_ICHOH, new Item.Properties()));
	...
	public static Item SNOWCORE = register("block_snowcore", new AddInfoBlock_NT(Seasonal_Blocks.SNOWCORE, new Item.Properties().tab(ItemGroups_CM.SEASONAL)));
	public static Item SNOWMAN = register("block_snowman", new AddInfoBlock_NT(Seasonal_Blocks.SNOWMAN, new Item.Properties().tab(ItemGroups_CM.SEASONAL)));
	
	public static Item COCOA_F = register("item_cocoa_ferm", new AddInfo_ST(new Item.Properties()));
	public static Item COCOA_R = register("item_cocoa_roast", new AddInfo_ST(new Item.Properties()));
	public static Item COCOA_M = register("item_cocoa_mass", new AddInfo_ST(new Item.Properties()));
	public static Item CHOCO_raw = register("item_choco_raw", new AddInfo_ST(new Item.Properties().craftRemainder(Items.BOWL)));
	...
	public static Item FOOD_CHOCO = register("item_food_choco", new IG_Seasonal(new Item.Properties().food(FoodBuilders.CHOCO)));
	public static Item FOOD_CHOCO_apple = register("item_food_choco_apple", new IG_Seasonal(new Item.Properties().food(FoodBuilders.CHOCO_apple)));
	public static Item FOOD_CHOCO_cherry = register("item_food_choco_cherry", new IG_Seasonal(new Item.Properties().food(FoodBuilders.CHOCO_cherry)));
	public static Item FOOD_CHOCO_citrus = register("item_food_choco_citrus", new IG_Seasonal(new Item.Properties().food(FoodBuilders.CHOCO_citrus)));
	public static Item FOOD_CHOCO_grape = register("item_food_choco_grape", new IG_Seasonal(new Item.Properties().food(FoodBuilders.CHOCO_grape)));
	public static Item FOOD_CHOCO_tea = register("item_food_choco_greentea", new IG_Seasonal(new Item.Properties().food(FoodBuilders.CHOCO_tea)));
	public static Item FOOD_CHOCO_heart = register("item_food_choco_heart", new IG_Seasonal(new Item.Properties().food(FoodBuilders.CHOCO_heart)));
	...
	public static Item FOOD_WATAGASHI = register("item_food_watagashi", new Food_Watagashi(new Item.Properties()));
	public static Item FOOD_WATAGASHI_apple = register("item_food_watagashi_y", new Food_Watagashi(new Item.Properties()));
	public static Item FOOD_WATAGASHI_cherry = register("item_food_watagashi_p", new Food_Watagashi(new Item.Properties()));
	public static Item FOOD_WATAGASHI_citrus = register("item_food_watagashi_o", new Food_Watagashi(new Item.Properties()));
	public static Item FOOD_WATAGASHI_grape = register("item_food_watagashi_r", new Food_Watagashi(new Item.Properties()));
	public static Item FOOD_WATAGASHI_tea = register("item_food_watagashi_g", new Food_Watagashi(new Item.Properties()));
	...
	public static Item WATAGASHI_apple = register("block_watagashi_yellow", new Seasonal_noFuel(Seasonal_Blocks.WATAGASHI_apple, new Item.Properties()));
	public static Item WATAGASHI_cherry = register("block_watagashi_pink", new Seasonal_noFuel(Seasonal_Blocks.WATAGASHI_cherry, new Item.Properties()));
	public static Item WATAGASHI_citrus = register("block_watagashi_orange", new Seasonal_noFuel(Seasonal_Blocks.WATAGASHI_citrus, new Item.Properties()));
	public static Item WATAGASHI_grape = register("block_watagashi_red", new Seasonal_noFuel(Seasonal_Blocks.WATAGASHI_grape, new Item.Properties()));
	public static Item WATAGASHI_tea = register("block_watagashi_green", new Seasonal_noFuel(Seasonal_Blocks.WATAGASHI_tea, new Item.Properties()));
	...
	public static Item KAKIGOURI_block = register("block_kakigouri_block1", new Dish_Kakigouri(Seasonal_Blocks.KAKIGOURI_block, new Item.Properties()));
	public static Item KAKIGOURI_apple = register("block_kakigouri_yellow1", new Dish_Kakigouri(Seasonal_Blocks.KAKIGOURI_apple, new Item.Properties()));
	public static Item KAKIGOURI_cherry = register("block_kakigouri_pink1", new Dish_Kakigouri(Seasonal_Blocks.KAKIGOURI_cherry, new Item.Properties()));
	public static Item KAKIGOURI_citrus = register("block_kakigouri_orange1", new Dish_Kakigouri(Seasonal_Blocks.KAKIGOURI_citrus, new Item.Properties()));
	public static Item KAKIGOURI_grape = register("block_kakigouri_red1", new Dish_Kakigouri(Seasonal_Blocks.KAKIGOURI_grape, new Item.Properties()));
	public static Item KAKIGOURI_tea = register("block_kakigouri_green1", new Dish_Kakigouri(Seasonal_Blocks.KAKIGOURI_tea, new Item.Properties()));
