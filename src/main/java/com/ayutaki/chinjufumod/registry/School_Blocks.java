...
public class School_Blocks {
	...
	public static Block BLACKBOARD = register( "block_blackboard", new BlackBoard(woodState()));

	public static Block BOARD_OAK = register("block_board_oak", woodBoard());
	public static Block BOARD_SPRUCE = register("block_board_spruce", woodBoard());
	public static Block BOARD_BIRCH = register("block_board_birch", woodBoard());
	public static Block BOARD_JUNGLE = register("block_board_jungle", woodBoard());
	public static Block BOARD_ACACIA = register("block_board_acacia", woodBoard());
	public static Block BOARD_DOAK = register("block_board_darkoak", woodBoard());
	public static Block BOARD_SAKURA = register("block_board_sakura", woodBoard());
	public static Block BOARD_KAEDE = register("block_board_kaede", woodBoard());
	public static Block BOARD_ICHOH = register("block_board_ichoh", woodBoard());
