...
public class Items_Chinjufu {
	...
	/* Chinjufu */
	public static Item ADMIRAL_STAMPB = register("item_admiralstamp_b", new AdmiralStamp_NT(Chinjufu_Blocks.I_ADMIRAL_STAMP, new Item.Properties().durability(16).tab(ItemGroups_CM.CHINJUFU)));
	public static Item WORK_ORDER = register("item_workorder", new IG_Chinjufu(new Item.Properties()));
	public static Item REPORT_BOX = register("block_report_box", new Chinjufu_noFuel(Chinjufu_Blocks.REPORT_BOX, new Item.Properties()));
	
	public static Item SHOUHOU_empty = register("item_shouhou_empty", new AddInfo_NT(new Item.Properties().tab(ItemGroups_CM.CHINJUFU)));
	public static Item SHOUHOU = register("item_shouhou", new Shouhou(new Item.Properties()));

	public static Item BAUXITE = register("item_bauxite", new IG_Chinjufu(new Item.Properties()));
	public static Item ALUMINUM = register("item_ingot_alumi", new IG_Chinjufu(new Item.Properties()));
	public static Item SUMI = register("item_sumi_c", new AddInfo_NT(new Item.Properties().tab(ItemGroups_CM.CHINJUFU)));

	public static Item BAUXITE_ORE = register("block_bauxite_ore", new Chinjufu_noFuel(Chinjufu_Blocks.BAUXITE_ORE, new Item.Properties()));

	public static Item OIL_DRUM = register("block_fuel_can", new Chinjufu_Fuel7200(Chinjufu_Blocks.OIL_DRUM, new Item.Properties()));
	public static Item EMPTY_BOX = register("block_empty_box", new Chinjufu_Fuel100(Chinjufu_Blocks.EMPTY_BOX, new Item.Properties()));
	public static Item AMMO_BOX = register("block_ammunition_box", new Chinjufu_noFuel(Chinjufu_Blocks.AMMO_BOX, new Item.Properties()));
	public static Item BAUXITE_BOX = register("block_bauxite_box", new Chinjufu_noFuel(Chinjufu_Blocks.BAUXITE_BOX, new Item.Properties()));
	public static Item ALUMI_BLOCK = register("block_alumi_block", new Chinjufu_noFuel(Chinjufu_Blocks.ALUMI_BLOCK, new Item.Properties()));
	public static Item STEEL_BLOCK = register("block_steel_block", new Chinjufu_noFuel(Chinjufu_Blocks.STEEL_BLOCK, new Item.Properties()));
	public static Item GOLD_BLOCK = register("block_gold_block", new Chinjufu_noFuel(Chinjufu_Blocks.GOLD_BLOCK, new Item.Properties()));
	public static Item NETHERITE_BLOCK = register("block_netherite_block", new Chinjufu_noFuel(Chinjufu_Blocks.NETHERITE_BLOCK, new Item.Properties()));
	public static Item B_ADMIRAL_STAMP = register("block_stamp_block", new NoGroup_noFuel(Chinjufu_Blocks.B_ADMIRAL_STAMP, new Item.Properties()));
	...
	public static Item BOARD_OAK = register("block_board_oak", new Chinjufu_noFuel(School_Blocks.BOARD_OAK, new Item.Properties()));
	public static Item BOARD_SPRUCE = register("block_board_spruce", new Chinjufu_noFuel(School_Blocks.BOARD_SPRUCE, new Item.Properties()));
	public static Item BOARD_BIRCH = register("block_board_birch", new Chinjufu_noFuel(School_Blocks.BOARD_BIRCH, new Item.Properties()));
	public static Item BOARD_JUNGLE = register("block_board_jungle", new Chinjufu_noFuel(School_Blocks.BOARD_JUNGLE, new Item.Properties()));
	public static Item BOARD_ACACIA = register("block_board_acacia", new Chinjufu_noFuel(School_Blocks.BOARD_ACACIA, new Item.Properties()));
	public static Item BOARD_DOAK = register("block_board_darkoak", new Chinjufu_noFuel(School_Blocks.BOARD_DOAK, new Item.Properties()));
	public static Item BOARD_SAKURA = register("block_board_sakura", new Chinjufu_noFuel(School_Blocks.BOARD_SAKURA, new Item.Properties()));
	public static Item BOARD_KAEDE = register("block_board_kaede", new Chinjufu_noFuel(School_Blocks.BOARD_KAEDE, new Item.Properties()));
	public static Item BOARD_ICHOH = register("block_board_ichoh", new Chinjufu_noFuel(School_Blocks.BOARD_ICHOH, new Item.Properties()));
	
	public static Item CHALK_white = register("item_chalk_white", new Chalk_White(new Item.Properties()));
	public static Item CHALK_orange = register("item_chalk_orange", new Chalk_Orange(new Item.Properties()));
	public static Item CHALK_magenta = register("item_chalk_magenta", new Chalk_Magenta(new Item.Properties()));
	public static Item CHALK_lightb = register("item_chalk_lightblue", new Chalk_LightBlue(new Item.Properties()));
	public static Item CHALK_yellow = register("item_chalk_yellow", new Chalk_Yellow(new Item.Properties()));
	public static Item CHALK_lime = register("item_chalk_lime", new Chalk_Lime(new Item.Properties()));
	public static Item CHALK_pink = register("item_chalk_pink", new Chalk_Pink(new Item.Properties()));
	public static Item CHALK_gray = register("item_chalk_gray", new Chalk_Gray(new Item.Properties()));
	public static Item CHALK_lightg = register("item_chalk_lightgray", new Chalk_LightGray(new Item.Properties()));
	public static Item CHALK_cyan = register("item_chalk_cyan", new Chalk_Cyan(new Item.Properties()));
	public static Item CHALK_purple = register("item_chalk_purple", new Chalk_Purple(new Item.Properties()));
	public static Item CHALK_blue = register("item_chalk_blue", new Chalk_Blue(new Item.Properties()));
	public static Item CHALK_brown = register("item_chalk_brown", new Chalk_Brown(new Item.Properties()));
	public static Item CHALK_green = register("item_chalk_green", new Chalk_Green(new Item.Properties()));
	public static Item CHALK_red = register("item_chalk_red", new Chalk_Red(new Item.Properties()));
	public static Item CHALK_black = register("item_chalk_black", new Chalk_Black(new Item.Properties()));
	public static Item BOARD_ERASER = register("item_blackboard_eraser", new Board_Eraser(new Item.Properties()));
	...
	public static Item OFFICEDESK_OAK = register("block_officedesk_oak", new Chinjufu_Fuel300(Furniture_Blocks.OFFICEDESK_OAK, new Item.Properties()));
	public static Item OFFICEDESK_SPRUCE = register("block_officedesk_spruce", new Chinjufu_Fuel300(Furniture_Blocks.OFFICEDESK_SPRUCE, new Item.Properties()));
	public static Item OFFICEDESK_BIRCH = register("block_officedesk_birch", new Chinjufu_Fuel300(Furniture_Blocks.OFFICEDESK_BIRCH, new Item.Properties()));
	public static Item OFFICEDESK_JUNGLE = register("block_officedesk_jungle", new Chinjufu_Fuel300(Furniture_Blocks.OFFICEDESK_JUNGLE, new Item.Properties()));
	public static Item OFFICEDESK_ACACIA = register("block_officedesk_acacia", new Chinjufu_Fuel300(Furniture_Blocks.OFFICEDESK_ACACIA, new Item.Properties()));
	public static Item OFFICEDESK_DOAK = register("block_officedesk_darkoak", new Chinjufu_Fuel300(Furniture_Blocks.OFFICEDESK_DOAK, new Item.Properties()));
	public static Item OFFICEDESK_SAKURA = register("block_officedesk_sakura", new Chinjufu_Fuel300(Furniture_Blocks.OFFICEDESK_SAKURA, new Item.Properties()));
	public static Item OFFICEDESK_KAEDE = register("block_officedesk_kaede", new Chinjufu_Fuel300(Furniture_Blocks.OFFICEDESK_KAEDE, new Item.Properties()));
	public static Item OFFICEDESK_ICHOH = register("block_officedesk_ichoh", new Chinjufu_Fuel300(Furniture_Blocks.OFFICEDESK_ICHOH, new Item.Properties()));
	...
	public static Item AMP = register("block_amp", new Chinjufu_noFuel(Harbor_Blocks.AMP, new Item.Properties()));
	public static Item AMP_white = register("block_amp_white", new Chinjufu_noFuel(Harbor_Blocks.AMP_white, new Item.Properties()));
	public static Item AMP_orange = register("block_amp_orange", new Chinjufu_noFuel(Harbor_Blocks.AMP_orange, new Item.Properties()));
	public static Item AMP_magenta = register("block_amp_magenta", new Chinjufu_noFuel(Harbor_Blocks.AMP_magenta, new Item.Properties()));
	public static Item AMP_lightb = register("block_amp_lightblue", new Chinjufu_noFuel(Harbor_Blocks.AMP_lightb, new Item.Properties()));
	public static Item AMP_yellow = register("block_amp_yellow", new Chinjufu_noFuel(Harbor_Blocks.AMP_yellow, new Item.Properties()));
	public static Item AMP_lime = register("block_amp_lime", new Chinjufu_noFuel(Harbor_Blocks.AMP_lime, new Item.Properties()));
	public static Item AMP_pink = register("block_amp_pink", new Chinjufu_noFuel(Harbor_Blocks.AMP_pink, new Item.Properties()));
	public static Item AMP_gray = register("block_amp_gray", new Chinjufu_noFuel(Harbor_Blocks.AMP_gray, new Item.Properties()));
	public static Item AMP_cyan = register("block_amp_cyan", new Chinjufu_noFuel(Harbor_Blocks.AMP_cyan, new Item.Properties()));
	public static Item AMP_purple = register("block_amp_purple", new Chinjufu_noFuel(Harbor_Blocks.AMP_purple, new Item.Properties()));
	public static Item AMP_blue = register("block_amp_blue", new Chinjufu_noFuel(Harbor_Blocks.AMP_blue, new Item.Properties()));
	public static Item AMP_brown = register("block_amp_brown", new Chinjufu_noFuel(Harbor_Blocks.AMP_brown, new Item.Properties()));
	public static Item AMP_green = register("block_amp_green", new Chinjufu_noFuel(Harbor_Blocks.AMP_green, new Item.Properties()));
	public static Item AMP_red = register("block_amp_red", new Chinjufu_noFuel(Harbor_Blocks.AMP_red, new Item.Properties()));
	public static Item AMP_black = register("block_amp_black", new Chinjufu_noFuel(Harbor_Blocks.AMP_black, new Item.Properties()));
