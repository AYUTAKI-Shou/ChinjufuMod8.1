...
public class Items_Chinjufu {
	...
	public static Item ADMIRAL_STAMPB = register("item_admiralstamp_b", new AdmiralStamp(Chinjufu_Blocks.I_ADMIRAL_STAMP, new Item.Properties().maxStackSize(1).maxDamage(16).group(ItemGroups_CM.CHINJUFU)));
	...
	public static Item SHOUHOU_empty = register("item_shouhou_empty", new AddInfo_NT(new Item.Properties().group(ItemGroups_CM.CHINJUFU)));
	...
	public static Item SUMI = register("item_sumi_c", new AddInfo_NT(new Item.Properties().group(ItemGroups_CM.CHINJUFU)));
	...
	public static Item AMMOBOX = register("block_ammunition_box", new Chinjufu_noFuel(Chinjufu_Blocks.AMMOBOX, new Item.Properties()));
