...
public class Items_Wadeco {
	...
	public static final RegistryObject<Item> GARASUDO = register("block_garasudo", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDO.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDO_SPRU = register("block_garasudo_spruce", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDO_SPRU.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDO_BIR = register("block_garasudo_birch", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDO_BIR.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDO_JUN = register("block_garasudo_jungle", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDO_JUN.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDO_ACA = register("block_garasudo_acacia", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDO_ACA.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDO_DOAK = register("block_garasudo_darkoak", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDO_DOAK.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDO_MANGROVE = register("block_garasudo_mangrove", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDO_MANGROVE.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDO_CHERRY = register("block_garasudo_cherry", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDO_CHERRY.get(), new Item.Properties()));

	public static final RegistryObject<Item> GARASUDOB = register("block_garasudob", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDOB.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDOB_SPRU = register("block_garasudob_spruce", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDOB_SPRU.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDOB_BIR = register("block_garasudob_birch", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDOB_BIR.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDOB_JUN = register("block_garasudob_jungle", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDOB_JUN.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDOB_ACA = register("block_garasudob_acacia", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDOB_ACA.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDOB_DOAK = register("block_garasudob_darkoak", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDOB_DOAK.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDOB_MANGROVE = register("block_garasudob_mangrove", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDOB_MANGROVE.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDOB_CHERRY = register("block_garasudob_cherry", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDOB_CHERRY.get(), new Item.Properties()));

	public static final RegistryObject<Item> GARASUDOH = register("block_garasudohalf", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDOH.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDOH_SPRU = register("block_garasudohalf_spruce", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDOH_SPRU.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDOH_BIR = register("block_garasudohalf_birch", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDOH_BIR.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDOH_JUN = register("block_garasudohalf_jungle", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDOH_JUN.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDOH_ACA = register("block_garasudohalf_acacia", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDOH_ACA.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDOH_DOAK = register("block_garasudohalf_darkoak", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDOH_DOAK.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDOH_MANGROVE = register("block_garasudohalf_mangrove", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDOH_MANGROVE.get(), new Item.Properties()));
	public static final RegistryObject<Item> GARASUDOH_CHERRY = register("block_garasudohalf_cherry", () -> new Not_Fuel(Slidedoor_Blocks.GARASUDOH_CHERRY.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> SHOUJI_MANGROVE = register("block_shouji_mangrove", () -> new Fuel_200(Slidedoor_Blocks.SHOUJI_MANGROVE.get(), new Item.Properties()));
	public static final RegistryObject<Item> SHOUJI_CHERRY = register("block_shouji_cherry", () -> new Fuel_200(Slidedoor_Blocks.SHOUJI_CHERRY.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> SHOUJIB_MANGROVE = register("block_shoujib_mangrove", () -> new Fuel_200(Slidedoor_Blocks.SHOUJIB_MANGROVE.get(), new Item.Properties()));
	public static final RegistryObject<Item> SHOUJIB_CHERRY = register("block_shoujib_cherry", () -> new Fuel_200(Slidedoor_Blocks.SHOUJIB_CHERRY.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> SHOUJIH_MANGROVE = register("block_shoujihalf_mangrove", () -> new Fuel_100(Slidedoor_Blocks.SHOUJIH_MANGROVE.get(), new Item.Properties()));
	public static final RegistryObject<Item> SHOUJIH_CHERRY = register("block_shoujihalf_cherry", () -> new Fuel_100(Slidedoor_Blocks.SHOUJIH_CHERRY.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> SHOUJI_WIN_MANGROVE = register("block_shoujih_mangrove", () -> new Fuel_100(Slidedoor_Blocks.SHOUJI_WIN_MANGROVE.get(), new Item.Properties()));
	public static final RegistryObject<Item> SHOUJI_WIN_CHERRY = register("block_shoujih_cherry", () -> new Fuel_100(Slidedoor_Blocks.SHOUJI_WIN_CHERRY.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> RANMA_mangrove = register("block_ranma_mangrove", () -> new Fuel_150(Ranma_Blocks.RANMA_mangrove.get(), new Item.Properties()));
	public static final RegistryObject<Item> RANMA_cherry = register("block_ranma_cherry", () -> new Fuel_150(Ranma_Blocks.RANMA_cherry.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> RANMAB_mangrove = register("block_ranmab_mangrove", () -> new Fuel_150(Ranma_Blocks.RANMAB_mangrove.get(), new Item.Properties()));
	public static final RegistryObject<Item> RANMAB_cherry = register("block_ranmab_cherry", () -> new Fuel_150(Ranma_Blocks.RANMAB_cherry.get(), new Item.Properties()));

	public static final RegistryObject<Item> RANMAC_oak = register("block_ranmac_oak", () -> new Not_Fuel(Ranma_Blocks.RANMAC_oak.get(), new Item.Properties()));
	public static final RegistryObject<Item> RANMAC_spruce = register("block_ranmac_spru", () -> new Not_Fuel(Ranma_Blocks.RANMAC_spruce.get(), new Item.Properties()));
	public static final RegistryObject<Item> RANMAC_birch = register("block_ranmac_bir", () -> new Not_Fuel(Ranma_Blocks.RANMAC_birch.get(), new Item.Properties()));
	public static final RegistryObject<Item> RANMAC_jungle = register("block_ranmac_jun", () -> new Not_Fuel(Ranma_Blocks.RANMAC_jungle.get(), new Item.Properties()));
	public static final RegistryObject<Item> RANMAC_acacia = register("block_ranmac_aca", () -> new Not_Fuel(Ranma_Blocks.RANMAC_acacia.get(), new Item.Properties()));
	public static final RegistryObject<Item> RANMAC_darkoak = register("block_ranmac_doak", () -> new Not_Fuel(Ranma_Blocks.RANMAC_darkoak.get(), new Item.Properties()));
	public static final RegistryObject<Item> RANMAC_mangrove = register("block_ranmac_mangrove", () -> new Not_Fuel(Ranma_Blocks.RANMAC_mangrove.get(), new Item.Properties()));
	public static final RegistryObject<Item> RANMAC_cherry = register("block_ranmac_cherry", () -> new Not_Fuel(Ranma_Blocks.RANMAC_cherry.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> KANKI_mangrove = register("block_kanki_mangrove", () -> new Fuel_150(Ranma_Blocks.KANKI_mangrove.get(), new Item.Properties()));
	public static final RegistryObject<Item> KANKI_cherry = register("block_kanki_cherry", () -> new Fuel_150(Ranma_Blocks.KANKI_cherry.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> KOUSHI_mangrove = register("block_koushi_mangrove", () -> new Fuel_150(Ranma_Blocks.KOUSHI_mangrove.get(), new Item.Properties()));
	public static final RegistryObject<Item> KOUSHI_cherry = register("block_koushi_cherry", () -> new Fuel_150(Ranma_Blocks.KOUSHI_cherry.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> KOUSHIB_mangrove = register("block_koushib_mangrove", () -> new Fuel_150(Ranma_Blocks.KOUSHIB_mangrove.get(), new Item.Properties()));
	public static final RegistryObject<Item> KOUSHIB_cherry = register("block_koushib_cherry", () -> new Fuel_150(Ranma_Blocks.KOUSHIB_cherry.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> NOREN_white = register("block_noren_white", () -> new Not_Fuel(Ranma_Blocks.NOREN_white.get(), new Item.Properties()));
	public static final RegistryObject<Item> NOREN_orange = register("block_noren_orange", () -> new Not_Fuel(Ranma_Blocks.NOREN_orange.get(), new Item.Properties()));
	public static final RegistryObject<Item> NOREN_magenta = register("block_noren_magenta", () -> new Not_Fuel(Ranma_Blocks.NOREN_magenta.get(), new Item.Properties()));
	public static final RegistryObject<Item> NOREN_lightb = register("block_noren_lightb", () -> new Not_Fuel(Ranma_Blocks.NOREN_lightb.get(), new Item.Properties()));
	public static final RegistryObject<Item> NOREN_yellow = register("block_noren_yellow", () -> new Not_Fuel(Ranma_Blocks.NOREN_yellow.get(), new Item.Properties()));
	public static final RegistryObject<Item> NOREN_lime = register("block_noren_lime", () -> new Not_Fuel(Ranma_Blocks.NOREN_lime.get(), new Item.Properties()));
	public static final RegistryObject<Item> NOREN_pink = register("block_noren_pink", () -> new Not_Fuel(Ranma_Blocks.NOREN_pink.get(), new Item.Properties()));
	public static final RegistryObject<Item> NOREN_gray = register("block_noren_gray", () -> new Not_Fuel(Ranma_Blocks.NOREN_gray.get(), new Item.Properties()));
	public static final RegistryObject<Item> NOREN_lightg = register("block_noren_lightg", () -> new Not_Fuel(Ranma_Blocks.NOREN_lightg.get(), new Item.Properties()));
	public static final RegistryObject<Item> NOREN_cyan = register("block_noren_cyan", () -> new Not_Fuel(Ranma_Blocks.NOREN_cyan.get(), new Item.Properties()));
	public static final RegistryObject<Item> NOREN_purple = register("block_noren_purple", () -> new Not_Fuel(Ranma_Blocks.NOREN_purple.get(), new Item.Properties()));
	public static final RegistryObject<Item> NOREN_blue = register("block_noren_blue", () -> new Not_Fuel(Ranma_Blocks.NOREN_blue.get(), new Item.Properties()));
	public static final RegistryObject<Item> NOREN_brown = register("block_noren_brown", () -> new Not_Fuel(Ranma_Blocks.NOREN_brown.get(), new Item.Properties()));
	public static final RegistryObject<Item> NOREN_green = register("block_noren_green", () -> new Not_Fuel(Ranma_Blocks.NOREN_green.get(), new Item.Properties()));
	public static final RegistryObject<Item> NOREN_red = register("block_noren_red", () -> new Not_Fuel(Ranma_Blocks.NOREN_red.get(), new Item.Properties()));
	public static final RegistryObject<Item> NOREN_black = register("block_noren_black", () -> new Not_Fuel(Ranma_Blocks.NOREN_black.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> ANDON_white = register("block_andon_white", () -> new Not_Fuel(JPDeco_Blocks.ANDON_white.get(), new Item.Properties()));
	public static final RegistryObject<Item> ANDON_orange = register("block_andon_orange", () -> new Not_Fuel(JPDeco_Blocks.ANDON_orange.get(), new Item.Properties()));
	public static final RegistryObject<Item> ANDON_magenta = register("block_andon_magenta", () -> new Not_Fuel(JPDeco_Blocks.ANDON_magenta.get(), new Item.Properties()));
	public static final RegistryObject<Item> ANDON_lightb = register("block_andon_lightb", () -> new Not_Fuel(JPDeco_Blocks.ANDON_lightb.get(), new Item.Properties()));
	public static final RegistryObject<Item> ANDON_yellow = register("block_andon_yellow", () -> new Not_Fuel(JPDeco_Blocks.ANDON_yellow.get(), new Item.Properties()));
	public static final RegistryObject<Item> ANDON_lime = register("block_andon_lime", () -> new Not_Fuel(JPDeco_Blocks.ANDON_lime.get(), new Item.Properties()));
	public static final RegistryObject<Item> ANDON_pink = register("block_andon_pink", () -> new Not_Fuel(JPDeco_Blocks.ANDON_pink.get(), new Item.Properties()));
	public static final RegistryObject<Item> ANDON_gray = register("block_andon_gray", () -> new Not_Fuel(JPDeco_Blocks.ANDON_gray.get(), new Item.Properties()));
	public static final RegistryObject<Item> ANDON_lightg = register("block_andon_lightg", () -> new Not_Fuel(JPDeco_Blocks.ANDON_lightg.get(), new Item.Properties()));
	public static final RegistryObject<Item> ANDON_cyan = register("block_andon_cyan", () -> new Not_Fuel(JPDeco_Blocks.ANDON_cyan.get(), new Item.Properties()));
	public static final RegistryObject<Item> ANDON_purple = register("block_andon_purple", () -> new Not_Fuel(JPDeco_Blocks.ANDON_purple.get(), new Item.Properties()));
	public static final RegistryObject<Item> ANDON_blue = register("block_andon_blue", () -> new Not_Fuel(JPDeco_Blocks.ANDON_blue.get(), new Item.Properties()));
	public static final RegistryObject<Item> ANDON_brown = register("block_andon_brown", () -> new Not_Fuel(JPDeco_Blocks.ANDON_brown.get(), new Item.Properties()));
	public static final RegistryObject<Item> ANDON_green = register("block_andon_green", () -> new Not_Fuel(JPDeco_Blocks.ANDON_green.get(), new Item.Properties()));
	public static final RegistryObject<Item> ANDON_red = register("block_andon_red", () -> new Not_Fuel(JPDeco_Blocks.ANDON_red.get(), new Item.Properties()));
	public static final RegistryObject<Item> ANDON_black = register("block_andon_black", () -> new Not_Fuel(JPDeco_Blocks.ANDON_black.get(), new Item.Properties()));

	public static final RegistryObject<Item> KASA_white = register("block_mkasa_white", () -> new Not_Fuel(Unit_Blocks.KASA_white.get(), new Item.Properties()));
	public static final RegistryObject<Item> KASA_orange = register("block_mkasa_orange", () -> new Not_Fuel(Unit_Blocks.KASA_orange.get(), new Item.Properties()));
	public static final RegistryObject<Item> KASA_magenta = register("block_mkasa_magenta", () -> new Not_Fuel(Unit_Blocks.KASA_magenta.get(), new Item.Properties()));
	public static final RegistryObject<Item> KASA_lightb = register("block_mkasa_lightb", () -> new Not_Fuel(Unit_Blocks.KASA_lightb.get(), new Item.Properties()));
	public static final RegistryObject<Item> KASA_yellow = register("block_mkasa_yellow", () -> new Not_Fuel(Unit_Blocks.KASA_yellow.get(), new Item.Properties()));
	public static final RegistryObject<Item> KASA_lime = register("block_mkasa_lime", () -> new Not_Fuel(Unit_Blocks.KASA_lime.get(), new Item.Properties()));
	public static final RegistryObject<Item> KASA_pink = register("block_mkasa_pink", () -> new Not_Fuel(Unit_Blocks.KASA_pink.get(), new Item.Properties()));
	public static final RegistryObject<Item> KASA_gray = register("block_mkasa_gray", () -> new Not_Fuel(Unit_Blocks.KASA_gray.get(), new Item.Properties()));
	public static final RegistryObject<Item> KASA_lightg = register("block_mkasa_lightg", () -> new Not_Fuel(Unit_Blocks.KASA_lightg.get(), new Item.Properties()));
	public static final RegistryObject<Item> KASA_cyan = register("block_mkasa_cyan", () -> new Not_Fuel(Unit_Blocks.KASA_cyan.get(), new Item.Properties()));
	public static final RegistryObject<Item> KASA_purple = register("block_mkasa_purple", () -> new Not_Fuel(Unit_Blocks.KASA_purple.get(), new Item.Properties()));
	public static final RegistryObject<Item> KASA_blue = register("block_mkasa_blue", () -> new Not_Fuel(Unit_Blocks.KASA_blue.get(), new Item.Properties()));
	public static final RegistryObject<Item> KASA_brown = register("block_mkasa_brown", () -> new Not_Fuel(Unit_Blocks.KASA_brown.get(), new Item.Properties()));
	public static final RegistryObject<Item> KASA_green = register("block_mkasa_green", () -> new Not_Fuel(Unit_Blocks.KASA_green.get(), new Item.Properties()));
	public static final RegistryObject<Item> KASA_red = register("block_mkasa_red", () -> new Not_Fuel(Unit_Blocks.KASA_red.get(), new Item.Properties()));
	public static final RegistryObject<Item> KASA_black = register("block_mkasa_black", () -> new Not_Fuel(Unit_Blocks.KASA_black.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> BONSAI_oak = register("block_bonsai_oak", () -> new Not_Fuel(Garden_Blocks.BONSAI_oak.get(), new Item.Properties()));
	public static final RegistryObject<Item> BONSAI_spru = register("block_bonsai_spruce", () -> new Not_Fuel(Garden_Blocks.BONSAI_spru.get(), new Item.Properties()));
	public static final RegistryObject<Item> BONSAI_bir = register("block_bonsai_birch", () -> new Not_Fuel(Garden_Blocks.BONSAI_bir.get(), new Item.Properties()));
	public static final RegistryObject<Item> BONSAI_jun = register("block_bonsai_jungle", () -> new Not_Fuel(Garden_Blocks.BONSAI_jun.get(), new Item.Properties()));
	public static final RegistryObject<Item> BONSAI_aca = register("block_bonsai_acacia", () -> new Not_Fuel(Garden_Blocks.BONSAI_aca.get(), new Item.Properties()));
	public static final RegistryObject<Item> BONSAI_doak = register("block_bonsai_darkoak", () -> new Not_Fuel(Garden_Blocks.BONSAI_doak.get(), new Item.Properties()));
	public static final RegistryObject<Item> BONSAI_mangrove = register("block_bonsai_mangrove", () -> new Not_Fuel(Garden_Blocks.BONSAI_mangrove.get(), new Item.Properties()));
	public static final RegistryObject<Item> BONSAI_cherry = register("block_bonsai_cherry", () -> new Not_Fuel(Garden_Blocks.BONSAI_cherry.get(), new Item.Properties()));

	public static final RegistryObject<Item> KANYOU = register("block_kanyouoak_bot", () -> new Not_Fuel(Garden_Blocks.KANYOU.get(), new Item.Properties()));
	public static final RegistryObject<Item> KANYOU_spruce = register("block_kanyouspruce_bot", () -> new Not_Fuel(Garden_Blocks.KANYOU_spruce.get(), new Item.Properties()));
	public static final RegistryObject<Item> KANYOU_birch = register("block_kanyoubirch_bot", () -> new Not_Fuel(Garden_Blocks.KANYOU_birch.get(), new Item.Properties()));
	public static final RegistryObject<Item> KANYOU_jungle = register("block_kanyoujungle_bot", () -> new Not_Fuel(Garden_Blocks.KANYOU_jungle.get(), new Item.Properties()));
	public static final RegistryObject<Item> KANYOU_acacia = register("block_kanyouacacia_bot", () -> new Not_Fuel(Garden_Blocks.KANYOU_acacia.get(), new Item.Properties()));
	public static final RegistryObject<Item> KANYOU_darkoak = register("block_kanyoudarkoak_bot", () -> new Not_Fuel(Garden_Blocks.KANYOU_darkoak.get(), new Item.Properties()));
	public static final RegistryObject<Item> KANYOU_mangrove = register("block_kanyoumangrove_bot", () -> new Not_Fuel(Garden_Blocks.KANYOU_mangrove.get(), new Item.Properties()));
	public static final RegistryObject<Item> KANYOU_cherry = register("block_kanyoucherry_bot", () -> new Not_Fuel(Garden_Blocks.KANYOU_cherry.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> IKEGAKI_mangrove = register("block_low_mangrove", () -> new Fuel_150(Garden_Blocks.IKEGAKI_mangrove.get(), new Item.Properties()));
	public static final RegistryObject<Item> IKEGAKI_cherry = register("block_low_cherry", () -> new Fuel_150(Garden_Blocks.IKEGAKI_cherry.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> IKEGAKILONG_mangrove = register("block_longmangrove_bot", () -> new Fuel_300(Garden_Blocks.IKEGAKILONG_mangrove.get(), new Item.Properties()));
	public static final RegistryObject<Item> IKEGAKILONG_cherry = register("block_longcherry_bot", () -> new Fuel_300(Garden_Blocks.IKEGAKILONG_cherry.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> ITABEI_mangrove = register("block_itabei_mangrove", () -> new Fuel_200(Garden_Blocks.ITABEI_mangrove.get(), new Item.Properties()));
	public static final RegistryObject<Item> ITABEI_cherry = register("block_itabei_cherry", () -> new Fuel_200(Garden_Blocks.ITABEI_cherry.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> KIDO_mangrove = register("block_kido_mangrove", () -> new Fuel_200(Garden_Blocks.KIDO_mangrove.get(), new Item.Properties()));
	public static final RegistryObject<Item> KIDO_cherry = register("block_kido_cherry", () -> new Fuel_200(Garden_Blocks.KIDO_cherry.get(), new Item.Properties()));

	public static final RegistryObject<Item> SHISHIODOSHI = register("block_shishiodoshi", () -> new Not_Fuel(Garden_Blocks.SHISHIODOSHI.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHOUZUBACHI = register("block_chouzubachi_kara", () -> new Not_Fuel(Garden_Blocks.CHOUZUBACHI.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHOUZUBACHI_gra = register("block_chouzu_gra_kara", () -> new Not_Fuel(Garden_Blocks.CHOUZUBACHI_gra.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHOUZUBACHI_dio = register("block_chouzu_dio_kara", () -> new Not_Fuel(Garden_Blocks.CHOUZUBACHI_dio.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHOUZUBACHI_and = register("block_chouzu_and_kara", () -> new Not_Fuel(Garden_Blocks.CHOUZUBACHI_and.get(), new Item.Properties()));

	public static final RegistryObject<Item> ISHITOUROU = register("block_ishitourou_stone", () -> new Not_Fuel(Garden_Blocks.ISHITOUROU.get(), new Item.Properties()));
	public static final RegistryObject<Item> ISHITOUROU_gra = register("block_ishitourou_gra", () -> new Not_Fuel(Garden_Blocks.ISHITOUROU_gra.get(), new Item.Properties()));
	public static final RegistryObject<Item> ISHITOUROU_dio = register("block_ishitourou_dio", () -> new Not_Fuel(Garden_Blocks.ISHITOUROU_dio.get(), new Item.Properties()));
	public static final RegistryObject<Item> ISHITOUROU_and = register("block_ishitourou_and", () -> new Not_Fuel(Garden_Blocks.ISHITOUROU_and.get(), new Item.Properties()));

	public static final RegistryObject<Item> LONGTOUROU = register("block_longtourou_stone", () -> new Not_Fuel(Garden_Blocks.LONGTOUROU.get(), new Item.Properties()));
	public static final RegistryObject<Item> LONGTOUROU_gra = register("block_longtourou_gra", () -> new Not_Fuel(Garden_Blocks.LONGTOUROU_gra.get(), new Item.Properties()));
	public static final RegistryObject<Item> LONGTOUROU_dio = register("block_longtourou_dio", () -> new Not_Fuel(Garden_Blocks.LONGTOUROU_dio.get(), new Item.Properties()));
	public static final RegistryObject<Item> LONGTOUROU_and = register("block_longtourou_and", () -> new Not_Fuel(Garden_Blocks.LONGTOUROU_and.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> GATE_SPRUCE = register("block_gate_spruce", () -> new Not_Fuel(Gate_Blocks.GATE_SPRUCE.get(), new Item.Properties()));
	public static final RegistryObject<Item> GATE_SPRUCE_B = register("block_gate_spruce_b", () -> new Not_Fuel(Gate_Blocks.GATE_SPRUCE_B.get(), new Item.Properties()));
	public static final RegistryObject<Item> GATE_IRON = register("block_gate_iron", () -> new Not_Fuel(Gate_Blocks.GATE_IRON.get(), new Item.Properties()));
	public static final RegistryObject<Item> GATE_IRONGRILL = register("block_gate_irongrill", () -> new Not_Fuel(Gate_Blocks.GATE_IRONGRILL.get(), new Item.Properties()));
	public static final RegistryObject<Item> TETSUSAKU_BOT = register("block_ironfence_bot", () -> new Not_Fuel(Garden_Blocks.TETSUSAKU_BOT.get(), new Item.Properties()));

	public static final RegistryObject<Item> HAKE = register("item_hake", () -> new AddInfo_Item(new Item.Properties()));
	...
	public static final RegistryObject<Item> MAKIBISHI = register("block_makibishi", () -> new Not_Fuel(Garden_Blocks.MAKIBISHI.get(), new Item.Properties()));
