...
public class Items_Wadeco {
	...
	public static Item HAKE = register("item_hake", new AddInfo_NT(new Item.Properties().tab(ItemGroups_CM.WADECO)));
	...
	public static Item KUMADE = register("item_kumade", new Kumade_DT(new Item.Properties().durability(128)));
	public static Item NOMI = register("item_chisel", new Chisel_DT(new Item.Properties().durability(256)));
