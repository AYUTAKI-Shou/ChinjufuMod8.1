...
public class Items_Wadeco {
	...
	public static Item HAKE = register("item_hake", new AddInfo_NT(new Item.Properties().group(ItemGroups_CM.WADECO)));
	public static Item HAKE_white = register("item_hake_white", new Hake_White(new Item.Properties()));
	public static Item HAKE_orange = register("item_hake_orange", new Hake_Orange(new Item.Properties()));
	public static Item HAKE_magenta = register("item_hake_magenta", new Hake_Magenta(new Item.Properties()));
	public static Item HAKE_lightb = register("item_hake_lightblue", new Hake_LightBlue(new Item.Properties()));
	public static Item HAKE_yellow = register("item_hake_yellow", new Hake_Yellow(new Item.Properties()));
	public static Item HAKE_lime = register("item_hake_lime", new Hake_Lime(new Item.Properties()));
	public static Item HAKE_pink = register("item_hake_pink", new Hake_Pink(new Item.Properties()));
	public static Item HAKE_gray = register("item_hake_gray", new Hake_Gray(new Item.Properties()));
	public static Item HAKE_lightg = register("item_hake_lightgray", new Hake_LightGray(new Item.Properties()));
	public static Item HAKE_cyan = register("item_hake_cyan", new Hake_Cyan(new Item.Properties()));
	public static Item HAKE_purple = register("item_hake_purple", new Hake_Purple(new Item.Properties()));
	public static Item HAKE_blue = register("item_hake_blue", new Hake_Blue(new Item.Properties()));
	public static Item HAKE_brown = register("item_hake_brown", new Hake_Brown(new Item.Properties()));
	public static Item HAKE_green = register("item_hake_green", new Hake_Green(new Item.Properties()));
	public static Item HAKE_red = register("item_hake_red", new Hake_Red(new Item.Properties()));
	public static Item HAKE_black = register("item_hake_black", new Hake_Black(new Item.Properties()));

	public static Item KUMADE = register("item_kumade", new Kumade_DT(new Item.Properties().maxStackSize(1).maxDamage(128)));
	public static Item NOMI = register("item_chisel", new Chisel_DT(new Item.Properties().maxStackSize(1).maxDamage(256)));
