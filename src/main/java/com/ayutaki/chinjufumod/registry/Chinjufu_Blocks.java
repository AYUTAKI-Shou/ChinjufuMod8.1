...
public class Chinjufu_Blocks {
	...
	public static Block EMPTY_BOX = register("block_empty_box", new EmptyBox(boxState().isSuffocating(Chinjufu_Blocks::never)));
	public static Block AMMO_BOX = register("block_ammunition_box", new AmmoBauxiteBox(boxState()));
	...
	private static Properties metalState() {
		return AbstractBlock.Properties.of(Material.METAL).sound(SoundType.METAL).strength(1.0F, 3.0F).noOcclusion().isValidSpawn(Chinjufu_Blocks::neverEntity);
	}
	
	private static Properties boxState() {
		return AbstractBlock.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(1.0F, 3.0F).isValidSpawn(Chinjufu_Blocks::neverEntity);
	}
	...
	private static Properties wakeState() {
		return AbstractBlock.Properties.of(Material.TOP_SNOW).sound(SoundType.SNOW).strength(0.1F, 3.0F).noOcclusion()
				.isValidSpawn(Chinjufu_Blocks::neverEntity).isSuffocating(Chinjufu_Blocks::never);
	}
