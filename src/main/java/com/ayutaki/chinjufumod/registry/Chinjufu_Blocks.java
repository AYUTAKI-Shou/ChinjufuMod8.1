...
public class Chinjufu_Blocks {
	...
	private static Properties metalState() {
		return BlockBehaviour.Properties.of(Material.METAL).sound(SoundType.METAL).strength(1.0F, 3.0F).noOcclusion().isValidSpawn(Chinjufu_Blocks::neverEntity);
	}
	
	private static Properties boxState() {
		return BlockBehaviour.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(1.0F, 3.0F).isValidSpawn(Chinjufu_Blocks::neverEntity);
	}
