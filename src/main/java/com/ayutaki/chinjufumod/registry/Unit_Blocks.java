...
public class Unit_Blocks {
	...
	public static Block ENDAI = register("block_mendai", endai(MaterialColor.WOOD));
	public static Block ENDAI_r = register("block_mendai_red", endai(MaterialColor.COLOR_RED));
	...
	public static Block LETTERTRAY = register("block_lettertray_c", new TrayLetter(bookState()));
	public static Block FUDETRAY = register("block_fudetray_c", new TrayLetter(bookState()));
	...
	public static Block KASA_orange = register("block_mkasa_orange", wagasa(MaterialColor.COLOR_ORANGE));
	public static Block KASA_magenta = register("block_mkasa_magenta", wagasa(MaterialColor.COLOR_MAGENTA));
	public static Block KASA_lightb = register("block_mkasa_lightb", wagasa(MaterialColor.COLOR_LIGHT_BLUE));
	public static Block KASA_yellow = register("block_mkasa_yellow", wagasa(MaterialColor.COLOR_YELLOW));
	public static Block KASA_lime = register("block_mkasa_lime", wagasa(MaterialColor.COLOR_LIGHT_GREEN));
	public static Block KASA_pink = register("block_mkasa_pink", wagasa(MaterialColor.COLOR_PINK));
	public static Block KASA_gray = register("block_mkasa_gray", wagasa(MaterialColor.COLOR_GRAY));
	public static Block KASA_lightg = register("block_mkasa_lightg", wagasa(MaterialColor.COLOR_LIGHT_GRAY));
	public static Block KASA_cyan = register("block_mkasa_cyan", wagasa(MaterialColor.COLOR_CYAN));
	public static Block KASA_purple = register("block_mkasa_purple", wagasa(MaterialColor.COLOR_PURPLE));
	public static Block KASA_blue = register("block_mkasa_blue", wagasa(MaterialColor.COLOR_BLUE));
	public static Block KASA_brown = register("block_mkasa_brown", wagasa(MaterialColor.COLOR_BROWN));
	public static Block KASA_green = register("block_mkasa_green", wagasa(MaterialColor.COLOR_GREEN));
	public static Block KASA_red = register("block_mkasa_red", wagasa(MaterialColor.COLOR_RED));
	public static Block KASA_black = register("block_mkasa_black", wagasa(MaterialColor.COLOR_BLACK));
	...
	public static Block CLOTHTABLE_oak = register("block_clothtable_oak", clothtable());
	public static Block CLOTHTABLE_spruce = register("block_clothtable_spruce", clothtable());
	public static Block CLOTHTABLE_birch = register("block_clothtable_birch", clothtable());
	public static Block CLOTHTABLE_jungle = register("block_clothtable_jungle", clothtable());
	public static Block CLOTHTABLE_acacia = register("block_clothtable_acacia", clothtable());
	public static Block CLOTHTABLE_darkoak = register("block_clothtable_darkoak", clothtable());
	public static Block CLOTHTABLE_sakura = register("block_clothtable_sakura", clothtable());
	public static Block CLOTHTABLE_kaede = register("block_clothtable_kaede", clothtable());
	public static Block CLOTHTABLE_ichoh = register("block_clothtable_ichoh", clothtable());
	
	public static Block CLOTHTABLE_oaksub = register("block_clothtable_oaksub", clothtableSub());
	public static Block CLOTHTABLE_sprucesub = register("block_clothtable_sprucesub", clothtableSub());
	public static Block CLOTHTABLE_birchsub = register("block_clothtable_birchsub", clothtableSub());
	public static Block CLOTHTABLE_junglesub = register("block_clothtable_junglesub", clothtableSub());
	public static Block CLOTHTABLE_acaciasub = register("block_clothtable_acaciasub", clothtableSub());
	public static Block CLOTHTABLE_darkoaksub = register("block_clothtable_darkoaksub", clothtableSub());
	public static Block CLOTHTABLE_sakurasub = register("block_clothtable_sakurasub", clothtableSub());
	public static Block CLOTHTABLE_kaedesub = register("block_clothtable_kaedesub", clothtableSub());
	public static Block CLOTHTABLE_ichohsub = register("block_clothtable_ichohsub", clothtableSub());
	...
	private static Properties bookState() {
		return AbstractBlock.Properties.of(Material.WOOD).sound(SoundType.WOOD).strength(0.5F).noOcclusion()
				.isValidSpawn(Unit_Blocks::neverEntity).isSuffocating(Unit_Blocks::never).noCollission();
	}
	...
	private static Endai endai(MaterialColor color) {
		return new Endai(AbstractBlock.Properties.of(Material.WOOD, color).strength(1.0F, 3.0F).sound(SoundType.WOOD)
				.noOcclusion().isValidSpawn(Unit_Blocks::neverEntity).isSuffocating(Unit_Blocks::never));
	}
	...
	private static Wagasa wagasa(MaterialColor color) {
		return new Wagasa(AbstractBlock.Properties.of(Material.WOOD, color).strength(1.0F, 1.0F).sound(SoundType.WOOL)
				.noOcclusion().isValidSpawn(Unit_Blocks::neverEntity).isSuffocating(Unit_Blocks::never));
	}
