...
public class Unit_Blocks {
	...
	public static final RegistryObject<Block> UNITDESK_mangrove = register("block_unitdesk_mangrove", () -> unitDesk());
	public static final RegistryObject<Block> UNITDESK_cherry = register("block_unitdesk_cherry", () -> unitDesk());
	...
	public static final RegistryObject<Block> CAFETABLE_mangrove = register("block_cafetable_mangrove", () -> cafeTable());
	public static final RegistryObject<Block> CAFETABLE_cherry = register("block_cafetable_cherry", () -> cafeTable());
	...
	public static final RegistryObject<Block> LOWDESK_mangrove = register("block_lowdesk_mangrove", () -> lowDesk());
	public static final RegistryObject<Block> LOWDESK_cherry = register("block_lowdesk_cherry", () -> lowDesk());
	...
	public static final RegistryObject<Block> CHABUDAI_mangrove = register("block_chabudai_mangrove", () -> chabudai());
	public static final RegistryObject<Block> CHABUDAI_cherry = register("block_chabudai_cherry", () -> chabudai());
	...
	public static final RegistryObject<Block> KOTATSU_mangrove = register("block_kotatsu_mangrove", () -> kotatsu());
	public static final RegistryObject<Block> KOTATSU_cherry = register("block_kotatsu_cherry", () -> kotatsu());
	...
	public static final RegistryObject<Block> CLOTHTABLE_mangrove = register("block_clothtable_mangrove", () -> clothtable());
	public static final RegistryObject<Block> CLOTHTABLE_cherry = register("block_clothtable_cherry", () -> clothtable());
	...
	public static final RegistryObject<Block> CLOTHTABLE_mangrovesub = register("block_clothtable_mangrovesub", () -> clothtableSub());
	public static final RegistryObject<Block> CLOTHTABLE_cherrysub = register("block_clothtable_cherrysub", () -> clothtableSub());
