...
public class Unit_Blocks {
	...
	public static final RegistryObject<Block> LETTERTRAY = register("block_lettertray_c", () -> new TrayLetter(bookState()));
	public static final RegistryObject<Block> FUDETRAY = register("block_fudetray_c", () -> new TrayLetter(bookState()));
	...
	public static final RegistryObject<Block> KASA_white = register("block_mkasa_white", () -> wagasa(MaterialColor.SNOW));
	public static final RegistryObject<Block> KASA_orange = register("block_mkasa_orange", () -> wagasa(MaterialColor.COLOR_ORANGE));
	public static final RegistryObject<Block> KASA_magenta = register("block_mkasa_magenta", () -> wagasa(MaterialColor.COLOR_MAGENTA));
	public static final RegistryObject<Block> KASA_lightb = register("block_mkasa_lightb", () -> wagasa(MaterialColor.COLOR_LIGHT_BLUE));
	public static final RegistryObject<Block> KASA_yellow = register("block_mkasa_yellow", () -> wagasa(MaterialColor.COLOR_YELLOW));
	public static final RegistryObject<Block> KASA_lime = register("block_mkasa_lime", () -> wagasa(MaterialColor.COLOR_LIGHT_GREEN));
	public static final RegistryObject<Block> KASA_pink = register("block_mkasa_pink", () -> wagasa(MaterialColor.COLOR_PINK));
	public static final RegistryObject<Block> KASA_gray = register("block_mkasa_gray", () -> wagasa(MaterialColor.COLOR_GRAY));
	public static final RegistryObject<Block> KASA_lightg = register("block_mkasa_lightg", () -> wagasa(MaterialColor.COLOR_LIGHT_GRAY));
	public static final RegistryObject<Block> KASA_cyan = register("block_mkasa_cyan", () -> wagasa(MaterialColor.COLOR_CYAN));
	public static final RegistryObject<Block> KASA_purple = register("block_mkasa_purple", () -> wagasa(MaterialColor.COLOR_PURPLE));
	public static final RegistryObject<Block> KASA_blue = register("block_mkasa_blue", () -> wagasa(MaterialColor.COLOR_BLUE));
	public static final RegistryObject<Block> KASA_brown = register("block_mkasa_brown", () -> wagasa(MaterialColor.COLOR_BROWN));
	public static final RegistryObject<Block> KASA_green = register("block_mkasa_green", () -> wagasa(MaterialColor.COLOR_GREEN));
	public static final RegistryObject<Block> KASA_red = register("block_mkasa_red", () -> wagasa(MaterialColor.COLOR_RED));
	public static final RegistryObject<Block> KASA_black = register("block_mkasa_black", () -> wagasa(MaterialColor.COLOR_BLACK));
	...
	public static final RegistryObject<Block> CLOTHTABLE_oak = register("block_clothtable_oak", () -> clothtable());
	public static final RegistryObject<Block> CLOTHTABLE_spruce = register("block_clothtable_spruce", () -> clothtable());
	public static final RegistryObject<Block> CLOTHTABLE_birch = register("block_clothtable_birch", () -> clothtable());
	public static final RegistryObject<Block> CLOTHTABLE_jungle = register("block_clothtable_jungle", () -> clothtable());
	public static final RegistryObject<Block> CLOTHTABLE_acacia = register("block_clothtable_acacia", () -> clothtable());
	public static final RegistryObject<Block> CLOTHTABLE_darkoak = register("block_clothtable_darkoak", () -> clothtable());
	public static final RegistryObject<Block> CLOTHTABLE_sakura = register("block_clothtable_sakura", () -> clothtable());
	public static final RegistryObject<Block> CLOTHTABLE_kaede = register("block_clothtable_kaede", () -> clothtable());
	public static final RegistryObject<Block> CLOTHTABLE_ichoh = register("block_clothtable_ichoh", () -> clothtable());
	
	public static final RegistryObject<Block> CLOTHTABLE_oaksub = register("block_clothtable_oaksub", () -> clothtableSub());
	public static final RegistryObject<Block> CLOTHTABLE_sprucesub = register("block_clothtable_sprucesub", () -> clothtableSub());
	public static final RegistryObject<Block> CLOTHTABLE_birchsub = register("block_clothtable_birchsub", () -> clothtableSub());
	public static final RegistryObject<Block> CLOTHTABLE_junglesub = register("block_clothtable_junglesub", () -> clothtableSub());
	public static final RegistryObject<Block> CLOTHTABLE_acaciasub = register("block_clothtable_acaciasub", () -> clothtableSub());
	public static final RegistryObject<Block> CLOTHTABLE_darkoaksub = register("block_clothtable_darkoaksub", () -> clothtableSub());
	public static final RegistryObject<Block> CLOTHTABLE_sakurasub = register("block_clothtable_sakurasub", () -> clothtableSub());
	public static final RegistryObject<Block> CLOTHTABLE_kaedesub = register("block_clothtable_kaedesub", () -> clothtableSub());
	public static final RegistryObject<Block> CLOTHTABLE_ichohsub = register("block_clothtable_ichohsub", () -> clothtableSub());
	...
	private static Properties woodState() {
		return BlockBehaviour.Properties.of(Material.WOOD).strength(1.0F, 3.0F).sound(SoundType.WOOD)
				.noOcclusion().isValidSpawn(Unit_Blocks::neverEntity).isSuffocating(Unit_Blocks::never);
	}
	
	private static Properties bookState() {
		return BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(0.5F).sound(SoundType.WOOD)
				.noOcclusion().isValidSpawn(Unit_Blocks::neverEntity).isSuffocating(Unit_Blocks::never);
	}
	...
	private static Wagasa wagasa(MaterialColor color) {
		return new Wagasa(BlockBehaviour.Properties.of(Material.WOOD, color).strength(1.0F, 1.0F).sound(SoundType.WOOL)
				.noOcclusion().isValidSpawn(Unit_Blocks::neverEntity).isSuffocating(Unit_Blocks::never));
	}
	...
	private static ClothTable clothtable() {
		return new ClothTable(woodState());
	}
	
	private static ClothTable_Sub clothtableSub() {
		return new ClothTable_Sub(woodState());
	}
