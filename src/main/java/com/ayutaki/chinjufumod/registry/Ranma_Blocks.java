...
public class Ranma_Blocks {
	...
	public static final RegistryObject<Block> RANMA_mangrove = register("block_ranma_mangrove", () -> ranma());
	public static final RegistryObject<Block> RANMA_cherry = register("block_ranma_cherry", () -> ranma());
	...
	public static final RegistryObject<Block> RANMAB_mangrove = register("block_ranmab_mangrove", () -> ranma());
	public static final RegistryObject<Block> RANMAB_cherry = register("block_ranmab_cherry", () -> ranma());
	...
	public static final RegistryObject<Block> RANMAC_mangrove = register("block_ranmac_mangrove", () -> ranma());
	public static final RegistryObject<Block> RANMAC_cherry = register("block_ranmac_cherry", () -> ranma());
	...
	public static final RegistryObject<Block> KANKI_mangrove = register("block_kanki_mangrove", () -> ranmaNoInfo());
	public static final RegistryObject<Block> KANKI_cherry = register("block_kanki_cherry", () -> ranmaNoInfo());
	...
	public static final RegistryObject<Block> KOUSHI_mangrove = register("block_koushi_mangrove", () -> ranmaNoInfo());
	public static final RegistryObject<Block> KOUSHI_cherry = register("block_koushi_cherry", () -> ranmaNoInfo());
	...
	public static final RegistryObject<Block> KOUSHIB_mangrove = register("block_koushib_mangrove", () -> koushiBtype());
	public static final RegistryObject<Block> KOUSHIB_cherry = register("block_koushib_cherry", () -> koushiBtype());
