...
public class Items_Teatime {
	...
	public static Item INE = register("item_ine", new IG_Teatime(new Item.Properties().craftRemainder(Items_Teatime.INEWARA)));
	public static Item INE_D = register("item_ine_dry", new IG_Teatime(new Item.Properties().craftRemainder(Items_Teatime.INEWARA)));
	...
	/* Barrel */
	public static Item KOUBOBOT_full = register("block_bin_koubo_f", new AddInfoBlock_NT(Hakkou_Blocks.KOUBOBOT_full, new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item NYUSANBOT_full = register("block_bin_nyusan_f", new AddInfoBlock_NT(Hakkou_Blocks.NYUSANBOT_full, new Item.Properties().tab(ItemGroups_CM.TEATIME)));
	public static Item KOUBO = register("item_koubo", new AddInfo_TT(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE)));
	public static Item NYUSAN = register("item_nyusan", new AddInfo_TT(new Item.Properties().craftRemainder(Items.GLASS_BOTTLE)));

	public static Item MIZUOKE = register("block_mizuoke", new Mizuoke_TT(Fluids.EMPTY, Hakkou_Blocks.MIZUOKE, new Item.Properties()));
	public static Item MIZUOKE_full = register("block_mizuoke_full", new Mizuoke_TT(Fluids.WATER, Hakkou_Blocks.MIZUOKE_full, new Item.Properties().craftRemainder(Items_Teatime.MIZUOKE)));
	public static Item MIZUOKE_Milk = register("item_mizuoke_milk", new MizuokeMilk_TT(new Item.Properties().craftRemainder(Items_Teatime.MIZUOKE)));
	...
	public static Item SHOUYU_bot_14 = register("block_shouyu_bot", new HakkouTips_NT(Hakkou_Blocks.SHOUYU_bot_14, new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.SHOUYU_bot_24)));
	public static Item KOMEZU_bot_12 = register("block_komezu_bot", new HakkouTips_NT(Hakkou_Blocks.KOMEZU_bot_12, new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.KOMEZU_bot_22)));
	public static Item SOYOIL_bot_12 = register("block_soyoil_bot", new HakkouTips_NT(Dish_Blocks.SOYOIL_bot_12, new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.SOYOIL_bot_22)));
	public static Item DASHI_bot_14 = register("block_dashi_bot", new HakkouTips_NT(Hakkou_Blocks.DASHI_bot_14, new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.DASHI_bot_24)));
	public static Item OSAUCE_bot_14 = register("block_osauce_bot", new HakkouTips_NT(Dish_Blocks.OSAUCE_bot_14, new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.OSAUCE_bot_24)));
	public static Item MAYO_bot_14 = register("block_mayo_bot", new HakkouTips_NT(Dish_Blocks.MAYO_bot_14, new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.MAYO_bot_24)));
	public static Item VANILLA_bot_14 = register("block_vanilla_bot", new HakkouTips_NT(Hakkou_Blocks.VANILLA_bot_14, new Item.Properties().tab(ItemGroups_CM.TEATIME).craftRemainder(Items_NoTab.VANILLA_bot_24)));
	...
	public static Item MUSHIGOME = register("item_mushigome", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item MUSHIGOME_TAKE = register("item_mushigome_take", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item MUSHIGOME_KURI = register("item_mushigome_kuri", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item MUSHI_SEKIHAN = register("item_mushisekihan", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item KOMEKOUJI = register("item_komekouji", new AddInfo_TT(new Item.Properties()));
	public static Item SHUBO = register("item_shubo", new AddInfo_TT(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item SAKEKASU = register("item_sakekasu", new AddInfo_TT(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item MOROMI = register("item_moromi", new AddInfo_TT(new Item.Properties().craftRemainder(Items_Teatime.SAKEKASU)));

	public static Item NIMAME = register("item_nimame", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	...
	public static Item ANKO = register("item_anko", new AddInfo_TT(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item CUSTARD = register("item_custard", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item CUSTARD_CREAM = register("item_custard_cream", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));

	public static Item BOWL_ICE_VANILLA = register("item_bowl_icecream", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item BOWL_ICE_GREEN = register("item_bowl_icecream_greentea", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item BOWL_ICE_RED = register("item_bowl_icecream_redtea", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item BOWL_ICE_CACAO = register("item_bowl_icecream_cacao", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	
	public static Item BOWL_KANTEN_APPLE = register("item_bowl_kanten_apple", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item BOWL_KANTEN_CHERRY = register("item_bowl_kanten_cherry", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item BOWL_KANTEN_CITRUS = register("item_bowl_kanten_citrus", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item BOWL_KANTEN_GRAPE = register("item_bowl_kanten_grape", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item BOWL_KANTEN_MILK = register("item_bowl_kanten_milk", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item BOWL_YOKAN = register("item_bowl_yokan", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	public static Item BOWL_YOKAN_MATCHA = register("item_bowl_yokan_matcha", new IG_Teatime(new Item.Properties().craftRemainder(Items.BOWL)));
	...
	public static Item KEIRYO_CUP_full = register("item_measurecup_full", new MeasureCupFull_TT(new Item.Properties().craftRemainder(Items_Teatime.KEIRYO_CUP)));
	public static Item KANSUI = register("item_kansui", new MeasureCupFull_TT(new Item.Properties().craftRemainder(Items_Teatime.KEIRYO_CUP)));
	...
	public static Item FPKINOKOAK = register("item_food_frypan_b_kinokoak", new AddInfo_NT(new Item.Properties().craftRemainder(Items_Teatime.FRYPAN_kara).tab(ItemGroups_CM.TEATIME)));
	...
	public static Item TAMAGOYAKI = register("block_food_tgy_1", new Dish_Plate(Dish_Blocks.TAMAGOYAKI, (new Item.Properties()).craftRemainder(Items_Teatime.SARA)));
	...
	public static Item KETTLE_boil = register("item_kettle_boil", new IG_Teatime(new Item.Properties().craftRemainder(Items_Teatime.KETTLE_kara)));
	...
	//public static Item NORI_N = register("item_food_norinama", new Teatime_noFuel(Crop_Blocks.NORI, new Item.Properties()));
	...
	public static Item TOAMI = register("item_toami", new Toami_TT(Crop_Blocks.TOAMI, new Item.Properties().durability(32)));
	public static Item SHIKAKE_AMI = register("block_ami_shikake", new AmiShikake_TT(Crop_Blocks.SHIKAKE_AMI, new Item.Properties().durability(12)));
	public static Item YOUSHOKU_AMI = register("block_ami_youshoku", new AmiYoushoku_TT(Crop_Blocks.YOUSHOKU_AMI, new Item.Properties().durability(12)));
	...
	public static Item IKA = register("item_squid_raw", new AddInfo_TT(new Item.Properties().craftRemainder(Items_Teatime.CUT_IKA)));	
	
	public static Item KAIHORI = register("item_kaihori", new Kaihori_TT(new Item.Properties().durability(256)));
	...
	public static Item KINE_YOKO = register("item_kineyoko", new KineYoko_TT(new Item.Properties().durability(128)));
