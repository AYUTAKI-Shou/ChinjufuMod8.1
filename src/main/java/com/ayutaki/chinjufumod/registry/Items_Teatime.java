...
public class Items_Teatime {
	...
	public static final RegistryObject<Item> SEEDSBOX = register("block_seedsbox", () -> new Not_Fuel(Crop_Blocks.SEEDSBOX.get(), new Item.Properties()));

	public static final RegistryObject<Item> SEEDS_AZUKI = register("item_seeds_azuki", () -> new Not_Fuel(Crop_Blocks.AZUKI.get(), new Item.Properties()));
	public static final RegistryObject<Item> SEEDS_CABBAGE = register("item_seeds_cabbage", () -> new Not_Fuel(Crop_Blocks.CABBAGE.get(), new Item.Properties()));
	public static final RegistryObject<Item> SEEDS_HAKUSAI = register("item_seeds_hakusai", () -> new Not_Fuel(Crop_Blocks.HAKUSAI.get(), new Item.Properties()));
	public static final RegistryObject<Item> SEEDS_CORN = register("item_seeds_corn", () -> new Not_Fuel(Crop_Blocks.CORN.get(), new Item.Properties()));
	public static final RegistryObject<Item> SEEDS_GREENONION = register("item_seeds_greenonion", () -> new Not_Fuel(Crop_Blocks.GREENONION.get(), new Item.Properties()));
	public static final RegistryObject<Item> SEEDS_ONION = register("item_seeds_onion", () -> new Not_Fuel(Crop_Blocks.ONION.get(), new Item.Properties()));
	public static final RegistryObject<Item> SEEDS_RICE = register("item_seeds_rice", () -> new Not_Fuel(Crop_Blocks.RICE.get(), new Item.Properties()));
	public static final RegistryObject<Item> SEEDS_SOY = register("item_seeds_soy", () -> new Not_Fuel(Crop_Blocks.SOY.get(), new Item.Properties()));
	public static final RegistryObject<Item> SEEDS_SPINACH = register("item_seeds_spinach", () -> new Not_Fuel(Crop_Blocks.SPINACH.get(), new Item.Properties()));
	public static final RegistryObject<Item> SEEDS_TOMATO = register("item_seeds_tomato", () -> new Not_Fuel(Crop_Blocks.TOMATO.get(), new Item.Properties()));
	public static final RegistryObject<Item> SEEDS_CHERRY = register("item_seeds_cherry", () -> new Not_Fuel(Crop_Blocks.SAKURA.get(), new Item.Properties()));

	public static final RegistryObject<Item> CHANOKI = register("block_wood_chanoki_nae", () -> new Not_Fuel(Crop_Blocks.CHANOKI.get(), new Item.Properties()));
	public static final RegistryObject<Item> BUDOUNOKI = register("block_wood_grape_nae", () -> new Not_Fuel(Crop_Blocks.BUDOUNOKI.get(), new Item.Properties()));
	public static final RegistryObject<Item> MIKAN_NAE = register("block_wood_mikan", () -> new Not_Fuel(Crop_Blocks.MIKAN.get(), new Item.Properties()));
	public static final RegistryObject<Item> HODAGI = register("block_hodagi_a_bot", () -> new Not_Fuel(Crop_Blocks.HODAGI_A_BOT.get(), new Item.Properties()));

	public static final RegistryObject<Item> SEEDS_PEPPER = register("item_seeds_pepper", () -> new Not_Fuel(Crop_Blocks.PEPPER.get(), new Item.Properties()));
	public static final RegistryObject<Item> SEEDS_CUMIN = register("item_seeds_cumin", () -> new Not_Fuel(Crop_Blocks.CUMIN.get(), new Item.Properties()));
	public static final RegistryObject<Item> SEEDS_TURMERIC = register("item_seeds_turmeric", () -> new Not_Fuel(Crop_Blocks.TURMERIC.get(), new Item.Properties()));
	public static final RegistryObject<Item> SEEDS_CHILI = register("item_seeds_chilipepper", () -> new Not_Fuel(Crop_Blocks.CHILI.get(), new Item.Properties()));
	public static final RegistryObject<Item> SEEDS_VANILLA = register("item_seeds_vanilla", () -> new Not_Fuel(Crop_Blocks.VANILLA.get(), new Item.Properties()));
	public static final RegistryObject<Item> CROP_TENGUSA = register("item_crop_tengusa", () -> new Tengusa_Item(Crop_Blocks.TENGUSA.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> TENCHA = register("item_chaba_tencha", () -> new AddInfo_Item(new Item.Properties()));
	public static final RegistryObject<Item> MATCHA = register("item_chaba_matcha", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> TENGUSA_WASH = register("item_crop_tengusawash", () -> new Not_Fuel(Dish_Blocks.TENGUSA_WASH.get(), new Item.Properties()));
	public static final RegistryObject<Item> TENGUSA_DRY = register("item_crop_tengusadry", () -> new Item(new Item.Properties()));
	
	public static final RegistryObject<Item> INAGI = register("block_inagi", () -> new Not_Fuel(Crop_Blocks.INAGI.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> VANILLA_RAW = register("item_vanillabeans", () -> new AddInfo_Item(new Item.Properties()));
	...
	public static final RegistryObject<Item> FOOD_GREENONION = register("item_food_greenonion", () -> new Item(new Item.Properties().food(FoodBuilders.GREENONION)));
	...
	public static final RegistryObject<Item> BOX_H_EMPTY = register("block_boxh_empty", () -> new Not_Fuel(Pantry_Blocks.BOX_H_EMPTY.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> BOX_H_AZUKI = register("block_boxh_azuki", () -> new Fuel_100(Pantry_Blocks.BOX_H_AZUKI.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> BOX_H_GREENONION = register("block_boxh_greenonion", () -> new Fuel_100(Pantry_Blocks.BOX_H_GREENONION.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> BOX_H_ORIENTCLAM = register("block_boxh_hamaguri", () -> new Fuel_100(Pantry_Blocks.BOX_H_ORIENTCLAM.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> BOX_H_SQUID = register("block_boxh_squid", () -> new Fuel_100(Pantry_Blocks.BOX_H_SQUID.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> CHADUTSU = register("block_tea_chadutsu", () -> new Not_Fuel(Pantry_Blocks.CHADUTSU.get(), new Item.Properties()));
	public static final RegistryObject<Item> CANTEA = register("block_tea_can", () -> new Not_Fuel(Pantry_Blocks.CANTEA.get(), new Item.Properties()));
	...
	/* Barrel */
	public static final RegistryObject<Item> KOUBOBOT_full = register("block_bin_koubo_f", () -> new AddInfo_ItemBlock(Hakkou_Blocks.KOUBOBOT_full.get(), new Item.Properties()));
	public static final RegistryObject<Item> NYUSANBOT_full = register("block_bin_nyusan_f", () -> new AddInfo_ItemBlock(Hakkou_Blocks.NYUSANBOT_full.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> CHEESE_CURD = register("block_food_cheesecurd", () -> new Not_Fuel(Hakkou_Blocks.CHEESE_CURD.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHEESE = register("block_food_cheese_1", () -> new Not_Fuel(Hakkou_Blocks.CHEESE.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> HAKKOU_TARU = register("block_taru_hakkou", () -> new Not_Fuel(Hakkou_Blocks.HAKKOU_TARU.get(), new Item.Properties()));
	public static final RegistryObject<Item> KOUJI_TARU = register("block_taru_kouji_f", () -> new Not_Fuel(Hakkou_Blocks.KOUJI_TARU.get(), new Item.Properties()));
	public static final RegistryObject<Item> SHUBO_TARU = register("block_taru_shubo_f", () -> new Not_Fuel(Hakkou_Blocks.SHUBO_TARU.get(), new Item.Properties()));
	public static final RegistryObject<Item> MOROMI_TARU = register("block_taru_moromi_f", () -> new Not_Fuel(Hakkou_Blocks.MOROMI_TARU.get(), new Item.Properties()));
	public static final RegistryObject<Item> JUKUSEI_TARU = register("block_taru_jukusei_f", () -> new Not_Fuel(Hakkou_Blocks.JUKUSEI_TARU.get(), new Item.Properties()));
	public static final RegistryObject<Item> RINGOSHU_TARU = register("block_taru_ringoshu_f", () -> new Not_Fuel(Hakkou_Blocks.RINGOSHU_TARU.get(), new Item.Properties()));
	public static final RegistryObject<Item> BUDOUSHU_TARU = register("block_taru_budoushu_f", () -> new Not_Fuel(Hakkou_Blocks.BUDOUSHU_TARU.get(), new Item.Properties()));
	public static final RegistryObject<Item> HACHIMITSU_TARU = register("block_taru_hachimitsushu_f", () -> new Not_Fuel(Hakkou_Blocks.HACHIMITSU_TARU.get(), new Item.Properties()));

	/* Bottle */
	public static final RegistryObject<Item> NAMASAKEBOT = register("block_bot_sakenama_1", () -> new Not_Fuel(Hakkou_Blocks.NAMASAKEBOT.get(), new Item.Properties()));
	public static final RegistryObject<Item> SAKEBOT = register("block_bot_sake_1", () -> new Not_Fuel(Hakkou_Blocks.SAKEBOT.get(), new Item.Properties()));
	public static final RegistryObject<Item> JUKUSAKEBOT = register("block_bot_sakejuku_1", () -> new Not_Fuel(Hakkou_Blocks.JUKUSAKEBOT.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEAMAZAKE_nama = register("block_food_nabeaz_n", () -> new Not_Fuel(Hakkou_Blocks.NABEAMAZAKE_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEAMAZAKE = register("block_food_nabeaz_1", () -> new Not_Fuel(Hakkou_Blocks.NABEAMAZAKE.get(), new Item.Properties()));
	public static final RegistryObject<Item> CIDERBOT = register("block_bot_cider_1", () -> new Not_Fuel(Hakkou_Blocks.CIDERBOT.get(), new Item.Properties()));
	public static final RegistryObject<Item> JUKUCIDERBOT = register("block_bot_ciderjuku_1", () -> new Not_Fuel(Hakkou_Blocks.JUKUCIDERBOT.get(), new Item.Properties()));
	public static final RegistryObject<Item> WINEBOT = register("block_bot_wine_1", () -> new Not_Fuel(Hakkou_Blocks.WINEBOT.get(), new Item.Properties()));
	public static final RegistryObject<Item> JUKUWINEBOT = register("block_bot_winejuku_1", () -> new Not_Fuel(Hakkou_Blocks.JUKUWINEBOT.get(), new Item.Properties()));
	public static final RegistryObject<Item> MEADBOT = register("block_bot_mead_1", () -> new Not_Fuel(Hakkou_Blocks.MEADBOT.get(), new Item.Properties()));
	public static final RegistryObject<Item> JUKUMEADBOT = register("block_bot_meadjuku_1", () -> new Not_Fuel(Hakkou_Blocks.JUKUMEADBOT.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> AMAZAKEGLASS = register("block_glass_amazake", () -> new Yunomi_Item(Hakkou_Blocks.AMAZAKEGLASS.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> MISO_TARU = register("block_taru_miso_f", () -> new Not_Fuel(Hakkou_Blocks.MISO_TARU.get(), new Item.Properties()));
	public static final RegistryObject<Item> HAKUSAI_TARU1 = register("block_taru_hakusai_f", () -> new Not_Fuel(Hakkou_Blocks.HAKUSAI_TARU1.get(), new Item.Properties()));
	public static final RegistryObject<Item> HAKUSAI_TARU2 = register("block_taru_hakusai_f2", () -> new Not_Fuel(Hakkou_Blocks.HAKUSAI_TARU2.get(), new Item.Properties()));
	public static final RegistryObject<Item> SHOUYU_TARU = register("block_taru_shouyu_f", () -> new Not_Fuel(Hakkou_Blocks.SHOUYU_TARU.get(), new Item.Properties()));
	public static final RegistryObject<Item> KOMEZU_TARU = register("block_taru_komezu_f", () -> new Not_Fuel(Hakkou_Blocks.KOMEZU_TARU.get(), new Item.Properties()));
	public static final RegistryObject<Item> KINOKO_TARU = register("block_taru_kinoko_f", () -> new Not_Fuel(Hakkou_Blocks.KINOKO_TARU.get(), new Item.Properties()));
	public static final RegistryObject<Item> KONBU_TARU = register("block_taru_konbu_f", () -> new Not_Fuel(Hakkou_Blocks.KONBU_TARU.get(), new Item.Properties()));
	public static final RegistryObject<Item> NORI_TARU = register("block_taru_nori_f", () -> new Not_Fuel(Hakkou_Blocks.NORI_TARU.get(), new Item.Properties()));
	public static final RegistryObject<Item> KOUCHA_TARU = register("block_taru_koucha_f", () -> new Not_Fuel(Hakkou_Blocks.KOUCHA_TARU.get(), new Item.Properties()));
	public static final RegistryObject<Item> PEPPER_TARU = register("block_taru_pepper_f", () -> new Not_Fuel(Hakkou_Blocks.PEPPER_TARU.get(), new Item.Properties()));
	public static final RegistryObject<Item> VANILLA_TARU = register("block_taru_vanilla_f", () -> new Not_Fuel(Hakkou_Blocks.VANILLA_TARU.get(), new Item.Properties()));

	public static final RegistryObject<Item> SHOUYU_bot_14 = register("block_shouyu_bot", () -> new HakkouItem_Tips(Hakkou_Blocks.SHOUYU_bot_14.get(), new Item.Properties().craftRemainder(Items_NoTab.SHOUYU_bot_24.get())));
	public static final RegistryObject<Item> KOMEZU_bot_12 = register("block_komezu_bot", () -> new HakkouItem_Tips(Hakkou_Blocks.KOMEZU_bot_12.get(), new Item.Properties().craftRemainder(Items_NoTab.KOMEZU_bot_22.get())));
	public static final RegistryObject<Item> SOYOIL_bot_12 = register("block_soyoil_bot", () -> new HakkouItem_Tips(Dish_Blocks.SOYOIL_bot_12.get(), new Item.Properties().craftRemainder(Items_NoTab.SOYOIL_bot_22.get())));
	public static final RegistryObject<Item> DASHI_bot_14 = register("block_dashi_bot", () -> new HakkouItem_Tips(Hakkou_Blocks.DASHI_bot_14.get(), new Item.Properties().craftRemainder(Items_NoTab.DASHI_bot_24.get())));
	public static final RegistryObject<Item> OSAUCE_bot_14 = register("block_osauce_bot", () -> new HakkouItem_Tips(Dish_Blocks.OSAUCE_bot_14.get(), new Item.Properties().craftRemainder(Items_NoTab.OSAUCE_bot_24.get())));
	public static final RegistryObject<Item> MAYO_bot_14 = register("block_mayo_bot", () -> new HakkouItem_Tips(Dish_Blocks.MAYO_bot_14.get(), new Item.Properties().craftRemainder(Items_NoTab.MAYO_bot_24.get())));
	public static final RegistryObject<Item> VANILLA_bot_14 = register("block_vanilla_bot", () -> new HakkouItem_Tips(Hakkou_Blocks.VANILLA_bot_14.get(), new Item.Properties().craftRemainder(Items_NoTab.VANILLA_bot_24.get())));
	...
	/* Salt */
	public static final RegistryObject<Item> ENDEN = register("block_enden", () -> new Not_Fuel(Crop_Blocks.ENDEN.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> MUSHI_SEKIHAN = register("item_mushisekihan", () -> new Item(new Item.Properties().craftRemainder(Items.BOWL)));
	...
	public static final RegistryObject<Item> YUDEAZUKI = register("item_azuki_boil", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> ANKO = register("item_anko", () -> new AddInfo_Item(new Item.Properties().craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> CUSTARD = register("item_custard", () -> new Item(new Item.Properties().craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> CUSTARD_CREAM = register("item_custard_cream", () -> new Item(new Item.Properties().craftRemainder(Items.BOWL)));

	public static final RegistryObject<Item> BOWL_ICE_VANILLA = register("item_bowl_icecream", () -> new Item(new Item.Properties().craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> BOWL_ICE_GREEN = register("item_bowl_icecream_greentea", () -> new Item(new Item.Properties().craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> BOWL_ICE_RED = register("item_bowl_icecream_redtea", () -> new Item(new Item.Properties().craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> BOWL_ICE_CACAO = register("item_bowl_icecream_cacao", () -> new Item(new Item.Properties().craftRemainder(Items.BOWL)));
	
	public static final RegistryObject<Item> BOWL_KANTEN_APPLE = register("item_bowl_kanten_apple", () -> new Item(new Item.Properties().craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> BOWL_KANTEN_CHERRY = register("item_bowl_kanten_cherry", () -> new Item(new Item.Properties().craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> BOWL_KANTEN_CITRUS = register("item_bowl_kanten_citrus", () -> new Item(new Item.Properties().craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> BOWL_KANTEN_GRAPE = register("item_bowl_kanten_grape", () -> new Item(new Item.Properties().craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> BOWL_KANTEN_MILK = register("item_bowl_kanten_milk", () -> new Item(new Item.Properties().craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> BOWL_YOKAN = register("item_bowl_yokan", () -> new Item(new Item.Properties().craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> BOWL_YOKAN_MATCHA = register("item_bowl_yokan_matcha", () -> new Item(new Item.Properties().craftRemainder(Items.BOWL)));
	...
	public static final RegistryObject<Item> KIJI_ANPAN = register("item_kiji_pananko", () -> new AddInfo_Item(new Item.Properties()));
	public static final RegistryObject<Item> KIJI_CUSTARD_PAN = register("item_kiji_pancustard", () -> new AddInfo_Item(new Item.Properties()));
	public static final RegistryObject<Item> KIJI_APPLE_PAN = register("item_kiji_panapple", () -> new AddInfo_Item(new Item.Properties()));
	public static final RegistryObject<Item> KIJI_CHERRY_PAN = register("item_kiji_pancherry", () -> new AddInfo_Item(new Item.Properties()));
	public static final RegistryObject<Item> KIJI_CITRUS_PAN = register("item_kiji_pancitrus", () -> new AddInfo_Item(new Item.Properties()));
	public static final RegistryObject<Item> KIJI_GRAPE_PAN = register("item_kiji_pangrape", () -> new AddInfo_Item(new Item.Properties()));
	public static final RegistryObject<Item> KIJI_GREENTEA_PAN = register("item_kiji_pangreentea", () -> new AddInfo_Item(new Item.Properties()));
	...
	public static final RegistryObject<Item> KEIRYO_CUP_full = register("item_measurecup_full", () -> new MeasurecupFull_Item(new Item.Properties().craftRemainder(Items_Teatime.KEIRYO_CUP.get())));
	public static final RegistryObject<Item> KANSUI = register("item_kansui", () -> new MeasurecupFull_Item(new Item.Properties().craftRemainder(Items_Teatime.KEIRYO_CUP.get())));
	...
	public static final RegistryObject<Item> ZUNDOU_MIZU = register("block_zundou_mizu", () -> new Not_Fuel(Dish_Blocks.ZUNDOU_MIZU.get(), new Item.Properties()));
	public static final RegistryObject<Item> ZUNDOU_SHIO = register("block_zundou_shiomizu", () -> new Not_Fuel(Dish_Blocks.ZUNDOU_SHIO.get(), new Item.Properties()));
	public static final RegistryObject<Item> ZUNDOU_MILK = register("block_zundou_milk", () -> new Not_Fuel(Dish_Blocks.ZUNDOU_MILK.get(), new Item.Properties()));

	public static final RegistryObject<Item> ZUNDOU_NCURRY = register("block_food_cunabe_n", () -> new Not_Fuel(Dish_Blocks.ZUNDOU_NCURRY.get(), new Item.Properties()));
	public static final RegistryObject<Item> ZUNDOU_CURRY = register("block_food_cunabe_1", () -> new Not_Fuel(Dish_Blocks.ZUNDOU_CURRY.get(), new Item.Properties()));
	public static final RegistryObject<Item> ZUNDOU_NCURRY_C = register("block_food_cunabe_cn", () -> new Not_Fuel(Dish_Blocks.ZUNDOU_NCURRY_C.get(), new Item.Properties()));
	public static final RegistryObject<Item> ZUNDOU_CURRY_C = register("block_food_cunabe_c1", () -> new Not_Fuel(Dish_Blocks.ZUNDOU_CURRY_C.get(), new Item.Properties()));
	public static final RegistryObject<Item> ZUNDOU_NCURRY_T = register("block_food_cunabe_tn", () -> new Not_Fuel(Dish_Blocks.ZUNDOU_NCURRY_T.get(), new Item.Properties()));
	public static final RegistryObject<Item> ZUNDOU_CURRY_T = register("block_food_cunabe_t1", () -> new Not_Fuel(Dish_Blocks.ZUNDOU_CURRY_T.get(), new Item.Properties()));

	public static final RegistryObject<Item> ZUNDOU_NSTEW = register("block_food_stewnabe_n", () -> new Not_Fuel(Dish_Blocks.ZUNDOU_NSTEW.get(), new Item.Properties()));
	public static final RegistryObject<Item> ZUNDOU_STEW = register("block_food_stewnabe_1", () -> new Not_Fuel(Dish_Blocks.ZUNDOU_STEW.get(), new Item.Properties()));
	public static final RegistryObject<Item> ZUNDOU_DASHI = register("block_food_dashinabe_1", () -> new Not_Fuel(Dish_Blocks.ZUNDOU_DASHI.get(), new Item.Properties()));
	public static final RegistryObject<Item> ZUNDOU_RSOUP_nama = register("block_food_rsoup_n", () -> new Not_Fuel(Dish_Blocks.ZUNDOU_RSOUP_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> ZUNDOU_RSOUP = register("block_food_rsoup_1", () -> new Not_Fuel(Dish_Blocks.ZUNDOU_RSOUP.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> NABETORI_nama = register("block_food_nabe_n", () -> new Not_Fuel(Dish_Blocks.NABETORI_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEMISO_nama = register("block_food_nabemiso_n", () -> new Not_Fuel(Dish_Blocks.NABEMISO_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEGOHAN_nama = register("block_food_nabegohan_n", () -> new Not_Fuel(Dish_Blocks.NABEGOHAN_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEGOHANTAKE_nama = register("block_food_nabegohantake_n", () -> new Not_Fuel(Dish_Blocks.NABEGOHANTAKE_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEGOHANKURI_nama = register("block_food_nabegohankuri_n", () -> new Not_Fuel(Dish_Blocks.NABEGOHANKURI_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABESEKIHAN_nama = register("block_food_nabesekihan_n", () -> new Not_Fuel(Dish_Blocks.NABESEKIHAN_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABECORN_nama = register("block_food_nabecorns_n", () -> new Not_Fuel(Dish_Blocks.NABECORN_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABESHIO_nama = register("block_food_nabeshio_n", () -> new Not_Fuel(Dish_Blocks.NABESHIO_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABENIMAME_nama = register("block_food_nabenimame_n", () -> new Not_Fuel(Dish_Blocks.NABENIMAME_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABETOUFU_nama = register("block_food_nabetoufu_n", () -> new Not_Fuel(Dish_Blocks.NABETOUFU_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEAZUKI_nama = register("block_food_nabeazuki_n", () -> new Not_Fuel(Dish_Blocks.NABEAZUKI_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEANKO_nama = register("block_food_nabeanko_n", () -> new Not_Fuel(Dish_Blocks.NABEANKO_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEPUDDING_nama = register("block_food_nabepudding_n", () -> new Not_Fuel(Dish_Blocks.NABEPUDDING_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEPUDDING_green = register("block_food_nabepudding_g", () -> new Not_Fuel(Dish_Blocks.NABEPUDDING_green.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEPUDDING_red = register("block_food_nabepudding_r", () -> new Not_Fuel(Dish_Blocks.NABEPUDDING_red.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEPUDDING_cacao = register("block_food_nabepudding_c", () -> new Not_Fuel(Dish_Blocks.NABEPUDDING_cacao.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABE_CREAM = register("block_food_nabecream", () -> new Not_Fuel(Dish_Blocks.NABE_CREAM.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABETENGUSA_nama = register("block_food_nabetengusa_n", () -> new Not_Fuel(Dish_Blocks.NABETENGUSA_nama.get(), new Item.Properties()));
	
	public static final RegistryObject<Item> NABETORI = register("block_food_nabe_1", () -> new Not_Fuel(Dish_Blocks.NABETORI.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEMISO = register("block_food_nabemiso_1", () -> new Not_Fuel(Dish_Blocks.NABEMISO.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEZENZAI_M = register("block_food_nabezenzai_m", () -> new Not_Fuel(Dish_Blocks.NABEZENZAI_M.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEZENZAI_K = register("block_food_nabezenzai_k", () -> new Not_Fuel(Dish_Blocks.NABEZENZAI_K.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEGOHAN = register("block_food_nabegohan_1", () -> new Not_Fuel(Dish_Blocks.NABEGOHAN.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEGOHAN_TAKE = register("block_food_nabegohantake_1", () -> new Not_Fuel(Dish_Blocks.NABEGOHAN_TAKE.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABEGOHAN_KURI = register("block_food_nabegohankuri_1", () -> new Not_Fuel(Dish_Blocks.NABEGOHAN_KURI.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABESEKIHAN = register("block_food_nabesekihan_1", () -> new Not_Fuel(Dish_Blocks.NABESEKIHAN.get(), new Item.Properties()));
	public static final RegistryObject<Item> NABECORN = register("block_food_nabecorns_1", () -> new Not_Fuel(Dish_Blocks.NABECORN.get(), new Item.Properties()));

	public static final RegistryObject<Item> FRYPAN_kara = register("block_food_frypan", () -> new Not_Fuel(Dish_Blocks.FRYPAN_kara.get(), new Item.Properties()));
	public static final RegistryObject<Item> FPTAMAGO_nama = register("block_food_frypan_n_tamago", () -> new Not_Fuel(Dish_Blocks.FPTAMAGO_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> FPGYUDON_nama = register("block_food_frypan_n_gyudon", () -> new Not_Fuel(Dish_Blocks.FPGYUDON_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> FPOYAKODON_nama = register("block_food_frypan_n_oyakodon", () -> new Not_Fuel(Dish_Blocks.FPOYAKODON_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> FPKATSU_nama = register("block_food_frypan_n_katsu", () -> new Not_Fuel(Dish_Blocks.FPKATSU_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> FPKATSU_bake = register("block_food_frypan_b_katsu", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> FPKATSUDON_nama = register("block_food_frypan_n_katsudon", () -> new Not_Fuel(Dish_Blocks.FPKATSUDON_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> FPEGGBURG_nama = register("block_food_frypan_n_eggb", () -> new Not_Fuel(Dish_Blocks.FPEGGBURG_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> FPTOMATO_nama = register("block_food_frypan_n_tomatos", () -> new Not_Fuel(Dish_Blocks.FPTOMATO_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> FPKINOKO_nama = register("block_food_frypan_n_kinokos", () -> new Not_Fuel(Dish_Blocks.FPKINOKO_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> FPSEAFOOD_nama = register("block_food_frypan_n_seafood", () -> new Not_Fuel(Dish_Blocks.FPSEAFOOD_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> FPKINOKOAK_nama = register("block_food_frypan_n_kinokoak", () -> new Not_Fuel(Dish_Blocks.FPKINOKOAK_nama.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> FPCURRY_nama = register("block_food_frypan_n_roux", () -> new Not_Fuel(Dish_Blocks.FPCURRY_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> FPOSAUCE_nama = register("block_food_frypan_n_osauce", () -> new Not_Fuel(Dish_Blocks.FPOSAUCE_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> OKONOMIYAKI_nama = register("block_food_teppan_n_okonomiyaki", () -> new Not_Fuel(Dish_Blocks.OKONOMIYAKI_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> OKONOMIS_nama = register("block_food_teppan_n_okonomis", () -> new Not_Fuel(Dish_Blocks.OKONOMIS_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> OKONOMIC_nama = register("block_food_teppan_n_okonomic", () -> new Not_Fuel(Dish_Blocks.OKONOMIC_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> OKONOMISOBA_nama = register("block_food_teppan_n_okonomisoba", () -> new Not_Fuel(Dish_Blocks.OKONOMISOBA_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> OKONOMISOBAS_nama = register("block_food_teppan_n_okonomisobas", () -> new Not_Fuel(Dish_Blocks.OKONOMISOBAS_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> OKONOMISOBAC_nama = register("block_food_teppan_n_okonomisobac", () -> new Not_Fuel(Dish_Blocks.OKONOMISOBAC_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> YAKISOBA_nama = register("block_food_teppan_n_yakisoba", () -> new Not_Fuel(Dish_Blocks.YAKISOBA_nama.get(), new Item.Properties()));
	public static final RegistryObject<Item> YAKISOBASHIO_nama = register("block_food_teppan_n_yakisobashio", () -> new Not_Fuel(Dish_Blocks.YAKISOBASHIO_nama.get(), new Item.Properties()));

	public static final RegistryObject<Item> NIBOSHI = register("block_niboshi", () -> new Not_Fuel(Dish_Blocks.NIBOSHI.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> CURRYSET = register("block_food_curryset_1", () -> new Not_Fuel(Dish_Blocks.CURRYSET.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> CURRYSET_C = register("block_food_curryset_c1", () -> new Not_Fuel(Dish_Blocks.CURRYSET_C.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> CURRYSET_T = register("block_food_curryset_t1", () -> new Not_Fuel(Dish_Blocks.CURRYSET_T.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> TAMAGOYAKITEI = register("block_food_tgytei_1", () -> new Not_Fuel(Dish_Blocks.TAMAGOYAKITEI.get(), new Item.Properties()));
	public static final RegistryObject<Item> YAKIZAKANATEI = register("block_food_yakizakanatei_1", () -> new Not_Fuel(Dish_Blocks.YAKIZAKANATEI.get(), new Item.Properties()));
	public static final RegistryObject<Item> YAKIJYAKETEI = register("block_food_yakijyaketei_1", () -> new Not_Fuel(Dish_Blocks.YAKIJYAKETEI.get(), new Item.Properties()));
	public static final RegistryObject<Item> TAMAGOYAKITEI_TAKE = register("block_food_tgyteitake_1", () -> new Not_Fuel(Dish_Blocks.TAMAGOYAKITEI_TAKE.get(), new Item.Properties()));
	public static final RegistryObject<Item> YAKIZAKANATEI_TAKE = register("block_food_yakizakanateitake_1", () -> new Not_Fuel(Dish_Blocks.YAKIZAKANATEI_TAKE.get(), new Item.Properties()));
	public static final RegistryObject<Item> YAKIJYAKETEI_TAKE = register("block_food_yakijyaketeitake_1", () -> new Not_Fuel(Dish_Blocks.YAKIJYAKETEI_TAKE.get(), new Item.Properties()));
	public static final RegistryObject<Item> TAMAGOYAKITEI_KURI = register("block_food_tgyteikuri_1", () -> new Not_Fuel(Dish_Blocks.TAMAGOYAKITEI_KURI.get(), new Item.Properties()));
	public static final RegistryObject<Item> YAKIZAKANATEI_KURI = register("block_food_yakizakanateikuri_1", () -> new Not_Fuel(Dish_Blocks.YAKIZAKANATEI_KURI.get(), new Item.Properties()));
	public static final RegistryObject<Item> YAKIJYAKETEI_KURI = register("block_food_yakijyaketeikuri_1", () -> new Not_Fuel(Dish_Blocks.YAKIJYAKETEI_KURI.get(), new Item.Properties()));
	public static final RegistryObject<Item> TAMAGOYAKITEI_SEKI = register("block_food_tgytei_sekihan_1", () -> new Not_Fuel(Dish_Blocks.TAMAGOYAKITEI_SEKI.get(), new Item.Properties()));
	public static final RegistryObject<Item> YAKIZAKANATEI_SEKI = register("block_food_yakizakanatei_sekihan_1", () -> new Not_Fuel(Dish_Blocks.YAKIZAKANATEI_SEKI.get(), new Item.Properties()));
	public static final RegistryObject<Item> YAKIJYAKETEI_SEKI = register("block_food_yakijyaketei_sekihan_1", () -> new Not_Fuel(Dish_Blocks.YAKIJYAKETEI_SEKI.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> EGGBURGSET = register("block_food_egbset_1", () -> new Not_Fuel(Dish_Blocks.EGGBURGSET.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> PIZZA = register("block_food_pizza_1", () -> new Not_Fuel(Dish_Blocks.PIZZA.get(), new Item.Properties()));
	public static final RegistryObject<Item> PIZZA_C = register("block_food_pizza_c1", () -> new Not_Fuel(Dish_Blocks.PIZZA_C.get(), new Item.Properties()));
	public static final RegistryObject<Item> PIZZA_T = register("block_food_pizza_t1", () -> new Not_Fuel(Dish_Blocks.PIZZA_T.get(), new Item.Properties()));
	public static final RegistryObject<Item> PIZZA_S = register("block_food_pizza_s1", () -> new Not_Fuel(Dish_Blocks.PIZZA_S.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> CHICKEN = register("block_food_roastchicken_1", () -> new Not_Fuel(Dish_Blocks.CHICKEN.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> SUSHIMESHI = register("block_food_sushimeshi", () -> new Not_Fuel(Dish_Blocks.SUSHIMESHI.get(), new Item.Properties().craftRemainder(Items.BOWL)));
	public static final RegistryObject<Item> SUSHIGETA_kara = register("block_food_sushigeta_kara", () -> new Not_Fuel(Dish_Blocks.SUSHIGETA_kara.get(), new Item.Properties()));

	public static final RegistryObject<Item> SUSHISET_salmon = register("block_food_sushiset_salmon", () -> new Not_Fuel(Dish_Blocks.SUSHISET_salmon.get(), new Item.Properties()));
	public static final RegistryObject<Item> SUSHISET_fish = register("block_food_sushiset_fish", () -> new Not_Fuel(Dish_Blocks.SUSHISET_fish.get(), new Item.Properties()));
	public static final RegistryObject<Item> SUSHISET_beef = register("block_food_sushiset_beef", () -> new Not_Fuel(Dish_Blocks.SUSHISET_beef.get(), new Item.Properties()));
	public static final RegistryObject<Item> SUSHISET_tamago = register("block_food_sushiset_tamago", () -> new Not_Fuel(Dish_Blocks.SUSHISET_tamago.get(), new Item.Properties()));
	public static final RegistryObject<Item> SUSHISET_4shoku = register("block_food_sushiset_4shoku", () -> new Not_Fuel(Dish_Blocks.SUSHISET_4shoku.get(), new Item.Properties()));

	public static final RegistryObject<Item> SUSHIOKE = register("block_food_sushioke_kara", () -> new Not_Fuel(Dish_Blocks.SUSHIOKE.get(), new Item.Properties()));
	public static final RegistryObject<Item> SUSHIOKE_FULL_1 = register("block_food_sushiokefull_1", () -> new Not_Fuel(Dish_Blocks.SUSHIOKE_FULL_1.get(), new Item.Properties()));
	public static final RegistryObject<Item> SHOUYUSARA_1 = register("block_food_shouyusara_1", () -> new Not_Fuel(Dish_Blocks.SHOUYUSARA_1.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> KETTLE_kara = register("item_kettle_kara", () -> new Not_Fuel(Dish_Blocks.KETTLE_kara.get(), new Item.Properties()));
	public static final RegistryObject<Item> KETTLE_full = register("block_kettle_full", () -> new Not_Fuel(Dish_Blocks.KETTLE_full.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> KYUSU = register("block_food_kyusu_1", () -> new Not_Fuel(Dish_Blocks.KYUSU.get(), new Item.Properties()));
	public static final RegistryObject<Item> JPTEACUP = register("block_food_jpteacup_1", () -> new Yunomi_Item(Dish_Blocks.JPTEACUP.get(), new Item.Properties()));

	public static final RegistryObject<Item> JPTEASET = register("block_food_jpteaset_1", () -> new Not_Fuel(Dish_Blocks.JPTEASET.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHAUKE_SENBEI = register("block_food_senbei", () -> new Not_Fuel(Dish_Blocks.CHAUKE_SENBEI.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHAUKE_MIKAN = register("block_food_mikan", () -> new Not_Fuel(Dish_Blocks.CHAUKE_MIKAN.get(), new Item.Properties()));

	public static final RegistryObject<Item> TEAPOT_kara = register("block_food_teapot", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> TEAPOT = register("block_food_teapot_1", () -> new Not_Fuel(Dish_Blocks.TEAPOT.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> TEASET = register("block_food_teaset_1", () -> new Not_Fuel(Dish_Blocks.TEASET.get(), new Item.Properties()));
	public static final RegistryObject<Item> CHAUKE_SCONE = register("block_food_scone", () -> new Not_Fuel(Dish_Blocks.CHAUKE_SCONE.get(), new Item.Properties()));

	public static final RegistryObject<Item> SCONESET_kara = register("block_food_teastand", () -> new Not_Fuel(Dish_Blocks.SCONESET_kara.get(), new Item.Properties()));
	public static final RegistryObject<Item> SCONESET_1 = register("block_food_sconeset_1", () -> new Not_Fuel(Dish_Blocks.SCONESET_1.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> NORIAMI = register("block_noriami", () -> new Not_Fuel(Crop_Blocks.NORIAMI.get(), new Item.Properties()));
	public static final RegistryObject<Item> NORI_N = register("item_food_norinama", () -> new AddInfo_Item(new Item.Properties()));
	...
	public static final RegistryObject<Item> ONIGIRI_SEKIHAN = register("item_food_onigirisekihan", () -> new Item(new Item.Properties().food(FoodBuilders.ONIGIRI_TAKEKURI)));
	...
	public static final RegistryObject<Item> MOCHI_ANKO = register("item_food_mochianko", () -> new AddInfo_Item(new Item.Properties().food(FoodBuilders.MOCHI_ANKO)));
	public static final RegistryObject<Item> MOCHI_OHAGI = register("item_food_mochiohagi", () -> new AddInfo_Item(new Item.Properties().food(FoodBuilders.MOCHI_ANKO)));
	public static final RegistryObject<Item> MOCHI_SAKURA = register("item_food_mochisakura", () -> new AddInfo_Item(new Item.Properties().food(FoodBuilders.MOCHI_SAKURA)));

	public static final RegistryObject<Item> ANPAN = register("item_food_pananko", () -> new AddInfo_Item(new Item.Properties().food(FoodBuilders.MOCHI)));
	public static final RegistryObject<Item> CUSTARD_PAN = register("item_food_pancustard", () -> new Item(new Item.Properties().food(FoodBuilders.MOCHI)));
	public static final RegistryObject<Item> APPLE_PAN = register("item_food_panapple", () -> new Item(new Item.Properties().food(FoodBuilders.PAN_APPLE)));
	public static final RegistryObject<Item> CHERRY_PAN = register("item_food_pancherry", () -> new Item(new Item.Properties().food(FoodBuilders.PAN_CHERRY)));
	public static final RegistryObject<Item> CITRUS_PAN = register("item_food_pancitrus", () -> new Item(new Item.Properties().food(FoodBuilders.PAN_CITRUS)));
	public static final RegistryObject<Item> GRAPE_PAN = register("item_food_pangrape", () -> new Item(new Item.Properties().food(FoodBuilders.PAN_GRAPE)));
	public static final RegistryObject<Item> GREENTEA_PAN = register("item_food_pangreentea", () -> new Item(new Item.Properties().food(FoodBuilders.PAN_TEA)));
	...
	public static final RegistryObject<Item> KIT_SINK = register("block_kit_sink", () -> new Not_Fuel(Kitchen_Blocks.KIT_SINK.get(), new Item.Properties()));

	public static final RegistryObject<Item> KIT_COOKTOP = register("block_kit_stove", () -> new Not_Fuel(Kitchen_Blocks.KIT_COOKTOP.get(), new Item.Properties()));
	public static final RegistryObject<Item> KIT_OVEN = register("block_kit_oven", () -> new Not_Fuel(Kitchen_Blocks.KIT_OVEN.get(), new Item.Properties()));
	public static final RegistryObject<Item> KIT_OVEN_B = register("block_kit_oven_black", () -> new Not_Fuel(Kitchen_Blocks.KIT_OVEN_B.get(), new Item.Properties()));
	public static final RegistryObject<Item> IRORI = register("block_irori", () -> new Not_Fuel(Kitchen_Blocks.IRORI.get(), new Item.Properties()));
	public static final RegistryObject<Item> KIT_REIZOU = register("block_kit_reizou", () -> new Not_Fuel(Kitchen_Blocks.KIT_REIZOU.get(), new Item.Properties()));
	
	public static final RegistryObject<Item> KIT_KANKI_1 = register("block_kit_kanki", () -> new Not_Fuel(Kitchen_Blocks.KIT_KANKI_1.get(), new Item.Properties()));
	public static final RegistryObject<Item> KIT_HAIKIDUCT = register("block_kit_duct", () -> new Not_Fuel(Kitchen_Blocks.KIT_HAIKIDUCT.get(), new Item.Properties()));
	public static final RegistryObject<Item> KIT_DUCTEND_1 = register("block_kit_ductend", () -> new Not_Fuel(Kitchen_Blocks.KIT_DUCTEND_1.get(), new Item.Properties()));
	...
	public static final RegistryObject<Item> HAMAGURI = register("block_hamaguri", () -> new Not_Fuel(Crop_Blocks.HAMAGURI.get(), new Item.Properties()));

	public static final RegistryObject<Item> KINE_YOKO = register("item_kineyoko", () -> new KineYoko_Item(new Item.Properties().durability(128)));
