...
import com.ayutaki.chinjufumod.blocks.garden.Lit_Tourou;
import com.ayutaki.chinjufumod.blocks.garden.Lit_TourouLong;
...
public class Garden_Blocks {
	...
	public static void init() {
		...
		KASA_white = new Wagasa("block_mkasa_white");
		KASA_orange = new Wagasa("block_mkasa_orange");
		KASA_magenta = new Wagasa("block_mkasa_magenta");
		KASA_lightb = new Wagasa("block_mkasa_lightb");
		KASA_yellow = new Wagasa("block_mkasa_yellow");
		KASA_lime = new Wagasa("block_mkasa_lime");
		KASA_pink = new Wagasa("block_mkasa_pink");
		KASA_gray = new Wagasa("block_mkasa_gray");
		KASA_lightg = new Wagasa("block_mkasa_lightg");
		KASA_cyan = new Wagasa("block_mkasa_cyan");
		KASA_purple = new Wagasa("block_mkasa_purple");
		KASA_blue = new Wagasa("block_mkasa_blue");
		KASA_brown = new Wagasa("block_mkasa_brown");
		KASA_green = new Wagasa("block_mkasa_green");
		KASA_red = new Wagasa("block_mkasa_red");
		KASA_black = new Wagasa("block_mkasa_black");
		...
		IKEGAKI_S = new IkegakiSmall("block_ikegaki_small");
		IKEGAKI_L_TOP = new IkegakiLong_Top("block_ikegakilong_top");
		IKEGAKI_L_BOT = new IkegakiLong_Bottom("block_ikegakilong_bottom");
		...
		ISHITOUROU = new Tourou("block_ishitourou_stone");
		LIT_ISHITOUROU = new Lit_Tourou("lit_ishitourou_stone");
		LONGTOUROU_TOP = new TourouLong_Top("block_longtourou_top");
		LONGTOUROU_BOT = new TourouLong_Bot("block_longtourou_bot");
		LIT_LONGTOUROU_TOP = new Lit_TourouLong("lit_longtourou_top");
