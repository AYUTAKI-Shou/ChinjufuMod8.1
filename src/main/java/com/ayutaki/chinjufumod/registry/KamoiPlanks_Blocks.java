...
public class KamoiPlanks_Blocks {
	...
	public static final RegistryObject<Block> KAMOI_mangrove_oak = register("block_ka_mangrove_oak", () -> kamoiOak());
	public static final RegistryObject<Block> KAMOI_cherry_oak = register("block_ka_cherry_oak", () -> kamoiOak());
	...
	public static final RegistryObject<Block> KAMOI_mangrove_spru = register("block_ka_mangrove_spru", () -> kamoiSpruce());
	public static final RegistryObject<Block> KAMOI_cherry_spru = register("block_ka_cherry_spru", () -> kamoiSpruce());
	...
	public static final RegistryObject<Block> KAMOI_mangrove_bir = register("block_ka_mangrove_bir", () -> kamoiBirch());
	public static final RegistryObject<Block> KAMOI_cherry_bir = register("block_ka_cherry_bir", () -> kamoiBirch());
	...
	public static final RegistryObject<Block> KAMOI_mangrove_jun = register("block_ka_mangrove_jun", () -> kamoiJungle());
	public static final RegistryObject<Block> KAMOI_cherry_jun = register("block_ka_cherry_jun", () -> kamoiJungle());
	...
	public static final RegistryObject<Block> KAMOI_mangrove_aca = register("block_ka_mangrove_aca", () -> kamoiAcacia());
	public static final RegistryObject<Block> KAMOI_cherry_aca = register("block_ka_cherry_aca", () -> kamoiAcacia());
	...
	public static final RegistryObject<Block> KAMOI_mangrove_doak = register("block_ka_mangrove_doak", () -> kamoiDarkOak());
	public static final RegistryObject<Block> KAMOI_cherry_doak = register("block_ka_cherry_doak", () -> kamoiDarkOak());
	...
	public static final RegistryObject<Block> KAMOI_oak_mangrove = register("block_ka_oak_mangrove", () -> kamoiMangrove());
	public static final RegistryObject<Block> KAMOI_spru_mangrove = register("block_ka_spru_mangrove", () -> kamoiMangrove());
	public static final RegistryObject<Block> KAMOI_bir_mangrove = register("block_ka_bir_mangrove", () -> kamoiMangrove());
	public static final RegistryObject<Block> KAMOI_jun_mangrove = register("block_ka_jun_mangrove", () -> kamoiMangrove());
	public static final RegistryObject<Block> KAMOI_aca_mangrove = register("block_ka_aca_mangrove", () -> kamoiMangrove());
	public static final RegistryObject<Block> KAMOI_doak_mangrove = register("block_ka_doak_mangrove", () -> kamoiMangrove());
	public static final RegistryObject<Block> KAMOI_mangrove_mangrove = register("block_ka_mangrove_mangrove", () -> kamoiMangrove());
	public static final RegistryObject<Block> KAMOI_cherry_mangrove = register("block_ka_cherry_mangrove", () -> kamoiMangrove());
	public static final RegistryObject<Block> KAMOI_saku_mangrove = register("block_ka_saku_mangrove", () -> kamoiMangrove());
	public static final RegistryObject<Block> KAMOI_kae_mangrove = register("block_ka_kae_mangrove", () -> kamoiMangrove());
	public static final RegistryObject<Block> KAMOI_ich_mangrove = register("block_ka_ich_mangrove", () -> kamoiMangrove());
	
	public static final RegistryObject<Block> KAMOI_oak_cherry = register("block_ka_oak_cherry", () -> kamoiCherry());
	public static final RegistryObject<Block> KAMOI_spru_cherry = register("block_ka_spru_cherry", () -> kamoiCherry());
	public static final RegistryObject<Block> KAMOI_bir_cherry = register("block_ka_bir_cherry", () -> kamoiCherry());
	public static final RegistryObject<Block> KAMOI_jun_cherry = register("block_ka_jun_cherry", () -> kamoiCherry());
	public static final RegistryObject<Block> KAMOI_aca_cherry = register("block_ka_aca_cherry", () -> kamoiCherry());
	public static final RegistryObject<Block> KAMOI_doak_cherry = register("block_ka_doak_cherry", () -> kamoiCherry());
	public static final RegistryObject<Block> KAMOI_mangrove_cherry = register("block_ka_mangrove_cherry", () -> kamoiCherry());
	public static final RegistryObject<Block> KAMOI_cherry_cherry = register("block_ka_cherry_cherry", () -> kamoiCherry());
	public static final RegistryObject<Block> KAMOI_saku_cherry = register("block_ka_saku_cherry", () -> kamoiCherry());
	public static final RegistryObject<Block> KAMOI_kae_cherry = register("block_ka_kae_cherry", () -> kamoiCherry());
	public static final RegistryObject<Block> KAMOI_ich_cherry = register("block_ka_ich_cherry", () -> kamoiCherry());
	...
	public static final RegistryObject<Block> KAMOI_mangrove_sakura = register("block_ka_mangrove_saku", () -> kamoiSakura());
	public static final RegistryObject<Block> KAMOI_cherry_sakura = register("block_ka_cherry_saku", () -> kamoiSakura());
	...
	public static final RegistryObject<Block> KAMOI_mangrove_kaede = register("block_ka_mangrove_kae", () -> kamoiKaede());
	public static final RegistryObject<Block> KAMOI_cherry_kaede = register("block_ka_cherry_kae", () -> kamoiKaede());
	...
	public static final RegistryObject<Block> KAMOI_mangrove_ichoh = register("block_ka_mangrove_ich", () -> kamoiIchoh());
	public static final RegistryObject<Block> KAMOI_cherry_ichoh = register("block_ka_cherry_ich", () -> kamoiIchoh());
	...
	private static KamoiPlanks_Mangrove kamoiMangrove() {
		return new KamoiPlanks_Mangrove(woodState());
	}

	private static KamoiPlanks_Cherry kamoiCherry() {
		return new KamoiPlanks_Cherry(woodState());
	}
