...
public class KamoiPlanks_Blocks {
	...
	public static Block KAMOI_oak_sakura, KAMOI_spru_sakura, KAMOI_bir_sakura, KAMOI_jun_sakura, KAMOI_aca_sakura,
								KAMOI_doak_sakura, KAMOI_saku_sakura, KAMOI_kae_sakura, KAMOI_ich_sakura;
	public static Block KAMOI_oak_kaede, KAMOI_spru_kaede, KAMOI_bir_kaede, KAMOI_jun_kaede, KAMOI_aca_kaede,
								KAMOI_doak_kaede, KAMOI_saku_kaede, KAMOI_kae_kaede, KAMOI_ich_kaede;
	public static Block KAMOI_oak_ichoh, KAMOI_spru_ichoh, KAMOI_bir_ichoh, KAMOI_jun_ichoh, KAMOI_aca_ichoh,
								KAMOI_doak_ichoh, KAMOI_saku_ichoh, KAMOI_kae_ichoh, KAMOI_ich_ichoh;
	...
	public static void init() {
		...
		KAMOI_oak_sakura = new KamoiPlanks_Sakura("block_ka_oak_saku");
		KAMOI_spru_sakura = new KamoiPlanks_Sakura("block_ka_spru_saku");
		KAMOI_bir_sakura = new KamoiPlanks_Sakura("block_ka_bir_saku");
		KAMOI_jun_sakura = new KamoiPlanks_Sakura("block_ka_jun_saku");
		KAMOI_aca_sakura = new KamoiPlanks_Sakura("block_ka_aca_saku");
		KAMOI_doak_sakura = new KamoiPlanks_Sakura("block_ka_doak_saku");
		KAMOI_saku_sakura = new KamoiPlanks_Sakura("block_ka_saku_saku");
		KAMOI_kae_sakura = new KamoiPlanks_Sakura("block_ka_kae_saku");
		KAMOI_ich_sakura = new KamoiPlanks_Sakura("block_ka_ich_saku");

		KAMOI_oak_kaede = new KamoiPlanks_Kaede("block_ka_oak_kae");
		KAMOI_spru_kaede = new KamoiPlanks_Kaede("block_ka_spru_kae");
		KAMOI_bir_kaede = new KamoiPlanks_Kaede("block_ka_bir_kae");
		KAMOI_jun_kaede = new KamoiPlanks_Kaede("block_ka_jun_kae");
		KAMOI_aca_kaede = new KamoiPlanks_Kaede("block_ka_aca_kae");
		KAMOI_doak_kaede = new KamoiPlanks_Kaede("block_ka_doak_kae");
		KAMOI_saku_kaede = new KamoiPlanks_Kaede("block_ka_saku_kae");
		KAMOI_kae_kaede = new KamoiPlanks_Kaede("block_ka_kae_kae");
		KAMOI_ich_kaede = new KamoiPlanks_Kaede("block_ka_ich_kae");

		KAMOI_oak_ichoh = new KamoiPlanks_Ichoh("block_ka_oak_ich");
		KAMOI_spru_ichoh = new KamoiPlanks_Ichoh("block_ka_spru_ich");
		KAMOI_bir_ichoh = new KamoiPlanks_Ichoh("block_ka_bir_ich");
		KAMOI_jun_ichoh = new KamoiPlanks_Ichoh("block_ka_jun_ich");
		KAMOI_aca_ichoh = new KamoiPlanks_Ichoh("block_ka_aca_ich");
		KAMOI_doak_ichoh = new KamoiPlanks_Ichoh("block_ka_doak_ich");
		KAMOI_saku_ichoh = new KamoiPlanks_Ichoh("block_ka_saku_ich");
		KAMOI_kae_ichoh = new KamoiPlanks_Ichoh("block_ka_kae_ich");
		KAMOI_ich_ichoh = new KamoiPlanks_Ichoh("block_ka_ich_ich");
	}
	...
	public static void register() {
		...
		registerBlock(KAMOI_oak_sakura);
		registerBlock(KAMOI_spru_sakura);
		registerBlock(KAMOI_bir_sakura);
		registerBlock(KAMOI_jun_sakura);
		registerBlock(KAMOI_aca_sakura);
		registerBlock(KAMOI_doak_sakura);
		registerBlock(KAMOI_saku_sakura);
		registerBlock(KAMOI_kae_sakura);
		registerBlock(KAMOI_ich_sakura);

		registerBlock(KAMOI_oak_kaede);
		registerBlock(KAMOI_spru_kaede);
		registerBlock(KAMOI_bir_kaede);
		registerBlock(KAMOI_jun_kaede);
		registerBlock(KAMOI_aca_kaede);
		registerBlock(KAMOI_doak_kaede);
		registerBlock(KAMOI_saku_kaede);
		registerBlock(KAMOI_kae_kaede);
		registerBlock(KAMOI_ich_kaede);

		registerBlock(KAMOI_oak_ichoh);
		registerBlock(KAMOI_spru_ichoh);
		registerBlock(KAMOI_bir_ichoh);
		registerBlock(KAMOI_jun_ichoh);
		registerBlock(KAMOI_aca_ichoh);
		registerBlock(KAMOI_doak_ichoh);
		registerBlock(KAMOI_saku_ichoh);
		registerBlock(KAMOI_kae_ichoh);
		registerBlock(KAMOI_ich_ichoh);
	}
