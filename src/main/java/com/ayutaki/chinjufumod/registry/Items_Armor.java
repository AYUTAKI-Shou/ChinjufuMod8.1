...
public class Items_Armor {
	...
	public static Item ISE_HELMET = register("item_ise_helmet", new Armor_Ise(CMArmorMaterial.ISE, EquipmentSlotType.HEAD, new Item.Properties()));
	public static Item ISE_CHESTPLATE = register("item_ise_chestplate", new Armor_Ise(CMArmorMaterial.ISE, EquipmentSlotType.CHEST, new Item.Properties()));
	public static Item ISE_LEGGINGS = register("item_ise_leggings", new Armor_Ise(CMArmorMaterial.ISE, EquipmentSlotType.LEGS, new Item.Properties()));
	public static Item ISE_BOOTS = register("item_ise_boots", new Armor_Ise(CMArmorMaterial.ISE, EquipmentSlotType.FEET, new Item.Properties()));
	public static Item ISE_BOOTS_KAI = register("item_ise_bootskai", new Armor_IseKai(CMArmorMaterial.ISE, EquipmentSlotType.FEET, new Item.Properties()));
	...
	public static Item I401_HELMET = register("item_i401_helmet", new Armor_I401(CMArmorMaterial.I401, EquipmentSlotType.HEAD, new Item.Properties()));
	public static Item I401_CHESTPLATE = register("item_i401_chestplate", new Armor_I401(CMArmorMaterial.I401, EquipmentSlotType.CHEST, new Item.Properties()));
	public static Item I401_LEGGINGS = register("item_i401_leggings", new Armor_I401(CMArmorMaterial.I401, EquipmentSlotType.LEGS, new Item.Properties()));
	public static Item I401_BOOTS = register( "item_i401_boots", new Armor_I401(CMArmorMaterial.I401, EquipmentSlotType.FEET, new Item.Properties()));
