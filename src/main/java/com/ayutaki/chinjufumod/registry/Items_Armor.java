...
public class Items_Armor {
	...
	public static Item ISE_HELMET, ISE_CHESTPLATE, ISE_LEGGINGS, ISE_BOOTS, ISE_BOOTS_KAI;
	...
	public static Item I401_HELMET, I401_CHESTPLATE, I401_LEGGINGS, I401_BOOTS;
	...
	public static void init() {
		...
		ISE_HELMET = new Armor_Ise("item_ise_helmet", CMArmorMaterial.ISE, 1, EntityEquipmentSlot.HEAD);
		ISE_CHESTPLATE = new Armor_Ise("item_ise_chestplate", CMArmorMaterial.ISE, 1, EntityEquipmentSlot.CHEST);
		ISE_LEGGINGS = new Armor_Ise("item_ise_leggings", CMArmorMaterial.ISE, 2, EntityEquipmentSlot.LEGS);
		ISE_BOOTS = new Armor_Ise("item_ise_boots", CMArmorMaterial.ISE, 1, EntityEquipmentSlot.FEET);
		ISE_BOOTS_KAI = new Armor_Ise("item_ise_bootskai", CMArmorMaterial.ISE, 1, EntityEquipmentSlot.FEET);
		...
		I401_HELMET = new Armor_I401("item_i401_helmet", CMArmorMaterial.I401, 1, EntityEquipmentSlot.HEAD);
		I401_CHESTPLATE = new Armor_I401("item_i401_chestplate", CMArmorMaterial.I401, 1, EntityEquipmentSlot.CHEST);
		I401_LEGGINGS = new Armor_I401("item_i401_leggings", CMArmorMaterial.I401, 2, EntityEquipmentSlot.LEGS);
		I401_BOOTS = new Armor_I401( "item_i401_boots", CMArmorMaterial.I401, 1, EntityEquipmentSlot.FEET);
	...
	public static void register() {
		...
		registerItem(ISE_HELMET);
		registerItem(ISE_CHESTPLATE);
		registerItem(ISE_LEGGINGS);
		registerItem(ISE_BOOTS);
		registerItem(ISE_BOOTS_KAI);
		...
		registerItem(I401_HELMET);
		registerItem(I401_CHESTPLATE);
		registerItem(I401_LEGGINGS);
		registerItem(I401_BOOTS);
	...
	public static void registerRenders() {
		...
		registerRender(ISE_HELMET);
		registerRender(ISE_CHESTPLATE);
		registerRender(ISE_LEGGINGS);
		registerRender(ISE_BOOTS);
		registerRender(ISE_BOOTS_KAI);
		...
		registerRender(I401_HELMET);
		registerRender(I401_CHESTPLATE);
		registerRender(I401_LEGGINGS);
		registerRender(I401_BOOTS);
