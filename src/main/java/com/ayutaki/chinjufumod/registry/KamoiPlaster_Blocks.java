...
public class KamoiPlaster_Blocks {
	...
	public static final RegistryObject<Block> KAMOI_dirt_mangrove = register("block_ka_dirt_mangrove", () -> kamoiDirtWall());
	public static final RegistryObject<Block> KAMOI_dirt_cherry = register("block_ka_dirt_cherry", () -> kamoiDirtWall());
	...
	public static final RegistryObject<Block> KAMOI_white_mangrove = register("block_ka_white_mangrove", () -> kamoiPlasterMangrove());
	public static final RegistryObject<Block> KAMOI_orange_mangrove = register("block_ka_orange_mangrove", () -> kamoiPlasterMangrove());
	public static final RegistryObject<Block> KAMOI_magenta_mangrove = register("block_ka_magenta_mangrove", () -> kamoiPlasterMangrove());
	public static final RegistryObject<Block> KAMOI_lightb_mangrove = register("block_ka_lightb_mangrove", () -> kamoiPlasterMangrove());
	public static final RegistryObject<Block> KAMOI_yellow_mangrove = register("block_ka_yellow_mangrove", () -> kamoiPlasterMangrove());
	public static final RegistryObject<Block> KAMOI_lime_mangrove = register("block_ka_lime_mangrove", () -> kamoiPlasterMangrove());
	public static final RegistryObject<Block> KAMOI_pink_mangrove = register("block_ka_pink_mangrove", () -> kamoiPlasterMangrove());
	public static final RegistryObject<Block> KAMOI_gray_mangrove = register("block_ka_gray_mangrove", () -> kamoiPlasterMangrove());
	public static final RegistryObject<Block> KAMOI_lightg_mangrove = register("block_ka_lightg_mangrove", () -> kamoiPlasterMangrove());
	public static final RegistryObject<Block> KAMOI_cyan_mangrove = register("block_ka_cyan_mangrove", () -> kamoiPlasterMangrove());
	public static final RegistryObject<Block> KAMOI_purple_mangrove = register("block_ka_purple_mangrove", () -> kamoiPlasterMangrove());
	public static final RegistryObject<Block> KAMOI_blue_mangrove = register("block_ka_blue_mangrove", () -> kamoiPlasterMangrove());
	public static final RegistryObject<Block> KAMOI_brown_mangrove = register("block_ka_brown_mangrove", () -> kamoiPlasterMangrove());
	public static final RegistryObject<Block> KAMOI_green_mangrove = register("block_ka_green_mangrove", () -> kamoiPlasterMangrove());
	public static final RegistryObject<Block> KAMOI_red_mangrove = register("block_ka_red_mangrove", () -> kamoiPlasterMangrove());
	public static final RegistryObject<Block> KAMOI_black_mangrove = register("block_ka_black_mangrove", () -> kamoiPlasterMangrove());

	public static final RegistryObject<Block> KAMOI_white_cherry = register("block_ka_white_cherry", () -> kamoiPlasterCherry());
	public static final RegistryObject<Block> KAMOI_orange_cherry = register("block_ka_orange_cherry", () -> kamoiPlasterCherry());
	public static final RegistryObject<Block> KAMOI_magenta_cherry = register("block_ka_magenta_cherry", () -> kamoiPlasterCherry());
	public static final RegistryObject<Block> KAMOI_lightb_cherry = register("block_ka_lightb_cherry", () -> kamoiPlasterCherry());
	public static final RegistryObject<Block> KAMOI_yellow_cherry = register("block_ka_yellow_cherry", () -> kamoiPlasterCherry());
	public static final RegistryObject<Block> KAMOI_lime_cherry = register("block_ka_lime_cherry", () -> kamoiPlasterCherry());
	public static final RegistryObject<Block> KAMOI_pink_cherry = register("block_ka_pink_cherry", () -> kamoiPlasterCherry());
	public static final RegistryObject<Block> KAMOI_gray_cherry = register("block_ka_gray_cherry", () -> kamoiPlasterCherry());
	public static final RegistryObject<Block> KAMOI_lightg_cherry = register("block_ka_lightg_cherry", () -> kamoiPlasterCherry());
	public static final RegistryObject<Block> KAMOI_cyan_cherry = register("block_ka_cyan_cherry", () -> kamoiPlasterCherry());
	public static final RegistryObject<Block> KAMOI_purple_cherry = register("block_ka_purple_cherry", () -> kamoiPlasterCherry());
	public static final RegistryObject<Block> KAMOI_blue_cherry = register("block_ka_blue_cherry", () -> kamoiPlasterCherry());
	public static final RegistryObject<Block> KAMOI_brown_cherry = register("block_ka_brown_cherry", () -> kamoiPlasterCherry());
	public static final RegistryObject<Block> KAMOI_green_cherry = register("block_ka_green_cherry", () -> kamoiPlasterCherry());
	public static final RegistryObject<Block> KAMOI_red_cherry = register("block_ka_red_cherry", () -> kamoiPlasterCherry());
	public static final RegistryObject<Block> KAMOI_black_cherry = register("block_ka_black_cherry", () -> kamoiPlasterCherry());
	...
	private static KamoiPlaster_Mangrove kamoiPlasterMangrove() {
		return new KamoiPlaster_Mangrove(stoneState());
	}

	private static KamoiPlaster_Cherry kamoiPlasterCherry() {
		return new KamoiPlaster_Cherry(stoneState());
	}
