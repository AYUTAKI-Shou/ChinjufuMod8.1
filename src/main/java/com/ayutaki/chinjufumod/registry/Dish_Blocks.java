...
public class Dish_Blocks {
	...
	private static Properties metalDish() {
		return BlockBehaviour.Properties.of(Material.METAL).noCollission().strength(1.0F, 3.0F).sound(SoundType.METAL).noOcclusion()
				.isValidSpawn(Dish_Blocks::neverEntity).isSuffocating(Dish_Blocks::never);
	}
	
	private static Properties stoneDish() {
		return BlockBehaviour.Properties.of(Material.STONE).noCollission().strength(1.0F, 3.0F).sound(SoundType.STONE).noOcclusion()
				.isValidSpawn(Dish_Blocks::neverEntity).isSuffocating(Dish_Blocks::never);
	}
	
	private static Properties woodDish() {
		return BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F, 3.0F).sound(SoundType.WOOD).noOcclusion()
				.isValidSpawn(Dish_Blocks::neverEntity).isSuffocating(Dish_Blocks::never);
	}
	
	private static Properties snowDish() {
		return BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.SNOW).noOcclusion()
				.isValidSpawn(Dish_Blocks::neverEntity).isSuffocating(Dish_Blocks::never);
	}
	...
	private static Properties grassRandom() {
		return BlockBehaviour.Properties.of(Material.GRASS).noCollission().strength(1.0F).sound(SoundType.GRASS).noOcclusion()
