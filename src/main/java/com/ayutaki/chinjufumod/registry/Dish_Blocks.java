...
public class Dish_Blocks {
	...
	public static Block OSAUCE_bot_14 = register("block_osauce_bot", new Bot_Dashi(stoneState()));
	public static Block OSAUCE_bot_24 = register("block_osauce_bot_2", new Bot_Dashi(stoneState()));
	public static Block OSAUCE_bot_34 = register("block_osauce_bot_3", new Bot_Dashi(stoneState()));
	public static Block OSAUCE_bot_44 = register("block_osauce_bot_4", new Bot_Dashi(stoneState()));
	public static Block MAYO_bot_14 = register("block_mayo_bot", new Bot_Dashi(stoneState()));
	public static Block MAYO_bot_24 = register("block_mayo_bot_2", new Bot_Dashi(stoneState()));
	public static Block MAYO_bot_34 = register("block_mayo_bot_3", new Bot_Dashi(stoneState()));
	public static Block MAYO_bot_44 = register("block_mayo_bot_4", new Bot_Dashi(stoneState()));
	public static Block SOYOIL_bot_12 = register("block_soyoil_bot", new Bot_Shouyu(stoneState()));
	public static Block SOYOIL_bot_22 = register("block_soyoil_bot_2", new Bot_Shouyu(stoneState()));
	public static Block TENGUSA_WASH = register("block_tengusawash", new TengusaWashed(grassRandom()));
	...
	public static Block ZUNDOU_NSTEW = register("block_food_stewnabe_n", new Zundou_NamaCurry(metalDish()));
	...
	public static Block NABETORI_nama = register("block_food_nabe_n", new Nabe_NamaSoup(stoneDish()));
	public static Block NABEMISO_nama = register("block_food_nabemiso_n", new Nabe_NamaSoup(stoneDish()));
	public static Block NABEGOHAN_nama = register("block_food_nabegohan_n", new Nabe_NamaGohan(stoneDish()));
	public static Block NABEGOHANTAKE_nama = register("block_food_nabegohantake_n", new Nabe_NamaGohan(stoneDish()));
	public static Block NABEGOHANKURI_nama = register("block_food_nabegohankuri_n", new Nabe_NamaGohan(stoneDish()));
	public static Block NABESEKIHAN_nama = register("block_food_nabesekihan_n", new Nabe_NamaGohan(stoneDish()));
	public static Block NABECORN_nama = register("block_food_nabecorns_n", new Nabe_NamaSoup(stoneDish()));
	public static Block NABESHIO_nama = register("block_food_nabeshio_n", new Nabe2_TakeSude(stoneDish()));
	public static Block NABENIMAME_nama = register("block_food_nabenimame_n", new Nabe2_TakeBowl(stoneDish()));
	public static Block NABETOUFU_nama = register("block_food_nabetoufu_n", new Nabe2_TakeSude(stoneDish()));
	
	public static Block NABEAZUKI_nama = register("block_food_nabeazuki_n", new Nabe2_TakeSude(stoneDish()));
	public static Block NABEANKO_nama = register("block_food_nabeanko_n", new Nabe2_TakeBowl(stoneDish()));
	public static Block NABEPUDDING_nama = register("block_food_nabepudding_n", new Nabe2_Pudding(stoneDish()));
	public static Block NABEPUDDING_green = register("block_food_nabepudding_g", new Nabe2_Pudding(stoneDish()));
	public static Block NABEPUDDING_red = register("block_food_nabepudding_r", new Nabe2_Pudding(stoneDish()));
	public static Block NABEPUDDING_cacao = register("block_food_nabepudding_c", new Nabe2_Pudding(stoneDish()));
	public static Block NABE_CREAM = register("block_food_nabecream", new NabeCream(stoneDish()));
	public static Block NABE_CREAM_sub = register("block_food_nabecream_sub", new NabeCream(stoneDish()));
	public static Block KURI_NABE_nama = register("block_food_nabekuri_n", new Nabe2_TakeBowl(stoneDish()));
	public static Block NABETENGUSA_nama = register("block_food_nabetengusa_n", new NabeTengusa(stoneDish()));
	
	public static Block NABETORI = register("block_food_nabe_1", new NabeTori(stoneDish()));
	public static Block NABEMISO = register("block_food_nabemiso_1", new Nabe_Shikki(stoneDish()));
	public static Block NABEZENZAI_M = register("block_food_nabezenzai_m", new Nabe_Shikki(stoneDish()));
	public static Block NABEZENZAI_K = register("block_food_nabezenzai_k", new Nabe_Shikki(stoneDish()));
	public static Block NABEGOHAN = register("block_food_nabegohan_1", new NabeGohan(stoneDish()));
	public static Block NABEGOHAN_TAKE = register("block_food_nabegohantake_1", new NabeGohan_Other(stoneDish()));
	public static Block NABEGOHAN_KURI = register("block_food_nabegohankuri_1", new NabeGohan_Other(stoneDish()));
	public static Block NABESEKIHAN = register("block_food_nabesekihan_1", new NabeGohan_Other(stoneDish()));
	...
	public static Block FRYPAN_kara = register("block_food_frypan", new Frypan_kara(metalDish()));
	public static Block FPTAMAGO_nama = register("block_food_frypan_n_tamago", new Frypan_TakePlate(metalDish()));
	public static Block FPGYUDON_nama = register("block_food_frypan_n_gyudon", new Frypan_DonNama(metalDish()));
	public static Block FPOYAKODON_nama = register("block_food_frypan_n_oyakodon", new Frypan_DonNama(metalDish()));
	public static Block FPKATSU_nama = register("block_food_frypan_n_katsu", new Frypan_Katsu(metalDish()));
	public static Block FPKATSUDON_nama = register("block_food_frypan_n_katsudon", new Frypan_DonNama(metalDish()));
	public static Block FPEGGBURG_nama = register("block_food_frypan_n_eggb", new Frypan_TakePlate(metalDish()));
	public static Block FPTOMATO_nama = register("block_food_frypan_n_tomatos", new Frypan_PastaNama(metalDish()));
	public static Block FPKINOKO_nama = register("block_food_frypan_n_kinokos", new Frypan_PastaNama(metalDish()));
	public static Block FPSEAFOOD_nama = register("block_food_frypan_n_seafood", new Frypan_PastaNama(metalDish()));
	public static Block FPKINOKOAK_nama = register("block_food_frypan_n_kinokoak", new Frypan_KinokoAK(metalDish()));
	public static Block FPCURRY_nama = register("block_food_frypan_n_roux", new Frypan_Curry(metalDish()));

	public static Block FPOSAUCE_nama = register("block_food_frypan_n_osauce", new Frypan_OSauce(metalDish()));
	...
	public static Block NIBOSHI = register("block_niboshi", new Niboshi(snowDish().tickRandomly()));
	...
	public static Block MISOSOUP = register("block_food_misosp_1", new Soup_Shikki(woodDish()));
	public static Block ZENZAI_M = register("block_food_zenzai_m", new Soup_Shikki(woodDish()));
	public static Block ZENZAI_K = register("block_food_zenzai_k", new Soup_Shikki(woodDish()));
	...
	public static Block SEKIHAN = register("block_food_sekihan", new Gohan(stoneDish()));
	...
	public static Block YAKIJYAKETEI = register("block_food_yakijyaketei_1", new YakiZakana_set(stoneDish()));
	...
	public static Block YAKIJYAKETEI_TAKE = register("block_food_yakijyaketeitake_1", new YakiZakana_set(stoneDish()));
	...
	public static Block YAKIJYAKETEI_KURI = register("block_food_yakijyaketeikuri_1", new YakiZakana_set(stoneDish()));
	public static Block TAMAGOYAKITEI_SEKI = register("block_food_tgytei_sekihan_1", new Tamagoyaki_set(stoneDish()));
	public static Block YAKIZAKANATEI_SEKI = register("block_food_yakizakanatei_sekihan_1", new YakiZakana_set(stoneDish()));
	public static Block YAKIJYAKETEI_SEKI = register("block_food_yakijyaketei_sekihan_1", new YakiZakana_set(stoneDish()));
	...
	public static Block ICECREAM = register("block_food_icecream_1", new Ice_Pudding(stoneDish()));
	public static Block ICECREAM_GREEN = register("block_food_icecream_greentea", new Ice_Pudding(stoneDish()));
	public static Block ICECREAM_RED = register("block_food_icecream_redtea", new Ice_Pudding(stoneDish()));
	public static Block ICECREAM_CACAO = register("block_food_icecream_cacao", new Ice_Pudding(stoneDish()));

	public static Block CUSTARD_PUDDING = register("block_food_pudding_custard", new Ice_Pudding(stoneDish()));
	public static Block GREENTEA_PUDDING = register("block_food_pudding_greentea", new Ice_Pudding(stoneDish()));
	public static Block REDTEA_PUDDING = register("block_food_pudding_redtea", new Ice_Pudding(stoneDish()));
	public static Block CACAO_PUDDING = register("block_food_pudding_cacao", new Ice_Pudding(stoneDish()));

	public static Block NABEK_APPLE = register("block_food_nabek_apple", new NabeKanten(stoneDish()));
	public static Block NABEK_CHERRY = register("block_food_nabek_cherry", new NabeKanten(stoneDish()));
	public static Block NABEK_CITRUS = register("block_food_nabek_citrus", new NabeKanten(stoneDish()));
	public static Block NABEK_GRAPE = register("block_food_nabek_grape", new NabeKanten(stoneDish()));
	public static Block NABEK_MILK = register("block_food_nabek_milk", new NabeKantenMilk(stoneDish()));
	public static Block NABEK_YOKAN = register("block_food_nabek_yokan", new NabeYokan(stoneDish()));
	public static Block NABEK_MATCHA = register("block_food_nabek_matcha", new NabeYokan(stoneDish()));
	public static Block KANTEN_APPLE = register("block_food_kanten_apple", new Kanten(stoneDish()));
	public static Block KANTEN_CHERRY = register("block_food_kanten_cherry", new Kanten(stoneDish()));
	public static Block KANTEN_CITRUS = register("block_food_kanten_citrus", new Kanten(stoneDish()));
	public static Block KANTEN_GRAPE = register("block_food_kanten_grape", new Kanten(stoneDish()));
	public static Block KANTEN_MILK = register("block_food_kanten_milk", new Kanten(stoneDish()));
	public static Block YOKAN = register("block_food_yokan", new Kanten(stoneDish()));
	public static Block YOKAN_MATCHA = register("block_food_yokan_matcha", new Kanten(stoneDish()));
	...
	private static Properties metalDish() {
		return Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F, 3.0F).sound(SoundType.METAL).notSolid();
	}
	
	private static Properties stoneDish() {
		return Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F, 3.0F).sound(SoundType.STONE).notSolid();
	}
	
	private static Properties woodDish() {
		return Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F, 3.0F).sound(SoundType.WOOD).notSolid();
	}
	
	private static Properties snowDish() {
		return Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F).sound(SoundType.SNOW).notSolid();
	}
	
	private static Properties stoneState() {
		return Block.Properties.create(Material.WOOD).doesNotBlockMovement().hardnessAndResistance(1.0F, 1.0F).sound(SoundType.STONE).notSolid();
	}
	
	private static Properties grassRandom() {
		return Block.Properties.create(Material.PLANTS).doesNotBlockMovement().hardnessAndResistance(0.5F)
