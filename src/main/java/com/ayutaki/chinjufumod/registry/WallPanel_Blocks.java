...
public class WallPanel_Blocks {
	...
	private static BrickSlab_CM brickSlab() {
		return new BrickSlab_CM(Block.Properties.create(Material.WOOD).hardnessAndResistance(1.0F, 6.0F).sound(SoundType.STONE).notSolid());
	}
	...
	private static WallPane_Stage3Wood woodPaneStage3() {
		return new WallPane_Stage3Wood(Block.Properties.create(Material.WOOD).hardnessAndResistance(1.0F, 3.0F).sound(SoundType.WOOD).notSolid());
	}
	...
	private static WallPane_Stage3Stone stonePaneStage3() {
		return new WallPane_Stage3Stone(Block.Properties.create(Material.WOOD).hardnessAndResistance(1.0F, 3.0F).sound(SoundType.STONE).notSolid());
	}
