...
import com.ayutaki.chinjufumod.blocks.wallpane.BrickSlab_CM;
...
public class WallPanel_Blocks {
	...
	public static Block PILLARSLAB_oak = register("block_kamoi_oak", new Kamoi_Oak(kamoiState()));
	public static Block PILLARSLAB_spru = register("block_kamoi_spruce", new Kamoi_Spruce(kamoiState()));
	public static Block PILLARSLAB_bir = register("block_kamoi_birch", new Kamoi_Birch(kamoiState()));
	public static Block PILLARSLAB_jun = register("block_kamoi_jungle", new Kamoi_Jungle(kamoiState()));
	public static Block PILLARSLAB_aca = register("block_kamoi_acacia", new Kamoi_Acacia(kamoiState()));
	public static Block PILLARSLAB_doak = register("block_kamoi_darkoak", new Kamoi_DarkOak(kamoiState()));
	...
	public static Block WP_STONE = register("block_wp_stone", new WallPane_Simple(baseState().strength(1.0F, 6.0F)));
	...
	public static Block WP_BRICK = register("block_wp_brick", new WallPane_Simple(baseState().strength(1.0F, 6.0F)));
	...
	public static Block WP_OBSIDIAN = register("block_wp_obsidian", new WallPane_Simple(baseState().strength(1.0F, 1200.0F)));
	...
	public static Block WP_NETHE_rack = register("block_wp_netherrack", new WallPane_Simple(baseState().strength(1.0F, 0.4F)));
	...
	public static Block WP_ENDSTONE = register("block_wp_endstone", new WallPane_Simple(baseState().strength(1.0F, 9.0F)));
	public static Block WP_ENDBRICKS = register("block_wp_endstone_b", new WallPane_Simple(baseState().strength(1.0F, 9.0F)));

	public static Block WP_PURPUR = register("block_wp_purpur", new WallPane_Simple(baseState().strength(1.0F, 6.0F)));
	...
	private static Properties baseState() {
		return AbstractBlock.Properties.of(Material.STONE).sound(SoundType.STONE)
	...
	private static BrickSlab_CM brickSlab() {
		return new BrickSlab_CM(stoneState().isValidSpawn(WallPanel_Blocks::neverEntitySlab).isSuffocating(WallPanel_Blocks::neverSlab));
	}

	private static BrickStairs_CM brickStairs() {
		return new BrickStairs_CM(BRICK_GRA.defaultBlockState(), stoneState().noOcclusion().isValidSpawn(WallPanel_Blocks::neverEntityStairs).isSuffocating(WallPanel_Blocks::never));
	}
	...
	private static WallPane_Stage3Wood woodPaneStage3() {
		return new WallPane_Stage3Wood(woodState().noOcclusion().isValidSpawn(WallPanel_Blocks::neverEntity).isSuffocating(WallPanel_Blocks::never));
	}
	...
	private static WallPane_Stage3Stone stonePaneStage3() {
		return new WallPane_Stage3Stone(stoneState().noOcclusion().isValidSpawn(WallPanel_Blocks::neverEntity).isSuffocating(WallPanel_Blocks::never));
	}
