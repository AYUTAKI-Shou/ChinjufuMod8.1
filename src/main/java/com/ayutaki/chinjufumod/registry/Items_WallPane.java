...
import com.ayutaki.chinjufumod.items.wallpanel.BrickC_WPT;
import com.ayutaki.chinjufumod.items.wallpanel.PillarSlab_WPT;
...
public class Items_WallPane {
	...
	public static void init() {
		...
		RGRA_slabhalf = new TabBlock_noFuel("block_rgra_slabhalf", WallBrick_Blocks.RGRA_slabhalf);
		RDIO_slabhalf = new TabBlock_noFuel("block_rdio_slabhalf", WallBrick_Blocks.RDIO_slabhalf);
		RAND_slabhalf = new TabBlock_noFuel("block_rand_slabhalf", WallBrick_Blocks.RAND_slabhalf);
		RGRA_stairs = new TabBlock_noFuel("block_rockstairs_gra", WallBrick_Blocks.RGRA_stairs);
		RDIO_stairs = new TabBlock_noFuel("block_rockstairs_dio", WallBrick_Blocks.RDIO_stairs);
		RAND_stairs = new TabBlock_noFuel("block_rockstairs_and", WallBrick_Blocks.RAND_stairs);

		BRICK_C = new BrickC_WPT("block_bricks_c");
		BGC_slabhalf = new TabBlock_noFuel("block_bgc_slabhalf", WallBrick_Blocks.BGC_slabhalf);
		BDC_slabhalf = new TabBlock_noFuel("block_bdc_slabhalf", WallBrick_Blocks.BDC_slabhalf);
		BAC_slabhalf = new TabBlock_noFuel("block_bac_slabhalf", WallBrick_Blocks.BAC_slabhalf);
		BGRA_stairs = new TabBlock_noFuel("block_brickstairs_gra_c", WallBrick_Blocks.BGRA_stairs);
		BDIO_stairs = new TabBlock_noFuel("block_brickstairs_dio_c", WallBrick_Blocks.BDIO_stairs);
		BAND_stairs = new TabBlock_noFuel("block_brickstairs_and_c", WallBrick_Blocks.BAND_stairs);

		BRICK_STONE_PIL = new TabBlock_noFuel("block_brick_stone_pil_c", WallBrick_Blocks.BRICK_STONE_PIL);
		BRICK_GRA_PIL = new TabBlock_noFuel("block_brick_gra_pil_c", WallBrick_Blocks.BRICK_GRA_PIL);
		BRICK_DIO_PIL = new TabBlock_noFuel("block_brick_dio_pil_c", WallBrick_Blocks.BRICK_DIO_PIL);
		BRICK_AND_PIL = new TabBlock_noFuel("block_brick_and_pil_c", WallBrick_Blocks.BRICK_AND_PIL);

		PILLAR_oak = new TabBlock_Fuel300("block_pillar_oak_c", WallBrick_Blocks.PILLAR_oak);
		PILLAR_spru = new TabBlock_Fuel300("block_pillar_spru_c", WallBrick_Blocks.PILLAR_spru);
		PILLAR_bir = new TabBlock_Fuel300("block_pillar_bir_c", WallBrick_Blocks.PILLAR_bir);
		PILLAR_jun = new TabBlock_Fuel300("block_pillar_jun_c", WallBrick_Blocks.PILLAR_jun);
		PILLAR_aca = new TabBlock_Fuel300("block_pillar_aca_c", WallBrick_Blocks.PILLAR_aca);
		PILLAR_doak = new TabBlock_Fuel300("block_pillar_doak_c", WallBrick_Blocks.PILLAR_doak);

		PILLARSLAB = new PillarSlab_WPT("block_kamoi");
	}
