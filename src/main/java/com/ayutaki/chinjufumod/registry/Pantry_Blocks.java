...
public class Pantry_Blocks {
	...
	public static Block BOX_H_EMPTY = register("block_boxh_empty", new Pantry_Empty(baseState().sound(SoundType.WOOD)));
	public static Block BOX_H_EMPTY2 = register("block_boxh_empty2", new Pantry_Empty(baseState().sound(SoundType.WOOD)));
	public static Block BOX_H_EMPTY3 = register("block_boxh_empty3", new Pantry_Empty(baseState().sound(SoundType.PLANT)));
	...
	public static Block BOX_H_AZUKI = register("block_boxh_azuki", pantrySack());
	...
	public static Block BOX_H_GREENONION = register("block_boxh_greenonion", pantryBox());
	public static Block BOX_H_ONION = register("block_boxh_onion", pantryBox());
	public static Block BOX_H_ORIENTCLAM = register("block_boxh_hamaguri", pantryBox());
	...
	public static Block BOX_H_SQUID = register("block_boxh_squid", pantryBox());
	...
	public static Block CHADUTSU = register("block_tea_chadutsu", new Chadutsu(baseState().sound(SoundType.STONE)));
	public static Block CANTEA = register("block_tea_can", new CanTea(baseState().sound(SoundType.STONE)));
	public static Block TAWARA = register("block_tawara_cm", new Tawara(baseState().sound(SoundType.PLANT)));
	...
	private static Pantry_Sack pantrySack() {
		return new Pantry_Sack(baseState().sound(SoundType.PLANT));
	}
