...
public class Pantry_Blocks {
	...
	public static final RegistryObject<Block> BOX_H_AZUKI = register("block_boxh_azuki", () -> pantrySack());
	...
	public static final RegistryObject<Block> BOX_H_GREENONION = register("block_boxh_greenonion", () -> pantryBox());
	public static final RegistryObject<Block> BOX_H_ONION = register("block_boxh_onion", () -> pantryBox());
	public static final RegistryObject<Block> BOX_H_ORIENTCLAM = register("block_boxh_hamaguri", () -> pantryBox());
	...
	public static final RegistryObject<Block> BOX_H_SQUID = register("block_boxh_squid", () -> pantryBox());
	...
	private static Properties baseState() {
		return BlockBehaviour.Properties.of(Material.WOOD).strength(1.0F, 3.0F).noOcclusion().isValidSpawn(Pantry_Blocks::neverEntity);
	}
