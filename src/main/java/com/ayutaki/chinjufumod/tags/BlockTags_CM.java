...
public class BlockTags_CM extends IntrinsicHolderTagsProvider<Block> {
	...
	public BlockTags_CM(PackOutput output, CompletableFuture<HolderLookup.Provider> provider) {
		super(output, Registries.BLOCK, provider, block -> block.builtInRegistryHolder().key(), ChinjufuMod.MOD_ID);
	}
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		.add(Window_Blocks.WINDOW_oak.get(), Window_Blocks.WINDOW_spruce.get(), Window_Blocks.WINDOW_birch.get(),
				...
				Window_Blocks.WINDOW_mangrove.get(), Window_Blocks.WINDOW_cherry.get(), Window_Blocks.WINDOW_paleoak.get(),
				...
				Window_Blocks.WINDOWB_mangrove.get(), Window_Blocks.WINDOWB_cherry.get(), Window_Blocks.WINDOWB_paleoak.get(),
				...
				Window_Blocks.WINDOWTALLBOT_mangrove.get(), Window_Blocks.WINDOWTALLBOT_cherry.get(), Window_Blocks.WINDOWTALLBOT_paleoak.get(),
				...
				Window_Blocks.WINDOWTALLTOP_mangrove.get(), Window_Blocks.WINDOWTALLTOP_cherry.get(), Window_Blocks.WINDOWTALLTOP_paleoak.get(),
				...
				Window_Blocks.WINDOWTALL_mangrove.get(), Window_Blocks.WINDOWTALL_cherry.get(), Window_Blocks.WINDOWTALL_paleoak.get(),
				...
				Slidedoor_Blocks.GARASUDO_MANGROVE.get(), Slidedoor_Blocks.GARASUDO_CHERRY.get(), Slidedoor_Blocks.GARASUDO_PALEOAK.get(),
				...
				Slidedoor_Blocks.GARASUDOB_MANGROVE.get(), Slidedoor_Blocks.GARASUDOB_CHERRY.get(), Slidedoor_Blocks.GARASUDOB_PALEOAK.get(),
				...
				Slidedoor_Blocks.GARASUDOH_MANGROVE.get(), Slidedoor_Blocks.GARASUDOH_CHERRY.get(), Slidedoor_Blocks.GARASUDOH_PALEOAK.get(),
				...
				Slidedoor_Blocks.SHOUJI_MANGROVE.get(), Slidedoor_Blocks.SHOUJI_CHERRY.get(), Slidedoor_Blocks.SHOUJI_PALEOAK.get(),
				...
				Slidedoor_Blocks.SHOUJIB_MANGROVE.get(), Slidedoor_Blocks.SHOUJIB_CHERRY.get(), Slidedoor_Blocks.SHOUJIB_PALEOAK.get(),
				...
				Slidedoor_Blocks.SHOUJIH_MANGROVE.get(), Slidedoor_Blocks.SHOUJIH_CHERRY.get(), Slidedoor_Blocks.SHOUJIH_PALEOAK.get(),
				...
				Slidedoor_Blocks.SHOUJI_WIN_MANGROVE.get(), Slidedoor_Blocks.SHOUJI_WIN_CHERRY.get(), Slidedoor_Blocks.SHOUJI_WIN_PALEOAK.get(),
				...
				Slidedoor_Blocks.SHOUJI_WINR_MANGROVE.get(), Slidedoor_Blocks.SHOUJI_WINR_CHERRY.get(), Slidedoor_Blocks.SHOUJI_WINR_PALEOAK.get(),
				...
				Ranma_Blocks.RANMA_mangrove.get(), Ranma_Blocks.RANMA_cherry.get(), Ranma_Blocks.RANMA_paleoak.get(),
				...
				Ranma_Blocks.RANMAB_mangrove.get(), Ranma_Blocks.RANMAB_cherry.get(), Ranma_Blocks.RANMAB_paleoak.get(),
				...
				Ranma_Blocks.RANMAC_mangrove.get(), Ranma_Blocks.RANMAC_cherry.get(), Ranma_Blocks.RANMAC_paleoak.get(),
				...
				Ranma_Blocks.KANKI_mangrove.get(), Ranma_Blocks.KANKI_cherry.get(), Ranma_Blocks.KANKI_paleoak.get(),
				...
				Ranma_Blocks.KOUSHI_mangrove.get(), Ranma_Blocks.KOUSHI_cherry.get(), Ranma_Blocks.KOUSHI_paleoak.get(),
				...
				Ranma_Blocks.KOUSHIB_mangrove.get(), Ranma_Blocks.KOUSHIB_cherry.get(), Ranma_Blocks.KOUSHIB_paleoak.get(),
				...
				Garden_Blocks.IKEGAKI_mangrove.get(), Garden_Blocks.IKEGAKI_cherry.get(), Garden_Blocks.IKEGAKI_paleoak.get(), 
				...
				Garden_Blocks.IKEGAKILONG_mangrove.get(), Garden_Blocks.IKEGAKILONG_cherry.get(), Garden_Blocks.IKEGAKILONG_paleoak.get(), 
				...
				Garden_Blocks.ITABEI_mangrove.get(), Garden_Blocks.ITABEI_cherry.get(), Garden_Blocks.ITABEI_paleoak.get(), 
				...
				Garden_Blocks.KIDO_mangrove.get(), Garden_Blocks.KIDO_cherry.get(), Garden_Blocks.KIDO_paleoak.get(), 
		...
		.add(Chinjufu_Blocks.EMPTY_BOX.get(), Chinjufu_Blocks.AMMO_BOX.get(), Chinjufu_Blocks.BAUXITE_BOX.get(),
				...
				Chair_Blocks.DININGCHAIR_mangrove.get(), Chair_Blocks.DININGCHAIR_cherry.get(), Chair_Blocks.DININGCHAIR_paleoak.get(),
				...
				Chair_Blocks.LOGCHAIR_mangrove.get(), Chair_Blocks.LOGCHAIR_cherry.get(), Chair_Blocks.LOGCHAIR_paleoak.get(),
				...
				Chair_Blocks.BENCH_mangrove.get(), Chair_Blocks.BENCH_cherry.get(), Chair_Blocks.BENCH_paleoak.get(),
				...
				Dish_Blocks.NIBOSHI.get(), 
				Dish_Blocks.MISOSOUP.get(), Dish_Blocks.ZENZAI_M.get(), Dish_Blocks.ZENZAI_K.get(),
				...
				Furniture_Blocks.DRESSINGTABLE_mangrove.get(), Furniture_Blocks.DRESSINGTABLE_cherry.get(), Furniture_Blocks.DRESSINGTABLE_paleoak.get(), 
				...
				Garden_Blocks.BONSAI_mangrove.get(), Garden_Blocks.BONSAI_cherry.get(), Garden_Blocks.BONSAI_paleoak.get(), 
				...
				Garden_Blocks.KANYOU_mangrove.get(), Garden_Blocks.KANYOU_cherry.get(), Garden_Blocks.KANYOU_paleoak.get(), 
				...
				KamoiPlanks_Blocks.KAMOI_mangrove_oak.get(), KamoiPlanks_Blocks.KAMOI_cherry_oak.get(), KamoiPlanks_Blocks.KAMOI_paleoak_oak.get(),
				...
				KamoiPlanks_Blocks.KAMOI_mangrove_spru.get(), KamoiPlanks_Blocks.KAMOI_cherry_spru.get(), KamoiPlanks_Blocks.KAMOI_paleoak_spru.get(),
				...
				KamoiPlanks_Blocks.KAMOI_mangrove_bir.get(), KamoiPlanks_Blocks.KAMOI_cherry_bir.get(), KamoiPlanks_Blocks.KAMOI_paleoak_bir.get(),
				...
				KamoiPlanks_Blocks.KAMOI_mangrove_jun.get(), KamoiPlanks_Blocks.KAMOI_cherry_jun.get(), KamoiPlanks_Blocks.KAMOI_paleoak_jun.get(),
				...
				KamoiPlanks_Blocks.KAMOI_mangrove_aca.get(), KamoiPlanks_Blocks.KAMOI_cherry_aca.get(), KamoiPlanks_Blocks.KAMOI_paleoak_aca.get(),
				...
				KamoiPlanks_Blocks.KAMOI_mangrove_doak.get(), KamoiPlanks_Blocks.KAMOI_cherry_doak.get(), KamoiPlanks_Blocks.KAMOI_paleoak_doak.get(),
				...
				KamoiPlanks_Blocks.KAMOI_mangrove_mangrove.get(), KamoiPlanks_Blocks.KAMOI_cherry_mangrove.get(), KamoiPlanks_Blocks.KAMOI_paleoak_mangrove.get(),
				...
				KamoiPlanks_Blocks.KAMOI_mangrove_cherry.get(), KamoiPlanks_Blocks.KAMOI_cherry_cherry.get(), KamoiPlanks_Blocks.KAMOI_paleoak_cherry.get(),
				KamoiPlanks_Blocks.KAMOI_saku_cherry.get(), KamoiPlanks_Blocks.KAMOI_kae_cherry.get(), KamoiPlanks_Blocks.KAMOI_ich_cherry.get(),
				KamoiPlanks_Blocks.KAMOI_oak_paleoak.get(), KamoiPlanks_Blocks.KAMOI_spru_paleoak.get(), KamoiPlanks_Blocks.KAMOI_bir_paleoak.get(),
				KamoiPlanks_Blocks.KAMOI_jun_paleoak.get(), KamoiPlanks_Blocks.KAMOI_aca_paleoak.get(), KamoiPlanks_Blocks.KAMOI_doak_paleoak.get(),
				KamoiPlanks_Blocks.KAMOI_mangrove_paleoak.get(), KamoiPlanks_Blocks.KAMOI_cherry_paleoak.get(), KamoiPlanks_Blocks.KAMOI_paleoak_paleoak.get(),
				KamoiPlanks_Blocks.KAMOI_saku_paleoak.get(), KamoiPlanks_Blocks.KAMOI_kae_paleoak.get(), KamoiPlanks_Blocks.KAMOI_ich_paleoak.get(),
				...
				KamoiPlanks_Blocks.KAMOI_mangrove_sakura.get(), KamoiPlanks_Blocks.KAMOI_cherry_sakura.get(), KamoiPlanks_Blocks.KAMOI_paleoak_sakura.get(),
				...
				KamoiPlanks_Blocks.KAMOI_mangrove_kaede.get(), KamoiPlanks_Blocks.KAMOI_cherry_kaede.get(), KamoiPlanks_Blocks.KAMOI_paleoak_kaede.get(),
				...
				KamoiPlanks_Blocks.KAMOI_mangrove_ichoh.get(), KamoiPlanks_Blocks.KAMOI_cherry_ichoh.get(), KamoiPlanks_Blocks.KAMOI_paleoak_ichoh.get(),
				...
				KamoiPlaster_Blocks.KAMOI_dirt_mangrove.get(), KamoiPlaster_Blocks.KAMOI_dirt_cherry.get(), KamoiPlaster_Blocks.KAMOI_dirt_paleoak.get(), 
				...
				KamoiPlaster_Blocks.KAMOI_black_mangrove.get(), KamoiPlaster_Blocks.KAMOI_black_cherry.get(), KamoiPlaster_Blocks.KAMOI_black_paleoak.get(), 
				...
				KamoiPlaster_Blocks.KAMOI_blue_mangrove.get(), KamoiPlaster_Blocks.KAMOI_blue_cherry.get(), KamoiPlaster_Blocks.KAMOI_blue_paleoak.get(), 
				...
				KamoiPlaster_Blocks.KAMOI_brown_mangrove.get(), KamoiPlaster_Blocks.KAMOI_brown_cherry.get(), KamoiPlaster_Blocks.KAMOI_brown_paleoak.get(), 
				...
				KamoiPlaster_Blocks.KAMOI_cyan_mangrove.get(), KamoiPlaster_Blocks.KAMOI_cyan_cherry.get(), KamoiPlaster_Blocks.KAMOI_cyan_paleoak.get(), 
				...
				KamoiPlaster_Blocks.KAMOI_gray_mangrove.get(), KamoiPlaster_Blocks.KAMOI_gray_cherry.get(), KamoiPlaster_Blocks.KAMOI_gray_paleoak.get(), 
				...
				KamoiPlaster_Blocks.KAMOI_green_mangrove.get(), KamoiPlaster_Blocks.KAMOI_green_cherry.get(), KamoiPlaster_Blocks.KAMOI_green_paleoak.get(), 
				...
				KamoiPlaster_Blocks.KAMOI_lightb_mangrove.get(), KamoiPlaster_Blocks.KAMOI_lightb_cherry.get(), KamoiPlaster_Blocks.KAMOI_lightb_paleoak.get(), 
				...
				KamoiPlaster_Blocks.KAMOI_lightg_mangrove.get(), KamoiPlaster_Blocks.KAMOI_lightg_cherry.get(), KamoiPlaster_Blocks.KAMOI_lightg_paleoak.get(), 
				...
				KamoiPlaster_Blocks.KAMOI_lime_mangrove.get(), KamoiPlaster_Blocks.KAMOI_lime_cherry.get(), KamoiPlaster_Blocks.KAMOI_lime_paleoak.get(), 
				...
				KamoiPlaster_Blocks.KAMOI_magenta_mangrove.get(), KamoiPlaster_Blocks.KAMOI_magenta_cherry.get(), KamoiPlaster_Blocks.KAMOI_magenta_paleoak.get(), 
				...
				KamoiPlaster_Blocks.KAMOI_orange_mangrove.get(), KamoiPlaster_Blocks.KAMOI_orange_cherry.get(), KamoiPlaster_Blocks.KAMOI_orange_paleoak.get(), 
				...
				KamoiPlaster_Blocks.KAMOI_pink_mangrove.get(), KamoiPlaster_Blocks.KAMOI_pink_cherry.get(), KamoiPlaster_Blocks.KAMOI_pink_paleoak.get(), 
				...
				KamoiPlaster_Blocks.KAMOI_purple_mangrove.get(), KamoiPlaster_Blocks.KAMOI_purple_cherry.get(), KamoiPlaster_Blocks.KAMOI_purple_paleoak.get(), 
				...
				KamoiPlaster_Blocks.KAMOI_red_mangrove.get(), KamoiPlaster_Blocks.KAMOI_red_cherry.get(), KamoiPlaster_Blocks.KAMOI_red_paleoak.get(), 
				...
				KamoiPlaster_Blocks.KAMOI_white_mangrove.get(), KamoiPlaster_Blocks.KAMOI_white_cherry.get(), KamoiPlaster_Blocks.KAMOI_white_paleoak.get(), 
				...
				KamoiPlaster_Blocks.KAMOI_yellow_mangrove.get(), KamoiPlaster_Blocks.KAMOI_yellow_cherry.get(), KamoiPlaster_Blocks.KAMOI_yellow_paleoak.get(), 
				...
				Pantry_Blocks.BOX_H_CABBAGE.get(), Pantry_Blocks.BOX_H_HAKUSAI.get(), Pantry_Blocks.BOX_H_CHERRY.get(), Pantry_Blocks.BOX_H_CITRUS.get(),
				Pantry_Blocks.BOX_H_CORN.get(), Pantry_Blocks.BOX_H_GRAPE.get(), Pantry_Blocks.BOX_H_GREENONION.get(), Pantry_Blocks.BOX_H_ONION.get(),
				Pantry_Blocks.BOX_H_ORIENTCLAM.get(), Pantry_Blocks.BOX_H_RICE.get(), Pantry_Blocks.BOX_H_SOY.get(), Pantry_Blocks.BOX_H_SPINACH.get(),
				Pantry_Blocks.BOX_H_SQUID.get(), Pantry_Blocks.BOX_H_TOMATO.get(), Pantry_Blocks.BOX_H_TAKENOKO.get(), Pantry_Blocks.BOX_H_KURI.get(),
				Pantry_Blocks.BOX_H_TGREEN.get(), Pantry_Blocks.BOX_H_TRED.get(), Pantry_Blocks.BOX_H_AZUKI.get(),
				...
				School_Blocks.SCHOOLCHAIR_mangrove.get(), School_Blocks.SCHOOLCHAIR_cherry.get(), School_Blocks.SCHOOLCHAIR_paleoak.get(),
				...
				School_Blocks.SCHOOLDESK_mangrove.get(), School_Blocks.SCHOOLDESK_cherry.get(), School_Blocks.SCHOOLDESK_paleoak.get(),
				...
				School_Blocks.TEACHERDESK_mangrove.get(), School_Blocks.TEACHERDESK_cherry.get(), School_Blocks.TEACHERDESK_paleoak.get(),
				...
				Unit_Blocks.UNITDESK_mangrove.get(), Unit_Blocks.UNITDESK_cherry.get(), Unit_Blocks.UNITDESK_paleoak.get(),
				...
				Unit_Blocks.CAFETABLE_mangrove.get(), Unit_Blocks.CAFETABLE_cherry.get(), Unit_Blocks.CAFETABLE_paleoak.get(),
				...
				Unit_Blocks.LOWDESK_mangrove.get(), Unit_Blocks.LOWDESK_cherry.get(), Unit_Blocks.LOWDESK_paleoak.get(),
				...
				Unit_Blocks.CHABUDAI_mangrove.get(), Unit_Blocks.CHABUDAI_cherry.get(), Unit_Blocks.CHABUDAI_paleoak.get(),
				...
				Unit_Blocks.KOTATSU_mangrove.get(), Unit_Blocks.KOTATSU_cherry.get(), Unit_Blocks.KOTATSU_paleoak.get(),
				...
				Unit_Blocks.CLOTHTABLE_mangrove.get(), Unit_Blocks.CLOTHTABLE_cherry.get(), Unit_Blocks.CLOTHTABLE_paleoak.get(),
				...
				Unit_Blocks.CLOTHTABLE_mangrovesub.get(), Unit_Blocks.CLOTHTABLE_cherrysub.get(), Unit_Blocks.CLOTHTABLE_paleoaksub.get(),
				...
				WallPanel_Blocks.PILLAR_mangrove.get(), WallPanel_Blocks.PILLAR_cherry.get(), WallPanel_Blocks.PILLAR_paleoak.get(),
				...
				WallPanel_Blocks.PILLARSLAB_mangrove.get(), WallPanel_Blocks.PILLARSLAB_cherry.get(), WallPanel_Blocks.PILLARSLAB_paleoak.get(),
				...
				WallPanel_Blocks.WP_LOG_mangrove.get(), WallPanel_Blocks.WP_LOG_cherry.get(), WallPanel_Blocks.WP_LOG_paleoak.get(),
				...
				WallPanel_Blocks.WP_PLANK_mangrove.get(), WallPanel_Blocks.WP_PLANK_cherry.get(), WallPanel_Blocks.WP_PLANK_paleoak.get(),
		...
		.add(Chinjufu_Blocks.BAUXITE_ORE.get(), Chinjufu_Blocks.BAUXITE_ORE_DEEP.get(), Chinjufu_Blocks.OIL_DRUM.get(),
				...
				Dish_Blocks.ZUNDOU_FISH.get(), Dish_Blocks.ZUNDOU_DASHI.get(), Dish_Blocks.ZUNDOU_UDON.get(), Dish_Blocks.ZUNDOU_PASTA.get(), 
				Dish_Blocks.ZUNDOU_RSOUP_nama.get(), Dish_Blocks.ZUNDOU_RSOUP.get(), Dish_Blocks.ZUNDOU_RAMEN.get(), 
				Dish_Blocks.ZUNDOU_AKU.get(), Dish_Blocks.ZUNDOU_ORIITO.get(), 
				...
				Dish_Blocks.SCONESET_kara.get(), Dish_Blocks.SCONESET_1.get(), Dish_Blocks.ICECREAM.get(), 
				...
				WallPanel_Blocks.WP_TUFF_B.get(), WallPanel_Blocks.WP_MUDPACK.get(), WallPanel_Blocks.WP_RESIN.get(),
				WallPanel_Blocks.WP_PRISMA.get(), WallPanel_Blocks.WP_OBSIDIAN.get(),
