...
public class ItemVTags_CM extends ItemTagsProvider {
	...
	public ItemVTags_CM(PackOutput outPut, CompletableFuture<HolderLookup.Provider> provider, CompletableFuture<TagLookup<Block>> tag, ExistingFileHelper helper) {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		.add(Items_Chinjufu.WINDOW_oak.get(), Items_Chinjufu.WINDOW_spruce.get(), Items_Chinjufu.WINDOW_birch.get(),
				...
				Items_Chinjufu.WINDOW_mangrove.get(), Items_Chinjufu.WINDOW_cherry.get(),
				...
				Items_Chinjufu.WINDOWB_mangrove.get(), Items_Chinjufu.WINDOWB_cherry.get(),
				...
				Items_Chinjufu.WINDOWTALLBOT_mangrove.get(), Items_Chinjufu.WINDOWTALLBOT_cherry.get(),
				...
				Items_Chinjufu.WINDOWTALL_mangrove.get(), Items_Chinjufu.WINDOWTALL_cherry.get(),
				...
				Items_Wadeco.GARASUDO_MANGROVE.get(), Items_Wadeco.GARASUDO_CHERRY.get(),
				...
				Items_Wadeco.GARASUDOB_MANGROVE.get(), Items_Wadeco.GARASUDOB_CHERRY.get(),
				...
				Items_Wadeco.GARASUDOH_MANGROVE.get(), Items_Wadeco.GARASUDOH_CHERRY.get(),
				...
				Items_Wadeco.SHOUJI_MANGROVE.get(), Items_Wadeco.SHOUJI_CHERRY.get(),
				...
				Items_Wadeco.SHOUJIB_MANGROVE.get(), Items_Wadeco.SHOUJIB_CHERRY.get(),
				...
				Items_Wadeco.SHOUJIH_MANGROVE.get(), Items_Wadeco.SHOUJIH_CHERRY.get(),
				...
				Items_Wadeco.SHOUJI_WIN_MANGROVE.get(), Items_Wadeco.SHOUJI_WIN_CHERRY.get(),
				...
				Items_Wadeco.RANMA_mangrove.get(), Items_Wadeco.RANMA_cherry.get(),
				...
				Items_Wadeco.RANMAB_mangrove.get(), Items_Wadeco.RANMAB_cherry.get(),
				...
				Items_Wadeco.RANMAC_mangrove.get(), Items_Wadeco.RANMAC_cherry.get(),
				...
				Items_Wadeco.KANKI_mangrove.get(), Items_Wadeco.KANKI_cherry.get(),
				...
				Items_Wadeco.KOUSHI_mangrove.get(), Items_Wadeco.KOUSHI_cherry.get(),
				...
				Items_Wadeco.KOUSHIB_mangrove.get(), Items_Wadeco.KOUSHIB_cherry.get(),
				...
				Items_Wadeco.IKEGAKI_mangrove.get(), Items_Wadeco.IKEGAKI_cherry.get(),
				...
				Items_Wadeco.IKEGAKILONG_mangrove.get(), Items_Wadeco.IKEGAKILONG_cherry.get(),
				...
				Items_Wadeco.ITABEI_mangrove.get(), Items_Wadeco.ITABEI_cherry.get(),
				...
				Items_Wadeco.KIDO_mangrove.get(), Items_Wadeco.KIDO_cherry.get(),
