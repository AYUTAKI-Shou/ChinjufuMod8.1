...
import com.ayutaki.chinjufumod.network.Sever_BlackBoardSend;
import com.ayutaki.chinjufumod.network.Sever_CleanEraser;
import com.ayutaki.chinjufumod.network.Sever_GenEraser;
import com.ayutaki.chinjufumod.network.Sever_WoodBoardSend;
...
public class ChinjufuMod {
	...
	public static final String MOD_VERSION = "[1.12.2]8.1";
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		EntityRegistry.registerModEntity(new ResourceLocation("chinjufumod:item_sb_zuiun"),
				SB_ZuiunEntity.class, "zuiun", ++entityID, this, 64, 1, true);
		EntityRegistry.registerModEntity(new ResourceLocation("chinjufumod:item_sb_seiran"),
				SB_SeiranEntity.class, "seiran", ++entityID, this, 64, 1, true);
		...
		GameRegistry.registerTileEntity(OfficeDesk_TileEntity.class, new ResourceLocation("chinjufumod:officedesk"));
		GameRegistry.registerTileEntity(BlackBoard_TileEntity.class, new ResourceLocation("chinjufumod:blackboard"));
		GameRegistry.registerTileEntity(WoodBoard_TileEntity.class, new ResourceLocation("chinjufumod:woodboard"));
	...
	private void network() {
		...
		int id = 0;
		CHANNEL.registerMessage(Sever_BlackBoardSend.class, Sever_BlackBoardSend.class, id++, Side.SERVER);
		CHANNEL.registerMessage(Sever_WoodBoardSend.class, Sever_WoodBoardSend.class, id++, Side.SERVER);
		
		CHANNEL.registerMessage(Sever_CleanEraser.class, Sever_CleanEraser.class, id++, Side.SERVER);
		CHANNEL.registerMessage(Sever_GenEraser.class, Sever_GenEraser.class, id++, Side.SERVER);
	}
}
