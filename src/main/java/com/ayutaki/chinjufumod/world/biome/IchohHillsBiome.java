...
public class IchohHillsBiome extends Biome {
	...
	public IchohHillsBiome() {
		...
		super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder_CM.AUTUMN_CONFIG)
				...
				.depth(0.45F).scale(0.3F).temperature(0.35F).downfall(0.45F).waterColor(4159204).waterFogColor(329011).parent((String)null));
		...
		/* Add Tree */
		ConfigFeature_CM.addIchohandOakHills(this);
