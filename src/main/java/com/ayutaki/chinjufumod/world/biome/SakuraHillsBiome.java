...
public class SakuraHillsBiome extends Biome {
	...
	public SakuraHillsBiome() {
		...
		super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG)
				...
				.depth(0.45F).scale(0.3F).temperature(0.6F).downfall(0.6F).waterColor(4159204).waterFogColor(329011).parent((String)null));
		...
		/* Add Tree */
		ConfigFeature_CM.addSakuraandOakHills(this);
		...
		ConfigFeature_CM.addTakenokoHills(this); // add タケノコ
