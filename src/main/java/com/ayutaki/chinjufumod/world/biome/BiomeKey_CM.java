...
public class BiomeKey_CM {
	...
	public static final ResourceKey<Biome> SAKURA_FOREST_KEY = BiomeUtils_CM.createKey("biome_sakura");
	public static final ResourceKey<Biome> SAKURA_HILLS_KEY = BiomeUtils_CM.createKey("biome_sakurahills");

	public static final ResourceKey<Biome> KAEDE_FOREST_KEY = BiomeUtils_CM.createKey("biome_kaede");
	public static final ResourceKey<Biome> KAEDE_HILLS_KEY = BiomeUtils_CM.createKey("biome_kaedehills");
	public static final ResourceKey<Biome> KAEDE_FORESTB_KEY = BiomeUtils_CM.createKey("biome_kaede_b");
	public static final ResourceKey<Biome> KAEDE_HILLSB_KEY = BiomeUtils_CM.createKey("biome_kaedehills_b");
	
	public static final ResourceKey<Biome> ICHOH_FOREST_KEY = BiomeUtils_CM.createKey("biome_ichoh");
	public static final ResourceKey<Biome> ICHOH_HILLS_KEY = BiomeUtils_CM.createKey("biome_ichohhills");
	public static final ResourceKey<Biome> ICHOH_FORESTB_KEY = BiomeUtils_CM.createKey("biome_ichoh_b");
	public static final ResourceKey<Biome> ICHOH_HILLSB_KEY = BiomeUtils_CM.createKey("biome_ichohhills_b");
