...
public class BiomeMaker_CM {
	...
	/* Share variables BirchForest(0.6F), CherryGrove(0.5F), darkForest(0.7F), taiga(0.25F) */
	...
	public static Biome makeSakuraBiome(HolderGetter<PlacedFeature> placedFeature, HolderGetter<ConfiguredWorldCarver<?>> worldCarver) {
		...
		/** Tree **/
		biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements_CM.SAKURA_OAK_PLACE);
		
		biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements_CM.TAKENOKO_PLACE); // add TAKENOKO
	...
	public static Biome makeSakuraHills(HolderGetter<PlacedFeature> placedFeature, HolderGetter<ConfiguredWorldCarver<?>> worldCarver) {
		...
		BiomeDefaultFeatures.addDefaultSoftDisks(biomeSettings);
		/** Tree **/
		biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements_CM.SAKURA_OAK_HILLS_PLACE);
		
		biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements_CM.TAKENOKO_HILLS_PLACE); // add TAKENOKO
		BiomeDefaultFeatures.addForestFlowers(biomeSettings);
		BiomeDefaultFeatures.addDefaultGrass(biomeSettings);
		BiomeDefaultFeatures.addDefaultMushrooms(biomeSettings);
		...
		Music music = Musics.createGameMusic(SoundEvents.MUSIC_BIOME_CHERRY_GROVE);
		return biome(true, 0.6F, 0.6F, mobSpawn, biomeSettings, music);
	}
	...
	public static Biome makeKaedeBiome(HolderGetter<PlacedFeature> placedFeature, HolderGetter<ConfiguredWorldCarver<?>> worldCarver, boolean bush) {
		...
		BiomeDefaultFeatures.addDefaultSoftDisks(biomeSettings);
		/** Tree **/
		biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements_CM.KAEDE_AUTUMNOAK_PLACE);
		/** KURI_BUSH **/
		if (bush) { biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements_CM.KURIIGA_PLACE); }
		...
		return biome(true, 0.45F, 0.45F, mobSpawn, biomeSettings, music);
	}
	...
	public static Biome makeKaedeHills(HolderGetter<PlacedFeature> placedFeature, HolderGetter<ConfiguredWorldCarver<?>> worldCarver, boolean bush) {
		...
		BiomeDefaultFeatures.addDefaultSoftDisks(biomeSettings);
		/** Tree **/
		biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements_CM.KAEDE_AUTUMNOAK_HILLS_PLACE);
		/** KURI_BUSH **/
		if (bush) { biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements_CM.KURIIGA_PLACE); }
		...
		Music music = Musics.createGameMusic(SoundEvents.MUSIC_BIOME_FOREST);
		return biome(true, 0.35F, 0.45F, mobSpawn, biomeSettings, music);
	}
	...
	public static Biome makeIchohBiome(HolderGetter<PlacedFeature> placedFeature, HolderGetter<ConfiguredWorldCarver<?>> worldCarver, boolean bush) {
		...
		BiomeDefaultFeatures.addDefaultSoftDisks(biomeSettings);
		/** Tree **/
		biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements_CM.ICHOH_AUTUMNOAK_PLACE);
		/** KURI_BUSH **/
		if (bush) { biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements_CM.KURIIGA_PLACE); }
	...
	public static Biome makeIchohHills(HolderGetter<PlacedFeature> placedFeature, HolderGetter<ConfiguredWorldCarver<?>> worldCarver, boolean bush) {
		...
		BiomeDefaultFeatures.addDefaultSoftDisks(biomeSettings);
		/** Tree **/
		biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements_CM.ICHOH_AUTUMNOAK_HILLS_PLACE);
		/** KURI_BUSH **/
		if (bush) { biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements_CM.KURIIGA_PLACE); }
