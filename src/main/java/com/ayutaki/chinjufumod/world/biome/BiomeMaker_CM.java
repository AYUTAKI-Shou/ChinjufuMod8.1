...
public class BiomeMaker_CM {
	...
	public static Biome makeSakuraBiome() {
		...
		/** Tree **/
		biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Placement_CM.SAKURA_OAK_PLACE.getHolder().orElseThrow());
		
		biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Placement_CM.TAKENOKO_PLACE.getHolder().orElseThrow()); // add TAKENOKO
	...
	public static Biome makeSakuraHills() {
		...
		BiomeDefaultFeatures.addDefaultSoftDisks(biomeSettings);
		/** Tree **/
		biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Placement_CM.SAKURA_OAK_HILLS_PLACE.getHolder().orElseThrow());
		
		biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Placement_CM.TAKENOKO_HILLS_PLACE.getHolder().orElseThrow()); // add TAKENOKO
		BiomeDefaultFeatures.addForestFlowers(biomeSettings);
		BiomeDefaultFeatures.addDefaultGrass(biomeSettings);
		BiomeDefaultFeatures.addDefaultMushrooms(biomeSettings);
		...
		return biome(Biome.Precipitation.RAIN, Biome.BiomeCategory.EXTREME_HILLS, 0.6F, 0.6F, mobSpawn, biomeSettings, NORMAL_MUSIC);
	}
	
	/* KAEDE 0.35F-0.45F, rain 0.45F */
	public static Biome makeKaedeBiome() {
		...
		BiomeDefaultFeatures.addDefaultSoftDisks(biomeSettings);
		/** Tree **/
		biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Placement_CM.KAEDE_AUTUMNOAK_PLACE.getHolder().orElseThrow());
		...
		return biome(Biome.Precipitation.RAIN, Biome.BiomeCategory.FOREST, 0.45F, 0.45F, mobSpawn, biomeSettings, NORMAL_MUSIC);
	}
	...
	public static Biome makeKaedeHills() {
		...
		BiomeDefaultFeatures.addDefaultSoftDisks(biomeSettings);
		/** Tree **/
		biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Placement_CM.KAEDE_AUTUMNOAK_HILLS_PLACE.getHolder().orElseThrow());
		...
		return biome(Biome.Precipitation.RAIN, Biome.BiomeCategory.EXTREME_HILLS, 0.35F, 0.45F, mobSpawn, biomeSettings, NORMAL_MUSIC);
	}
	
	/* ICHOH 0.35F-0.45F, rain 0.45F */
	public static Biome makeIchohBiome() {
		...
		BiomeDefaultFeatures.addDefaultSoftDisks(biomeSettings);
		/** Tree **/
		biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Placement_CM.ICHOH_AUTUMNOAK_PLACE.getHolder().orElseThrow());
	...
	public static Biome makeIchohHills() {
		...
		BiomeDefaultFeatures.addDefaultSoftDisks(biomeSettings);
		/** Tree **/
		biomeSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, Placement_CM.ICHOH_AUTUMNOAK_HILLS_PLACE.getHolder().orElseThrow());
