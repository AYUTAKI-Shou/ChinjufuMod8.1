...
public class ConfigFeature_CM {
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> SAKURA_OAK = CONFIG_FEATURES.register("sakura_oak", 
			() -> new ConfiguredFeature<>(Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(
					new WeightedPlacedFeature(Placement_CM.SAKURA_PLACE.getHolder().orElseThrow(), (float) Config_CM.INSTANCE.sakuraTreeChance.get() / 10 / 30 * 29), 
					new WeightedPlacedFeature(Placement_CM.SAKURA_FANCY_PLACE.getHolder().orElseThrow(), (float) Config_CM.INSTANCE.sakuraTreeChance.get() / 10 / 30),
					new WeightedPlacedFeature(Placement_CM.SAKURA_BEES_PLACE.getHolder().orElseThrow(), (float) Config_CM.INSTANCE.sakuraTreeChance.get() / 10 / 300),
					new WeightedPlacedFeature(Placement_CM.OAK_FANCY_PLACE.getHolder().orElseThrow(), (float) (10 - Config_CM.INSTANCE.sakuraTreeChance.get()) / 300)),
					Placement_CM.OAK_PLACE.getHolder().orElseThrow())));

	public static final RegistryObject<ConfiguredFeature<?, ?>> SAKURA_OAK_HILLS = CONFIG_FEATURES.register("sakura_oak_hills", 
			() -> new ConfiguredFeature<>(Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(
					new WeightedPlacedFeature(Placement_CM.SAKURA_PLACE.getHolder().orElseThrow(), (float) Config_CM.INSTANCE.sakuraTreeChance.get() / 10 / 30 * 29), 
					new WeightedPlacedFeature(Placement_CM.SAKURA_FANCY_PLACE.getHolder().orElseThrow(), (float) Config_CM.INSTANCE.sakuraTreeChance.get() / 10 / 30),
					new WeightedPlacedFeature(Placement_CM.OAK_FANCY_PLACE.getHolder().orElseThrow(), (float) (10 - Config_CM.INSTANCE.sakuraTreeChance.get()) / 200)), 
					Placement_CM.OAK_PLACE.getHolder().orElseThrow())));
	
	public static final RegistryObject<ConfiguredFeature<?, ?>> KAEDE_AUTUMNOAK = CONFIG_FEATURES.register("kaede_autumnoak", 
			() -> new ConfiguredFeature<>(Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(
					new WeightedPlacedFeature(Placement_CM.KAEDE_PLACE.getHolder().orElseThrow(), (float) Config_CM.INSTANCE.kaedeTreeChance.get() / 10), 
					new WeightedPlacedFeature(Placement_CM.OAKKARE_FANCY_PLACE.getHolder().orElseThrow(), (float) (10 - Config_CM.INSTANCE.kaedeTreeChance.get()) / 300)), 
					Placement_CM.OAKKARE_PLACE.getHolder().orElseThrow())));
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> KAEDE_AUTUMNOAK_HILLS = CONFIG_FEATURES.register("kaede_autumnoak_hills", 
			() -> new ConfiguredFeature<>(Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(
					new WeightedPlacedFeature(Placement_CM.KAEDE_PLACE.getHolder().orElseThrow(), (float) Config_CM.INSTANCE.kaedeTreeChance.get() / 10 / 100 * 99), 
					new WeightedPlacedFeature(Placement_CM.KAEDE_FANCY_PLACE.getHolder().orElseThrow(), (float) Config_CM.INSTANCE.kaedeTreeChance.get() / 10 / 100),
					new WeightedPlacedFeature(Placement_CM.OAKKARE_FANCY_PLACE.getHolder().orElseThrow(), (float) (10 - Config_CM.INSTANCE.kaedeTreeChance.get()) / 200)), 
					Placement_CM.OAKKARE_PLACE.getHolder().orElseThrow())));
	
	public static final RegistryObject<ConfiguredFeature<?, ?>> ICHOH_AUTUMNOAK = CONFIG_FEATURES.register("ichoh_autumnoak", 
			() -> new ConfiguredFeature<>(Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(
					new WeightedPlacedFeature(Placement_CM.ICHOH_PLACE.getHolder().orElseThrow(), (float) Config_CM.INSTANCE.ichohTreeChance.get() / 10 / 30 * 29), 
					new WeightedPlacedFeature(Placement_CM.ICHOH_FANCY_PLACE.getHolder().orElseThrow(), (float) Config_CM.INSTANCE.ichohTreeChance.get() / 10 / 30),
					new WeightedPlacedFeature(Placement_CM.OAKKARE_FANCY_PLACE.getHolder().orElseThrow(), (float) (10 - Config_CM.INSTANCE.ichohTreeChance.get()) / 300)), 
					Placement_CM.OAKKARE_PLACE.getHolder().orElseThrow())));
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> ICHOH_AUTUMNOAK_HILLS = CONFIG_FEATURES.register("ichoh_autumnoak_hills", 
			() -> new ConfiguredFeature<>(Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(
					new WeightedPlacedFeature(Placement_CM.ICHOH_PLACE.getHolder().orElseThrow(), (float) Config_CM.INSTANCE.ichohTreeChance.get() / 10 / 20 * 19), 
					new WeightedPlacedFeature(Placement_CM.ICHOH_FANCY_PLACE.getHolder().orElseThrow(), (float) Config_CM.INSTANCE.ichohTreeChance.get() / 10 / 20),
					new WeightedPlacedFeature(Placement_CM.OAKKARE_FANCY_PLACE.getHolder().orElseThrow(), (float) (10 - Config_CM.INSTANCE.ichohTreeChance.get()) / 200)), 
					Placement_CM.OAKKARE_PLACE.getHolder().orElseThrow())));
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> BAUXITE_ORE_CONFIG = CONFIG_FEATURES.register("ore_bauxite_config", 
			()-> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(OreFeatures.STONE_ORE_REPLACEABLES, Chinjufu_Blocks.BAUXITE_ORE.get().defaultBlockState()), 
			OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, Chinjufu_Blocks.BAUXITE_ORE_DEEP.get().defaultBlockState())), 8)));

	/////* SeaGrass */////
	public static final RegistryObject<ConfiguredFeature<?, ?>> TENGUSA_W_CONFIG = CONFIG_FEATURES.register("tengusa_w_config",
			()-> new ConfiguredFeature<>(Feature_CM.TENGUSA_WARM.get(), NoneFeatureConfiguration.INSTANCE));
	public static final RegistryObject<ConfiguredFeature<?, ?>> TENGUSA_L_CONFIG = CONFIG_FEATURES.register("tengusa_l_config",
			()-> new ConfiguredFeature<>(Feature_CM.TENGUSA_LUKE.get(), NoneFeatureConfiguration.INSTANCE));
	public static final RegistryObject<ConfiguredFeature<?, ?>> NORI_CONFIG = CONFIG_FEATURES.register("nori_config",
			()-> new ConfiguredFeature<>(Feature_CM.NORI_FEATURE.get(), NoneFeatureConfiguration.INSTANCE));
}
