...
public class ChinjufuModTabs {
	...
	public static final CreativeTabs CHINJUFU = new CreativeTabs("tab_chinjufumod") {
		@Override
		public ItemStack getTabIconItem() { return new ItemStack(Items_NoTab.EMBLEM_C);
		}
	};
	...
	public static final CreativeTabs WALLPANEL = new CreativeTabs("tab_wallpanel") {
		@Override
		public ItemStack getTabIconItem() { return new ItemStack(Item.getItemFromBlock(WallPanel_Blocks.WP_STONE_graB)); }
	};
}
