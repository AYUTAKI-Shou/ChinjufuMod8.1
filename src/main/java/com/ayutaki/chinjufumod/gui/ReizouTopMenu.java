...
public class ReizouTopMenu extends AbstractContainerMenu {
	...
	public ReizouTopMenu(final int windowId, final Inventory inventory, final FriendlyByteBuf data) {
		this(MenuTypes_CM.REIZOUTOP_MENU.get(), windowId, inventory, getContainer(inventory, data));
	}
	
	public ReizouTopMenu(MenuType<?> type, final int windowId, final Inventory inventory, final Container tileSlots) {
		super(type, windowId);
