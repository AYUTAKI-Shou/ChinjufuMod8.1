...
public class BlackBoard_Screen extends Screen {
	...
	public void removed() {
		...
		NetworkEvent_CM.severBlackBoardSend(this.BOARD.getBlockPos(), this.BOARD.boardText[0].getString(), this.BOARD.boardText[1].getString(), this.BOARD.boardText[2].getString(), 
				this.BOARD.boardText[3].getString(), this.BOARD.boardText[4].getString(), this.BOARD.boardText[5].getString());
	...
	private void drawBlackBoardLayer(PoseStack matrix, float ticks, int xIn, int yIn) {
