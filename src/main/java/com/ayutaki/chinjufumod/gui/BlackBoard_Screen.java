...
public class BlackBoard_Screen extends Screen {
	...
	public void removed() {
		...
		NetworkEvent_CM.serverBlackBoardSend(this.BOARD.getPos(), this.BOARD.boardText[0].getString(), this.BOARD.boardText[1].getString(), this.BOARD.boardText[2].getString(), 
	...
	private void drawBlackBoardLayer(float ticks, int xIn, int yIn) {
		...
		int posY = 50; //fix
		this.blit(posX, posY, 0, 0, this.xSize, this.ySize);
	}
