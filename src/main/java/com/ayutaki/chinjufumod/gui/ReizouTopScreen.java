...
@OnlyIn(Dist.CLIENT)
public class ReizouTopScreen extends ContainerScreen<ReizouTopMenu> {
	...
	public ReizouTopScreen(ReizouTopMenu menu, PlayerInventory inv, ITextComponent titleIn) {
	...
	/* Inventory title height. 110-> */
	@Override
	protected void renderLabels(MatrixStack stack, int mouseX, int mouseY) {
		this.font.draw(stack, this.title, 8.0f, 6.0f, 4210752);
		this.font.draw(stack, this.inventory.getDisplayName(), 8.0f, 74.0f, 4210752);
	}
}
