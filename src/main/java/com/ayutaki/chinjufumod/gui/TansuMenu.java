...
public class TansuMenu extends AbstractContainerMenu {
	...
	public TansuMenu(int windowId, Inventory inventory) {
		this(MenuTypes_CM.TANSU_MENU.get(), windowId, inventory, new SimpleContainer(45));
	}
	
	public TansuMenu(MenuType<?> type, int windowId, final Inventory inventory, final Container tileSlots) {
		super(type, windowId);
