...
public class Bricks_CM extends Regi_addState {
	...
	** 13=土壁, 14=土壁_CR **/
	...
	public MapColor getMapColor(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		...
		if (i == 13) { return MapColor.ADOBE; }
		if (i == 14) { return MapColor.ADOBE; }
		else { return MapColor.STONE; }
	}
	...
	private ItemStack cloneStack(IBlockState state) {
		...
		if (i == 1) { return new ItemStack(Items_WallPane.BRICK_C, 1, 1); }
		...
		if (i == 13) { return new ItemStack(Items_Wablock.DIRTWALL, 1, 0); }
		else { return new ItemStack(Items_Wablock.DIRTWALL, 1, 0); }
	}
}
