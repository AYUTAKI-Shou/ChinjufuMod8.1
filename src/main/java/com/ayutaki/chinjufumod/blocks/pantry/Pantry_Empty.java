...
public class Pantry_Empty extends BaseFacingSlab_Water {
	...
	/* Collision */
	private static final VoxelShape EMPTY_BOTTOM = VoxelShapes.or(Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 0.5D, 16.0D),
	...
	private static final VoxelShape EMPTY_TOP = VoxelShapes.or(Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 8.5D, 16.0D),
	...
	private static final VoxelShape EMPTY_DOUBLE = VoxelShapes.or(Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 8.5D, 16.0D),
			Block.makeCuboidShape(0.0D, 8.5D, 0.0D, 16.0D, 16.0D, 0.5D),
			Block.makeCuboidShape(0.0D, 8.5D, 15.5D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(0.0D, 8.5D, 0.0D, 0.5D, 16.0D, 16.0D),
			Block.makeCuboidShape(15.5D, 8.5D, 0.0D, 16.0D, 16.0D, 16.0D));

	private static final VoxelShape EMPTY2_BOTTOM = VoxelShapes.or(Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 4.5D, 16.0D),
	...
	private static final VoxelShape EMPTY2_TOP = VoxelShapes.or(Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 12.5D, 16.0D),
			...
			Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 0.5D, 8.0D, 16.0D),
			Block.makeCuboidShape(15.5D, 0.0D, 0.0D, 16.0D, 8.0D, 16.0D));
	private static final VoxelShape EMPTY2_DOUBLE = VoxelShapes.or(Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 12.5D, 16.0D),
			Block.makeCuboidShape(0.0D, 12.5D, 0.0D, 16.0D, 16.0D, 0.5D),
			Block.makeCuboidShape(0.0D, 12.5D, 15.5D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(0.0D, 12.5D, 0.0D, 0.5D, 16.0D, 16.0D),
			Block.makeCuboidShape(15.5D, 12.5D, 0.0D, 16.0D, 16.0D, 16.0D));

	private static final VoxelShape EMPTY3_BOTTOM = Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 8.0D, 16.0D);
	private static final VoxelShape EMPTY3_TOP = VoxelShapes.or(Block.makeCuboidShape(0.0D, 8.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(0.5D, 7.5D, 0.5D, 15.5D, 8.0D, 15.5D),
			Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 8.0D, 0.5D),
			Block.makeCuboidShape(0.0D, 0.0D, 15.5D, 16.0D, 8.0D, 16.0D),
			Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 0.5D, 8.0D, 16.0D),
	...
	public Pantry_Empty(Block.Properties props) {
		super(props);
	}
