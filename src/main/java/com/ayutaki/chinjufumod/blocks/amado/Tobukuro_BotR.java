...
public class Tobukuro_BotR extends BaseStage3_Face {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		default :
			if (westState.getMaterial().isReplaceable()) {
				...
				if (i == 3) { this.updateTOBUKURO_UP3(state, worldIn, pos); }
				else { this.updateTOBUKURO_UP(state, worldIn, pos); } }
	...
	private void updateTOBUKURO_UP3(IBlockState state, World worldIn, BlockPos pos) {
	...
	private Item cloneItem() {
		if (this == Slidedoor_Blocks.TOBUKURO_BOTR) { return Items_Wadeco.TOBUKURO_BOTR; }
