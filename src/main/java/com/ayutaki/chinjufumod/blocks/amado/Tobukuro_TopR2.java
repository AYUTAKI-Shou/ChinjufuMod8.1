...
public class Tobukuro_TopR2 extends BaseStage2_Face {
	...
	/** 1=1 sheet, 2=Zero **/
	public Tobukuro_TopR2(String name) {
		super(name);
		setHardness(2.0F);
		setResistance(5.0F);
	...
	private void updateTOBUKURO_DOWN(IBlockState state, World worldIn, BlockPos pos) {
		...
		worldIn.setBlockState(pos.down(), tobuBotR2_FACE.withProperty(STAGE_1_2, Integer.valueOf(i + 1)));
	}
	
	private Block takeRightBot2() {
		if (this == Slidedoor_Blocks.TOBUKURO_TOPR2) { return Slidedoor_Blocks.TOBUKURO_BOTR2; }
		else { return Slidedoor_Blocks.TOBUKUROS_BOTR2; }
	}
	
	private Block takeTop() {
		if (this == Slidedoor_Blocks.TOBUKURO_TOPR2) { return Slidedoor_Blocks.AMADO_TOP; }
		else { return Slidedoor_Blocks.AMADOS_TOP; }
	}

	private Block takeBot() {
		if (this == Slidedoor_Blocks.TOBUKURO_TOPR2) { return Slidedoor_Blocks.AMADO_BOT; }
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn) {
		if (worldIn.getBlockState(pos.down()).getBlock() instanceof Tobukuro_BotR2) {
