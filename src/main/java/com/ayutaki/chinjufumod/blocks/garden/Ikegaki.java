...
public class Ikegaki extends BaseWaterLogged {
	/* Collision */
	private static final VoxelShape AABB_BOX = VoxelShapes.or(Block.box(0.1D, 3.5D, 0.1D, 15.9D, 16.0D, 15.9D),
			Block.box(7.0D, 0.0D, 7.0D, 9.0D, 3.5D, 9.0D));
	private static final VoxelShape COLL_BOX = Block.box(0.0D, 0.0D, 0.0D, 16.0D, 24.0D, 16.0D);

	public Ikegaki(AbstractBlock.Properties props) {
		super(props);
	}
