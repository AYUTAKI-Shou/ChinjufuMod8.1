...
public class IkegakiLong extends Abstract_WaterLogged {
	...
	/* Collision */
	private static final VoxelShape AABB_TOP = Block.makeCuboidShape(0.1D, 0.0D, 0.1D, 15.9D, 16.0D, 15.9D);
	private static final VoxelShape AABB_BOT = VoxelShapes.or(Block.makeCuboidShape(0.1D, 4.0D, 0.1D, 15.9D, 16.0D, 15.9D),
			Block.makeCuboidShape(7.0D, 0.0D, 7.0D, 9.0D, 4.0D, 9.0D));

	public IkegakiLong(Block.Properties props) {
		super(props);
