...
public class Sudare extends Abstract_WaterLogged {
	/* Property */
	...
	/* Collision */
	private static final VoxelShape S1_SOUTH = Block.makeCuboidShape(0.0D, -16.0D, 0.0D, 16.0D, 16.0D, 0.5D);
	private static final VoxelShape S1_WEST = Block.makeCuboidShape(15.5D, -16.0D, 0.0D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape S1_NORTH = Block.makeCuboidShape(0.0D, -16.0D, 15.5D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape S1_EAST = Block.makeCuboidShape(0.0D, -16.0D, 0.0D, 0.5D, 16.0D, 16.0D);

	private static final VoxelShape S2_SOUTH = Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 0.5D);
	private static final VoxelShape S2_WEST = Block.makeCuboidShape(15.5D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape S2_NORTH = Block.makeCuboidShape(0.0D, 0.0D, 15.5D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape S2_EAST = Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 0.5D, 16.0D, 16.0D);

	private static final VoxelShape S3_SOUTH = Block.makeCuboidShape(0.0D, 14.0D, 0.0D, 16.0D, 16.0D, 0.5D);
	private static final VoxelShape S3_WEST = Block.makeCuboidShape(15.5D, 14.0D, 0.0D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape S3_NORTH = Block.makeCuboidShape(0.0D, 14.0D, 15.5D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape S3_EAST = Block.makeCuboidShape(0.0D, 14.0D, 0.0D, 0.5D, 16.0D, 16.0D);

	public Sudare(Block.Properties props) {
		super(props);
		/** Default state **/
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_sudare").applyTextStyle(TextFormatting.GRAY));
	}
}
