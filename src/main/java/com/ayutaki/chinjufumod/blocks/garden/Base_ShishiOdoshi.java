...
public class Base_ShishiOdoshi extends Abstract_WaterLogged {
	...
	public Base_ShishiOdoshi(AbstractBlock.Properties props) {
		super(props);
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_shishiodoshi").withStyle(TextFormatting.GRAY));
	}
}
