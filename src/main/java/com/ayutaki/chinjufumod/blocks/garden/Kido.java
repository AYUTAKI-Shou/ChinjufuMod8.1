...
public class Kido extends Regi_addState {
	/* Property */
	...
	/* Collision */
	private static final AxisAlignedBB SOUTH_AABB_CLOSE = new AxisAlignedBB(0.0D * cw, 0.0D * cw, 6.75D * cw, 16.0D * cw, 16.0D * cw, 9.25D * cw);
	private static final AxisAlignedBB SOUTH_AABB_OPEN_R = new AxisAlignedBB(0.0D * cw, 0.0D * cw, 6.75D * cw, 2.5D * cw, 16.0D * cw, 22.75D * cw);
	private static final AxisAlignedBB SOUTH_AABB_OPEN_L = new AxisAlignedBB(13.5D * cw, 0.0D * cw, 6.75D * cw, 16.0D * cw, 16.0D * cw, 22.75D * cw);

	private static final AxisAlignedBB EAST_AABB_CLOSE = new AxisAlignedBB(6.75D * cw, 0.0D * cw, 0.0D * cw, 9.25D * cw, 16.0D * cw, 16.0D * cw);
	private static final AxisAlignedBB EAST_AABB_OPEN_R = new AxisAlignedBB(6.75D * cw, 0.0D * cw, 13.5D * cw, 22.75D * cw, 16.0D * cw, 16.0D * cw);
	private static final AxisAlignedBB EAST_AABB_OPEN_L = new AxisAlignedBB(6.75D * cw, 0.0D * cw, 0.0D * cw, 22.75D * cw, 16.0D * cw, 2.5D * cw);

	private static final AxisAlignedBB WEST_AABB_CLOSE = new AxisAlignedBB(6.75D * cw, 0.0D * cw, 0.0D * cw, 9.25D * cw, 16.0D * cw, 16.0D * cw);
	private static final AxisAlignedBB WEST_AABB_OPEN_R = new AxisAlignedBB(-6.75D * cw, 0.0D * cw, 0.0D * cw, 9.25D * cw, 16.0D * cw, 2.5D * cw);
	private static final AxisAlignedBB WEST_AABB_OPEN_L = new AxisAlignedBB(-6.75D * cw, 0.0D * cw, 13.5D * cw, 9.25D * cw, 16.0D * cw, 16.0D * cw);

	private static final AxisAlignedBB NORTH_AABB_CLOSE = new AxisAlignedBB(0.0D * cw, 0.0D * cw, 6.75D * cw, 16.0D * cw, 16.0D * cw, 9.25D * cw);
	private static final AxisAlignedBB NORTH_AABB_OPEN_R = new AxisAlignedBB(13.5D * cw, 0.0D * cw, -6.75D * cw, 16.0D * cw, 16.0D * cw, 9.25D * cw);
	private static final AxisAlignedBB NORTH_AABB_OPEN_L = new AxisAlignedBB(0.0D * cw, 0.0D * cw, -6.75D * cw, 2.5D * cw, 16.0D * cw, 9.25D * cw);
	...
	private ItemStack cloneStack(IBlockState state) {
		if (state.getValue(HALF) != HalfState.UPPER) {
			...
			else { return new ItemStack(Items_Seasonal.SKIDO_item, 1, 2); }
		}
