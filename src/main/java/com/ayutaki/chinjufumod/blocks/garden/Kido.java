...
public class Kido extends Abstract_WaterLogged {
	...
	private static final VoxelShape OPENBR_SOUTH = VoxelShapes.or(FRAME_SOUTH, Block.box(13.5D, 0.0D, 6.75D, 16.0D, 16.0D, 22.75D));
	private static final VoxelShape OPENBR_WEST = VoxelShapes.or(FRAME_WEST, Block.box(-6.75D, 0.0D, 13.5D, 9.25D, 16.0D, 16.0D));
	private static final VoxelShape OPENBR_NORTH = VoxelShapes.or(FRAME_NORTH, Block.box(0.0D, 0.0D, -6.75D, 2.5D, 16.0D, 9.25D));
	private static final VoxelShape OPENBR_EAST = VoxelShapes.or(FRAME_EAST, Block.box(6.75D, 0.0D, 0.0D, 22.75D, 16.0D, 2.5D));

	private static final VoxelShape OPENBL_SOUTH = VoxelShapes.or(FRAME_SOUTH, Block.box(0.0D, 0.0D, 6.75D, 2.5D, 16.0D, 22.75D));
	private static final VoxelShape OPENBL_WEST = VoxelShapes.or(FRAME_WEST, Block.box(-6.75D, 0.0D, 0.0D, 9.25D, 16.0D, 2.5D));
	private static final VoxelShape OPENBL_NORTH = VoxelShapes.or(FRAME_NORTH, Block.box(13.5D, 0.0D, -6.75D, 16.0D, 16.0D, 9.25D));
	private static final VoxelShape OPENBL_EAST = VoxelShapes.or(FRAME_EAST, Block.box(6.75D, 0.0D, 13.5D, 22.75D, 16.0D, 16.0D));
	...
	public Kido(AbstractBlock.Properties props) {
		super(props);
	...
	private void moveSound(World worldIn, BlockPos pos, boolean open) {
		if (open) { worldIn.playSound(null, pos, SoundEvents.WOODEN_DOOR_CLOSE, SoundCategory.BLOCKS, 0.8F, 1.0F); }
		else { worldIn.playSound(null, pos, SoundEvents.WOODEN_DOOR_OPEN, SoundCategory.BLOCKS, 0.8F, 1.0F); }
	}
