...
public class Tourou extends Abstract_WaterLogged {
	...
	/* Collision */
	private static final VoxelShape AABB_BOX = Block.makeCuboidShape(1.0D, 0.0D, 1.0D, 15.0D, 15.0D, 15.0D);

	public Tourou(Block.Properties props) {
		super(props);
		/** Default state **/
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_ishitourou").applyTextStyle(TextFormatting.GRAY));
	}
}
