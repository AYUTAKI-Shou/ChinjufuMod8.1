...
public class ShishiOdoshi_B2 extends Base_ShishiOdoshi {
	...
	public ShishiOdoshi_B2(String name) {
		super(name);
	}
	...
	public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state) {
		worldIn.scheduleUpdate(pos, Garden_Blocks.SHISHIODOSHIB2, this.tickRate(worldIn));
	}
