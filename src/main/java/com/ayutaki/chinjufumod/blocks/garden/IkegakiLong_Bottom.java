...
public class IkegakiLong_Bottom extends Regi_addState {
	/* Property */
	public static final PropertyInteger STAGE_0_9 = PropertyInteger.create("stage", 0, 9);

	public IkegakiLong_Bottom(String name) {
		super(name);
	...
	private ItemStack cloneStack(IBlockState state) {
		...
		else { return new ItemStack(Items_Seasonal.SIKEGAKILONG_BOT, 1, 3); }
	}
