...
public class Kamoi_DirtWall extends Abstract_KamoiStone {
	...
	private Item cloneItem() {
		...
		if (this == KamoiPlaster_Blocks.KAMOI_dirt_mangrove.get()) { return Items_WallPanel.PILLARSLAB_mangrove.get(); }
		if (this == KamoiPlaster_Blocks.KAMOI_dirt_cherry.get()) { return Items_WallPanel.PILLARSLAB_cherry.get(); }
		if (this == KamoiPlaster_Blocks.KAMOI_dirt_paleoak.get()) { return Items_WallPanel.PILLARSLAB_paleoak.get(); }
