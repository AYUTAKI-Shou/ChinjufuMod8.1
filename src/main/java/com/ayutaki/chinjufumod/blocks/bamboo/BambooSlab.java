...
public class BambooSlab extends BaseFacingSlabW {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		boolean block2Item = (this == JPDeco_Blocks.TAKE_SH && hItem == Items_Wadeco.TAKE_SH) ||
				(this == JPDeco_Blocks.TAKE_SHY && hItem == Items_Wadeco.TAKE_SHY) ||
				(this == JPDeco_Blocks.TAKE_SHK && hItem == Items_Wadeco.TAKE_SHK);
	...
	private Item cloneItem() {
		...
		else { return Items_Wadeco.TAKE_SHK; }
	}
}
