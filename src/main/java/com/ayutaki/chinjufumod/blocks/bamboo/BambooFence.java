...
public class BambooFence extends BlockFence {
	...
	private static final AxisAlignedBB[] BOUNDING_BOXES = new AxisAlignedBB[] {new AxisAlignedBB(0.40625D, 0.0D, 0.40625D, 0.59375D, 1.0D, 0.59375D),
	...
	private static final AxisAlignedBB PILLAR_AABB = new AxisAlignedBB(0.40625D, 0.0D, 0.40625D, 0.59375D, 1.5D, 0.59375D);
	private static final AxisAlignedBB SOUTH_AABB = new AxisAlignedBB(0.40625D, 0.0D, 0.59375D, 0.59375D, 1.5D, 1.0D);
	private static final AxisAlignedBB WEST_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.40625D, 0.40625D, 1.5D, 0.59375D);
	private static final AxisAlignedBB NORTH_AABB = new AxisAlignedBB(0.40625D, 0.0D, 0.0D, 0.59375D, 1.5D, 0.40625D);
	private static final AxisAlignedBB EAST_AABB = new AxisAlignedBB(0.59375D, 0.0D, 0.40625D, 1.0D, 1.5D, 0.59375D);
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		stack.add(new ItemStack(Items_Wadeco.TAKEFENCE, 1, cloneMeta()));
		return stack;
	}

	@Override
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		return new ItemStack(Items_Wadeco.TAKEFENCE, 1, cloneMeta());
	}

	private int cloneMeta() {
		if (this == JPDeco_Blocks.TAKEFENCE) { return 0; }
		if (this == JPDeco_Blocks.TAKEFENCE_Y) { return 1; }
		else { return 2; }
	}
}
