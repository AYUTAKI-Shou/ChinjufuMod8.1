...
public class BambooTrapDoor extends BlockTrapDoor {
	...
	private Item cloneItem() {
		if (this == JPDeco_Blocks.TAKE_TRAPDOOR) { return Items_Wadeco.TAKE_TRAPDOOR; }
		if (this == JPDeco_Blocks.TAKE_TRAPDOOR_Y) { return Items_Wadeco.TAKE_TRAPDOOR_Y; }
		else { return Items_Wadeco.TAKE_TRAPDOOR_K; }
	}
}
