...
public class DiningChair extends Regi_addState {
	...
	public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
		...
		switch (direction) {
		case NORTH :
		default : return flag? AABB_BASE : AABB_NORTH;
		case SOUTH : return flag? AABB_BASE : AABB_SOUTH;
		case EAST : return flag? AABB_BASE : AABB_EAST;
		case WEST : return flag? AABB_BASE : AABB_WEST;
		}
	}
	...
	private Item cloneItem(IBlockState state) {
		if (state.getValue(HALF) == Half.UPPER) { return Items.AIR; }
		else { return Items_Chinjufu.DININGCHAIR_item; }
	}
	
	private int cloneMeta(IBlockState state) {
		if (state.getValue(HALF) == Half.UPPER) { return 0; }
		else {
			if (this == Furniture_Blocks.DININGCHAIR) { return 0; }
			if (this == Furniture_Blocks.DININGCHAIR_s) { return 1; }
			if (this == Furniture_Blocks.DININGCHAIR_b) { return 2; }
			if (this == Furniture_Blocks.DININGCHAIR_j) { return 3; }
			if (this == Furniture_Blocks.DININGCHAIR_a) { return 4; }
			if (this == Furniture_Blocks.DININGCHAIR_d) { return 5; }
			if (this == Furniture_Blocks.DININGCHAIR_saku) { return 6; }
			if (this == Furniture_Blocks.DININGCHAIR_kae) { return 7; }
			else { return 8; } 
		}
	}
