...
public class Bench extends BaseFacingSapo {
	...
	private static final AxisAlignedBB AABB_SOUTH = new AxisAlignedBB(0.0, 0.0, 0.3125, 1.0, 0.4375, 1.0);
	private static final AxisAlignedBB AABB_EAST = new AxisAlignedBB(0.3125, 0.0, 0.0, 1.0, 0.4375, 1.0);
	private static final AxisAlignedBB AABB_WEST = new AxisAlignedBB(0.0, 0.0, 0.0, 0.6875, 0.4375, 1.0);
	private static final AxisAlignedBB AABB_NORTH = new AxisAlignedBB(0.0, 0.0, 0.0, 1.0, 0.4375, 0.6875);

	private static final AxisAlignedBB CHAIR_BASE = new AxisAlignedBB(0.0, 0.0, 0.0, 1.0, 0.4375, 1.0);
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		stack.add(new ItemStack(Items_Chinjufu.BENCH_item, 1, cloneMeta()));
		return stack;
	}

	@Override
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		return new ItemStack(Items_Chinjufu.BENCH_item, 1, cloneMeta());
	}
	
	private int cloneMeta() {
		if (this == Furniture_Blocks.BENCH) { return 0; }
		if (this == Furniture_Blocks.BENCH_spru) { return 1; }
		if (this == Furniture_Blocks.BENCH_bir) { return 2; }
		if (this == Furniture_Blocks.BENCH_jun) { return 3; }
		if (this == Furniture_Blocks.BENCH_aca) { return 4; }
		if (this == Furniture_Blocks.BENCH_doak) { return 5; }
		if (this == Furniture_Blocks.BENCH_saku) { return 6; }
		if (this == Furniture_Blocks.BENCH_kae) { return 7; }
		else { return 8; } 
	}
}
