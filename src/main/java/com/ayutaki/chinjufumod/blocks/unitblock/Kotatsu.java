...
public class Kotatsu extends BaseUnitBlock {
	...
	private static final VoxelShape FFFF = VoxelShapes.or(Block.box(2.0D, 6.0D, 2.0D, 14.0D, 8.0D, 14.0D),
	...
	private static final VoxelShape TTFF = VoxelShapes.or(Block.box(1.0D, 6.0D, 0.0D, 16.0D, 8.0D, 15.0D),
			Block.box(3.0D, 0.0D, 10.5D, 5.5D, 6.0D, 13.0D));
	private static final VoxelShape FTFT = VoxelShapes.or(Block.box(0.0D, 6.0D, 0.0D, 15.0D, 8.0D, 15.0D),
			Block.box(10.5D, 0.0D, 10.5D, 13.0D, 6.0D, 13.0D));
	private static final VoxelShape TFTF = VoxelShapes.or(Block.box(1.0D, 6.0D, 1.0D, 16.0D, 8.0D, 16.0D),
			Block.box(3.0D, 0.0D, 3.0D, 5.5D, 6.0D, 5.5D));
	private static final VoxelShape FFTT = VoxelShapes.or(Block.box(0.0D, 6.0D, 1.0D, 15.0D, 8.0D, 16.0D),
			Block.box(10.5D, 0.0D, 3.0D, 13.0D, 6.0D, 5.5D));

	private static final VoxelShape FTTT = Block.box(0.0D, 6.0D, 0.0D, 15.0D, 8.0D, 16.0D);
	private static final VoxelShape TTTF = Block.box(1.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D);
	private static final VoxelShape TTFT = Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 15.0D);
	private static final VoxelShape TFTT = Block.box(0.0D, 6.0D, 1.0D, 16.0D, 8.0D, 16.0D);

	public Kotatsu(AbstractBlock.Properties props) {
		super(props);
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_kotatsu").withStyle(TextFormatting.GRAY));
	}
}
