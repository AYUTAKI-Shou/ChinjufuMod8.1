...
public class Kotatsu extends BaseUnitBlock {
	...
	private static final VoxelShape FFFF = Shapes.or(Block.box(2.0D, 6.0D, 2.0D, 14.0D, 8.0D, 14.0D),
	...
	private static final VoxelShape TTFF = Shapes.or(Block.box(1.0D, 6.0D, 0.0D, 16.0D, 8.0D, 15.0D),
			Block.box(3.0D, 0.0D, 10.5D, 5.5D, 6.0D, 13.0D));
	private static final VoxelShape FTFT = Shapes.or(Block.box(0.0D, 6.0D, 0.0D, 15.0D, 8.0D, 15.0D),
			Block.box(10.5D, 0.0D, 10.5D, 13.0D, 6.0D, 13.0D));
	private static final VoxelShape TFTF = Shapes.or(Block.box(1.0D, 6.0D, 1.0D, 16.0D, 8.0D, 16.0D),
			Block.box(3.0D, 0.0D, 3.0D, 5.5D, 6.0D, 5.5D));
	private static final VoxelShape FFTT = Shapes.or(Block.box(0.0D, 6.0D, 1.0D, 15.0D, 8.0D, 16.0D),
			Block.box(10.5D, 0.0D, 3.0D, 13.0D, 6.0D, 5.5D));

	private static final VoxelShape FTTT = Shapes.or(Block.box(0.0D, 6.0D, 0.0D, 15.0D, 8.0D, 16.0D));
	private static final VoxelShape TTTF = Shapes.or(Block.box(1.0D, 6.0D, 0.0D, 16.0D, 8.0D, 16.0D));
	private static final VoxelShape TTFT = Shapes.or(Block.box(0.0D, 6.0D, 0.0D, 16.0D, 8.0D, 15.0D));
	private static final VoxelShape TFTT = Shapes.or(Block.box(0.0D, 6.0D, 1.0D, 16.0D, 8.0D, 16.0D));
	
	public Kotatsu(BlockBehaviour.Properties props) {
		super(props);
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable BlockGetter worldIn, List<Component> blockTip, TooltipFlag tipFlag) {
		blockTip.add(new TranslatableComponent("tips.block_kotatsu").withStyle(ChatFormatting.GRAY));
	}
}
