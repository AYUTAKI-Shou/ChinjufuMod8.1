...
public class ClothTable extends BaseClothTable {
	...
	private Block takeSub() {
		...
		if (this == Unit_Blocks.CLOTHTABLE_mangrove.get()) { return Unit_Blocks.CLOTHTABLE_mangrovesub.get(); }
		if (this == Unit_Blocks.CLOTHTABLE_cherry.get()) { return Unit_Blocks.CLOTHTABLE_cherrysub.get(); }
		if (this == Unit_Blocks.CLOTHTABLE_paleoak.get()) { return Unit_Blocks.CLOTHTABLE_paleoaksub.get(); }
	...
	private Block takeBlock() {
		...
		if (this == Unit_Blocks.CLOTHTABLE_mangrove.get()) { return Unit_Blocks.CAFETABLE_mangrove.get(); }
		if (this == Unit_Blocks.CLOTHTABLE_cherry.get()) { return Unit_Blocks.CAFETABLE_cherry.get(); }
		if (this == Unit_Blocks.CLOTHTABLE_paleoak.get()) { return Unit_Blocks.CAFETABLE_paleoak.get(); }
