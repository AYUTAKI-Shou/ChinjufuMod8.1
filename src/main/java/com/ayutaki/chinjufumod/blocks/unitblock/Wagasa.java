...
public class Wagasa extends BaseUnitBlock {
	/* Collision */
	private static final VoxelShape TTTT = Shapes.or(Block.box(6.0D, 14.0D, 6.0D, 10.0D, 16.0D, 10.0D),
	...
	private static final VoxelShape FFFF = Shapes.or(Block.box(7.5D, 15.0D, 7.5D, 8.5D, 16.0D, 8.5D),
	...
	private static final VoxelShape TTFF = Shapes.or(Block.box(14.0D, 10.25D, 0.0D, 16.0D, 11.0D, 2.0D),
	...
	private static final VoxelShape FTFT = Shapes.or(Block.box(0.0D, 10.25D, 0.0D, 2.0D, 11.0D, 2.0D),
			...
			Block.box(0.0D, 5.0D, 0.0D, 16.0D, 5.75D, 16.0D));
	private static final VoxelShape TFTF = Shapes.or(Block.box(14.0D, 10.25D, 14.0D, 16.0D, 11.0D, 16.0D),
			...
			Block.box(0.0D, 5.0D, 0.0D, 16.0D, 5.75D, 16.0D));
	private static final VoxelShape FFTT = Shapes.or(Block.box(0.0D, 10.25D, 14.0D, 2.0D, 11.0D, 16.0D),
	...
	private static final VoxelShape FTTT = Shapes.or(Block.box(0.0D, 10.25D, 0.0D, 2.0D, 11.0D, 16.0D),
			...
			Block.box(0.0D, 5.0D, 0.0D, 16.0D, 5.75D, 16.0D));
	private static final VoxelShape TTTF = Shapes.or(Block.box(14.0D, 10.25D, 0.0D, 16.0D, 11.0D, 16.0D),
			...
			Block.box(0.0D, 5.0D, 0.0D, 16.0D, 5.75D, 16.0D));
	private static final VoxelShape TTFT = Shapes.or(Block.box(0.0D, 10.25D, 0.0D, 16.0D, 11.0D, 2.0D),
			...
			Block.box(0.0D, 5.0D, 0.0D, 16.0D, 5.75D, 16.0D));
	private static final VoxelShape TFTT = Shapes.or(Block.box(0.0D, 10.25D, 14.0D, 16.0D, 11.0D, 16.0D),
	...
	public Wagasa(BlockBehaviour.Properties props) {
		super(props);
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable BlockGetter worldIn, List<Component> blockTip, TooltipFlag tipFlag) {
		blockTip.add(new TranslatableComponent("tips.block_mkasa").withStyle(ChatFormatting.GRAY));
	}
}
