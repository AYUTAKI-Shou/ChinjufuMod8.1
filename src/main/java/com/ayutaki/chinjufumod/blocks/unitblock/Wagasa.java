...
public class Wagasa extends BaseUnitBlock {
	/* Collision */
	private static final VoxelShape TTTT = VoxelShapes.or(Block.makeCuboidShape(6.0D, 14.0D, 6.0D, 10.0D, 16.0D, 10.0D),
	...
	private static final VoxelShape FFFF = VoxelShapes.or(Block.makeCuboidShape(7.5D, 15.0D, 7.5D, 8.5D, 16.0D, 8.5D),
	...
	private static final VoxelShape TTFF = VoxelShapes.or(Block.makeCuboidShape(14.0D, 10.25D, 0.0D, 16.0D, 11.0D, 2.0D),
	...
	private static final VoxelShape FTFT = VoxelShapes.or(Block.makeCuboidShape(0.0D, 10.25D, 0.0D, 2.0D, 11.0D, 2.0D),
			...
			Block.makeCuboidShape(0.0D, 5.0D, 0.0D, 16.0D, 5.75D, 16.0D));
	private static final VoxelShape TFTF = VoxelShapes.or(Block.makeCuboidShape(14.0D, 10.25D, 14.0D, 16.0D, 11.0D, 16.0D),
			...
			Block.makeCuboidShape(0.0D, 5.0D, 0.0D, 16.0D, 5.75D, 16.0D));
	private static final VoxelShape FFTT = VoxelShapes.or(Block.makeCuboidShape(0.0D, 10.25D, 14.0D, 2.0D, 11.0D, 16.0D),
	...
	private static final VoxelShape FTTT = VoxelShapes.or(Block.makeCuboidShape(0.0D, 10.25D, 0.0D, 2.0D, 11.0D, 16.0D),
			...
			Block.makeCuboidShape(0.0D, 5.0D, 0.0D, 16.0D, 5.75D, 16.0D));
	private static final VoxelShape TTTF = VoxelShapes.or(Block.makeCuboidShape(14.0D, 10.25D, 0.0D, 16.0D, 11.0D, 16.0D),
			...
			Block.makeCuboidShape(0.0D, 5.0D, 0.0D, 16.0D, 5.75D, 16.0D));
	private static final VoxelShape TTFT = VoxelShapes.or(Block.makeCuboidShape(0.0D, 10.25D, 0.0D, 16.0D, 11.0D, 2.0D),
			...
			Block.makeCuboidShape(0.0D, 5.0D, 0.0D, 16.0D, 5.75D, 16.0D));
	private static final VoxelShape TFTT = VoxelShapes.or(Block.makeCuboidShape(0.0D, 10.25D, 14.0D, 16.0D, 11.0D, 16.0D),
	...
	public Wagasa(Block.Properties props) {
		super(props);
	}
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_mkasa").applyTextStyle(TextFormatting.GRAY));
	}
}
