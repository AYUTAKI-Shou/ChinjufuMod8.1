...
public class CafeTable extends BaseUnitBlock {
	...
	public CafeTable(AbstractBlock.Properties props) {
		super(props);
	}
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		boolean carpets = (hItem.is(ItemTags.CARPETS));
		...
		if (TEATABLE) {
			...
			if (carpets) {
				...
				worldIn.setBlock(pos, clothTable.defaultBlockState()
						.setValue(BaseClothTable.STAGE_0_15, Integer.valueOf(this.takeMeta(hItem)))
