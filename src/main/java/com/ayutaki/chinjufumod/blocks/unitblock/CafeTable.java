...
public class CafeTable extends BaseUnitDesk {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (carpets) {
			...
			worldIn.setBlockState(pos, takeBlock(state).getDefaultState()
					.withProperty(ClothTable.STAGE_0_15, Integer.valueOf(k)));
			return true; }
	...
	private Block takeBlock(IBlockState state) {
		...
		if (i == 0) { return Unit_Blocks.CLOTHTABLE_oak; }
		if (i == 1) { return Unit_Blocks.CLOTHTABLE_spruce; }
		if (i == 2) { return Unit_Blocks.CLOTHTABLE_birch; }
		if (i == 3) { return Unit_Blocks.CLOTHTABLE_jungle; }
		if (i == 4) { return Unit_Blocks.CLOTHTABLE_acacia; }
		if (i == 5) { return Unit_Blocks.CLOTHTABLE_darkoak; }
		if (i == 6) { return Unit_Blocks.CLOTHTABLE_sakura; }
		if (i == 7) { return Unit_Blocks.CLOTHTABLE_kaede; }
