...
public class CafeTable extends BaseUnitBlock {
	...
	private Block takeBlock() {
		...
		if (this == Unit_Blocks.CAFETABLE_paleoak.get()) { return Unit_Blocks.CLOTHTABLE_paleoak.get(); }
	...
	private Block takeSub() {
		...
		if (this == Unit_Blocks.CAFETABLE_paleoak.get()) { return Unit_Blocks.CLOTHTABLE_paleoaksub.get(); }
