...
public class Endai extends BaseEndai {
	/** 0=normal, 1=red, 2=teatable **/
	public Endai(String name) {
		super(name);
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (hStack.isEmpty()) {
			if (playerIn.isSneaking()) {
				...
				worldIn.setBlockState(pos, Unit_Blocks.ENDAI_sub.getDefaultState()
						.withProperty(Endai_sub.STAGE_0_2, Integer.valueOf(i))); }
			return true;
		}
		return false;
	}
