...
public class UnitDesk extends BaseUnitBlock {
	/* Collision */
	private static final VoxelShape TTTT = Block.makeCuboidShape(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D);

	private static final VoxelShape FFFF = VoxelShapes.or(Block.makeCuboidShape(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
	...
	private static final VoxelShape TTFF = VoxelShapes.or(Block.makeCuboidShape(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(1.0D, 0.0D, 14.0D, 16.0D, 15.0D, 15.0D),
			Block.makeCuboidShape(1.0D, 0.0D, 0.0D, 2.0D, 15.0D, 15.0D));
	private static final VoxelShape FTFT = VoxelShapes.or(Block.makeCuboidShape(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(0.0D, 0.0D, 14.0D, 15.0D, 15.0D, 15.0D),
			Block.makeCuboidShape(14.0D, 0.0D, 0.0D, 15.0D, 15.0D, 15.0D));
	private static final VoxelShape TFTF = VoxelShapes.or(Block.makeCuboidShape(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(1.0D, 0.0D, 1.0D, 16.0D, 15.0D, 2.0D),
			Block.makeCuboidShape(1.0D, 0.0D, 1.0D, 2.0D, 15.0D, 16.0D));
	private static final VoxelShape FFTT = VoxelShapes.or(Block.makeCuboidShape(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(0.0D, 0.0D, 1.0D, 15.0D, 15.0D, 2.0D),
			Block.makeCuboidShape(14.0D, 0.0D, 1.0D, 15.0D, 15.0D, 16.0D));

	private static final VoxelShape FTFF = VoxelShapes.or(Block.makeCuboidShape(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(1.0D, 0.0D, 0.0D, 2.0D, 15.0D, 15.0D),
			Block.makeCuboidShape(14.0D, 0.0D, 0.0D, 15.0D, 15.0D, 15.0D),
			Block.makeCuboidShape(1.0D, 0.0D, 14.0D, 15.0D, 15.0D, 15.0D));
	private static final VoxelShape FFTF = VoxelShapes.or(Block.makeCuboidShape(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(1.0D, 0.0D, 1.0D, 2.0D, 15.0D, 16.0D),
			Block.makeCuboidShape(1.0D, 0.0D, 1.0D, 15.0D, 15.0D, 16.0D),
			Block.makeCuboidShape(1.0D, 0.0D, 1.0D, 15.0D, 15.0D, 2.0D));
	private static final VoxelShape TFFF = VoxelShapes.or(Block.makeCuboidShape(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(1.0D, 0.0D, 1.0D, 16.0D, 15.0D, 2.0D),
			Block.makeCuboidShape(1.0D, 0.0D, 14.0D, 16.0D, 15.0D, 15.0D),
			Block.makeCuboidShape(1.0D, 0.0D, 1.0D, 2.0D, 15.0D, 15.0D));
	private static final VoxelShape FFFT = VoxelShapes.or(Block.makeCuboidShape(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(0.0D, 0.0D, 1.0D, 15.0D, 15.0D, 2.0D),
			Block.makeCuboidShape(0.0D, 0.0D, 14.0D, 15.0D, 15.0D, 15.0D),
			Block.makeCuboidShape(14.0D, 0.0D, 1.0D, 15.0D, 15.0D, 15.0D));

	private static final VoxelShape FTTF = VoxelShapes.or(Block.makeCuboidShape(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(1.0D, 0.0D, 0.0D, 2.0D, 15.0D, 16.0D),
			Block.makeCuboidShape(14.0D, 0.0D, 0.0D, 15.0D, 15.0D, 16.0D));
	private static final VoxelShape TFFT = VoxelShapes.or(Block.makeCuboidShape(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(0.0D, 0.0D, 1.0D, 16.0D, 15.0D, 2.0D),
			Block.makeCuboidShape(0.0D, 0.0D, 14.0D, 16.0D, 15.0D, 15.0D));

	public UnitDesk(Block.Properties props) {
		super(props);
	}
