...
public class UnitDesk extends BaseUnitBlock {
	...
	private static final VoxelShape FFFF = Shapes.or(Block.box(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
	...
	private static final VoxelShape TTFF = Shapes.or(Block.box(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.box(1.0D, 0.0D, 14.0D, 16.0D, 15.0D, 15.0D),
			Block.box(1.0D, 0.0D, 0.0D, 2.0D, 15.0D, 15.0D));
	private static final VoxelShape FTFT = Shapes.or(Block.box(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.box(0.0D, 0.0D, 14.0D, 15.0D, 15.0D, 15.0D),
			Block.box(14.0D, 0.0D, 0.0D, 15.0D, 15.0D, 15.0D));
	private static final VoxelShape TFTF = Shapes.or(Block.box(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.box(1.0D, 0.0D, 1.0D, 16.0D, 15.0D, 2.0D),
			Block.box(1.0D, 0.0D, 1.0D, 2.0D, 15.0D, 16.0D));
	private static final VoxelShape FFTT = Shapes.or(Block.box(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.box(0.0D, 0.0D, 1.0D, 15.0D, 15.0D, 2.0D),
			Block.box(14.0D, 0.0D, 1.0D, 15.0D, 15.0D, 16.0D));

	private static final VoxelShape FTFF = Shapes.or(Block.box(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.box(1.0D, 0.0D, 0.0D, 2.0D, 15.0D, 15.0D),
			Block.box(14.0D, 0.0D, 0.0D, 15.0D, 15.0D, 15.0D),
			Block.box(1.0D, 0.0D, 14.0D, 15.0D, 15.0D, 15.0D));
	private static final VoxelShape FFTF = Shapes.or(Block.box(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.box(1.0D, 0.0D, 1.0D, 2.0D, 15.0D, 16.0D),
			Block.box(1.0D, 0.0D, 1.0D, 15.0D, 15.0D, 16.0D),
			Block.box(1.0D, 0.0D, 1.0D, 15.0D, 15.0D, 2.0D));
	private static final VoxelShape TFFF = Shapes.or(Block.box(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.box(1.0D, 0.0D, 1.0D, 16.0D, 15.0D, 2.0D),
			Block.box(1.0D, 0.0D, 14.0D, 16.0D, 15.0D, 15.0D),
			Block.box(1.0D, 0.0D, 1.0D, 2.0D, 15.0D, 15.0D));
	private static final VoxelShape FFFT = Shapes.or(Block.box(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.box(0.0D, 0.0D, 1.0D, 15.0D, 15.0D, 2.0D),
			Block.box(0.0D, 0.0D, 14.0D, 15.0D, 15.0D, 15.0D),
			Block.box(14.0D, 0.0D, 1.0D, 15.0D, 15.0D, 15.0D));

	private static final VoxelShape FTTF = Shapes.or(Block.box(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.box(1.0D, 0.0D, 0.0D, 2.0D, 15.0D, 16.0D),
			Block.box(14.0D, 0.0D, 0.0D, 15.0D, 15.0D, 16.0D));
	private static final VoxelShape TFFT = Shapes.or(Block.box(0.0D, 15.0D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.box(0.0D, 0.0D, 1.0D, 16.0D, 15.0D, 2.0D),
			Block.box(0.0D, 0.0D, 14.0D, 16.0D, 15.0D, 15.0D));
	
	public UnitDesk(BlockBehaviour.Properties props) {
		super(props);
	}
