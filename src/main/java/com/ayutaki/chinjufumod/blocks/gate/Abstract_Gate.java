...
public abstract class Abstract_Gate extends Abstract_WaterLogged {
	/* Property */
	...
	public Abstract_Gate(AbstractBlock.Properties props) {
		super(props);
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_gate").withStyle(TextFormatting.GRAY));
	}
}
