...
public class GrillGate_1 extends BaseGate_Part1 {
	...
	private static final AxisAlignedBB UP_SOUTH = CollisionHelper.getBlockBounds(EnumFacing.SOUTH, 0.46875, 0.0, 0.0, 0.53125, 2.0, 1.0);
	private static final AxisAlignedBB UP_EAST = CollisionHelper.getBlockBounds(EnumFacing.EAST, 0.46875, 0.0, 0.0, 0.53125, 2.0, 1.0);
	private static final AxisAlignedBB UP_WEST = CollisionHelper.getBlockBounds(EnumFacing.WEST, 0.46875, 0.0, 0.0, 0.53125, 2.0, 1.0);
	private static final AxisAlignedBB UP_NORTH = CollisionHelper.getBlockBounds(EnumFacing.NORTH, 0.46875, 0.0, 0.0, 0.53125, 2.0, 1.0);
	
	public GrillGate_1(String name) {
		super(name);
