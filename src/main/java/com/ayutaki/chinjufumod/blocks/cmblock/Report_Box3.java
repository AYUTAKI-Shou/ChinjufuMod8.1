...
public class Report_Box3 extends Base_Report {

	public Report_Box3(String name) {
		super(name);
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		IBlockState reportBox4 = Chinjufu_Blocks.REPORT_BOX4.getDefaultState()
				...
				if (northState.getBlock() instanceof BlockStaticLiquid || northState.getBlock() instanceof BlockDynamicLiquid) {
					...
					if (wait) {
						if (hItem == Items.ROTTEN_FLESH && gHC >= 16) { 
							...
							if (i == 4) { worldIn.setBlockState(pos, reportBox4, 3); } }
	...
	public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state) {
		worldIn.scheduleUpdate(pos, Chinjufu_Blocks.REPORT_BOX3, this.tickRate(worldIn));
	}
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 2) { 
			stack.add(new ItemStack(Items.PAPER, 15, 0));
			stack.add(new ItemStack(Items_Chinjufu.REPORT_BOX, 1, 0)); }
		if (i == 3) { 
			stack.add(new ItemStack(Items.PAPER, 15, 0));
			stack.add(new ItemStack(Items_Chinjufu.REPORT_BOX, 1, 0)); }
