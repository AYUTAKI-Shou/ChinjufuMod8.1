...
public class Report_Box2 extends Base_Report {

	public Report_Box2(String name) {
		super(name);
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		IBlockState reportBox3 = Chinjufu_Blocks.REPORT_BOX3.getDefaultState()
				...
				if (northState.getBlock() instanceof BlockStaticLiquid || northState.getBlock() instanceof BlockDynamicLiquid) {
					...
					if (wait) {
						if (hItem == Items.ROTTEN_FLESH && gHC >= 16) { 
							this.flesh16_seWool(westState, worldIn, pos, playerIn, hand);
							
							if (i == 2) { worldIn.setBlockState(pos, state.withProperty(STAGE_1_4, Integer.valueOf(i + 1)), 3); }
							if (i == 4) { worldIn.setBlockState(pos, reportBox3, 3); } }
	...
	public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state) {
		worldIn.scheduleUpdate(pos, Chinjufu_Blocks.REPORT_BOX2, this.tickRate(worldIn));
	}
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 2) { 
			stack.add(new ItemStack(Items.PAPER, 25, 0));
			stack.add(new ItemStack(Items_Chinjufu.REPORT_BOX, 1, 0)); }
		if (i == 3) { 
			stack.add(new ItemStack(Items.PAPER, 25, 0));
			stack.add(new ItemStack(Items_Chinjufu.REPORT_BOX, 1, 0)); }
		if (i == 4) { 
			stack.add(new ItemStack(Items.PAPER, 20, 0));
			stack.add(new ItemStack(Items_Chinjufu.REPORT_BOX, 1, 0)); }
		return stack;
	}
}
