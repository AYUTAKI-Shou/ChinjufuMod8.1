...
public class WakeWater3 extends Base_WakeWater {
	...
	public WakeWater3(Block.Properties props) {
		super(props);
	}
	...
	public BlockState updatePostPlacement(BlockState state, Direction facing, BlockState newState, IWorld worldIn, BlockPos pos, BlockPos newPos) {
		if (true) { worldIn.getPendingBlockTicks().scheduleTick(pos, this, 130); }
	...
	public void onBlockAdded(BlockState state, World worldIn, BlockPos pos, BlockState oldState, boolean isMoving) {
		worldIn.getPendingBlockTicks().scheduleTick(pos, this, 130);
	}
