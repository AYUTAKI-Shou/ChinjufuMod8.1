...
public class Enden_kara extends Abstract_Harvest {
	/* Property */
	...
	public Enden_kara(Block.Properties props) {
		super(props);
		/** Default state **/
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (hItem != Items_Teatime.MIZUOKE_full) { CMEvents.textNotHave(worldIn, pos, playerIn); }
