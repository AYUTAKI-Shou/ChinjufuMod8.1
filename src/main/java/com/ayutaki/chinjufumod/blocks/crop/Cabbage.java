...
public class Cabbage extends BaseFarmCrop {
	...
	private static final AxisAlignedBB[] CROPS_AABB = new AxisAlignedBB[] { new AxisAlignedBB(0.0D * cw, -1.0D * cw, 0.0D * cw, 16.0D * cw, 2.0D * cw, 16.0D * cw),
			...
			new AxisAlignedBB(0.0D * cw, -1.0D * cw, 0.0D * cw, 16.0D * cw, 2.0D * cw, 16.0D * cw),
			new AxisAlignedBB(0.0D * cw, -1.0D * cw, 0.0D * cw, 16.0D * cw, 2.0D * cw, 16.0D * cw),
			new AxisAlignedBB(6.0D * cw, -1.0D * cw, 6.0D * cw, 10.0D * cw, 2.0D * cw, 10.0D * cw),
			new AxisAlignedBB(5.0D * cw, -1.0D * cw, 5.0D * cw, 11.0D * cw, 3.0D * cw, 11.0D * cw),
