...
public class Cabbage extends CropBlock {
	/* Collision */
	private static final VoxelShape[] SHAPES = new VoxelShape[]{ Block.box(0.0D, -1.0D, 0.0D, 16.0D, 2.0D, 16.0D),
	...
	public Cabbage(BlockBehaviour.Properties props) {
		super(props);
	}
	...
	public ItemStack getCloneItemStack(BlockGetter worldIn, BlockPos pos, BlockState state) {
		return new ItemStack(Items_Teatime.SEEDS_CABBAGE.get());
	}
}
