...
public class Mikan extends Abstract_WaterLogged {
	...
	private static final VoxelShape BOT_0 = VoxelShapes.or(AABB_BASE, Block.box(7.5D, 0.1D, 7.5D, 8.5D, 12.0D, 8.5D));
	private static final VoxelShape BOT_1 = VoxelShapes.or(AABB_BASE, Block.box(3.0D, 8.0D, 3.0D, 13.0D, 16.0D, 13.0D),
			Block.box(7.25D, 0.1D, 7.25D, 8.75D, 8.0D, 8.75D));
	private static final VoxelShape BOT_2 = VoxelShapes.or(AABB_BASE, Block.box(2.0D, 9.0D, 2.0D, 14.0D, 20.0D, 14.0D),
			Block.box(7.25D, 0.1D, 7.25D, 8.75D, 9.0D, 8.75D));
	private static final VoxelShape BOT_3 = VoxelShapes.or(AABB_BASE, Block.box(2.0D, 12.0D, 2.0D, 14.0D, 24.0D, 14.0D),
			Block.box(7.0D, 0.1D, 7.0D, 9.0D, 12.0D, 9.0D));
	private static final VoxelShape BOT_4 = VoxelShapes.or(AABB_BASE, Block.box(1.0D, 14.0D, 1.0D, 15.0D, 28.0D, 15.0D),
			Block.box(7.0D, 0.1D, 7.0D, 9.0D, 14.0D, 9.0D));

	private static final VoxelShape BOT_5 = VoxelShapes.or(AABB_BASE, Block.box(7.0D, 0.1D, 7.0D, 9.0D, 16.0D, 9.0D));
	private static final VoxelShape TOP_5 = Block.box(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D);

	public Mikan(AbstractBlock.Properties props) {
		super(props);
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_wood_mikan").withStyle(TextFormatting.GRAY));
	}
}
