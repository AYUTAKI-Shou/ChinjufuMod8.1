...
public class Base_YoushokuAmi extends Abstract_WaterLogged {
	...
	/* Collision */
	private static final VoxelShape AABB_BOX = Block.box(4.0D, 0.0D, 4.0D, 12.0D, 16.0D, 12.0D);
	
	private static final VoxelShape AABB_1 = VoxelShapes.or(Block.box(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 2.0D),
			Block.box(0.0D, 0.0D, 0.0D, 2.0D, 16.0D, 16.0D));
	private static final VoxelShape AABB_2 = Block.box(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 2.0D);
	private static final VoxelShape AABB_3 = VoxelShapes.or(Block.box(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 2.0D),
			Block.box(14.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D));
	private static final VoxelShape AABB_4 = Block.box(0.0D, 0.0D, 0.0D, 2.0D, 16.0D, 16.0D);
	private static final VoxelShape AABB_6 = Block.box(14.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape AABB_7 = VoxelShapes.or(Block.box(0.0D, 0.0D, 14.0D, 16.0D, 16.0D, 16.0D),
			Block.box(0.0D, 0.0D, 0.0D, 2.0D, 16.0D, 16.0D));
	private static final VoxelShape AABB_8 = Block.box(0.0D, 0.0D, 14.0D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape AABB_9 = VoxelShapes.or(Block.box(0.0D, 0.0D, 14.0D, 16.0D, 16.0D, 16.0D),
			Block.box(14.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D));	
	
	private static final VoxelShape BOT_BASE = Block.box(0.0D, -1.0D, 0.0D, 16.0D, 2.0D, 16.0D);
	...
	private static final VoxelShape TAKE_1 = VoxelShapes.or(Block.box(0.0D, 13.0D, 0.0D, 16.0D, 16.0D, 3.0D),
			Block.box(0.0D, 13.0D, 3.0D, 3.0D, 16.0D, 16.0D));
	private static final VoxelShape TAKE_2 = Block.box(0.0D, 13.0D, 0.0D, 16.0D, 16.0D, 3.0D);
	private static final VoxelShape TAKE_3 = VoxelShapes.or(Block.box(0.0D, 13.0D, 0.0D, 16.0D, 16.0D, 3.0D),
			Block.box(13.0D, 13.0D, 3.0D, 16.0D, 16.0D, 16.0D));
	private static final VoxelShape TAKE_4 = Block.box(0.0D, 13.0D, 0.0D, 3.0D, 16.0D, 16.0D);
	private static final VoxelShape TAKE_6 = Block.box(13.0D, 13.0D, 0.0D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape TAKE_7 = VoxelShapes.or(Block.box(0.0D, 13.0D, 13.0D, 16.0D, 16.0D, 16.0D),
			Block.box(0.0D, 13.0D, 0.0D, 3.0D, 16.0D, 13.0D));
	private static final VoxelShape TAKE_8 = Block.box(0.0D, 13.0D, 13.0D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape TAKE_9 = VoxelShapes.or(Block.box(0.0D, 13.0D, 13.0D, 16.0D, 16.0D, 16.0D),
	...
	public Base_YoushokuAmi(AbstractBlock.Properties props) {
		super(props);
