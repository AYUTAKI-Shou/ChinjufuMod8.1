...
public class Base_YoushokuAmi extends Abstract_WaterLogged {
	/* Property */
	...
	/* Collision */
	private static final VoxelShape AABB_BOX = Block.makeCuboidShape(4.0D, 0.0D, 4.0D, 12.0D, 16.0D, 12.0D);
	
	private static final VoxelShape AABB_1 = VoxelShapes.or(Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 2.0D),
			Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 2.0D, 16.0D, 16.0D));
	private static final VoxelShape AABB_2 = Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 2.0D);
	private static final VoxelShape AABB_3 = VoxelShapes.or(Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 2.0D),
			Block.makeCuboidShape(14.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D));
	private static final VoxelShape AABB_4 = Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 2.0D, 16.0D, 16.0D);
	private static final VoxelShape AABB_6 = Block.makeCuboidShape(14.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape AABB_7 = VoxelShapes.or(Block.makeCuboidShape(0.0D, 0.0D, 14.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 2.0D, 16.0D, 16.0D));
	private static final VoxelShape AABB_8 = Block.makeCuboidShape(0.0D, 0.0D, 14.0D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape AABB_9 = VoxelShapes.or(Block.makeCuboidShape(0.0D, 0.0D, 14.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(14.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D));
	
	private static final VoxelShape BOT_BASE = Block.makeCuboidShape(0.0D, -1.0D, 0.0D, 16.0D, 2.0D, 16.0D);
	private static final VoxelShape BOT_1 = VoxelShapes.or(AABB_1, BOT_BASE);
	private static final VoxelShape BOT_2 = VoxelShapes.or(AABB_2, BOT_BASE);
	private static final VoxelShape BOT_3 = VoxelShapes.or(AABB_3, BOT_BASE);
	private static final VoxelShape BOT_4 = VoxelShapes.or(AABB_4, BOT_BASE);
	private static final VoxelShape BOT_6 = VoxelShapes.or(AABB_6, BOT_BASE);
	private static final VoxelShape BOT_7 = VoxelShapes.or(AABB_7, BOT_BASE);
	private static final VoxelShape BOT_8 = VoxelShapes.or(AABB_8, BOT_BASE);
	private static final VoxelShape BOT_9 = VoxelShapes.or(AABB_9, BOT_BASE);
	
	private static final VoxelShape TAKE_1 = VoxelShapes.or(Block.makeCuboidShape(0.0D, 13.0D, 0.0D, 16.0D, 16.0D, 3.0D),
			Block.makeCuboidShape(0.0D, 13.0D, 3.0D, 3.0D, 16.0D, 16.0D));
	private static final VoxelShape TAKE_2 = Block.makeCuboidShape(0.0D, 13.0D, 0.0D, 16.0D, 16.0D, 3.0D);
	private static final VoxelShape TAKE_3 = VoxelShapes.or(Block.makeCuboidShape(0.0D, 13.0D, 0.0D, 16.0D, 16.0D, 3.0D),
			Block.makeCuboidShape(13.0D, 13.0D, 3.0D, 16.0D, 16.0D, 16.0D));
	private static final VoxelShape TAKE_4 = Block.makeCuboidShape(0.0D, 13.0D, 0.0D, 3.0D, 16.0D, 16.0D);
	private static final VoxelShape TAKE_6 = Block.makeCuboidShape(13.0D, 13.0D, 0.0D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape TAKE_7 = VoxelShapes.or(Block.makeCuboidShape(0.0D, 13.0D, 13.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(0.0D, 13.0D, 0.0D, 3.0D, 16.0D, 13.0D));
	private static final VoxelShape TAKE_8 = Block.makeCuboidShape(0.0D, 13.0D, 13.0D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape TAKE_9 = VoxelShapes.or(Block.makeCuboidShape(0.0D, 13.0D, 13.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(13.0D, 13.0D, 0.0D, 16.0D, 16.0D, 13.0D));
	
	private static final VoxelShape TOP_1 = VoxelShapes.or(AABB_1, TAKE_1);
	private static final VoxelShape TOP_2 = VoxelShapes.or(AABB_2, TAKE_2);
	private static final VoxelShape TOP_3 = VoxelShapes.or(AABB_3, TAKE_3);
	private static final VoxelShape TOP_4 = VoxelShapes.or(AABB_4, TAKE_4);
	private static final VoxelShape TOP_6 = VoxelShapes.or(AABB_6, TAKE_6);
	private static final VoxelShape TOP_7 = VoxelShapes.or(AABB_7, TAKE_7);
	private static final VoxelShape TOP_8 = VoxelShapes.or(AABB_8, TAKE_8);
	private static final VoxelShape TOP_9 = VoxelShapes.or(AABB_9, TAKE_9);
	
	private static final VoxelShape TOPBOT_1 = VoxelShapes.or(AABB_1, TAKE_1, BOT_BASE);
	private static final VoxelShape TOPBOT_2 = VoxelShapes.or(AABB_2, TAKE_2, BOT_BASE);
	private static final VoxelShape TOPBOT_3 = VoxelShapes.or(AABB_3, TAKE_3, BOT_BASE);
	private static final VoxelShape TOPBOT_4 = VoxelShapes.or(AABB_4, TAKE_4, BOT_BASE);
	private static final VoxelShape TOPBOT_6 = VoxelShapes.or(AABB_6, TAKE_6, BOT_BASE);
	private static final VoxelShape TOPBOT_7 = VoxelShapes.or(AABB_7, TAKE_7, BOT_BASE);
	private static final VoxelShape TOPBOT_8 = VoxelShapes.or(AABB_8, TAKE_8, BOT_BASE);
	private static final VoxelShape TOPBOT_9 = VoxelShapes.or(AABB_9, TAKE_9, BOT_BASE);
	
	public Base_YoushokuAmi(Block.Properties props) {
		super(props);
		/** Default state **/
