...
public class Base_HodaGi_Top extends BaseStage4_FaceWater {
	/* Collision */
	private static final VoxelShape AABB_SOUTH = Block.makeCuboidShape(5.0D, -4.0D, 0.0D, 11.0D, 8.0D, 10.0D);
	private static final VoxelShape AABB_WEST = Block.makeCuboidShape(6.0D, -4.0D, 5.0D, 16.0D, 8.0D, 11.0D);
	private static final VoxelShape AABB_NORTH = Block.makeCuboidShape(5.0D, -4.0D, 6.0D, 11.0D, 8.0D, 16.0D);
	private static final VoxelShape AABB_EAST = Block.makeCuboidShape(0.0D, -4.0D, 5.0D, 10.0D, 8.0D, 11.0D);

	public Base_HodaGi_Top(Block.Properties props) {
		super(props);
	}
