...
public class Base_HodaGi_Top extends BaseStage4_FaceWater {
	/* Collision */
	private static final VoxelShape AABB_SOUTH = Block.box(5.0D, -4.0D, 0.0D, 11.0D, 8.0D, 10.0D);
	private static final VoxelShape AABB_WEST = Block.box(6.0D, -4.0D, 5.0D, 16.0D, 8.0D, 11.0D);
	private static final VoxelShape AABB_NORTH = Block.box(5.0D, -4.0D, 6.0D, 11.0D, 8.0D, 16.0D);
	private static final VoxelShape AABB_EAST = Block.box(0.0D, -4.0D, 5.0D, 10.0D, 8.0D, 11.0D);

	public Base_HodaGi_Top(BlockBehaviour.Properties props) {
		super(props);
	}
