...
public class LostClam extends Abstract_Falling {
	/* Property */
	public static final IntegerProperty STAGE_0_4 = IntegerProperty.create("stage", 0, 4);
	private final int dustColor;
	
	public LostClam(int color, AbstractBlock.Properties props) {
		super(props);
	...
	public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random rand) {
		...
		if (rand.nextInt(6) == 0) {
			...
			else { worldIn.setBlock(pos, state.setValue(STAGE_0_4, Integer.valueOf(i + 1)), 3); }
		}
	}
