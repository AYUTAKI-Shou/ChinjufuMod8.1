...
public class Chanoki extends Abstract_WaterLogged {
	...
	private static final VoxelShape AABB_0 = VoxelShapes.or(AABB_BASE, Block.box(7.0D, 0.1D, 7.0D, 9.0D, 12.0D, 9.0D));
	private static final VoxelShape AABB_1 = VoxelShapes.or(AABB_BASE, Block.box(3.0D, 4.0D, 3.0D, 13.0D, 13.0D, 13.0D),
			Block.box(7.0D, 0.1D, 7.0D, 9.0D, 4.0D, 9.0D));
	private static final VoxelShape AABB_2 = VoxelShapes.or(AABB_BASE, Block.box(2.0D, 4.0D, 2.0D, 14.0D, 14.0D, 14.0D),
			Block.box(7.0D, 0.1D, 7.0D, 9.0D, 4.0D, 9.0D));
	private static final VoxelShape AABB_3 = VoxelShapes.or(AABB_BASE, Block.box(1.5D, 4.0D, 1.5D, 14.5D, 14.5D, 14.5D),
			Block.box(7.0D, 0.1D, 7.0D, 9.0D, 4.0D, 9.0D));
	private static final VoxelShape AABB_4 = VoxelShapes.or(AABB_BASE, Block.box(1.0D, 3.75D, 1.0D, 15.0D, 15.0D, 15.0D),
			Block.box(7.0D, 0.1D, 7.0D, 9.0D, 4.0D, 9.0D));
	private static final VoxelShape AABB_5 = VoxelShapes.or(AABB_BASE, Block.box(0.5D, 3.5D, 0.5D, 15.5D, 15.5D, 15.5D),
			Block.box(7.0D, 0.1D, 7.0D, 9.0D, 3.5D, 9.0D));
	private static final VoxelShape AABB_7 = VoxelShapes.or(AABB_BASE, Block.box(0.0D, 3.5D, 0.0D, 16.0D, 16.0D, 16.0D),
			Block.box(7.0D, 0.1D, 7.0D, 9.0D, 3.5D, 9.0D));

	public Chanoki(AbstractBlock.Properties props) {
		super(props);
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_wood_chanoki_nae").withStyle(TextFormatting.GRAY));
	}
}
