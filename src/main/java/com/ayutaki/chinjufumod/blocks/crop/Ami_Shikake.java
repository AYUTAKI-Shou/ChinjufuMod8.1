...
public class Ami_Shikake extends Abstract_WaterLogged {
	...
	private static final VoxelShape AABB_1 = VoxelShapes.or(Block.box(13.0D, 0.0D, 0.0D, 16.0D, 16.0D, 1.0D),
	...
	private static final VoxelShape AABB_3 = VoxelShapes.or(Block.box(0.0D, 0.0D, 0.0D, 3.0D, 16.0D, 1.0D),
			Block.box(3.0D, 0.0D, 3.0D, 13.0D, 16.0D, 4.0D),
	...
	private static final VoxelShape AABB_5N = VoxelShapes.or(Block.box(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 1.0D),
			Block.box(0.0D, 0.0D, 0.0D, 1.0D, 16.0D, 16.0D));
	private static final VoxelShape AABB_5S = VoxelShapes.or(Block.box(0.0D, 0.0D, 15.0D, 16.0D, 16.0D, 16.0D),
			Block.box(15.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D));
	private static final VoxelShape AABB_5E = VoxelShapes.or(Block.box(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 1.0D),
			Block.box(15.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D));
	private static final VoxelShape AABB_5W = VoxelShapes.or(Block.box(0.0D, 0.0D, 15.0D, 16.0D, 16.0D, 16.0D),
			Block.box(0.0D, 0.0D, 0.0D, 1.0D, 16.0D, 16.0D));
	...
	private static final VoxelShape AABB_7 = VoxelShapes.or(Block.box(13.0D, 0.0D, 15.0D, 16.0D, 16.0D, 16.0D),
	...
	private static final VoxelShape AABB_9 = VoxelShapes.or(Block.box(0.0D, 0.0D, 15.0D, 3.0D, 16.0D, 16.0D),
			Block.box(3.0D, 0.0D, 12.0D, 13.0D, 16.0D, 13.0D),
	...
	public Ami_Shikake(AbstractBlock.Properties props) {
		super(props);
