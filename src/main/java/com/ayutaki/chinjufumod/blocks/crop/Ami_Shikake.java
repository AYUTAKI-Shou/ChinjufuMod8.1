...
public class Ami_Shikake extends Abstract_WaterLogged {
	/* Property */
	...
	private static final VoxelShape AABB_1 = VoxelShapes.or(Block.makeCuboidShape(13.0D, 0.0D, 0.0D, 16.0D, 16.0D, 1.0D),
	...
	private static final VoxelShape AABB_2 = Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 1.0D);
	private static final VoxelShape AABB_2N = Block.makeCuboidShape(15.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D);
	
	private static final VoxelShape AABB_3 = VoxelShapes.or(Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 3.0D, 16.0D, 1.0D),
			Block.makeCuboidShape(3.0D, 0.0D, 3.0D, 13.0D, 16.0D, 4.0D),
	...
	private static final VoxelShape AABB_4 = Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 1.0D, 16.0D, 16.0D);
	private static final VoxelShape AABB_4W = Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 1.0D);
	
	private static final VoxelShape AABB_5N = VoxelShapes.or(Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 1.0D),
			Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 1.0D, 16.0D, 16.0D));
	private static final VoxelShape AABB_5S = VoxelShapes.or(Block.makeCuboidShape(0.0D, 0.0D, 15.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(15.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D));
	private static final VoxelShape AABB_5E = VoxelShapes.or(Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 16.0D, 16.0D, 1.0D),
			Block.makeCuboidShape(15.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D));
	private static final VoxelShape AABB_5W = VoxelShapes.or(Block.makeCuboidShape(0.0D, 0.0D, 15.0D, 16.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 1.0D, 16.0D, 16.0D));
	
	private static final VoxelShape AABB_6 = Block.makeCuboidShape(15.0D, 0.0D, 0.0D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape AABB_6E = Block.makeCuboidShape(0.0D, 0.0D, 15.0D, 16.0D, 16.0D, 16.0D);

	private static final VoxelShape AABB_7 = VoxelShapes.or(Block.makeCuboidShape(13.0D, 0.0D, 15.0D, 16.0D, 16.0D, 16.0D),
	...
	private static final VoxelShape AABB_8 = Block.makeCuboidShape(0.0D, 0.0D, 15.0D, 16.0D, 16.0D, 16.0D);
	private static final VoxelShape AABB_8S = Block.makeCuboidShape(0.0D, 0.0D, 0.0D, 1.0D, 16.0D, 16.0D);
	
	private static final VoxelShape AABB_9 = VoxelShapes.or(Block.makeCuboidShape(0.0D, 0.0D, 15.0D, 3.0D, 16.0D, 16.0D),
			Block.makeCuboidShape(3.0D, 0.0D, 12.0D, 13.0D, 16.0D, 13.0D),
	...
	private static final VoxelShape BOTTOM_1 = VoxelShapes.or(AABB_1, BOT_BASE);
	private static final VoxelShape BOTTOM_2 = VoxelShapes.or(AABB_2, BOT_BASE);
	private static final VoxelShape BOTTOM_2N = VoxelShapes.or(AABB_2N, BOT_BASE);
	private static final VoxelShape BOTTOM_3 = VoxelShapes.or(AABB_3, BOT_BASE);
	private static final VoxelShape BOTTOM_4 = VoxelShapes.or(AABB_4, BOT_BASE);
	private static final VoxelShape BOTTOM_4W = VoxelShapes.or(AABB_4W, BOT_BASE);
	private static final VoxelShape BOTTOM_5N = VoxelShapes.or(AABB_5N, BOT_BASE);
	private static final VoxelShape BOTTOM_5S = VoxelShapes.or(AABB_5S, BOT_BASE);
	private static final VoxelShape BOTTOM_5E = VoxelShapes.or(AABB_5E, BOT_BASE);
	private static final VoxelShape BOTTOM_5W = VoxelShapes.or(AABB_5W, BOT_BASE);
	private static final VoxelShape BOTTOM_6 = VoxelShapes.or(AABB_6, BOT_BASE);
	private static final VoxelShape BOTTOM_6E = VoxelShapes.or(AABB_6E, BOT_BASE);
	private static final VoxelShape BOTTOM_7 = VoxelShapes.or(AABB_7, BOT_BASE);
	private static final VoxelShape BOTTOM_8 = VoxelShapes.or(AABB_8, BOT_BASE);
	private static final VoxelShape BOTTOM_8S = VoxelShapes.or(AABB_8S, BOT_BASE);
	private static final VoxelShape BOTTOM_9 = VoxelShapes.or(AABB_9, BOT_BASE);
	
	public Ami_Shikake(Block.Properties props) {
		super(props);
		/** Default state **/
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (stage == 5) {
			...
			if (hItem == Items_Teatime.SHIKAKE_AMI) { return ActionResultType.FAIL; }
			
			if (hItem != Items_Teatime.SHIKAKE_AMI && hItem != Items.STRING && hItem != Items_Seasonal.ORIITO) {
