...
public class Hamaguri extends Regi_Name {
	/* Collision */
	private static final AxisAlignedBB AABB_BOX = new AxisAlignedBB(0.3125D, 0.0D, 0.3125D, 0.6875D, 0.125D, 0.6875D);
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> blockTip, ITooltipFlag advanced) {
		blockTip.add(I18n.format("tips.item_chestnut.name"));
	}
}
