...
public class Hamaguri extends Abstract_WaterLogged {
	/* Collision */
	private static final VoxelShape AABB_BOX = Block.makeCuboidShape(5.0D, 0.0D, 5.0D, 11.0D, 2.0D, 11.0D);
	
	public Hamaguri(Block.Properties props) {
		super(props);
		/** Default state **/
	...
	private void dropHamaguri(ServerWorld worldIn, BlockPos pos) {
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.item_chestnut").applyTextStyle(TextFormatting.GRAY));
	}
}
