...
public class Sakura_me extends CropBlock {
	/* Collision */
	private static final VoxelShape[] SHAPES = new VoxelShape[]{ Block.box(5.0D, 0.0D, 5.0D, 11.0D, 3.0D, 11.0D),
	...
	public Sakura_me(BlockBehaviour.Properties props) {
		super(props);
	}
	...
	public ItemStack getCloneItemStack(BlockGetter worldIn, BlockPos pos, BlockState state) {
		return new ItemStack(Items_Teatime.SEEDS_CHERRY.get());
	}
}
