...
public class Sakura_me extends CropsBlock {
	/* Collision */
	private static final VoxelShape[] SHAPES = new VoxelShape[]{ Block.box(5.0D, -1.0D, 5.0D, 11.0D, 3.0D, 11.0D),
			...
			Block.box(4.0D, -1.0D, 4.0D, 12.0D, 12.0D, 12.0D),
			Block.box(3.0D, -1.0D, 3.0D, 13.0D, 12.0D, 13.0D),
			Block.box(2.0D, -1.0D, 2.0D, 13.0D, 14.0D, 14.0D),
			Block.box(1.0D, -1.0D, 1.0D, 15.0D, 15.0D, 15.0D) };

	public Sakura_me(AbstractBlock.Properties props) {
		super(props);
	}
