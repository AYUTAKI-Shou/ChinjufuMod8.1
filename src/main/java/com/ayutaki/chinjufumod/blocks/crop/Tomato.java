...
public class Tomato extends CropBlock {
	...
	private static final VoxelShape[] SHAPES = new VoxelShape[]{ Block.box(1.0D, -1.0D, 1.0D, 15.0D, 1.0D, 15.0D),
			...
			Block.box(1.0D, -1.0D, 1.0D, 15.0D, 7.5D, 15.0D),
			Block.box(1.0D, -1.0D, 1.0D, 15.0D, 10.0D, 15.0D),
			Block.box(1.0D, -1.0D, 1.0D, 15.0D, 10.5D, 15.0D),
			Block.box(1.0D, -1.0D, 1.0D, 15.0D, 11.0D, 15.0D),
			Block.box(1.0D, -1.0D, 1.0D, 15.0D, 11.0D, 15.0D) };

	public Tomato(BlockBehaviour.Properties props) {
		super(props);
	}
	...
	public ItemStack getCloneItemStack(LevelReader worldIn, BlockPos pos, BlockState state) {
		return new ItemStack(Items_Teatime.SEEDS_TOMATO.get());
	}
}
