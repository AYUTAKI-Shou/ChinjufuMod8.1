...
public class Tomato extends BaseFarmCrop {
	...
	private static final AxisAlignedBB[] CROPS_AABB = new AxisAlignedBB[] { new AxisAlignedBB(0.0D * cw, -1.0D * cw, 0.0D * cw, 16.0D * cw, 1.0D * cw, 16.0D * cw),
			...
			new AxisAlignedBB(1.0D * cw, -1.0D * cw, 1.0D * cw, 15.0D * cw, 5.0D * cw, 15.0D * cw),
			new AxisAlignedBB(1.0D * cw, -1.0D * cw, 1.0D * cw, 15.0D * cw, 7.5D * cw, 15.0D * cw),
			new AxisAlignedBB(1.0D * cw, -1.0D * cw, 1.0D * cw, 15.0D * cw, 10.0D * cw, 15.0D * cw),
			new AxisAlignedBB(1.0D * cw, -1.0D * cw, 1.0D * cw, 15.0D * cw, 10.5D * cw, 15.0D * cw),
			new AxisAlignedBB(1.0D * cw, -1.0D * cw, 1.0D * cw, 15.0D * cw, 11.0D * cw, 15.0D * cw),
			new AxisAlignedBB(1.0D * cw, -1.0D * cw, 1.0D * cw, 15.0D * cw, 11.0D * cw, 15.0D * cw) };
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		stack.add(new ItemStack(Items_Teatime.SEEDS_TOMATO, (age == 7)? i : 1, 0));
		stack.add(new ItemStack(Items_Teatime.FOOD_TOMATO, (age == 7)? 4 : 0, 0));
		return stack;
	}

	@Override
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		return new ItemStack(Items_Teatime.SEEDS_TOMATO, 1, 0);
	}
}
