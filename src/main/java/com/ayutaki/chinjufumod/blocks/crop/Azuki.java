...
public class Azuki extends CropsBlock {
	/* Collision */
	private static final VoxelShape[] SHAPES = new VoxelShape[]{ Block.makeCuboidShape(1.0D, -1.0D, 1.0D, 15.0D, 1.0D, 15.0D),
	...
	public Azuki(Block.Properties props) {
		super(props);
	}
	...
	/* Clone Item in Creative. ...13 */
	@Override
	protected IItemProvider getSeedsItem() {
		return Items_Teatime.SEEDS_AZUKI;
	}
}
