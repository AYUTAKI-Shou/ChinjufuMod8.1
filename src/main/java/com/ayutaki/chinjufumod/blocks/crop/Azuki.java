...
public class Azuki extends BaseFarmCrop {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		stack.add(new ItemStack(Items_Teatime.SEEDS_AZUKI, (age == 7)? i : 1, 0));
		stack.add(new ItemStack(Items_Teatime.SEEDS_AZUKI, (age == 7)? 2 : 0, 0));
		return stack;
	}

	@Override
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		return new ItemStack(Items_Teatime.SEEDS_AZUKI, 1, 0);
	}
}
