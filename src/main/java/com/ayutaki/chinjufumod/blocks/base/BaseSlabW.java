...
public abstract class BaseSlabW extends Regi_addState {
	...
	public BaseSlabW(String name) {
		...
		setLightOpacity(2);
		/** Default state **/
		setDefaultState(this.blockState.getBaseState().withProperty(DOUBLE, Boolean.valueOf(false))
