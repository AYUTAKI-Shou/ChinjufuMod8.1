...
public class XmasTree extends Abstract_WaterLogged {
	...
	/* Collision */
	private static final VoxelShape AABB_BOT = VoxelShapes.or(Block.makeCuboidShape(1.5D, 12.0D, 1.5D, 14.5D, 16.0D, 14.5D),
	...
	private static final VoxelShape AABB_TOP = VoxelShapes.or(Block.makeCuboidShape(6.0D, 8.0D, 6.0D, 10.0D, 12.0D, 10.0D),
			Block.makeCuboidShape(4.5D, 4.0D, 4.5D, 11.5D, 8.0D, 11.5D),
			Block.makeCuboidShape(3.0D, 0.0D, 3.0D, 13.0D, 4.0D, 13.0D));

	public XmasTree(Block.Properties props) {
		super(props);
		/** Default state **/
