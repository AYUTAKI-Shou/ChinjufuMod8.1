...
public class Kadomatsu extends Abstract_WaterLogged {
	/* Property */
	public static final EnumProperty<DoubleBlockHalf> HALF = BlockStateProperties.DOUBLE_BLOCK_HALF;
	public static final DirectionProperty H_FACING = BlockStateProperties.HORIZONTAL_FACING;

	/* Collision */
	private static final VoxelShape AABB_BOT = Block.makeCuboidShape(3.5D, 0.0D, 3.5D, 12.5D, 16.0D, 12.5D);
	private static final VoxelShape AABB_TOP = Block.makeCuboidShape(3.5D, 0.0D, 3.5D, 12.5D, 14.0D, 12.5D);

	public Kadomatsu(Block.Properties props) {
		super(props);
		/** Default state **/
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_kadomatsu").applyTextStyle(TextFormatting.GRAY));
	}
}
