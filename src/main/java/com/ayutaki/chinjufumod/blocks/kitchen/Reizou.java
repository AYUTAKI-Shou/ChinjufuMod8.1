...
public class Reizou extends AbstractReizou<Reizou_TileEntity> {
	...
	public Reizou(AbstractBlock.Properties props, Supplier<TileEntityType<? extends Reizou_TileEntity>> entityType) {
	...
	public void neighborChanged(BlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos newPos, boolean t_f) {
	...
	public void setPlacedBy(World worldIn, BlockPos pos, BlockState state, LivingEntity entity, ItemStack stack) {
		...
		if (stack.hasCustomHoverName()) {
			...
			TileEntity upEntity = worldIn.getBlockEntity(pos.above());
			if (upEntity instanceof ReizouTop_TileEntity) {
				((ReizouTop_TileEntity)upEntity).setCustomName(stack.getHoverName());
			}
		}
	}
