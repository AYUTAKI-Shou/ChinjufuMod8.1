...
public class Kit_Cooktop extends Abstract_WaterLogged {
	/* Property */
	...
	public Kit_Cooktop(Block.Properties props) {
		super(props);
		/** Default state **/
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_kit_stove").applyTextStyle(TextFormatting.GRAY));
	}
}
