...
public class Kit_TanaSara_A extends BaseKit_Tana2Stage {

	public Kit_TanaSara_A(String name) {
		super(name);
	}
			...
			if (hStack.isEmpty()) {
				...
				if (i == 1) {
					worldIn.setBlockState(pos, Kitchen_Blocks.KIT_SARA1.getDefaultState()
							...
							.withProperty(Kit_TanaSara_1.STAGE_1_4, Integer.valueOf(4))); }
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		stack.add(new ItemStack(Items_Teatime.Item_SARA, i + 4, 0));
