...
public class Tansu extends BlockContainer {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		stack.add(new ItemStack(Items_Chinjufu.TANSU, 1, cloneMeta()));
		return stack;
	}

	@Override
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		return new ItemStack(Items_Chinjufu.TANSU, 1, cloneMeta());
	}
	
	private int cloneMeta() {
		if (this == Furniture_Blocks.TANSU_OAK) { return 0; }
		if (this == Furniture_Blocks.TANSU_SPRUCE) { return 1; }
		if (this == Furniture_Blocks.TANSU_BIRCH) { return 2; }
		if (this == Furniture_Blocks.TANSU_JUNGLE) { return 3; }
		if (this == Furniture_Blocks.TANSU_ACACIA) { return 4; }
		if (this == Furniture_Blocks.TANSU_DOAK) { return 5; }
		if (this == Furniture_Blocks.TANSU_SAKURA) { return 6; }
		if (this == Furniture_Blocks.TANSU_KAEDE) { return 7; }
		else { return 8; }
	}
}
