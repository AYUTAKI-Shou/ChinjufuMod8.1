...
public class LightEmbed extends Abstract_WaterLogged {
	...
	/* Collision */
	private static final VoxelShape AABB_1 = Block.makeCuboidShape(1.0D, 15.0D, 1.0D, 15.0D, 19.5D, 15.0D);
	private static final VoxelShape AABB_2 = Block.makeCuboidShape(1.0D, 15.0D, 1.0D, 15.0D, 24.0D, 15.0D);
	private static final VoxelShape AABB_3 = Block.makeCuboidShape(1.0D, -8.0D, 1.0D, 15.0D, 1.0D, 15.0D);
	private static final VoxelShape AABB_4 = Block.makeCuboidShape(1.0D, -3.5D, 1.0D, 15.0D, 1.0D, 15.0D);

	public LightEmbed(Block.Properties props) {
		super(props);
		/** Default state **/
