...
public class Kamoi_Kaede extends Base_Kamoi {
	...
	public Kamoi_Kaede(String name) {
		super(name);
	}
	...
	private Block takeWood(Item hItem, int k) {
		if (hItem == new ItemStack(Blocks.WOODEN_SLAB).getItem()) {
			...
			if (k == 0) { return KamoiPlanks_Blocks.KAMOI_oak_kaede; }
			if (k == 1) { return KamoiPlanks_Blocks.KAMOI_spru_kaede; }
			if (k == 2) { return KamoiPlanks_Blocks.KAMOI_bir_kaede; }
			if (k == 3) { return KamoiPlanks_Blocks.KAMOI_jun_kaede; }
			if (k == 4) { return KamoiPlanks_Blocks.KAMOI_aca_kaede; }
			else { return KamoiPlanks_Blocks.KAMOI_doak_kaede; } }
