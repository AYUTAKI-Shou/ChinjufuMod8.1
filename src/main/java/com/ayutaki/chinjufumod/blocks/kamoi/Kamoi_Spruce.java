...
public class Kamoi_Spruce extends Base_Kamoi {
	...
	private Block takeWood (Item hItem) {
		...
		if (hItem == Items.MANGROVE_SLAB) { return KamoiPlanks_Blocks.KAMOI_mangrove_spru.get(); }
		if (hItem == Items.CHERRY_SLAB) { return KamoiPlanks_Blocks.KAMOI_cherry_spru.get(); }
		if (hItem == Items.PALE_OAK_SLAB) { return KamoiPlanks_Blocks.KAMOI_paleoak_spru.get(); }
