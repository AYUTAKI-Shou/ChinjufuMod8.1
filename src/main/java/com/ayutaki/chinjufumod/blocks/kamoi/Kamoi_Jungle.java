...
public class Kamoi_Jungle extends Base_Kamoi {
	...
	public Kamoi_Jungle(String name) {
		super(name);
	}
	...
	private Block takeWood(Item hItem, int k) {
		if (hItem == new ItemStack(Blocks.WOODEN_SLAB).getItem()) {
			...
			if (k == 0) { return KamoiPlanks_Blocks.KAMOI_oak_jun; }
			if (k == 1) { return KamoiPlanks_Blocks.KAMOI_spru_jun; }
			if (k == 2) { return KamoiPlanks_Blocks.KAMOI_bir_jun; }
			if (k == 3) { return KamoiPlanks_Blocks.KAMOI_jun_jun; }
			if (k == 4) { return KamoiPlanks_Blocks.KAMOI_aca_jun; }
			else { return KamoiPlanks_Blocks.KAMOI_doak_jun; } }
