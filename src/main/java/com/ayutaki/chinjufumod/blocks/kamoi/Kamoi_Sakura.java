...
public class Kamoi_Sakura extends Base_Kamoi {
	...
	public Kamoi_Sakura(String name) {
		super(name);
	}
	...
	private Block takeWood(Item hItem, int k) {
		if (hItem == new ItemStack(Blocks.WOODEN_SLAB).getItem()) {
			...
			if (k == 0) { return KamoiPlanks_Blocks.KAMOI_oak_sakura; }
			if (k == 1) { return KamoiPlanks_Blocks.KAMOI_spru_sakura; }
			if (k == 2) { return KamoiPlanks_Blocks.KAMOI_bir_sakura; }
			if (k == 3) { return KamoiPlanks_Blocks.KAMOI_jun_sakura; }
			if (k == 4) { return KamoiPlanks_Blocks.KAMOI_aca_sakura; }
			else { return KamoiPlanks_Blocks.KAMOI_doak_sakura; } }
