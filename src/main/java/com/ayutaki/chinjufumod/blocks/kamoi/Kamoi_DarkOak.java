...
public class Kamoi_DarkOak extends Base_Kamoi {
	...
	public Kamoi_DarkOak(String name) {
		super(name);
	}
	...
	private Block takeWood(Item hItem, int k) {
		if (hItem == new ItemStack(Blocks.WOODEN_SLAB).getItem()) {
			...
			if (k == 0) { return KamoiPlanks_Blocks.KAMOI_oak_doak; }
			if (k == 1) { return KamoiPlanks_Blocks.KAMOI_spru_doak; }
			if (k == 2) { return KamoiPlanks_Blocks.KAMOI_bir_doak; }
			if (k == 3) { return KamoiPlanks_Blocks.KAMOI_jun_doak; }
			if (k == 4) { return KamoiPlanks_Blocks.KAMOI_aca_doak; }
			else { return KamoiPlanks_Blocks.KAMOI_doak_doak; } }
