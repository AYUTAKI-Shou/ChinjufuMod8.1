...
public class Carpet_CM extends Block {
	public static final MapCodec<Carpet_CM> CODEC = simpleCodec(Carpet_CM::new);
	@Override
	public MapCodec<? extends Carpet_CM> codec() { return CODEC; }
	
	/* Property */
	private static final VoxelShape AABB_BOX = Block.box(0.0D, 0.0D, 0.0D, 16.0D, 0.5D, 16.0D);
	
	public Carpet_CM(BlockBehaviour.Properties props) {
		super(props);
	}
