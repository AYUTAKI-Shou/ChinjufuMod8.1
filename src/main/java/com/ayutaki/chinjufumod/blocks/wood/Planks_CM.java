...
public class Planks_CM extends Regi_addState {
	/** 1=サクラ, 2=カエデ, 3=イチョウ **/
	...
	private Item cloneItem(IBlockState state) {
		...
		if (i == 2) { return Items_Seasonal.PLANKS_kaede; }
		if (i == 3) { return Items_Seasonal.PLANKS_ichoh; }
		return Items_Seasonal.PLANKS_sakura;
	}
}
