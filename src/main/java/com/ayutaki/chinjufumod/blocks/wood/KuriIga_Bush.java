...
public class KuriIga_Bush extends BushBlock {
	public static final MapCodec<KuriIga_Bush> CODEC = simpleCodec(KuriIga_Bush::new);
	@Override
	public MapCodec<? extends KuriIga_Bush> codec() { return CODEC; }
	
	/* Collision */
	protected static final float AABB_OFFSET = 6.0F;
	private static final VoxelShape AABB_BOX = Block.box(6.0D, -1.0D, 6.0D, 10.0D, 3.5D, 10.0D);

	public KuriIga_Bush(BlockBehaviour.Properties props) {
		super(props);
	}
