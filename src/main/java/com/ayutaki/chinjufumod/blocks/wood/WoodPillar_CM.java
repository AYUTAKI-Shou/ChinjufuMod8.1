...
public class WoodPillar_CM extends RotatedPillarBlock {
	...
	public WoodPillar_CM(BlockBehaviour.Properties props) {
		super(props);
	}
	...
	public ItemStack getCloneItemStack(LevelReader worldIn, BlockPos pos, BlockState state, boolean flag) {
		...
		if (this == WallPanel_Blocks.PILLAR_mangrove.get()) { return new ItemStack(Items_WallPanel.PILLAR_mangrove.get()); }
		if (this == WallPanel_Blocks.PILLAR_cherry.get()) { return new ItemStack(Items_WallPanel.PILLAR_cherry.get()); }
		if (this == WallPanel_Blocks.PILLAR_paleoak.get()) { return new ItemStack(Items_WallPanel.PILLAR_paleoak.get()); }
