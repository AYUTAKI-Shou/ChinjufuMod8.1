...
public class WoodLeaf_Kuri extends Abstract_Harvest implements net.minecraftforge.common.IForgeShearable {
	...
	public WoodLeaf_Kuri(AbstractBlock.Properties props) {
		super(props);
