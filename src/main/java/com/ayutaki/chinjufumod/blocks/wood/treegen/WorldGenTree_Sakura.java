...
public class WorldGenTree_Sakura extends WorldGenAbstractTree {

	private IBlockState blockStateWood = Seasonal_Blocks.SAKURA_log.getDefaultState();
	private IBlockState blockStateLeaves =
			Seasonal_Blocks.SAKURA_flow.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));

	/* 生成される木の高さの最小値 デフォルト4 */
	private final int minTreeHeight = 4;

	public WorldGenTree_Sakura(boolean parShouldNotify) {
