...
public class Suiden extends Abstract_Harvest implements IWaterLoggable {
	...
	public Suiden(AbstractBlock.Properties props) {
		super(props);
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		/** 土壌調整 **/
		if (hItem == Items_Teatime.INEWARA || hItem == Items_Seasonal.WARAHAI || hItem == Items_Seasonal.OCHIBA_carpet || 
				hItem == Items_Seasonal.KAEDE_carpet || hItem == Items.BONE_MEAL) {
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_suiden").withStyle(TextFormatting.GRAY));
	}
}
