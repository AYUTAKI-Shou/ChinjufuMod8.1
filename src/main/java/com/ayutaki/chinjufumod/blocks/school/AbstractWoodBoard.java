...
public abstract class AbstractWoodBoard extends ContainerBlock implements IWaterLoggable {
	/* Property */
	public static final DirectionProperty H_FACING = BlockStateProperties.HORIZONTAL_FACING;
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;
	
	protected AbstractWoodBoard(AbstractBlock.Properties props) {
		super(props);
	...
	public TileEntity newBlockEntity(IBlockReader world) {
		return new WoodBoard_TileEntity();
	}
	...
	public BlockState updateShape(BlockState state, Direction facing, BlockState newState, IWorld worldIn, BlockPos pos, BlockPos newPos) {
		...
		return facing.getOpposite() == state.getValue(H_FACING) && !state.canSurvive(worldIn, pos) ? Blocks.AIR
