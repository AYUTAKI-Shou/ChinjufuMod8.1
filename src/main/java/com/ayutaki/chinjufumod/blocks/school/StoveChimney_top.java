...
public class StoveChimney_top extends BaseWaterLogged {
	/* Collision */
	private static final VoxelShape AABB_BOX = VoxelShapes.or(Block.makeCuboidShape(7.0D, 15.0D, 7.0D, 9.0D, 16.0D, 9.0D),
	...
	public StoveChimney_top(Block.Properties props) {
		super(props);
	}
