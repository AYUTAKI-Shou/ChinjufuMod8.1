...
public class CStove_top extends BlockContainer {
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) {
		...
		if (active) {
			worldIn.setBlockState(pos, School_Blocks.LIT_CSTOVE_top.getDefaultState().withProperty(H_FACING, state.getValue(H_FACING)), 3);
			worldIn.setBlockState(pos, School_Blocks.LIT_CSTOVE_top.getDefaultState().withProperty(H_FACING, state.getValue(H_FACING)), 3); }
		
		else {
			worldIn.setBlockState(pos, School_Blocks.CSTOVE_top.getDefaultState().withProperty(H_FACING, state.getValue(H_FACING)), 3);
			worldIn.setBlockState(pos, School_Blocks.CSTOVE_top.getDefaultState().withProperty(H_FACING, state.getValue(H_FACING)), 3); }
