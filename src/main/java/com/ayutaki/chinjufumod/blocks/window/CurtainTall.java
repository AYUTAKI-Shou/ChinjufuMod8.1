...
public class CurtainTall extends Regi_addState {
	/* Property */
	...
	/* Collision */
	private static final AxisAlignedBB AABB_SOUTH = CollisionHelper.getBlockBounds(EnumFacing.SOUTH, 0.9375, 0.0, 0.0, 1.0, 1.0, 1.0);
	private static final AxisAlignedBB AABB_EAST = CollisionHelper.getBlockBounds(EnumFacing.EAST, 0.9375, 0.0, 0.0, 1.0, 1.0, 1.0);
	private static final AxisAlignedBB AABB_WEST = CollisionHelper.getBlockBounds(EnumFacing.WEST, 0.9375, 0.0, 0.0, 1.0, 1.0, 1.0);
	private static final AxisAlignedBB AABB_NORTH = CollisionHelper.getBlockBounds(EnumFacing.NORTH, 0.9375, 0.0, 0.0, 1.0, 1.0, 1.0);

	private static final AxisAlignedBB AABB_OR_SOUTH = CollisionHelper.getBlockBounds(EnumFacing.SOUTH, 0.86875, 0.0, 0.875, 1.0, 1.0, 1.0);
	private static final AxisAlignedBB AABB_OR_EAST = CollisionHelper.getBlockBounds(EnumFacing.EAST, 0.86875, 0.0, 0.875, 1.0, 1.0, 1.0);
	private static final AxisAlignedBB AABB_OR_WEST = CollisionHelper.getBlockBounds(EnumFacing.WEST, 0.86875, 0.0, 0.875, 1.0, 1.0, 1.0);
	private static final AxisAlignedBB AABB_OR_NORTH = CollisionHelper.getBlockBounds(EnumFacing.NORTH, 0.86875, 0.0, 0.875, 1.0, 1.0, 1.0);

	private static final AxisAlignedBB AABB_OL_SOUTH = CollisionHelper.getBlockBounds(EnumFacing.SOUTH, 0.86875, 0.0, 0.0, 1.0, 1.0, 0.125);
	private static final AxisAlignedBB AABB_OL_EAST = CollisionHelper.getBlockBounds(EnumFacing.EAST, 0.86875, 0.0, 0.0, 1.0, 1.0, 0.125);
	private static final AxisAlignedBB AABB_OL_WEST = CollisionHelper.getBlockBounds(EnumFacing.WEST, 0.86875, 0.0, 0.0, 1.0, 1.0, 0.125);
	private static final AxisAlignedBB AABB_OL_NORTH = CollisionHelper.getBlockBounds(EnumFacing.NORTH, 0.86875, 0.0, 0.0, 1.0, 1.0, 0.125);
	...
	private Item cloneItem(IBlockState state) {
		...
		else { return Items_Chinjufu.CURTAINTALL_item; }
	}
	
	private int cloneMeta(IBlockState state) {
		if (state.getValue(HALF) == HalfState.UPPER) { return 0; }
		else {
			if (this == Window_Blocks.CURTAINTALL_white) { return 0; }
			if (this == Window_Blocks.CURTAINTALL_orange) { return 1; }
			if (this == Window_Blocks.CURTAINTALL_magenta) { return 2; }
			if (this == Window_Blocks.CURTAINTALL_lightblue) { return 3; }
			if (this == Window_Blocks.CURTAINTALL_yellow) { return 4; }
			if (this == Window_Blocks.CURTAINTALL_lime) { return 5; }
			if (this == Window_Blocks.CURTAINTALL_pink) { return 6; }
			if (this == Window_Blocks.CURTAINTALL_gray) { return 7; }
			if (this == Window_Blocks.CURTAINTALL_lightgray) { return 8; }
			if (this == Window_Blocks.CURTAINTALL_cyan) { return 9; }
			if (this == Window_Blocks.CURTAINTALL_purple) { return 10; }
			if (this == Window_Blocks.CURTAINTALL_blue) { return 11; }
			if (this == Window_Blocks.CURTAINTALL_brown) { return 12; }
			if (this == Window_Blocks.CURTAINTALL_green) { return 13; }
			if (this == Window_Blocks.CURTAINTALL_red) { return 14; }
			else { return 15; } }
	}
