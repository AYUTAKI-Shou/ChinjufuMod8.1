...
public class CurtainLarge_1 extends BaseCurtainLarge {
	...
	private static final AxisAlignedBB RAIL_NORTH = CollisionHelper.getBlockBounds(EnumFacing.NORTH, 0.953125, 0.953125, 0.0, 1.0, 1.0, 1.0);
	private static final AxisAlignedBB RAIL_EAST = CollisionHelper.getBlockBounds(EnumFacing.EAST, 0.953125, 0.953125, 0.0, 1.0, 1.0, 1.0);
	private static final AxisAlignedBB RAIL_SOUTH = CollisionHelper.getBlockBounds(EnumFacing.SOUTH, 0.953125, 0.953125, 0.0, 1.0, 1.0, 1.0);
	private static final AxisAlignedBB RAIL_WEST = CollisionHelper.getBlockBounds(EnumFacing.WEST, 0.953125, 0.953125, 0.0, 1.0, 1.0, 1.0);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		// if (hItem instanceof Base_ItemHake) { return false; } Too Complex.
		...
		if (half == HalfState.LOWER) {
			...
			IBlockState blockState2 = takeBlock2().getDefaultState().withProperty(H_FACING, direction).withProperty(OPEN, Boolean.valueOf(flag));
			...
			IBlockState blockState2 = takeBlock2().getDefaultState().withProperty(H_FACING, dDirection).withProperty(OPEN, Boolean.valueOf(flag));
