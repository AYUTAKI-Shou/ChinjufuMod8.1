...
public class BaseCurtainLarge extends Regi_addState {
	/* Property */
	...
	private Item cloneItem(IBlockState state) {
		...
		else { return Items_Chinjufu.CURTAINL1_item; }
	}
	...
	private int cloneMeta(IBlockState state) {
		if (state.getValue(HALF) == HalfState.UPPER) { return 0; }
			...
			if (this == Window_Blocks.CURTAINL1_white || this == Window_Blocks.CURTAINL2_white) { return 0; }
			if (this == Window_Blocks.CURTAINL1_orange || this == Window_Blocks.CURTAINL2_orange) { return 1; }
			if (this == Window_Blocks.CURTAINL1_magenta || this == Window_Blocks.CURTAINL2_magenta) { return 2; }
			if (this == Window_Blocks.CURTAINL1_lightblue || this == Window_Blocks.CURTAINL2_lightblue) { return 3; }
			if (this == Window_Blocks.CURTAINL1_yellow || this == Window_Blocks.CURTAINL2_yellow) { return 4; }
			if (this == Window_Blocks.CURTAINL1_lime || this == Window_Blocks.CURTAINL2_lime) { return 5; }
			if (this == Window_Blocks.CURTAINL1_pink || this == Window_Blocks.CURTAINL2_pink) { return 6; }
			if (this == Window_Blocks.CURTAINL1_gray || this == Window_Blocks.CURTAINL2_gray) { return 7; }
			if (this == Window_Blocks.CURTAINL1_lightgray || this == Window_Blocks.CURTAINL2_lightgray) { return 8; }
			if (this == Window_Blocks.CURTAINL1_cyan || this == Window_Blocks.CURTAINL2_cyan) { return 9; }
			if (this == Window_Blocks.CURTAINL1_purple || this == Window_Blocks.CURTAINL2_purple) { return 10; }
			if (this == Window_Blocks.CURTAINL1_blue || this == Window_Blocks.CURTAINL2_blue) { return 11; }
			if (this == Window_Blocks.CURTAINL1_brown || this == Window_Blocks.CURTAINL2_brown) { return 12; }
			if (this == Window_Blocks.CURTAINL1_green || this == Window_Blocks.CURTAINL2_green) { return 13; }
			if (this == Window_Blocks.CURTAINL1_red || this == Window_Blocks.CURTAINL2_red) { return 14; }
			else { return 15; } }
	}
