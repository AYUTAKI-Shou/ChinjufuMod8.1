...
public class WindowTall extends Regi_addState {
	/* Property */
	...
	/* Collision */
	private static final AxisAlignedBB SOUTH_AABB_CLOSE = CollisionHelper.getBlockBounds(EnumFacing.SOUTH, 0.4375, 0.0, 0.0, 0.5625, 1.0, 1.0);
	private static final AxisAlignedBB EAST_AABB_CLOSE = CollisionHelper.getBlockBounds(EnumFacing.EAST, 0.4375, 0.0, 0.0, 0.5625, 1.0, 1.0);
	private static final AxisAlignedBB WEST_AABB_CLOSE = CollisionHelper.getBlockBounds(EnumFacing.WEST, 0.4375, 0.0, 0.0, 0.5625, 1.0, 1.0);
	private static final AxisAlignedBB NORTH_AABB_CLOSE = CollisionHelper.getBlockBounds(EnumFacing.NORTH, 0.4375, 0.0, 0.0, 0.5625, 1.0, 1.0);

	private static final AxisAlignedBB SOUTH_AABB_OPEN_R = CollisionHelper.getBlockBounds(EnumFacing.SOUTH, 0.4375, 0.0125, 0.8625, 1.4375, 0.9875, 0.9875);
	private static final AxisAlignedBB EAST_AABB_OPEN_R = CollisionHelper.getBlockBounds(EnumFacing.EAST, 0.4375, 0.0125, 0.8625, 1.4375, 0.9875, 0.9875);
	private static final AxisAlignedBB WEST_AABB_OPEN_R = CollisionHelper.getBlockBounds(EnumFacing.WEST, 0.4375, 0.0125, 0.8625, 1.4375, 0.9875, 0.9875);
	private static final AxisAlignedBB NORTH_AABB_OPEN_R = CollisionHelper.getBlockBounds(EnumFacing.NORTH, 0.4375, 0.0125, 0.8625, 1.4375, 0.9875, 0.9875);

	private static final AxisAlignedBB SOUTH_AABB_OPEN_L = CollisionHelper.getBlockBounds(EnumFacing.SOUTH, 0.4375, 0.0125, 0.0125, 1.4375, 0.9875, 0.1375);
	private static final AxisAlignedBB EAST_AABB_OPEN_L = CollisionHelper.getBlockBounds(EnumFacing.EAST, 0.4375, 0.0125, 0.0125, 1.4375, 0.9875, 0.1375);
	private static final AxisAlignedBB WEST_AABB_OPEN_L = CollisionHelper.getBlockBounds(EnumFacing.WEST, 0.4375, 0.0125, 0.0125, 1.4375, 0.9875, 0.1375);
	private static final AxisAlignedBB NORTH_AABB_OPEN_L = CollisionHelper.getBlockBounds(EnumFacing.NORTH, 0.4375, 0.0125, 0.0125, 1.4375, 0.9875, 0.1375);
	...
	private Item cloneItem(IBlockState state) {
		...
		else { return Items_Chinjufu.WINDOWTALL_item; }
	}
	
	private int cloneMeta(IBlockState state) {
		if (state.getValue(HALF) == HalfState.UPPER) { return 0; }
		else {
			if (this == Window_Blocks.WINDOWTALL_oak) { return 0; }
			if (this == Window_Blocks.WINDOWTALL_spruce) { return 1; }
			if (this == Window_Blocks.WINDOWTALL_birch) { return 2; }
			if (this == Window_Blocks.WINDOWTALL_jungle) { return 3; }
			if (this == Window_Blocks.WINDOWTALL_acacia) { return 4; }
			if (this == Window_Blocks.WINDOWTALL_darkoak) { return 5; }
			if (this == Window_Blocks.WINDOWTALL_sakura) { return 6; }
			if (this == Window_Blocks.WINDOWTALL_kaede) { return 7; }
			else { return 8; } }
	}
