...
public class WindowTall extends Abstract_WaterLogged {
	...
	private static final VoxelShape CLOSEB_SOUTH = VoxelShapes.or(FRAME_SOUTH, Block.makeCuboidShape(0.0D, 0.0D, 7.0D, 16.0D, 16.0D, 9.0D));
	private static final VoxelShape CLOSEB_WEST = VoxelShapes.or(FRAME_WEST, Block.makeCuboidShape(7.0D, 0.0D, 0.0D, 9.0D, 16.0D, 16.0D));
	private static final VoxelShape CLOSEB_NORTH = VoxelShapes.or(FRAME_NORTH, Block.makeCuboidShape(0.0D, 0.0D, 7.0D, 16.0D, 16.0D, 9.0D));
	private static final VoxelShape CLOSEB_EAST = VoxelShapes.or(FRAME_EAST, Block.makeCuboidShape(7.0D, 0.0D, 0.0D, 9.0D, 16.0D, 16.0D));
	
	private static final VoxelShape OPENBR_SOUTH = VoxelShapes.or(FRAME_SOUTH, Block.makeCuboidShape(13.8D, 0.0D, 7.0D, 15.8D, 16.0D, 23.0D));
	private static final VoxelShape OPENBR_WEST = VoxelShapes.or(FRAME_WEST, Block.makeCuboidShape(-7.0D, 0.0D, 13.8D, 9.0D, 16.0D, 15.8D));
	private static final VoxelShape OPENBR_NORTH = VoxelShapes.or(FRAME_NORTH, Block.makeCuboidShape(0.2D, 0.0D, -7.0D, 2.2D, 16.0D, 9.0D));
	private static final VoxelShape OPENBR_EAST = VoxelShapes.or(FRAME_EAST, Block.makeCuboidShape(7.0D, 0.0D, 0.2D, 23.0D, 16.0D, 2.2D));

	private static final VoxelShape OPENBL_SOUTH = VoxelShapes.or(FRAME_SOUTH, Block.makeCuboidShape(0.2D, 0.0D, 7.0D, 2.2D, 16.0D, 23.0D));
	private static final VoxelShape OPENBL_WEST = VoxelShapes.or(FRAME_WEST, Block.makeCuboidShape(-7.0D, 0.0D, 0.2D, 9.0D, 16.0D, 2.2D));
	private static final VoxelShape OPENBL_NORTH = VoxelShapes.or(FRAME_NORTH, Block.makeCuboidShape(13.8D, 0.0D, -7.0D, 15.8D, 16.0D, 9.0D));
	private static final VoxelShape OPENBL_EAST = VoxelShapes.or(FRAME_EAST, Block.makeCuboidShape(7.0D, 0.0D, 13.8D, 23.0D, 16.0D, 15.8D));
	
	private static final VoxelShape CLOSE_SOUTH = Block.makeCuboidShape(0.0D, 0.0D, 7.0D, 16.0D, 16.0D, 9.0D);
	private static final VoxelShape CLOSE_WEST = Block.makeCuboidShape(7.0D, 0.0D, 0.0D, 9.0D, 16.0D, 16.0D);
	private static final VoxelShape CLOSE_NORTH = Block.makeCuboidShape(0.0D, 0.0D, 7.0D, 16.0D, 16.0D, 9.0D);
	private static final VoxelShape CLOSE_EAST = Block.makeCuboidShape(7.0D, 0.0D, 0.0D, 9.0D, 16.0D, 16.0D);

	private static final VoxelShape OPENR_SOUTH = Block.makeCuboidShape(13.8D, 0.0D, 7.0D, 15.8D, 16.0D, 23.0D);
	private static final VoxelShape OPENR_WEST = Block.makeCuboidShape(-7.0D, 0.0D, 13.8D, 9.0D, 16.0D, 15.8D);
	private static final VoxelShape OPENR_NORTH = Block.makeCuboidShape(0.2D, 0.0D, -7.0D, 2.2D, 16.0D, 9.0D);
	private static final VoxelShape OPENR_EAST = Block.makeCuboidShape(7.0D, 0.0D, 0.2D, 23.0D, 16.0D, 2.2D);

	private static final VoxelShape OPENL_SOUTH = Block.makeCuboidShape(0.2D, 0.0D, 7.0D, 2.2D, 16.0D, 23.0D);
	private static final VoxelShape OPENL_WEST = Block.makeCuboidShape(-7.0D, 0.0D, 0.2D, 9.0D, 16.0D, 2.2D);
	private static final VoxelShape OPENL_NORTH = Block.makeCuboidShape(13.8D, 0.0D, -7.0D, 15.8D, 16.0D, 9.0D);
	private static final VoxelShape OPENL_EAST = Block.makeCuboidShape(7.0D, 0.0D, 13.8D, 23.0D, 16.0D, 15.8D);

	public WindowTall(Block.Properties props) {
		super(props);
		/** Default state **/
