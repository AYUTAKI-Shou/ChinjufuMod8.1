...
public class Stairs_Namako_B extends Base_Stairs_JP {
	...
	public Stairs_Namako_B(BlockState state, Block.Properties props) {
		super(state, props);
	}
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_namako").applyTextStyle(TextFormatting.GRAY));
	}
}
