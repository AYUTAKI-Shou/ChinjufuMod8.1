...
public class Stairs_Namako_B extends Base_Stairs_JP {
	...
	public Stairs_Namako_B(BlockState state, BlockBehaviour.Properties props) {
		super(state, props);
	}

	/* ToolTip */
	public void appendHoverText(ItemStack stack, @Nullable BlockGetter worldIn, List<Component> blockTip, TooltipFlag tipFlag) {
		blockTip.add(new TranslatableComponent("tips.block_namako").withStyle(ChatFormatting.GRAY));
	}
}
