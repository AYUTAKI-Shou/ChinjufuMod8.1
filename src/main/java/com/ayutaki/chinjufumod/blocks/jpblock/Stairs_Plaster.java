...
public class Stairs_Plaster extends Base_Stairs_JP {
	...
	public Stairs_Plaster(BlockState state, Block.Properties props) {
		super(state, props);
	}
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		if (this != JP_Blocks.DIRTWALL_stairs) {
			blockTip.add(new TranslationTextComponent("tips.block_plaster").applyTextStyle(TextFormatting.GRAY)); }
	}
}
