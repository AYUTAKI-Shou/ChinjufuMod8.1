...
public class Base_Wall extends Regi_addState {
	/* Property */
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (hStack.isEmpty() && playerIn.isSneaking()) {
			...
			worldIn.setBlockState(pos, this.takeBlock().getDefaultState()
					...
					.withProperty(Base_Wall.STAGE_0_15, Integer.valueOf(i)));
			return true;
		}
		return false;
	}
	...
	private Block takeBlock() {
		if (this instanceof Wall_PlasterCrash) { return JPBlock_Blocks.SHIKKUI_WALL; }
		if (this instanceof Wall_Namako) { return JPBlock_Blocks.NAMAKO_WALL_CR; }
		if (this instanceof Wall_NamakoCrash) { return JPBlock_Blocks.NAMAKO_WALL; }
		if (this instanceof Wall_NamakoB) { return JPBlock_Blocks.NAMAKOB_WALL_CR; }
		if (this instanceof Wall_NamakoBCrash) { return JPBlock_Blocks.NAMAKOB_WALL; }
		else { return JPBlock_Blocks.SHIKKUI_WALL_CR; }
	}
	...
	private Item cloneItem() {
		if (this instanceof Wall_Namako || this instanceof Wall_NamakoCrash) { return Items_Wablock.NAMAKO_WALL; }
		if (this instanceof Wall_NamakoB || this instanceof Wall_NamakoBCrash) { return Items_Wablock.NAMAKOB_WALL; }
		else { return Items_Wablock.SHIKKUI_WALL; }
	}
}
