...
public class TatamiKaede extends BaseTatamiWood {

	public TatamiKaede(String name) {
		super(name);
	}
	...
	private ItemStack cloneStack(IBlockState state) {
		...
		if (this == JPDeco_Blocks.TATAMI_KAEDE_ew || this == JPDeco_Blocks.TATAMI_KAEDE_ns) { 
		...
		if (this == JPDeco_Blocks.TATAMIY_KAEDE_ew || this == JPDeco_Blocks.TATAMIY_KAEDE_ns) { 
