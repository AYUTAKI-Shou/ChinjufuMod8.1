...
public class TatamiIchoh extends BaseTatamiWood {

	public TatamiIchoh(String name) {
		super(name);
	}
	...
	private ItemStack cloneStack(IBlockState state) {
		...
		if (this == JPDeco_Blocks.TATAMI_ICHOH_ew || this == JPDeco_Blocks.TATAMI_ICHOH_ns) { 
		...
		if (this == JPDeco_Blocks.TATAMIY_ICHOH_ew || this == JPDeco_Blocks.TATAMIY_ICHOH_ns) { 
