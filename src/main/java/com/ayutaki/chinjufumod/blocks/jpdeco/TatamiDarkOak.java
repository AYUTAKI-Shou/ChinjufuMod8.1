...
public class TatamiDarkOak extends BaseTatamiWood {

	public TatamiDarkOak(String name) {
		super(name);
	}
	...
	private ItemStack cloneStack(IBlockState state) {
		...
		if (this == JPDeco_Blocks.TATAMI_DOAK_ew || this == JPDeco_Blocks.TATAMI_DOAK_ns) { 
		...
		if (this == JPDeco_Blocks.TATAMIY_DOAK_ew || this == JPDeco_Blocks.TATAMIY_DOAK_ns) { 
