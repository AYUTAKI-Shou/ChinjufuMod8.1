...
public class TatamiBirch extends BaseTatamiWood {

	public TatamiBirch(String name) {
		super(name);
	}
	...
	private ItemStack cloneStack(IBlockState state) {
		...
		if (this == JPDeco_Blocks.TATAMI_BIRCH_ew || this == JPDeco_Blocks.TATAMI_BIRCH_ns) { 
		...
		if (this == JPDeco_Blocks.TATAMIY_BIRCH_ew || this == JPDeco_Blocks.TATAMIY_BIRCH_ns) { 
