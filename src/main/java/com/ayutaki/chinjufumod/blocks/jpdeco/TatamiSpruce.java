...
public class TatamiSpruce extends BaseTatamiWood {

	public TatamiSpruce(String name) {
		super(name);
	}
	...
	private ItemStack cloneStack(IBlockState state) {
		...
		if (this == JPDeco_Blocks.TATAMI_SPRUCE_ew || this == JPDeco_Blocks.TATAMI_SPRUCE_ns) { 
		...
		if (this == JPDeco_Blocks.TATAMIY_SPRUCE_ew || this == JPDeco_Blocks.TATAMIY_SPRUCE_ns) { 
