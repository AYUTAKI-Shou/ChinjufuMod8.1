...
public class TatamiOak extends BaseTatamiWood {

	public TatamiOak(String name) {
		super(name);
	}
	...
	private ItemStack cloneStack(IBlockState state) {
		...
		if (this == JPDeco_Blocks.TATAMI_OAK_ew || this == JPDeco_Blocks.TATAMI_OAK_ns) { 
		...
		if (this == JPDeco_Blocks.TATAMIY_OAK_ew || this == JPDeco_Blocks.TATAMIY_OAK_ns) { 
