...
public class TatamiAcacia extends BaseTatamiWood {

	public TatamiAcacia(String name) {
		super(name);
	}
	...
	private ItemStack cloneStack(IBlockState state) {
		...
		if (this == JPDeco_Blocks.TATAMI_ACACIA_ew || this == JPDeco_Blocks.TATAMI_ACACIA_ns) { 
		...
		if (this == JPDeco_Blocks.TATAMIY_ACACIA_ew || this == JPDeco_Blocks.TATAMIY_ACACIA_ns) { 
