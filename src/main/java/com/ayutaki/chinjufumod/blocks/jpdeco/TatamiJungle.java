...
public class TatamiJungle extends BaseTatamiWood {

	public TatamiJungle(String name) {
		super(name);
	}
	...
	private ItemStack cloneStack(IBlockState state) {
		...
		if (this == JPDeco_Blocks.TATAMI_JUNGLE_ew || this == JPDeco_Blocks.TATAMI_JUNGLE_ns) { 
		...
		if (this == JPDeco_Blocks.TATAMIY_JUNGLE_ew || this == JPDeco_Blocks.TATAMIY_JUNGLE_ns) { 
