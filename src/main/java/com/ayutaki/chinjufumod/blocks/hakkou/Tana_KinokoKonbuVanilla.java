...
public class Tana_KinokoKonbuVanilla extends BaseTana_Stage05 {
	...
	public Tana_KinokoKonbuVanilla(AbstractBlock.Properties props) {
		super(props);
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		if (this == Hakkou_Blocks.KINOKO_TARU) { blockTip.add(new TranslationTextComponent("tips.block_taru_kinoko").withStyle(TextFormatting.GRAY)); }
		if (this == Hakkou_Blocks.KONBU_TARU) { blockTip.add(new TranslationTextComponent("tips.block_taru_konbu").withStyle(TextFormatting.GRAY)); }
		if (this == Hakkou_Blocks.VANILLA_TARU) { blockTip.add(new TranslationTextComponent("tips.block_taru_vanilla").withStyle(TextFormatting.GRAY)); }
	}
}
