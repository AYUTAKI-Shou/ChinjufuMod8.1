...
public class TaruF_ShouyuKomezu extends BaseTaru_Stage08 {
	...
	public TaruF_ShouyuKomezu(Block.Properties props) {
		super(props);
	}
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		if (this == Hakkou_Blocks.SHOUYU_TARU) { blockTip.add(new TranslationTextComponent("tips.block_taru_shouyu").applyTextStyle(TextFormatting.GRAY)); }
		if (this == Hakkou_Blocks.KOMEZU_TARU) { blockTip.add(new TranslationTextComponent("tips.block_taru_komezu").applyTextStyle(TextFormatting.GRAY)); }
	}
}
