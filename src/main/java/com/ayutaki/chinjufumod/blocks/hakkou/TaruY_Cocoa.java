...
public class TaruY_Cocoa extends Regi_BlockLog {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		if (i == 1) {
			if (hItem == Items.BOWL) {
				...
				CMEvents.changeDish_seSnowB(worldIn, pos, playerIn, hand, Items_Seasonal.COCOA_F, 0);
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> blockTip, ITooltipFlag advanced) {
		blockTip.add(I18n.format("tips.block_taru_cocoa.name"));
	}
}
