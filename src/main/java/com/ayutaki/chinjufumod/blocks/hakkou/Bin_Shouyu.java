...
public class Bin_Shouyu extends BaseStage4_Face {
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		if (i == 1) { stack.add(new ItemStack(Items_Teatime.SHOUYU_bot_14, 1, 0)); }
		if (i == 2) { stack.add(new ItemStack(Items_NoTab.SHOUYU_bot_24, 1, 0)); }
		if (i == 3) { stack.add(new ItemStack(Items_NoTab.SHOUYU_bot_34, 1, 0)); }
		if (i == 4) { stack.add(new ItemStack(Items_NoTab.SHOUYU_bot_44, 1, 0)); }
		return stack;
	}

	@Override
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		return new ItemStack(Items_Teatime.SHOUYU_bot_14, 1, 0);
	}
}
