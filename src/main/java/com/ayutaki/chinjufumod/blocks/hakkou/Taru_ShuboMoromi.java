...
public class Taru_ShuboMoromi extends BaseTaru_Stage05 {
	...
	public Taru_ShuboMoromi(AbstractBlock.Properties props) {
		super(props);
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		if (this == Hakkou_Blocks.SHUBO_TARU) { blockTip.add(new TranslationTextComponent("tips.block_taru_shubo").withStyle(TextFormatting.GRAY)); }
		if (this == Hakkou_Blocks.MOROMI_TARU) { blockTip.add(new TranslationTextComponent("tips.block_taru_moromi").withStyle(TextFormatting.GRAY)); }
	}
}
