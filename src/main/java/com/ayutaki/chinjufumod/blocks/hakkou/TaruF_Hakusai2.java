...
public class TaruF_Hakusai2 extends Abstract_WaterLogged {
	...
	public TaruF_Hakusai2(AbstractBlock.Properties props) {
		super(props);
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_taru_hakusai_f2").withStyle(TextFormatting.GRAY));
	}
}
