...
public class TaruY_Hachimitsushu extends Regi_BlockLog {
	...
	public TaruY_Hachimitsushu(String name) {
		super(name);
	...
	private Item takeBottle(IBlockState state) {
		...
		if (i == 1) { return Items_Teatime.MEADBOT; }
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		else { stack.add(new ItemStack(Items_Teatime.HAKKOUTARU, 1, 0)); }
		return stack;
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> blockTip, ITooltipFlag advanced) {
		blockTip.add(I18n.format("tips.block_taru_hachimitsushu.name"));
	}
}
