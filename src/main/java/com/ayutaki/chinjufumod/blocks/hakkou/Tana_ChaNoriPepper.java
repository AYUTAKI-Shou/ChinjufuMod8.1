...
public class Tana_ChaNoriPepper extends BaseTana_Stage05 {
	...
	public Tana_ChaNoriPepper(Block.Properties props) {
		super(props);
	}
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		if (this == Hakkou_Blocks.KOUCHA_TARU) { blockTip.add(new TranslationTextComponent("tips.block_taru_koucha").applyTextStyle(TextFormatting.GRAY)); }
		if (this == Hakkou_Blocks.NORI_TARU) { blockTip.add(new TranslationTextComponent("tips.block_taru_nori").applyTextStyle(TextFormatting.GRAY)); }
		if (this == Hakkou_Blocks.PEPPER_TARU) { blockTip.add(new TranslationTextComponent("tips.block_taru_pepper").applyTextStyle(TextFormatting.GRAY)); }
	}
}
