...
public class BaseTaru_Yoh extends Abstract_Pillar implements IWaterLoggable {
	...
	/* Collision */
	private static final VoxelShape AABB_BOX = VoxelShapes.or(Block.box(1.0D, 14.0D, 1.0D, 15.0D, 16.0D, 15.0D),
	...
	private static final VoxelShape AABB_X = VoxelShapes.or(Block.box(0.0D, 1.0D, 1.0D, 2.0D, 15.0D, 15.0D),
	...
	private static final VoxelShape AABB_Z = VoxelShapes.or(Block.box(1.0D, 1.0D, 0.0D, 15.0D, 15.0D, 2.0D),
	...
	public BaseTaru_Yoh(AbstractBlock.Properties props) {
		super(props);
