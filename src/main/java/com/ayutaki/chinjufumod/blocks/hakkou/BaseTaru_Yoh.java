...
public class BaseTaru_Yoh extends Abstract_Pillar implements IWaterLoggable {
	/* Property */
	public static final IntegerProperty STAGE_1_6 = IntegerProperty.create("stage", 1, 6);
	public static final BooleanProperty WATERLOGGED = BlockStateProperties.WATERLOGGED;

	/* Collision */
	private static final VoxelShape AABB_BOX = VoxelShapes.or(Block.makeCuboidShape(1.0D, 14.0D, 1.0D, 15.0D, 16.0D, 15.0D),
	...
	private static final VoxelShape AABB_X = VoxelShapes.or(Block.makeCuboidShape(0.0D, 1.0D, 1.0D, 2.0D, 15.0D, 15.0D),
	...
	private static final VoxelShape AABB_Z = VoxelShapes.or(Block.makeCuboidShape(1.0D, 1.0D, 0.0D, 15.0D, 15.0D, 2.0D),
	...
	public BaseTaru_Yoh(Block.Properties props) {
		super(props);
