...
public class Cheese_Curd extends Abstract_WaterLogged {
	...
	public Cheese_Curd(Block.Properties props) {
		super(props);
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_cheesecurd").applyTextStyle(TextFormatting.GRAY));
	}
}
