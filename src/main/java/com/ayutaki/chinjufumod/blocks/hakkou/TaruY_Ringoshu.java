...
public class TaruY_Ringoshu extends Regi_BlockLog {
	...
	public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		if (i <= 1) {
			worldIn.scheduleUpdate(pos, this, COOK_TIME);
			worldIn.setBlockState(pos, state.withProperty(STAGE_0_3, Integer.valueOf(i + 1))); }
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		if (i == 1 || i == 2) {
			if (hItem == Items_Teatime.Item_DISH && k == 8) {
				...
				worldIn.setBlockState(pos, state.withProperty(STAGE_0_3, Integer.valueOf(3))); }
	...
	private Item takeBottle(IBlockState state) {
		...
		if (i == 1) { return Items_Teatime.CIDERBOT; }
		else { return Items_Teatime.JUKUCIDERBOT; }
	}
