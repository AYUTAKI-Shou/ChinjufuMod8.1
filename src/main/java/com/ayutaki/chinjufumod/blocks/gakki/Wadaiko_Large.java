...
public class Wadaiko_Large extends Wadaiko_Base {
	/* Collision */
	private static final VoxelShape BOT1_SOUTH = Block.box(2.5D, 0.0D, 3.5D, 13.5D, 15.25D, 12.5D);
	private static final VoxelShape BOT1_WEST = Block.box(3.5D, 0.0D, 2.5D, 12.5D, 15.25D, 13.5D);
	private static final VoxelShape BOT1_NORTH = Block.box(2.5D, 0.0D, 3.5D, 13.5D, 15.25D, 12.5D);
	private static final VoxelShape BOT1_EAST = Block.box(3.5D, 0.0D, 2.5D, 12.5D, 15.25D, 13.5D);

	private static final VoxelShape TOP1_SOUTH = Block.box(3.25D, 0.0D, 1.0D, 12.75D, 9.5D, 15.0D);
	private static final VoxelShape TOP1_WEST = Block.box(1.0D, 0.0D, 3.25D, 15.0D, 9.5D, 12.75D);
	private static final VoxelShape TOP1_NORTH = Block.box(3.25D, 0.0D, 1.0D, 12.75D, 9.5D, 15.0D);
	private static final VoxelShape TOP1_EAST = Block.box(1.0D, 0.0D, 3.25D, 15.0D, 9.5D, 12.75D);

	private static final VoxelShape BOT2_SOUTH = Block.box(3.25D, 0.0D, 0.5D, 12.75D, 16.0D, 15.5D);
	private static final VoxelShape BOT2_WEST = Block.box(0.5D, 0.0D, 3.25D, 15.0D, 15.5D, 12.75D);
	private static final VoxelShape BOT2_NORTH = Block.box(3.25D, 0.0D, 0.5D, 12.75D, 16.0D, 15.5D);
	private static final VoxelShape BOT2_EAST = Block.box(0.5D, 0.0D, 3.25D, 15.0D, 15.5D, 12.75D);

	private static final VoxelShape TOP2_SOUTH = VoxelShapes.or(Block.box(3.75D, 0.0D, 0.5D, 12.25D, 3.0D, 8.0D),
																										Block.box(3.75D, 0.0D, 8.0D, 12.25D, 7.0D, 15.5D));
	private static final VoxelShape TOP2_WEST = VoxelShapes.or(Block.box(0.5D, 0.0D, 3.75D, 8.0D, 7.0D, 12.25D),
																									Block.box(8.0D, 0.0D, 3.75D, 15.5D, 3.0D, 12.25D));
	private static final VoxelShape TOP2_NORTH = VoxelShapes.or(Block.box(3.75D, 0.0D, 0.5D, 12.25D, 7.0D, 8.0D),
																										Block.box(3.75D, 0.0D, 8.0D, 12.25D, 3.0D, 15.5D));
	private static final VoxelShape TOP2_EAST = VoxelShapes.or(Block.box(0.5D, 0.0D, 3.75D, 8.0D, 3.0D, 12.25D),
																									Block.box(8.0D, 0.0D, 3.75D, 15.5D, 7.0D, 12.25D));

	private static final VoxelShape BOT3_BOX = Block.box(3.25D, 0.0D, 3.25D, 12.75D, 14.0D, 12.75D);


	public Wadaiko_Large(AbstractBlock.Properties props) {
		super(props);
	}
