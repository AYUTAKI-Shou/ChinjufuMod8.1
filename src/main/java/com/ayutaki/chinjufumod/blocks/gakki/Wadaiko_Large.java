...
public class Wadaiko_Large extends Wadaiko_Base {
	/* Collision */
	private static final VoxelShape BOT1_SOUTH = Block.makeCuboidShape(2.5D, 0.0D, 3.5D, 13.5D, 15.25D, 12.5D);
	private static final VoxelShape BOT1_WEST = Block.makeCuboidShape(3.5D, 0.0D, 2.5D, 12.5D, 15.25D, 13.5D);
	private static final VoxelShape BOT1_NORTH = Block.makeCuboidShape(2.5D, 0.0D, 3.5D, 13.5D, 15.25D, 12.5D);
	private static final VoxelShape BOT1_EAST = Block.makeCuboidShape(3.5D, 0.0D, 2.5D, 12.5D, 15.25D, 13.5D);

	private static final VoxelShape TOP1_SOUTH = Block.makeCuboidShape(3.25D, 0.0D, 1.0D, 12.75D, 9.5D, 15.0D);
	private static final VoxelShape TOP1_WEST = Block.makeCuboidShape(1.0D, 0.0D, 3.25D, 15.0D, 9.5D, 12.75D);
	private static final VoxelShape TOP1_NORTH = Block.makeCuboidShape(3.25D, 0.0D, 1.0D, 12.75D, 9.5D, 15.0D);
	private static final VoxelShape TOP1_EAST = Block.makeCuboidShape(1.0D, 0.0D, 3.25D, 15.0D, 9.5D, 12.75D);

	private static final VoxelShape BOT2_SOUTH = Block.makeCuboidShape(3.25D, 0.0D, 0.5D, 12.75D, 16.0D, 15.5D);
	private static final VoxelShape BOT2_WEST = Block.makeCuboidShape(0.5D, 0.0D, 3.25D, 15.0D, 15.5D, 12.75D);
	private static final VoxelShape BOT2_NORTH = Block.makeCuboidShape(3.25D, 0.0D, 0.5D, 12.75D, 16.0D, 15.5D);
	private static final VoxelShape BOT2_EAST = Block.makeCuboidShape(0.5D, 0.0D, 3.25D, 15.0D, 15.5D, 12.75D);

	private static final VoxelShape TOP2_SOUTH = VoxelShapes.or(Block.makeCuboidShape(3.75D, 0.0D, 0.5D, 12.25D, 3.0D, 8.0D),
																										Block.makeCuboidShape(3.75D, 0.0D, 8.0D, 12.25D, 7.0D, 15.5D));
	private static final VoxelShape TOP2_WEST = VoxelShapes.or(Block.makeCuboidShape(0.5D, 0.0D, 3.75D, 8.0D, 7.0D, 12.25D),
																									Block.makeCuboidShape(8.0D, 0.0D, 3.75D, 15.5D, 3.0D, 12.25D));
	private static final VoxelShape TOP2_NORTH = VoxelShapes.or(Block.makeCuboidShape(3.75D, 0.0D, 0.5D, 12.25D, 7.0D, 8.0D),
																										Block.makeCuboidShape(3.75D, 0.0D, 8.0D, 12.25D, 3.0D, 15.5D));
	private static final VoxelShape TOP2_EAST = VoxelShapes.or(Block.makeCuboidShape(0.5D, 0.0D, 3.75D, 8.0D, 3.0D, 12.25D),
																									Block.makeCuboidShape(8.0D, 0.0D, 3.75D, 15.5D, 7.0D, 12.25D));

	private static final VoxelShape BOT3_BOX = Block.makeCuboidShape(3.25D, 0.0D, 3.25D, 12.75D, 14.0D, 12.75D);


	public Wadaiko_Large(Block.Properties props) {
		super(props);
	}
			...
			case 3:
				if (playerIn.isSneaking()) {
					...
					if (hit.getFace() == Direction.UP || hit.getFace() == Direction.DOWN) {
						if (hItem == Items.STICK) { CMEvents.wadaikoTop(worldIn, pos, 1.25F, 1.0F); }
						else { CMEvents.wadaikoTop(worldIn, pos, 0.2F, 1.0F); } }

					else {
						if (hItem == Items.STICK) { CMEvents.wadaikoSide(worldIn, pos, 1.25F, 1.0F); }
