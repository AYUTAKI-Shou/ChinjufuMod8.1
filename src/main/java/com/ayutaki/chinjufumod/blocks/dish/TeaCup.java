...
public class TeaCup extends BaseFood_Stage3WP {
	/* Collision */
	private static final VoxelShape AABB_BOX = Block.makeCuboidShape(6.0D, 0.0D, 6.0D, 10.0D, 2.0D, 10.0D);
	private static final VoxelShape AABB_DOWN = Block.makeCuboidShape(6.0D, -8.0D, 6.0D, 10.0D, 0.1D, 10.0D);

	public TeaCup(Block.Properties props) {
		super(props);
	}
