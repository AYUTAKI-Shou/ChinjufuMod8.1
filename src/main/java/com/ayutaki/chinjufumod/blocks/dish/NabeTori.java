...
public class NabeTori extends BaseNabe {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (hItem == Items_Teatime.Item_DISH && k == 5) {
			...
			CMEvents.changeDish_seSnowB(worldIn, pos, playerIn, hand, Items_Teatime.TONSUITORI, 0);
		...
		if (hItem != Items_Teatime.Item_DISH && k != 5) { CMEvents.textNotHave(worldIn, pos, playerIn); }
