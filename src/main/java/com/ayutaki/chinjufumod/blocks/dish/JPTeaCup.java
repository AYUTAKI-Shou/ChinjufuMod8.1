...
public class JPTeaCup extends BaseFood_Stage3WP {
	/* Collision */
	private static final VoxelShape AABB_BOX = Block.makeCuboidShape(6.8D, 0.0D, 6.8D, 9.2D, 3.0D, 9.2D);
	private static final VoxelShape AABB_DOWN = Block.makeCuboidShape(6.8D, -8.0D, 6.8D, 9.2D, 0.1D, 9.2D);

	public JPTeaCup(Block.Properties props) {
		super(props);
	}
