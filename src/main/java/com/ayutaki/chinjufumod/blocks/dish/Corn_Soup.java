...
public class Corn_Soup extends BaseFood_Stage3WP {
	/* Collision */
	private static final VoxelShape AABB_BOX = Block.makeCuboidShape(5.5D, 0.0D, 5.5D, 10.5D, 2.0D, 10.5D);
	private static final VoxelShape AABB_DOWN = Block.makeCuboidShape(5.5D, -8.0D, 5.5D, 10.5D, 0.1D, 10.5D);

	public Corn_Soup(Block.Properties props) {
		super(props);
	}
