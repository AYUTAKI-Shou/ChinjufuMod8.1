...
public class NabeNama_TK extends BaseNabeNama_4 {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (i == 4) {
			if (hItem == Items.BOWL) {
				...
				CMEvents.changeDish_seSnowB(worldIn, pos, playerIn, hand, Items_Seasonal.KURI_BOIL, 0);
	...
	private ItemStack cloneStack(IBlockState state) {
		...
		else { return new ItemStack(Items_Teatime.NABE_nama_TK, 1, 1); }
	}
}
