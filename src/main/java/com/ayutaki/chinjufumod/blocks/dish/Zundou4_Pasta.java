...
public class Zundou4_Pasta extends BaseZundou_4Cook {
	...
	public Zundou4_Pasta(AbstractBlock.Properties props) {
		super(props);
	}
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (hItem == Items_Teatime.SARA) {
			if (i == 3 || i == 4) {
				...
				CMEvents.changeDish_seSnowB(worldIn, pos, playerIn, hand, Items_Teatime.PASTA_sara);
		...
		if (hItem != Items_Teatime.SARA && hItem != Items_Teatime.PASTA_nama) { 
