...
public class Pasta extends BaseStage4_FDP {
	...
	private ItemStack cloneStack() {
		if (this == Dish_Blocks.PASTACHEESE) { return new ItemStack(Items_Teatime.PASTACHEESE, 1, 0); }
		if (this == Dish_Blocks.PASTAKINOKO) { return new ItemStack(Items_Teatime.PASTAKINOKO, 1, 0); }
		if (this == Dish_Blocks.PASTATOMATO) { return new ItemStack(Items_Teatime.PASTATOMATO, 1, 0); }
		if (this == Dish_Blocks.YAKISOBA) { return new ItemStack(Items_Teatime.OKONOMIYAKI, 1, 6); }
		else { return new ItemStack(Items_Teatime.OKONOMIYAKI, 1, 7); }
	}
}
