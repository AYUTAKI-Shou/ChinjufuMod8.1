...
public class Tamagoyaki_set extends BaseFood_Stage5Water {
	...
	public Tamagoyaki_set(BlockBehaviour.Properties props) {
		super(props);
	}
		...
		if (i == 5) { CMEvents.textIsEmpty(worldIn, pos, playerIn); }
			...
			if (hStack.isEmpty()) {
				...
				if (!worldIn.isClientSide) {
					int eTIME = (this == Dish_Blocks.TAMAGOYAKITEI.get())? 6600 : 6700;
					int eTIME2 = (this == Dish_Blocks.TAMAGOYAKITEI.get())? 4200 : 4300;
