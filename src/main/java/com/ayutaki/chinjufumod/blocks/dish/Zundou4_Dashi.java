...
public class Zundou4_Dashi extends BaseZundou_4Stage {
	...
	public Zundou4_Dashi(AbstractBlock.Properties props) {
		super(props);
	}
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (hItem == Items_Teatime.SHOUYU_donburi) {
			/** Collect with an Item **/
			CMEvents.changeBowl_seBucket(worldIn, pos, playerIn, hand, Items_Teatime.TSUYU_donburi);
		...
		if (hItem != Items_Teatime.SHOUYU_donburi && hItem != Items_Teatime.DASHI_bot_14) {
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_food_dashinabe_1").withStyle(TextFormatting.GRAY));
	}
}
