...
public class Irori_Sakana_E1 extends BaseIrori_Sakana {
	...
	public Irori_Sakana_E1(Block.Properties props) {
		super(props);
	}
		...
		if (waterIn(state)) { 
			...
			if (cookingIn(worldIn, pos, Direction.DOWN)) {
				...
				if (COOKED) { }
					...
					if (i == 0) { //1 EEEC
						worldIn.setBlockState(pos, state.with(STAGE_0_15, Integer.valueOf(1))); }
		
					if (i == 2) { //5 EECE
						worldIn.setBlockState(pos, state.with(STAGE_0_15, Integer.valueOf(5))); }
		
					if (i == 3 || i == 4 || i == 6) { //7 EECC
						worldIn.setBlockState(pos, state.with(STAGE_0_15, Integer.valueOf(7))); }
		
					if (i == 8) { //1 ECEE
						worldIn.setBlockState(pos, Dish_Blocks.IRORISAKANA_E2.getDefaultState()
								.with(BaseIrori_Sakana.STAGE_0_15, Integer.valueOf(1))); }
		
					if (i == 9 || i == 10) { //3 ECEC
						worldIn.setBlockState(pos, Dish_Blocks.IRORISAKANA_E2.getDefaultState()
								.with(BaseIrori_Sakana.STAGE_0_15, Integer.valueOf(3))); }
		
					if (i == 11 || i == 14) {//7 ECCE
							worldIn.setBlockState(pos, Dish_Blocks.IRORISAKANA_E2.getDefaultState()
								.with(BaseIrori_Sakana.STAGE_0_15, Integer.valueOf(7))); }
		
					if (i == 12 || i == 13 || i == 15) {//9 ECCC
						worldIn.setBlockState(pos, Dish_Blocks.IRORISAKANA_E2.getDefaultState()
								.with(BaseIrori_Sakana.STAGE_0_15, Integer.valueOf(9))); } } 
			}
