...
public class NabeGohan_Other extends BaseNabe {
	...
	public NabeGohan_Other(AbstractBlock.Properties props) {
		super(props);
	}
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (hItem != Items_Teatime.CHAWAN && hItem != Items.BOWL) { 
			CMEvents.textNotHave(worldIn, pos, playerIn); }
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_food_nabegohantake_1").withStyle(TextFormatting.GRAY));
	}
}
