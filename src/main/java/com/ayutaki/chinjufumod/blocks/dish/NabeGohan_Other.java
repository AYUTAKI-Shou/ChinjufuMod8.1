...
public class NabeGohan_Other extends BaseNabe {
	...
	public NabeGohan_Other(Block.Properties props) {
		super(props);
	}
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (hItem != Items_Teatime.CHAWAN && hItem != Items.BOWL) { CMEvents.textNotHave(worldIn, pos, playerIn); }
	...
	private Item takeBowl() {
		if (this == Dish_Blocks.NABEGOHAN_TAKE) { return Items_Teatime.MUSHIGOME_TAKE; }
		if (this == Dish_Blocks.NABEGOHAN_KURI) { return Items_Teatime.MUSHIGOME_KURI; }
		else { return Items_Teatime.MUSHI_SEKIHAN; }
	}
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_food_nabegohantake_1").applyTextStyle(TextFormatting.GRAY));
	}
}
