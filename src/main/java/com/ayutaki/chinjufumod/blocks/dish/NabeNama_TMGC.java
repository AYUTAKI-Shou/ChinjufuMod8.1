...
public class NabeNama_TMGC extends BaseNabeNama_4 {
	/** 1=鶏鍋, 2=味噌, 3=ご飯, 4=コーンスープ **/
	public NabeNama_TMGC(String name) {
		super(name);
	}
	...
	private Block takeBlock(IBlockState state) {
		...
		if (i == 1) { return Dish_Blocks.NABETORI; }
		if (i == 2) { return Dish_Blocks.NABEMISO; }
		if (i == 3) { return Dish_Blocks.NABEGOHAN; }
		else { return Dish_Blocks.NABECORNSOUP; }
	}
	...
	public List<ItemStack> getDrops(IBlockAccess worldIn, BlockPos pos, IBlockState state, int fortune) {
		...
		int i = ((Integer)state.getValue(STAGE_1_4)).intValue();
		/** 1=鶏鍋, 2=味噌, 3=ご飯, 4=コーンスープ **/
		stack.add(new ItemStack(Items_Teatime.NABE_NAMA_1, 1, i));
		return stack;
	}
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World worldIn, BlockPos pos, EntityPlayer playerIn) {
		int i = ((Integer)state.getValue(STAGE_1_4)).intValue();
		return new ItemStack(Items_Teatime.NABE_NAMA_1, 1, i);
	}
}
