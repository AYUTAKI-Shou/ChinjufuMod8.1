...
public class Frypan_DonNama extends BaseFrypan_2Cook {
	...
	public Frypan_DonNama(AbstractBlock.Properties props) {
		super(props);
	}
	...
	private Item takeItem() {
		if (this == Dish_Blocks.FPGYUDON_nama) { return Items_Teatime.DONBURI_GYU; }
		if (this == Dish_Blocks.FPOYAKODON_nama) { return Items_Teatime.DONBURI_OYAKO; }
		else { return Items_Teatime.DONBURI_KATSU; }
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		...
		blockTip.add(new TranslationTextComponent("tips.block_food_frypan_donburi").withStyle(TextFormatting.GRAY));
	}
}
