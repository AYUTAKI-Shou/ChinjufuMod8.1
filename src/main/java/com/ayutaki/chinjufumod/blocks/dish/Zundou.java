...
public class Zundou extends BaseStage2_FaceWater {
	...
	/** 1=close, 2=open **/
	public Zundou(Block.Properties props) {
		super(props);
	}
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (hItem == Items.WATER_BUCKET) {
			...
			worldIn.setBlockState(pos, Dish_Blocks.ZUNDOU_MIZU.getDefaultState()
					...
					.with(Zundou_Mizu.STAGE_1_2, Integer.valueOf(1))); }
		...
		if (hItem == Items.MILK_BUCKET) {
			...
			worldIn.setBlockState(pos, Dish_Blocks.ZUNDOU_MILK.getDefaultState()
					.with(Zundou_Milk.H_FACING, state.get(H_FACING))
					.with(Zundou_Milk.STAGE_1_2, Integer.valueOf(1))); }
