...
public class Zundou extends BaseStage2_FaceWater {
	...
	/** 1=close, 2=open **/
	public Zundou(BlockBehaviour.Properties props) {
		super(props);
	}
	...
	public InteractionResult useItemOn(ItemStack stack, BlockState state, Level worldIn, BlockPos pos, Player playerIn, InteractionHand hand, BlockHitResult hit) {
		...
		if (hItem != Items.WATER_BUCKET && hItem != Items_Teatime.MIZUOKE_full.get() && hItem != Items.MILK_BUCKET && hItem != Items_Teatime.MIZUOKE_Milk.get()) {
