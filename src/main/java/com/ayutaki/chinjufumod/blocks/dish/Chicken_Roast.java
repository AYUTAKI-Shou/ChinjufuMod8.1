...
public class Chicken_Roast extends BaseStage4_FDP {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (hItem == Items_Teatime.Item_SARA) {
			...
			CMEvents.changeDish_seSnowB(worldIn, pos, playerIn, hand, Items_Teatime.CHICKEN_small, 0);
			...
			if (i == 4) { worldIn.setBlockState(pos, Dish_Blocks.TEAPOT_kara.getDefaultState()
					...
					.withProperty(TeaPot_kara.STAGE_1_4, Integer.valueOf(3))); }
