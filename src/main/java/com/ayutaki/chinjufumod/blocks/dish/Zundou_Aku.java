...
public class Zundou_Aku extends BaseZundou_2Cook {
	/** 1=cold, 2=hot **/
	public Zundou_Aku(Block.Properties props) {
		super(props);
	}
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (hItem == Items_Seasonal.KUSATABA) {
			...
			worldIn.setBlockState(pos, Dish_Blocks.ZUNDOU_ORIITO.getDefaultState()
					.with(Zundou4_Oriito.H_FACING, state.get(H_FACING))
					.with(Zundou4_Oriito.STAGE_1_4, Integer.valueOf(1))); //Large Items cool it down.
		}
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		...
		blockTip.add(new TranslationTextComponent("tips.block_zundou_aku").applyTextStyle(TextFormatting.GRAY));
	}
}
