...
public class Frypan_PastaNama extends BaseFrypan_2Cook {
	...
	public Frypan_PastaNama(AbstractBlock.Properties props) {
		super(props);
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		...
		blockTip.add(new TranslationTextComponent("tips.block_food_frypan_pasta").withStyle(TextFormatting.GRAY));
	}
}
