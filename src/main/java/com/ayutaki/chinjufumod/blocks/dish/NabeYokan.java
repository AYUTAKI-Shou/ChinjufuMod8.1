...
public class NabeYokan extends BaseNabe_Kanten {
	...
	private int takeMeta() {
		if (this == Dish_Blocks.NABEK_YOKAN) { return 5; }
		else { return 6; }
	}
}
