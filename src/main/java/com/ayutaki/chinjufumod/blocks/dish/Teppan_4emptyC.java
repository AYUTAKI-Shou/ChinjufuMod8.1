...
public class Teppan_4emptyC extends Abstract_Teppan {
	...
	public Teppan_4emptyC(AbstractBlock.Properties props) {
		super(props);
	...
	private Item cloneItem() {
		if (this == Dish_Blocks.OKONOMIYAKI_click) { return Items_Teatime.OKONOMIYAKI_nama; }
		if (this == Dish_Blocks.OKONOMIS_click) { return Items_Teatime.OKONOMIS_nama; }
		else { return Items_Teatime.OKONOMIC_nama; }
	}
}
