...
public class Teppan_4emptyC extends Abstract_Teppan {
	...
	public Teppan_4emptyC(String name) {
		super(name);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (hStack.isEmpty()) {
			...
			worldIn.setBlockState(pos, this.toNama().getDefaultState()
					...
					.withProperty(Teppan_4empty.STAGE_1_4, Integer.valueOf(i + 1)), 3); }
	...
	private Block toNama() {
		...
		else { return Dish_Blocks.OKONOMIC_nama; }
	}
	...
	public int getComparatorInputOverride(IBlockState state, World worldIn, BlockPos pos) {
		return (2 - ((Integer)state.getValue(STAGE_1_2)).intValue()) * 2;
	}

	/*Create BlockStates in this block. */
	@Override
	protected BlockStateContainer createBlockState() {
		return new BlockStateContainer(this, new IProperty[] { DOWN, H_FACING, STAGE_1_2 });
	}
	...
	private int cloneMeta() {
		if (this == Dish_Blocks.OKONOMIYAKI_click) { return 2; }
		if (this == Dish_Blocks.OKONOMIS_click) { return 3; }
		else { return 4; }
	}
}
