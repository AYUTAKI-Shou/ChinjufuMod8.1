...
public class JPTea_Set extends BaseStage4_FDP {
	...
	private static final AxisAlignedBB DOWN_SOUTH = CollisionHelper.getBlockBounds(EnumFacing.SOUTH, 0.28125, -0.5, 0.125, 0.71875, 0.01, 0.875);
	private static final AxisAlignedBB DOWN_EAST = CollisionHelper.getBlockBounds(EnumFacing.EAST, 0.28125, -0.5, 0.125, 0.71875, 0.01, 0.875);
	private static final AxisAlignedBB DOWN_WEST = CollisionHelper.getBlockBounds(EnumFacing.WEST, 0.28125, -0.5, 0.125, 0.71875, 0.01, 0.875);
	private static final AxisAlignedBB DOWN_NORTH = CollisionHelper.getBlockBounds(EnumFacing.NORTH, 0.28125, -0.5, 0.125, 0.71875, 0.01, 0.875);

	public JPTea_Set(String name) {
		super(name);
