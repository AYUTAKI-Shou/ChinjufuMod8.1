...
public class Pizza_5 extends Base_DownStage5 {
	...
	public Pizza_5(Block.Properties props) {
		super(props);
	}
	...
	private Item takeItem() {
		if (this == Dish_Blocks.PIZZA) { return Items_Teatime.PC_PIZZA; }
		if (this == Dish_Blocks.PIZZA_C) { return Items_Teatime.PC_PIZZAC; }
		if (this == Dish_Blocks.PIZZA_T) { return Items_Teatime.PC_PIZZAT; }
		else { return Items_Teatime.PC_PIZZAS; }
	}
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_pizza_cheese").applyTextStyle(TextFormatting.GRAY));
	}
}
