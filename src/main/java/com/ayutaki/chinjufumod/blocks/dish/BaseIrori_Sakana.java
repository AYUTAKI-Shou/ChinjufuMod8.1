...
public class BaseIrori_Sakana extends Regi_addState {
	...
	public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
		...
		if ((downBlock != Kitchen_Blocks.IRORI) && (downBlock != Kitchen_Blocks.LIT_IRORI)) {
	...
	protected ItemStack cloneStack(int i) { return new ItemStack(Items_Teatime.KUSHI_SAKANA, i, 0); }
	protected ItemStack cloneCook(int i) { return new ItemStack(Items_Teatime.KUSHI_SAKANA_C, i, 0); }
}
