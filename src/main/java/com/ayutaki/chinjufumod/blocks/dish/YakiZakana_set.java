...
public class YakiZakana_set extends BaseStage4_FDP {
	...
	public YakiZakana_set(String name) {
		super(name);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (hStack.isEmpty()) {
			...
			if (i == 4) {
				boolean SAKANA = (this == Dish_Blocks.YAKIZAKANATEI);
				worldIn.setBlockState(pos, Dish_Blocks.FOODKARA_TEI.getDefaultState()
						...
						.withProperty(FoodKara_Tei.STAGE_1_4, Integer.valueOf(SAKANA? 2 : 3))); }
		}
	...
	private Item cloneItem() {
		if (this == Dish_Blocks.YAKIZAKANATEI_TAKE) { return Items_Teatime.YAKIZAKANATEI_TAKE; }
		if (this == Dish_Blocks.YAKIZAKANATEI_KURI) { return Items_Teatime.YAKIZAKANATEI_KURI; }
		if (this == Dish_Blocks.YAKIZAKANATEI_SEKI) { return Items_Teatime.YAKIZAKANATEI_SEKI; }
		if (this == Dish_Blocks.YAKIZAKANATEI) { return Items_Teatime.YAKIZAKANATEI; }
		if (this == Dish_Blocks.YAKIJYAKETEI_TAKE) { return Items_Teatime.YAKIJYAKETEI_TAKE; }
		if (this == Dish_Blocks.YAKIJYAKETEI_KURI) { return Items_Teatime.YAKIJYAKETEI_KURI; }
		if (this == Dish_Blocks.YAKIJYAKETEI_SEKI) { return Items_Teatime.YAKIJYAKETEI_SEKI; }
		else { return Items_Teatime.YAKIJYAKETEI; }
	}
}
