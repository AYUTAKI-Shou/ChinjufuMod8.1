...
public class Chicken_small extends BaseFood_Stage3WP {
	/* Collision */
	private static final VoxelShape AABB_BOX = Block.makeCuboidShape(4.0D, 0.0D, 4.0D, 12.0D, 2.0D, 12.0D);
	private static final VoxelShape AABB_DOWN = Block.makeCuboidShape(4.0D, -8.0D, 4.0D, 12.0D, 0.1D, 12.0D);

	public Chicken_small(Block.Properties props) {
		super(props);
	}
