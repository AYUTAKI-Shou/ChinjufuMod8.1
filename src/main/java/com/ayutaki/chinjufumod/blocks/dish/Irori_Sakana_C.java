...
public class Irori_Sakana_C extends BaseIrori_Sakana {
	...
	public Irori_Sakana_C(Block.Properties props) {
		super(props);
	}
	...
	public void tick(BlockState state, ServerWorld worldIn, BlockPos pos, Random rand) {
		...
		if (waterIn(state)) { 
			...
			if (cookingIn(worldIn, pos, Direction.DOWN)) {
				boolean COOKED = (i == 7 || i == 9 || i == 13 || i == 15);
				if (COOKED) { }
					...
					if (i == 0 || i == 8) { //9 CCEC
						worldIn.setBlockState(pos, state.with(STAGE_0_15, Integer.valueOf(9))); }
		
					if (i == 1 || i == 4 || i == 10) { //13 CCCE
						worldIn.setBlockState(pos, state.with(STAGE_0_15, Integer.valueOf(13))); }
		
					if (i == 2 || i == 3 || i == 5 || i == 6 || i == 11 || i == 12 || i == 14) { //15 CCCC
						worldIn.setBlockState(pos, state.with(STAGE_0_15, Integer.valueOf(15))); } }
			}
