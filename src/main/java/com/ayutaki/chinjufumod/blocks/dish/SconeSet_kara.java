...
public class SconeSet_kara extends BaseStage2_FaceWater {
	...
	private static final VoxelShape AABB_1 = Block.makeCuboidShape(3.0D, 0.0D, 3.0D, 13.0D, 10.5D, 13.0D);
	private static final VoxelShape AABB_2 = Block.makeCuboidShape(3.0D, 0.0D, 3.0D, 13.0D, 1.0D, 13.0D);

	public SconeSet_kara(Block.Properties props) {
		super(props);
	}
