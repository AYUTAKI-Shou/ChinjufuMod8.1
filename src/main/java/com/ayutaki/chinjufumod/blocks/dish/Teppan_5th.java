...
public class Teppan_5th extends Abstract_Teppan {
	...
	public Teppan_5th(AbstractBlock.Properties props) {
		super(props);
	...
	private Item takeItem() {
		if (this == Dish_Blocks.OKONOMISOBA_5) { return Items_Teatime.OKONOMISOBA; }
		if (this == Dish_Blocks.OKONOMISOBAS_5) { return Items_Teatime.OKONOMISOBAS; }
		else { return Items_Teatime.OKONOMISOBAC; }
	}
	...
	private Item cloneItem() {
		if (this == Dish_Blocks.OKONOMISOBA_5) { return Items_Teatime.OKONOMISOBA_nama; }
		if (this == Dish_Blocks.OKONOMISOBAS_5) { return Items_Teatime.OKONOMISOBAS_nama; }
		else { return Items_Teatime.OKONOMISOBAC_nama; }
	}
}
