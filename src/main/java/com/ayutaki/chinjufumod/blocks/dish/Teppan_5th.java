...
public class Teppan_5th extends Abstract_Teppan {
	...
	private int takeMeta() {
		if (this == Dish_Blocks.OKONOMISOBA_5) { return 3; }
		if (this == Dish_Blocks.OKONOMISOBAS_5) { return 4; }
		else { return 5; }
	}
	...
	private int cloneMeta() {
		if (this == Dish_Blocks.OKONOMISOBA_5) { return 5; }
		if (this == Dish_Blocks.OKONOMISOBAS_5) { return 6; }
		else { return 7; }
	}
}
