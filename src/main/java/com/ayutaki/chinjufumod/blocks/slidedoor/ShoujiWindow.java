...
public class ShoujiWindow extends BaseStage3_FaceWater {
	...
	private static final VoxelShape CLOSE_SOUTH = VoxelShapes.or(FRAME_SOUTH, Block.box(0.0D, 0.0D, 6.5D, 16.0D, 16.0D, 9.5D));
	private static final VoxelShape CLOSE_WEST = VoxelShapes.or(FRAME_WEST, Block.box(6.5D, 0.0D, 0.0D, 9.5D, 16.0D, 16.0D));
	private static final VoxelShape CLOSE_NORTH = VoxelShapes.or(FRAME_NORTH, Block.box(0.0D, 0.0D, 6.5D, 16.0D, 16.0D, 9.5D));
	private static final VoxelShape CLOSE_EAST = VoxelShapes.or(FRAME_EAST, Block.box(6.5D, 0.0D, 0.0D, 9.5D, 16.0D, 16.0D));

	private static final VoxelShape OPENR_SOUTH = VoxelShapes.or(FRAME_SOUTH, Block.box(7.5D, 0.0D, 6.5D, 16.0D, 16.0D, 9.5D));
	private static final VoxelShape OPENR_WEST = VoxelShapes.or(FRAME_WEST, Block.box(6.5D, 0.0D, 7.5D, 9.5D, 16.0D, 16.0D));
	private static final VoxelShape OPENR_NORTH = VoxelShapes.or(FRAME_NORTH, Block.box(0.0D, 0.0D, 6.5D, 8.5D, 16.0D, 9.5D));
	private static final VoxelShape OPENR_EAST = VoxelShapes.or(FRAME_EAST, Block.box(6.5D, 0.0D, 0.0D, 9.5D, 16.0D, 8.5D));

	private static final VoxelShape OPENL_SOUTH = VoxelShapes.or(FRAME_SOUTH, Block.box(0.0D, 0.0D, 6.5D, 8.5D, 16.0D, 9.5D));
	private static final VoxelShape OPENL_WEST = VoxelShapes.or(FRAME_WEST, Block.box(6.5D, 0.0D, 0.0D, 9.5D, 16.0D, 8.5D));
	private static final VoxelShape OPENL_NORTH = VoxelShapes.or(FRAME_NORTH, Block.box(7.5D, 0.0D, 6.5D, 16.0D, 16.0D, 9.5D));
	private static final VoxelShape OPENL_EAST = VoxelShapes.or(FRAME_EAST, Block.box(6.5D, 0.0D, 7.5D, 9.5D, 16.0D, 16.0D));

	public ShoujiWindow(AbstractBlock.Properties props) {
		super(props);
	}
	...
	public BlockState getStateForPlacement(BlockItemUseContext context) {
		...
		ItemStack hStack = playerIn.getItemInHand(Hand.MAIN_HAND);
	...
	private Block takeBlock(ItemStack hStack) {
		...
		else { return Slidedoor_Blocks.SHOUJI_WINR; }
	}
