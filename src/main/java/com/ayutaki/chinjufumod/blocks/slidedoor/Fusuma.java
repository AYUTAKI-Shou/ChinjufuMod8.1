...
public class Fusuma extends BaseSlidedoor {
	...
	private Item cloneItem(IBlockState state) {
		...
		else { return Items_Wadeco.FUSUMA_item; }
	}
	
	private int cloneMeta(IBlockState state) {
		if (state.getValue(HALF) == HalfState.UPPER) { return 0; }
		else {
			if (this == Fusuma_Blocks.FUSUMA_white) { return 0; }
			if (this == Fusuma_Blocks.FUSUMA_orange) { return 1; }
			if (this == Fusuma_Blocks.FUSUMA_magenta) { return 2; }
			if (this == Fusuma_Blocks.FUSUMA_lightblue) { return 3; }
			if (this == Fusuma_Blocks.FUSUMA_yellow) { return 4; }
			if (this == Fusuma_Blocks.FUSUMA_lime) { return 5; }
			if (this == Fusuma_Blocks.FUSUMA_pink) { return 6; }
			if (this == Fusuma_Blocks.FUSUMA_gray) { return 7; }
			if (this == Fusuma_Blocks.FUSUMA_lightgray) { return 8; }
			if (this == Fusuma_Blocks.FUSUMA_cyan) { return 9; }
			if (this == Fusuma_Blocks.FUSUMA_purple) { return 10; }
			if (this == Fusuma_Blocks.FUSUMA_blue) { return 11; }
			if (this == Fusuma_Blocks.FUSUMA_brown) { return 12; }
			if (this == Fusuma_Blocks.FUSUMA_green) { return 13; }
			if (this == Fusuma_Blocks.FUSUMA_red) { return 14; }
			else { return 15; }
		}
	}
}
