...
public class BaseSlidedoor extends Abstract_WaterLogged {
	...
	private static final VoxelShape CLOSEB_SOUTH = VoxelShapes.or(FRAME_SOUTH, Block.box(0.0D, 0.0D, 8.0D, 16.0D, 16.0D, 9.5D));
	private static final VoxelShape CLOSEB_WEST = VoxelShapes.or(FRAME_WEST, Block.box(6.5D, 0.0D, 0.0D, 8.0D, 16.0D, 16.0D));
	private static final VoxelShape CLOSEB_NORTH = VoxelShapes.or(FRAME_NORTH, Block.box(0.0D, 0.0D, 6.5D, 16.0D, 16.0D, 8.0D));
	private static final VoxelShape CLOSEB_EAST = VoxelShapes.or(FRAME_EAST, Block.box(8.0D, 0.0D, 0.0D, 9.5D, 16.0D, 16.0D));

	private static final VoxelShape OPENBR_SOUTH = VoxelShapes.or(FRAME_SOUTH, Block.box(14.0D, 0.0D, 8.0D, 30.0D, 16.0D, 9.5D));
	private static final VoxelShape OPENBR_WEST = VoxelShapes.or(FRAME_WEST, Block.box(6.5D, 0.0D, 14.0D, 8.0D, 16.0D, 30.0D));
	private static final VoxelShape OPENBR_NORTH = VoxelShapes.or(FRAME_NORTH, Block.box(-14.0D, 0.0D, 6.5D, 2.0D, 16.0D, 8.0D));
	private static final VoxelShape OPENBR_EAST = VoxelShapes.or(FRAME_EAST, Block.box(8.0D, 0.0D, -14.0D, 9.5D, 16.0D, 2.0D));

	private static final VoxelShape OPENBL_SOUTH = VoxelShapes.or(FRAME_SOUTH, Block.box(-14.0D, 0.0D, 8.0D, 2.0D, 16.0D, 9.5D));
	private static final VoxelShape OPENBL_WEST = VoxelShapes.or(FRAME_WEST, Block.box(6.5D, 0.0D, -14.0D, 8.0D, 16.0D, 2.0D));
	private static final VoxelShape OPENBL_NORTH = VoxelShapes.or(FRAME_NORTH, Block.box(14.0D, 0.0D, 6.5D, 30.0D, 16.0D, 8.0D));
	private static final VoxelShape OPENBL_EAST = VoxelShapes.or(FRAME_EAST, Block.box(8.0D, 0.0D, 14.0D, 9.5D, 16.0D, 30.0D));
	...
	public BaseSlidedoor(AbstractBlock.Properties props) {
		super(props);
