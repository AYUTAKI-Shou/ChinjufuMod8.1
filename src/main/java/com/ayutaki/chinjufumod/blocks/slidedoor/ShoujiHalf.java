...
public class ShoujiHalf extends BaseStage4_Face {
	...
	private Item cloneItem(IBlockState state) {
		boolean seasonal = (this == Slidedoor_Blocks.SHOUJIH_SAKU || this == Slidedoor_Blocks.SHOUJIH_KAE ||
				this == Slidedoor_Blocks.SHOUJIH_ICH);

		if (seasonal) { return Items_Seasonal.SSHOUJIH_item; }
		else { return Items_Wadeco.SHOUJIH_item; }
	}
	
	private int cloneMeta() {
		if (this == Slidedoor_Blocks.SHOUJIH) { return 0; }
		if (this == Slidedoor_Blocks.SHOUJIH_SPRU) { return 1; }
		if (this == Slidedoor_Blocks.SHOUJIH_BIR) { return 2; }
		if (this == Slidedoor_Blocks.SHOUJIH_JUN) { return 3; }
		if (this == Slidedoor_Blocks.SHOUJIH_ACA) { return 4; }
		if (this == Slidedoor_Blocks.SHOUJIH_DOAK) { return 5; }
		
		if (this == Slidedoor_Blocks.SHOUJIH_SAKU) { return 0; }
		if (this == Slidedoor_Blocks.SHOUJIH_KAE) { return 1; }
		else { return 2; }
	}
}
