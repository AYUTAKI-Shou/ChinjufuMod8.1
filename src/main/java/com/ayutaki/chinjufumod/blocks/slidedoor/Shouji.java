...
public class Shouji extends BaseSlidedoor {
	...
	private Item cloneItem(IBlockState state) {
		boolean seasonal = (this == Shouji_Blocks.SHOUJI_SAKU || this == Shouji_Blocks.SHOUJI_KAE ||
				this == Shouji_Blocks.SHOUJI_ICH || this == Shouji_Blocks.SHOUJIB_SAKU ||
				this == Shouji_Blocks.SHOUJIB_KAE || this == Shouji_Blocks.SHOUJIB_ICH);

		if (state.getValue(HALF) == HalfState.UPPER) { return Items.AIR; }
		else { 
			if (seasonal) { return Items_Seasonal.SSHOUJI_item; }
			else { return Items_Wadeco.SHOUJI_item; }
		}
	}
	...
	private int cloneMeta(IBlockState state) {
		if (state.getValue(HALF) == HalfState.UPPER) { return 0; }
			...
			if (this == Shouji_Blocks.SHOUJI) { return 0; }
			if (this == Shouji_Blocks.SHOUJI_SPRU) { return 1; }
			if (this == Shouji_Blocks.SHOUJI_BIR) { return 2; }
			if (this == Shouji_Blocks.SHOUJI_JUN) { return 3; }
			if (this == Shouji_Blocks.SHOUJI_ACA) { return 4; }
			if (this == Shouji_Blocks.SHOUJI_DOAK) { return 5; }
			if (this == Shouji_Blocks.SHOUJIB) { return 6; }
			if (this == Shouji_Blocks.SHOUJIB_SPRU) { return 7; }
			if (this == Shouji_Blocks.SHOUJIB_BIR) { return 8; }
			if (this == Shouji_Blocks.SHOUJIB_JUN) { return 9; }
			if (this == Shouji_Blocks.SHOUJIB_ACA) { return 10; }
			if (this == Shouji_Blocks.SHOUJIB_DOAK) { return 11; }
			
			if (this == Shouji_Blocks.SHOUJI_SAKU) { return 0; }
			if (this == Shouji_Blocks.SHOUJI_KAE) { return 1; }
			if (this == Shouji_Blocks.SHOUJI_ICH) { return 2; }
			if (this == Shouji_Blocks.SHOUJIB_SAKU) { return 3; }
			if (this == Shouji_Blocks.SHOUJIB_KAE) { return 4; }
			else { return 5; }
		}
	}
}
