...
public class Fusuma_B extends BaseSlidedoor {
	...
	public Fusuma_B(Block.Properties props) {
		super(props);
	}
	...
	public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (hItem instanceof Abstract_Hake || hItem instanceof ItemCurtain) { return ActionResultType.PASS; }
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_fusuma").applyTextStyle(TextFormatting.GRAY));
	}
}
