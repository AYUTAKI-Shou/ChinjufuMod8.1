...
public class Fusuma_B extends BaseSlidedoor {
	...
	public Fusuma_B(AbstractBlock.Properties props) {
		super(props);
	}
	...
	public ActionResultType use(BlockState state, World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand, BlockRayTraceResult hit) {
		...
		if (hItem instanceof ItemCurtain || hItem instanceof Abstract_Hake) { return ActionResultType.PASS; }
	...
	public void appendHoverText(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> blockTip, ITooltipFlag tipFlag) {
		blockTip.add(new TranslationTextComponent("tips.block_fusuma").withStyle(TextFormatting.GRAY));
	}
}
