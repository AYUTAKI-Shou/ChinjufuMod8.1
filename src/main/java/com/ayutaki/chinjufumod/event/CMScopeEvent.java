...
import com.ayutaki.chinjufumod.items.weapon.Abstract_RensouHou;
...
public class CMScopeEvent {
	...
	public static void updateFOV(FOVModifierEvent event) {
		...
		if (useItem && (main instanceof Abstract_RensouHou || main instanceof Triple_Kijyuu || main instanceof Abstract_BowKansaiki)) {
