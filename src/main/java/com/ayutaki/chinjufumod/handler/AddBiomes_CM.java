...
public class AddBiomes_CM {
	...
	public static void addBiomes() {
		...
		if (Config_CM.getInstance().sakuraBiomeGene() == true) {
			...
			BiomeDictionary.addTypes(SAKURA_FOREST_KEY, Type.OVERWORLD, Type.FOREST);
			...
			BiomeDictionary.addTypes(SAKURA_HILLS_KEY, Type.OVERWORLD, Type.FOREST, Type.HILLS, Type.RARE); }
		...
		if (Config_CM.getInstance().kaedeBiomeGene() == true) {
			...
			BiomeDictionary.addTypes(ACER_FOREST_KEY, Type.OVERWORLD, Type.FOREST);
			...
			BiomeDictionary.addTypes(ACER_HILLS_KEY, Type.OVERWORLD, Type.FOREST, Type.HILLS, Type.RARE); }
		...
		if (Config_CM.getInstance().ichohBiomeGene() == true) {
			...
			BiomeDictionary.addTypes(GINKGO_FOREST_KEY, Type.OVERWORLD, Type.FOREST);
			...
			BiomeDictionary.addTypes(GINKGO_HILLS_KEY, Type.OVERWORLD, Type.FOREST, Type.HILLS, Type.RARE); }
