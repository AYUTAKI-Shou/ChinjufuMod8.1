...
public class AddBiomes_CM {
	...
	public static void addBiomes() {
		...
		if (Config_CM.getInstance().sakuraBiomeGene() == true) {
			...
			BiomeDictionary.addTypes(Biomes_CM.SAKURA_FOREST.get(), Type.OVERWORLD, Type.FOREST);
			...
			BiomeDictionary.addTypes(Biomes_CM.SAKURA_HILLS.get(), Type.OVERWORLD, Type.FOREST, Type.HILLS, Type.RARE); }
		...
		if (Config_CM.getInstance().kaedeBiomeGene() == true) {
			...
			BiomeDictionary.addTypes(Biomes_CM.ACER_FOREST.get(), Type.OVERWORLD, Type.FOREST);
			...
			BiomeDictionary.addTypes(Biomes_CM.ACER_HILLS.get(), Type.OVERWORLD, Type.FOREST, Type.HILLS, Type.RARE); }
		...
		if (Config_CM.getInstance().ichohBiomeGene() == true) {
			...
			BiomeDictionary.addTypes(Biomes_CM.GINKGO_FOREST.get(), Type.OVERWORLD, Type.FOREST);
			...
			BiomeDictionary.addTypes(Biomes_CM.GINKGO_HILLS.get(), Type.OVERWORLD, Type.FOREST, Type.HILLS, Type.RARE); }
