...
public class Biomes_CM {
	...
	public static void registerBiomes(RegistryEvent.Register<Biome> event) {
		...
		if (Config_CM.sakuraBiomeRegister == true) {
			...
			BiomeDictionary.addTypes(BIOME_SAKURA, BiomeDictionary.Type.FOREST);
			...
			BiomeDictionary.addTypes(BIOME_SAKURA_HILL, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.HILLS, BiomeDictionary.Type.RARE);
		}
		if (Config_CM.sakuraBiomeRegister != true) { }
		...
		if (Config_CM.kaedeBiomeRegister == true) {
			...
			BiomeDictionary.addTypes(BIOME_KAEDE, BiomeDictionary.Type.FOREST);
			...
			BiomeDictionary.addTypes(BIOME_KAEDE_HILL, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.HILLS, BiomeDictionary.Type.RARE);
		...
		if (Config_CM.ichohBiomeRegister == true) {
			...
			BiomeDictionary.addTypes(BIOME_ICHOH, BiomeDictionary.Type.FOREST);
			...
			BiomeDictionary.addTypes(BIOME_ICHOH_HILL, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.HILLS, BiomeDictionary.Type.RARE);
