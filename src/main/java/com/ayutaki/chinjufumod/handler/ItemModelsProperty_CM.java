...
public class ItemModelsProperty_CM {
	...
	public static void register() {
		...
		ItemModelsProperties.register(Items_Teatime.KUSHI_SAKANA_C, new ResourceLocation("eat"), (stack, worldIn, entity) -> {
			return entity != null && entity.isUsingItem() && entity.getUseItem() == stack ? 1.0F : 0.0F; } );
		...
		/* floatplane */
		ItemModelsProperties.register(Items_Weapon.ZUIUN, new ResourceLocation("pull"), (stack, worldIn, entity) -> {
		return entity != null && entity.isUsingItem() && entity.getUseItem() == stack ? 1.0F : 0.0F; } );
		
		ItemModelsProperties.register(Items_Weapon.SEIRAN, new ResourceLocation("pull"), (stack, worldIn, entity) -> {
		return entity != null && entity.isUsingItem() && entity.getUseItem() == stack ? 1.0F : 0.0F; } );
		...
		ItemModelsProperties.register(Items_Teatime.BENTOU_SEKI, new ResourceLocation("eat"), (stack, worldIn, entity) -> {
			return entity != null && entity.isUsingItem() && entity.getUseItem() == stack ? 1.0F : 0.0F; } );
		
		ItemModelsProperties.register(Items_Teatime.SHAKEBEN_SEKI, new ResourceLocation("eat"), (stack, worldIn, entity) -> {
			return entity != null && entity.isUsingItem() && entity.getUseItem() == stack ? 1.0F : 0.0F; } );
	}
}
