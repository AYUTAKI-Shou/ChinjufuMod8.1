...
public class ItemModelsProperty_CM {
	...
	public static void register() {
		...
		ItemProperties.register(Items_Teatime.KUSHI_SAKANA_C.get(), new ResourceLocation("eat"), (stack, worldIn, entity, flag) -> {
			return entity != null && entity.isUsingItem() && entity.getUseItem() == stack ? 1.0F : 0.0F; } );
		...
		/* floatplane */
		ItemProperties.register(Items_Weapon.ZUIUN.get(), new ResourceLocation("pull"), (stack, worldIn, entity, flag) -> {
			return entity != null && entity.isUsingItem() && entity.getUseItem() == stack ? 1.0F : 0.0F; } );
		
		ItemProperties.register(Items_Weapon.SEIRAN.get(), new ResourceLocation("pull"), (stack, worldIn, entity, flag) -> {
			return entity != null && entity.isUsingItem() && entity.getUseItem() == stack ? 1.0F : 0.0F; } );
		...
		ItemProperties.register(Items_Teatime.BENTOU_SEKI.get(), new ResourceLocation("eat"), (stack, worldIn, entity, flag) -> {
			return entity != null && entity.isUsingItem() && entity.getUseItem() == stack ? 1.0F : 0.0F; } );
		
		ItemProperties.register(Items_Teatime.SHAKEBEN_SEKI.get(), new ResourceLocation("eat"), (stack, worldIn, entity, flag) -> {
			return entity != null && entity.isUsingItem() && entity.getUseItem() == stack ? 1.0F : 0.0F; } );
	}
}
