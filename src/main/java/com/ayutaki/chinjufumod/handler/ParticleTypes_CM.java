...
public class ParticleTypes_CM {
	...
	public static BasicParticleType CHALK_PT = register("chalk_pt", new BasicParticleType(false));
	public static BasicParticleType WAX_PT = register("wax_pt", new BasicParticleType(false));
