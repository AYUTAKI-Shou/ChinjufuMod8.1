...
public class ArmorLayer_CM {
	...
	public static final ModelLayerLocation ISE_INNER = register("armor_ise", "inner");
	public static final ModelLayerLocation ISE_OUTER = register("armor_ise", "outer");
	...
	public static final ModelLayerLocation I401_INNER = register("armor_i401", "inner");
	public static final ModelLayerLocation I401_OUTER = register("armor_i401", "outer");
	...
	public static final ModelLayerLocation SANTA_INNER = register("armor_santa", "inner");
	public static final ModelLayerLocation SANTA_OUTER = register("armor_santa", "outer");
	
	private static ModelLayerLocation createLocation(String name, String layer) {
		return new ModelLayerLocation(ChinjufuMod.id(name), layer);
	}
	
	private static ModelLayerLocation register(String name, String layer) {
		ModelLayerLocation modelLocation = createLocation(name, layer);
		if (!ALL_MODELS.add(modelLocation)) { throw new IllegalStateException("Duplicate registration for " + modelLocation); } 
		else { return modelLocation; }
	} // for 1.20.6
}
