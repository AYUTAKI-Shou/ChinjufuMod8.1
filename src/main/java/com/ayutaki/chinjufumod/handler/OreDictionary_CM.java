...
public class OreDictionary_CM {
	...
	* Link the material name in the ore dictionary with the material of your MOD.*/
	public static void registerOreDictionary() {
		...
		OreDictionary.registerOre("seedAzuki", Items_Teatime.SEEDS_AZUKI);
		...
		OreDictionary.registerOre("seedGreenonion", Items_Teatime.SEEDS_GREENONION);
		...
		OreDictionary.registerOre("cropGreenonion", Items_Teatime.FOOD_GREENONION);
		...
		OreDictionary.registerOre("foodSoysauce", Items_Teatime.SHOUYU_bot_14);
		OreDictionary.registerOre("foodSoysauce", Items_NoTab.SHOUYU_bot_24);
		OreDictionary.registerOre("foodSoysauce", Items_NoTab.SHOUYU_bot_34);
		OreDictionary.registerOre("foodSoysauce", Items_NoTab.SHOUYU_bot_44);
		OreDictionary.registerOre("foodVinegar", Items_Teatime.KOMEZU_bot_12);
		OreDictionary.registerOre("foodVinegar", Items_NoTab.KOMEZU_bot_22);
		OreDictionary.registerOre("foodOil", Items_Teatime.SOYOIL_bot_12);
		OreDictionary.registerOre("foodOil", Items_NoTab.SOYOIL_bot_22);
		...
		OreDictionary.registerOre("cropVanillabeans", new ItemStack(Items_Teatime.SPICE, 1, 8));
		OreDictionary.registerOre("cropVanillabean", new ItemStack(Items_Teatime.SPICE, 1, 8));
		...
		OreDictionary.registerOre("dustDashi", new ItemStack(Items_Teatime.DASHI_bot_14, 1, 0));
		OreDictionary.registerOre("dustDashi", new ItemStack(Items_NoTab.DASHI_bot_24, 1, 0));
		OreDictionary.registerOre("dustDashi", new ItemStack(Items_NoTab.DASHI_bot_34, 1, 0));
		OreDictionary.registerOre("dustDashi", new ItemStack(Items_NoTab.DASHI_bot_44, 1, 0));
		
		OreDictionary.registerOre("foodMayonnaise", new ItemStack(Items_Teatime.MAYO_bot_14, 1, 0));
		OreDictionary.registerOre("foodMayonnaise", new ItemStack(Items_NoTab.MAYO_bot_24, 1, 0));
		OreDictionary.registerOre("foodMayonnaise", new ItemStack(Items_NoTab.MAYO_bot_34, 1, 0));
		OreDictionary.registerOre("foodMayonnaise", new ItemStack(Items_NoTab.MAYO_bot_44, 1, 0));
		
		OreDictionary.registerOre("foodWorcestershiresauce", new ItemStack(Items_Teatime.OSAUCE_bot_14, 1, 0));
		OreDictionary.registerOre("foodWorcestershiresauce", new ItemStack(Items_NoTab.OSAUCE_bot_24, 1, 0));
		OreDictionary.registerOre("foodWorcestershiresauce", new ItemStack(Items_NoTab.OSAUCE_bot_34, 1, 0));
		OreDictionary.registerOre("foodWorcestershiresauce", new ItemStack(Items_NoTab.OSAUCE_bot_44, 1, 0));
		
		OreDictionary.registerOre("foodVanilla", new ItemStack(Items_Teatime.VANILLA_bot_14, 1, 0));
		OreDictionary.registerOre("foodVanilla", new ItemStack(Items_NoTab.VANILLA_bot_24, 1, 0));
		OreDictionary.registerOre("foodVanilla", new ItemStack(Items_NoTab.VANILLA_bot_34, 1, 0));
		OreDictionary.registerOre("foodVanilla", new ItemStack(Items_NoTab.VANILLA_bot_44, 1, 0));
		OreDictionary.registerOre("driedGracilaria", new ItemStack(Items_Teatime.SHIO, 1, 5));
	}
}
