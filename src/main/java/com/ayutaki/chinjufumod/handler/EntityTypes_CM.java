...
public class EntityTypes_CM {
	...
	public static EntityType<SB_ZuiunEntity> ZUIUN = register("zuiun", EntityType.Builder.<SB_ZuiunEntity>create(SB_ZuiunEntity::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<SB_SeiranEntity> SEIRAN = register("seiran", EntityType.Builder.<SB_SeiranEntity>create(SB_SeiranEntity::new, EntityClassification.MISC)
			.size(2.0F, 2.0F).setTrackingRange(64).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
