...
public class EntityTypes_CM {
	...
	public static EntityType<SB_ZuiunEntity> ZUIUN = register("zuiun", EntityType.Builder.<SB_ZuiunEntity>of(SB_ZuiunEntity::new, EntityClassification.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static EntityType<SB_SeiranEntity> SEIRAN = register("seiran", EntityType.Builder.<SB_SeiranEntity>of(SB_SeiranEntity::new, EntityClassification.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
