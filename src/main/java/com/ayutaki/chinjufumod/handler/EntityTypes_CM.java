...
public class EntityTypes_CM {
	...
	public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister.create(Registries.ENTITY_TYPE, ChinjufuMod.MOD_ID);

	public static final DeferredHolder<EntityType<?>, EntityType<SitableEntity>> SITABLE = register("entity_sit", 
			() -> EntityType.Builder.<SitableEntity>of(SitableEntity::new, MobCategory.MISC).sized(0.0F, 0.0F));
	
	public static final DeferredHolder<EntityType<?>, EntityType<ToamiEntity>> TOAMI = register("toami", 
	...
	public static final DeferredHolder<EntityType<?>, EntityType<AmmoEntity_Small>> AMMO_S = register("ammunition_small", 
			() -> EntityType.Builder.<AmmoEntity_Small>of(AmmoEntity_Small::new, MobCategory.MISC).sized(0.5F, 0.5F));
	public static final DeferredHolder<EntityType<?>, EntityType<AmmoEntity_Medium>> AMMO_M = register("ammunition_medium", 
			() -> EntityType.Builder.<AmmoEntity_Medium>of(AmmoEntity_Medium::new, MobCategory.MISC).sized(0.75F, 0.75F));
	public static final DeferredHolder<EntityType<?>, EntityType<AmmoEntity_Large>> AMMO_L = register("ammunition_large", 
			() -> EntityType.Builder.<AmmoEntity_Large>of(AmmoEntity_Large::new, MobCategory.MISC).sized(1.0F, 1.0F));
	public static final DeferredHolder<EntityType<?>, EntityType<AmmoEntity_Kijyuu>> AMMO_K = register("ammunition_kijyuu", 
			() -> EntityType.Builder.<AmmoEntity_Kijyuu>of(AmmoEntity_Kijyuu::new, MobCategory.MISC).sized(0.25F, 0.25F));
	
	/* Aircraft */
	public static final DeferredHolder<EntityType<?>, EntityType<KK_Type97Entity>> TYPE97 = register("type97", 
	...
	public static final DeferredHolder<EntityType<?>, EntityType<KK_TenzanEntity>> TENZAN = register("tenzan", 
			() -> EntityType.Builder.<KK_TenzanEntity>of(KK_TenzanEntity::new, MobCategory.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static final DeferredHolder<EntityType<?>, EntityType<KK_RyuseiEntity>> RYUSEI = register("ryusei", 
			() -> EntityType.Builder.<KK_RyuseiEntity>of(KK_RyuseiEntity::new, MobCategory.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static final DeferredHolder<EntityType<?>, EntityType<KK_TBFEntity>> TBF = register("tbf", 
			() -> EntityType.Builder.<KK_TBFEntity>of(KK_TBFEntity::new, MobCategory.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static final DeferredHolder<EntityType<?>, EntityType<KK_SwordfishEntity>> SWORDFISH = register("swordfish", 
			() -> EntityType.Builder.<KK_SwordfishEntity>of(KK_SwordfishEntity::new, MobCategory.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static final DeferredHolder<EntityType<?>, EntityType<KK_BarracudaEntity>> BARRACUDA = register("barracuda", 
			() -> EntityType.Builder.<KK_BarracudaEntity>of(KK_BarracudaEntity::new, MobCategory.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static final DeferredHolder<EntityType<?>, EntityType<KK_MosquitoEntity>> MOSQUITO = register("mosquito", 
			() -> EntityType.Builder.<KK_MosquitoEntity>of(KK_MosquitoEntity::new, MobCategory.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	
	public static final DeferredHolder<EntityType<?>, EntityType<KB_Type99Entity>> TYPE99 = register("type99", 
			() -> EntityType.Builder.<KB_Type99Entity>of(KB_Type99Entity::new, MobCategory.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static final DeferredHolder<EntityType<?>, EntityType<KB_SuiseiEntity>> SUISEI = register("suisei", 
			() -> EntityType.Builder.<KB_SuiseiEntity>of(KB_SuiseiEntity::new, MobCategory.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static final DeferredHolder<EntityType<?>, EntityType<KB_TypeZeroEntity>> TYPEZERO = register("typezero", 
			() -> EntityType.Builder.<KB_TypeZeroEntity>of(KB_TypeZeroEntity::new, MobCategory.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static final DeferredHolder<EntityType<?>, EntityType<KB_Ju87Entity>> JU87 = register("ju87", 
			() -> EntityType.Builder.<KB_Ju87Entity>of(KB_Ju87Entity::new, MobCategory.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static final DeferredHolder<EntityType<?>, EntityType<KB_Re2001Entity>> RE2001 = register("re2001", 
			() -> EntityType.Builder.<KB_Re2001Entity>of(KB_Re2001Entity::new, MobCategory.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static final DeferredHolder<EntityType<?>, EntityType<KB_SBDEntity>> SBD = register("sbd", 
			() -> EntityType.Builder.<KB_SBDEntity>of(KB_SBDEntity::new, MobCategory.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static final DeferredHolder<EntityType<?>, EntityType<KB_F4UEntity>> F4U = register("f4u", 
			() -> EntityType.Builder.<KB_F4UEntity>of(KB_F4UEntity::new, MobCategory.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	
	public static final DeferredHolder<EntityType<?>, EntityType<SB_ZuiunEntity>> ZUIUN = register("zuiun", 
			() -> EntityType.Builder.<SB_ZuiunEntity>of(SB_ZuiunEntity::new, MobCategory.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static final DeferredHolder<EntityType<?>, EntityType<SB_SeiranEntity>> SEIRAN = register("seiran", 
			() -> EntityType.Builder.<SB_SeiranEntity>of(SB_SeiranEntity::new, MobCategory.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));

	public static final DeferredHolder<EntityType<?>, EntityType<Gyorai61cmEntity>> GYORAI61 = register("gyorai", 
	...
	public static <T extends Entity> DeferredHolder<EntityType<?>, EntityType<T>> register(String name, Supplier<EntityType.Builder<T>> builder) {
		ResourceLocation location = ResourceLocation.fromNamespaceAndPath(ChinjufuMod.MOD_ID, name);
		return ENTITY_TYPES.register(name, () -> builder.get().build(ResourceKey.create(Registries.ENTITY_TYPE, location)));
	}
}
