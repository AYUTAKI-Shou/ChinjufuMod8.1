...
public class EntityTypes_CM {
	...
	public static final RegistryObject<EntityType<SitableEntity>> SITABLE = register("sitable",
	...
	public static final RegistryObject<EntityType<SB_ZuiunEntity>> ZUIUN = register("zuiun", 
			() -> EntityType.Builder.<SB_ZuiunEntity>of(SB_ZuiunEntity::new, MobCategory.MISC)
			.sized(2.0F, 2.0F).setTrackingRange(10).setUpdateInterval(10).setShouldReceiveVelocityUpdates(true));
	public static final RegistryObject<EntityType<SB_SeiranEntity>> SEIRAN = register("seiran", 
