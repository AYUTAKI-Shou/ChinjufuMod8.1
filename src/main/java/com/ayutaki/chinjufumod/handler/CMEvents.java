...
public class CMEvents {
	...
	public static void soundBubble(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.BUBBLE_COLUMN_BUBBLE_POP, SoundCategory.BLOCKS, 2.0F, 0.8F); } //17

	public static void soundClothBreak(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.WOOL_BREAK, SoundCategory.BLOCKS, 1.0F, 0.8F); } //3
	
	public static void soundClothPlace(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.WOOL_PLACE, SoundCategory.BLOCKS, 1.0F, 0.8F); } //7
	...
	public static void soundFlint(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.FLINTANDSTEEL_USE, SoundCategory.BLOCKS, 1.0F, 0.8F); } //7
	
	public static void soundFireExting(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.FIRE_EXTINGUISH, SoundCategory.BLOCKS, 0.2F, 2.0F); } //13

	public static void soundFish(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.FISH_SWIM, SoundCategory.NEUTRAL, 0.3F, 1.0F); } //5
	...
	public static void soundItemPick(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.ITEM_PICKUP, SoundCategory.PLAYERS, 0.2F, 2.0F); } //4
	...
	public static void soundKotePlace(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.METAL_HIT, SoundCategory.BLOCKS, 0.8F, 3.0F); } //3
	...
	public static void soundSAKEBottleFill(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.BOTTLE_FILL, SoundCategory.PLAYERS, 0.7F, 0.8F); } //4
	...
	public static void soundSnowBreak(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.SNOW_BREAK, SoundCategory.BLOCKS, 1.0F, 0.8F); } //15

	public static void soundSnowTake(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.SNOW_BREAK, SoundCategory.BLOCKS, 0.8F, 1.2F); } //4
	
	public static void soundSnowPlace(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.SNOW_PLACE, SoundCategory.BLOCKS, 0.8F, 1.2F); } //15
	
	public static void soundStoneButton_Off(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.STONE_BUTTON_CLICK_OFF, SoundCategory.BLOCKS, 0.8F, 0.65F); } //8
	
	public static void soundStoneButton_On(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.STONE_BUTTON_CLICK_ON, SoundCategory.BLOCKS, 1.0F, 0.8F); } //7 - ShishiOdoshi_2

	public static void soundStonePlace(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.STONE_PLACE, SoundCategory.BLOCKS, 1.0F, 0.8F); } //12
	...
	public static void soundWoodPlace(World worldIn, BlockPos pos) {
		worldIn.playSound(null, pos, SoundEvents.WOOD_PLACE, SoundCategory.BLOCKS, 1.0F, 0.8F); } //29
	
	
	public static void soundBucketEmpty(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		if (playerIn != null) { worldIn.playSound(playerIn, pos, SoundEvents.BUCKET_EMPTY, SoundCategory.BLOCKS, 1.0F, 1.0F); }
	} //5

	public static void soundBucketFill(World worldIn, BlockPos pos, PlayerEntity playerIn, float volume, float pitch) {
		if (playerIn != null) { worldIn.playSound(playerIn, pos, SoundEvents.BUCKET_FILL, SoundCategory.PLAYERS, volume, pitch); }
	} //6
	...
	public static void textEarlyCollect(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		...
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.rightclick.earlycollect"), true); } //112
	
	public static void textEarlyUse(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		CMEvents.soundTouchBlock(worldIn, pos);
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.rightclick.earlyuse"), true); } //6
	
	public static void textFullItem(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		CMEvents.soundTouchBlock(worldIn, pos);
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.rightclick.fullitem"), true); } //116
	
	public static void textNoPlace(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		CMEvents.soundTouchBlock(worldIn, pos);
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.rightclick.noplace"), true); } //25
	
	public static void textNotEnough_Items(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		CMEvents.soundTouchBlock(worldIn, pos);
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.rightclick.notenough_items"), true); } //11
	
	public static void textNotHave(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		CMEvents.soundTouchBlock(worldIn, pos);
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.rightclick.nothave"), true); } //244
	
	public static void textNotSneak(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		CMEvents.soundTouchBlock(worldIn, pos);
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.rightclick.notsneak"), true); } //9
	
	public static void textIsBlocked(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		CMEvents.soundTouchBlock(worldIn, pos);
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.rightclick.blocked"), true); } //65

	public static void textIsEmpty(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		CMEvents.soundTouchBlock(worldIn, pos);
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.rightclick.empty"), true); } //49
	
	public static void textIsSleeping(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		CMEvents.soundTouchBlock(worldIn, pos);
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.rightclick.sleeping"), true); } //3
	
	public static void textIsWaterlogged(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		CMEvents.soundTouchBlock(worldIn, pos);
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.rightclick.waterlogged"), true); } //101
	
	public static void textRequestHeat(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		CMEvents.soundTouchBlock(worldIn, pos);
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.rightclick.heat"), true); } //4
	
	public static void textRequestCool(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		CMEvents.soundTouchBlock(worldIn, pos);
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.rightclick.cool"), true); } //2
	
	public static void textNotEnough_EXP(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		CMEvents.soundTouchBlock(worldIn, pos);
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.rightclick.notenough_exp"), true); } //5
	
	public static void textNotDig(PlayerEntity playerIn) {
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.rightclick.notdig"), true); } //3

	public static void textNeedClean(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		CMEvents.soundTouchBlock(worldIn, pos);
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.need_clean"), true); } //3
	
	public static void textIsWaxed(World worldIn, BlockPos pos, PlayerEntity playerIn) {
		CMEvents.soundTouchBlock(worldIn, pos);
		playerIn.displayClientMessage(new TranslationTextComponent("text.chinjufumod.is_waxed"), true); } //3
	...
	public static void consume1_seBottle(World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand) {
		...
		if (playerIn != null) { worldIn.playSound(playerIn, pos, SoundEvents.BOTTLE_FILL, SoundCategory.PLAYERS, 0.7F, 1.0F); }
	} //4
	...
	public static void takeN_Item(int amount, PlayerEntity playerIn, Hand hand, Item item) {
		...
		if (hStack.isEmpty()) { playerIn.inventory.add(take); }
	...
	public static void Bottle_toWaterBottle(World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand) {
		...
		CMEvents.consume1_seBottle(worldIn, pos, playerIn, hand);
		ItemStack take = PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.WATER);
		if (hStack.isEmpty()) { playerIn.setItemInHand(hand, take); }
		else if (!playerIn.inventory.add(take)) { playerIn.drop(take, false); } } //5
	...
	public static void wash_Banner(World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand) {
		...
		copy.setCount(1);
		BannerTileEntity.removeLastPattern(copy);
		...
		else if (!playerIn.inventory.add(copy)) { playerIn.drop(copy, false); }
	...
	public static void wash_Shulker(World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand) {
		...
		playerIn.setItemInHand(hand, SHULKER);
		CMEvents.soundWaterUse(worldIn, pos);
	...
	public static void toolDamege(int damage, PlayerEntity playerIn, ItemStack hStack) {
		boolean mode = playerIn.abilities.instabuild;
		if (playerIn != null) {
			hStack.hurtAndBreak(mode? 0 : damage, playerIn, (user) -> { user.broadcastBreakEvent(playerIn.getUsedItemHand()); } ); }
	} //29
	
	
	/** Get EXP. **/
	public static void addEXP(int i, World worldIn, BlockPos pos) {
		worldIn.addFreshEntity(new ExperienceOrbEntity(worldIn, pos.getX(), pos.getY(), pos.getZ(), i)); } //27
	...
	public static void Wax_Particle(World worldIn, BlockPos pos, PlayerEntity playerIn, Hand hand) {
		...
		for(int n = 0; n < 15; ++n) {
			...
			double d1 = worldIn.random.nextGaussian() * 0.02D;
			double d2 = worldIn.random.nextGaussian() * 0.02D;
			worldIn.addParticle(ParticleTypes_CM.WAX_PT, pos.getX() + worldIn.random.nextFloat(), pos.getY() +worldIn.random.nextFloat(), pos.getZ() + worldIn.random.nextFloat(), d0, d1, d2); }
	...
	public static void walkOnWater(World worldIn, PlayerEntity playerIn) {
		...
		BlockState WAKE1 = Chinjufu_Blocks.WAKE_WATER1.defaultBlockState();
		...
		if (worldIn.getBlockState(new BlockPos(x + i, y - 1.0D, z + j)).getBlock() instanceof FlowingFluidBlock) {
			...
			if (underState.getMaterial() == Material.WATER && underState.getValue(FlowingFluidBlock.LEVEL).intValue() == 0) {

				BlockState levelState = worldIn.getBlockState(new BlockPos(x + i, y, z + j));
				if (levelState.getMaterial().isReplaceable()) {
					if (levelState.getMaterial() == Material.WATER && levelState.getValue(FlowingFluidBlock.LEVEL).intValue() == 0) { }
		...
		if (worldIn.getBlockState(new BlockPos(x + i, y - 1.0D, z + j)).getBlock() instanceof AbstractCoralPlantBlock) {
			BlockState underState = worldIn.getBlockState(new BlockPos(x + i, y - 1.0D, z + j));
			if (underState.getValue(AbstractCoralPlantBlock.WATERLOGGED)) {
		...
		if (worldIn.getBlockState(new BlockPos(x + i, y - 1.0D, z + j)).getBlock() instanceof SeaPickleBlock) {
			BlockState underState = worldIn.getBlockState(new BlockPos(x + i, y - 1.0D, z + j));
			if (underState.getValue(SeaPickleBlock.WATERLOGGED)) {
