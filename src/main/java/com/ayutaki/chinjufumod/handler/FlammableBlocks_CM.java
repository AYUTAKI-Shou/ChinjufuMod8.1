...
public class FlammableBlocks_CM {
	...
	/* FireBlock を参考に Block is a cube., 半ブロック, 階段に絞る */
	public static void setup() {
		...
		registerFlammable(WallPanel_Blocks.PILLAR_oak, 5, 5);
		registerFlammable(WallPanel_Blocks.PILLAR_spru, 5, 5);
		registerFlammable(WallPanel_Blocks.PILLAR_bir, 5, 5);
		registerFlammable(WallPanel_Blocks.PILLAR_jun, 5, 5);
		registerFlammable(WallPanel_Blocks.PILLAR_aca, 5, 5);
		registerFlammable(WallPanel_Blocks.PILLAR_doak, 5, 5);
