...
public class FlammableBlocks_CM {
	...
	public static void init() {
		...
		registerFlammable(Pantry_Blocks.BOX_H_KURI, 5, 20);
		registerFlammable(Pantry_Blocks.BOX_H_TAKENOKO, 5, 20);
		...
		registerFlammable(KamoiPlanks_Blocks.KAMOI_oak_sakura, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_spru_sakura, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_bir_sakura, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_jun_sakura, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_aca_sakura, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_doak_sakura, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_saku_sakura, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_kae_sakura, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_ich_sakura, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_oak_kaede, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_spru_kaede, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_bir_kaede, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_jun_kaede, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_aca_kaede, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_doak_kaede, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_saku_kaede, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_kae_kaede, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_ich_kaede, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_oak_ichoh, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_spru_ichoh, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_bir_ichoh, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_jun_ichoh, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_aca_ichoh, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_doak_ichoh, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_saku_ichoh, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_kae_ichoh, 5, 5);
		registerFlammable(KamoiPlanks_Blocks.KAMOI_ich_ichoh, 5, 5);
