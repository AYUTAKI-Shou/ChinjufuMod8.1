...
public class SoundEvents_CM {
	...
	public static final RegistryObject<SoundEvent> AM_CARTRIDGE_K = register("am_cartridge_k");
	...
	public static final RegistryObject<SoundEvent> WRITE_CHALK = register("write_chalk");
	public static final RegistryObject<SoundEvent> USE_ERASER = register("use_eraser");
	public static final RegistryObject<SoundEvent> CLEAN_ERASER = register("clean_eraser");
	...
	public static final RegistryObject<SoundEvent> SONAR = register("sonar");
	public static final RegistryObject<SoundEvent> PAGE_TURN = register("page_turn");
