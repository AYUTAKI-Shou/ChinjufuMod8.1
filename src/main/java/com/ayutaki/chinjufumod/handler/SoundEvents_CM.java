...
public class SoundEvents_CM {
	...
	public static SoundEvent AM_CARTRIDGE_K = register("am_cartridge_k");
	...
	public static SoundEvent KK_PROPELLER12 = register("kk_propeller_12");
	...
	public static SoundEvent WRITE_CHALK = register("write_chalk");
	public static SoundEvent USE_ERASER = register("use_eraser");
	public static SoundEvent CLEAN_ERASER = register("clean_eraser");
	...
	public static SoundEvent SONAR = register("sonar");
	public static SoundEvent PAGE_TURN = register("page_turn");
