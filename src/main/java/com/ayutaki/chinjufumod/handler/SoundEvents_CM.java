...
public class SoundEvents_CM {
	...
	public static SoundEvent AM_CARTRIDGE, AM_CARTRIDGE_K, AM_FIRE, AM_IMPACT, AM_HIT, SET_GUN, EMPTY_AMMO;
	...
	public static SoundEvent WRITE_REPORT, WRITE_CHALK, USE_ERASER, CLEAN_ERASER,
										OPEN, OPEN_OVEN, REIZOU_OPEN, REIZOU_CLOSE;
	public static SoundEvent TOUCH_BLOCK, THROW, SWING, ERROR, NOISE, SONAR, PAGE_TURN;
	
	public static void registerSounds() {

		AM_CARTRIDGE = registerSound("am_cartridge");
		AM_CARTRIDGE_K = registerSound("am_cartridge_k");
		...
		WRITE_CHALK = registerSound("write_chalk");
		USE_ERASER = registerSound("use_eraser");
		CLEAN_ERASER = registerSound("clean_eraser");
		...
		SONAR = registerSound("sonar");
		PAGE_TURN = registerSound("page_turn");
	}
