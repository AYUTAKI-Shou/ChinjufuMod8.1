...
public class CompostableItems_CM {
	...
	public static void register() {
		...
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.TENCHA.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.MATCHA.get(), 0.3F);
		...
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.YUDEAZUKI.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.ANKO.get(), 0.5F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.CUSTARD.get(), 0.3F);
		...
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.KIJI_ANPAN.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.KIJI_CUSTARD_PAN.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.KIJI_APPLE_PAN.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.KIJI_CHERRY_PAN.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.KIJI_CITRUS_PAN.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.KIJI_GRAPE_PAN.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.KIJI_GREENTEA_PAN.get(), 0.3F);
		...
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.PIZZA_nama.get(), 0.5F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.PIZZAC_nama.get(), 0.5F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.PIZZAT_nama.get(), 0.5F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.PIZZAS_nama.get(), 0.5F);
		...
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.PIZZA_C.get(), 1.0F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.PIZZA_T.get(), 1.0F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.PIZZA_S.get(), 1.0F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.PC_PIZZA.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.PC_PIZZAC.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.PC_PIZZAT.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.PC_PIZZAS.get(), 0.3F);
		...
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.FCHEESE.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.PC_CHEESE.get(), 0.3F);
		...
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.NORI_N.get(), 0.1F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.NORI_I.get(), 0.1F);
		...
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.ONIGIRI_SEKIHAN.get(), 0.5F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.FUTOMAKI.get(), 0.5F);

		ComposterBlock.COMPOSTABLES.put(Items_Teatime.KUSHI_SAKANA.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.KUSHI_SAKANA_C.get(), 0.5F);

		ComposterBlock.COMPOSTABLES.put(Items_Teatime.BENTOU.get(), 1.0F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.SHAKEBEN.get(), 1.0F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.BENTOU_TAKE.get(), 1.0F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.SHAKEBEN_TAKE.get(), 1.0F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.BENTOU_KURI.get(), 1.0F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.SHAKEBEN_KURI.get(), 1.0F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.BENTOU_SEKI.get(), 1.0F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.SHAKEBEN_SEKI.get(), 1.0F);
		
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.MOCHI.get(), 1.0F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.MOCHI_NORI.get(), 0.5F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.MOCHI_KINAKO.get(), 0.5F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.MOCHI_ANKO.get(), 0.5F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.MOCHI_OHAGI.get(), 0.5F);

		ComposterBlock.COMPOSTABLES.put(Items_Teatime.ANPAN.get(), 0.5F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.CUSTARD_PAN.get(), 0.5F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.APPLE_PAN.get(), 0.5F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.CHERRY_PAN.get(), 0.5F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.CITRUS_PAN.get(), 0.5F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.GRAPE_PAN.get(), 0.5F);
		ComposterBlock.COMPOSTABLES.put(Items_Teatime.GREENTEA_PAN.get(), 0.5F);
		
		
		/* Seasonal */
		ComposterBlock.COMPOSTABLES.put(Items_Seasonal.FOOD_CHOCO.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Seasonal.FOOD_CHOCO_apple.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Seasonal.FOOD_CHOCO_cherry.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Seasonal.FOOD_CHOCO_citrus.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Seasonal.FOOD_CHOCO_grape.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Seasonal.FOOD_CHOCO_tea.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Seasonal.FOOD_CHOCO_heart.get(), 0.3F);
		
		ComposterBlock.COMPOSTABLES.put(Items_Seasonal.FOOD_WATAGASHI.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Seasonal.FOOD_WATAGASHI_apple.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Seasonal.FOOD_WATAGASHI_cherry.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Seasonal.FOOD_WATAGASHI_citrus.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Seasonal.FOOD_WATAGASHI_grape.get(), 0.3F);
		ComposterBlock.COMPOSTABLES.put(Items_Seasonal.FOOD_WATAGASHI_tea.get(), 0.3F);
