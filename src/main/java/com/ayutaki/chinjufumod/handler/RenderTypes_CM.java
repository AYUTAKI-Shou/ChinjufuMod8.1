...
public class RenderTypes_CM {
	...
	public static void register() {
		...
		RenderTypeLookup.setRenderLayer(Chinjufu_Blocks.WAKE_WATER1, cutout);
		RenderTypeLookup.setRenderLayer(Chinjufu_Blocks.WAKE_WATER2, cutout);
		RenderTypeLookup.setRenderLayer(Chinjufu_Blocks.WAKE_WATER3, cutout);
		RenderTypeLookup.setRenderLayer(Chinjufu_Blocks.AMMO_BOX, cutout);
		RenderTypeLookup.setRenderLayer(Chinjufu_Blocks.BAUXITE_BOX, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_APPLE, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_BEEF, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_BEETROOT, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_BREAD, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_CARROT, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_CHICKEN, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_CHORUS, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_COD, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_EGG, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_FISH, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_MUTTON, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_PORK, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_POTATO, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_RABBIT, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_SALMON, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_SWBERRY, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_CABBAGE, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_HAKUSAI, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_CITRUS, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_CORN, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_GREENONION, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_GRAPE, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_ONION, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_ORIENTCLAM, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_SPINACH, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_SQUID, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_TOMATO, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_CHERRY, cutout);
		RenderTypeLookup.setRenderLayer(Pantry_Blocks.BOX_H_TAKENOKO, cutout);
		
		RenderTypeLookup.setRenderLayer(Crop_Blocks.AZUKI, cutout); /** 7.4.1 **/
		...
		RenderTypeLookup.setRenderLayer(Crop_Blocks.VANILLA, cutout);
		...
		RenderTypeLookup.setRenderLayer(Crop_Blocks.TENGUSA, cutout); /** 8.1 **/
		RenderTypeLookup.setRenderLayer(Crop_Blocks.NORI, cutout); /** 8.1 **/
		...
		RenderTypeLookup.setRenderLayer(Dish_Blocks.NABEGOHANTAKE_nama, trans); /** 7.4.1 **/
		RenderTypeLookup.setRenderLayer(Dish_Blocks.NABEGOHANKURI_nama, trans);
		RenderTypeLookup.setRenderLayer(Dish_Blocks.NABESEKIHAN_nama, trans); /** 7.4.1 **/
		...
		RenderTypeLookup.setRenderLayer(Dish_Blocks.NABEAZUKI_nama, trans); /** 7.4.1 **/
		RenderTypeLookup.setRenderLayer(Dish_Blocks.NABEANKO_nama, trans); /** 7.4.1 **/
		RenderTypeLookup.setRenderLayer(Dish_Blocks.NABEPUDDING_nama, trans); /** 7.4.1 **/
		RenderTypeLookup.setRenderLayer(Dish_Blocks.NABEPUDDING_green, trans); /** 7.4.1 **/
		RenderTypeLookup.setRenderLayer(Dish_Blocks.NABEPUDDING_red, trans); /** 7.4.1 **/
		RenderTypeLookup.setRenderLayer(Dish_Blocks.NABEPUDDING_cacao, trans); /** 7.4.1 **/
		RenderTypeLookup.setRenderLayer(Dish_Blocks.NABETENGUSA_nama, cutout); /** 8.1 **/
		...
		RenderTypeLookup.setRenderLayer(Dish_Blocks.OSAUCE_bot_14, trans);
		RenderTypeLookup.setRenderLayer(Dish_Blocks.OSAUCE_bot_24, trans);
		RenderTypeLookup.setRenderLayer(Dish_Blocks.OSAUCE_bot_34, trans);
		RenderTypeLookup.setRenderLayer(Dish_Blocks.OSAUCE_bot_44, trans);
		RenderTypeLookup.setRenderLayer(Dish_Blocks.MAYO_bot_14, trans);
		RenderTypeLookup.setRenderLayer(Dish_Blocks.MAYO_bot_24, trans);
		RenderTypeLookup.setRenderLayer(Dish_Blocks.MAYO_bot_34, trans);
		RenderTypeLookup.setRenderLayer(Dish_Blocks.MAYO_bot_44, trans);
		RenderTypeLookup.setRenderLayer(Dish_Blocks.SOYOIL_bot_12, trans); /** 7.4.1 **/
		RenderTypeLookup.setRenderLayer(Dish_Blocks.SOYOIL_bot_22, trans); /** 7.4.1 **/
		RenderTypeLookup.setRenderLayer(Dish_Blocks.TENGUSA_WASH, cutout); /** 8.1 **/
		...
		RenderTypeLookup.setRenderLayer(Wood_Blocks.DOOR_SAKURA, cutout);
		...
		RenderTypeLookup.setRenderLayer(Hakkou_Blocks.VANILLA_TARU, cutout);
		...
		RenderTypeLookup.setRenderLayer(Hakkou_Blocks.SHOUYU_bot_14, trans);
		RenderTypeLookup.setRenderLayer(Hakkou_Blocks.SHOUYU_bot_24, trans);
		RenderTypeLookup.setRenderLayer(Hakkou_Blocks.SHOUYU_bot_34, trans);
		RenderTypeLookup.setRenderLayer(Hakkou_Blocks.SHOUYU_bot_44, trans);
		RenderTypeLookup.setRenderLayer(Hakkou_Blocks.KOMEZU_bot_12, trans);
		RenderTypeLookup.setRenderLayer(Hakkou_Blocks.KOMEZU_bot_22, trans);
		RenderTypeLookup.setRenderLayer(Hakkou_Blocks.DASHI_bot_14, trans);
		RenderTypeLookup.setRenderLayer(Hakkou_Blocks.DASHI_bot_24, trans);
		RenderTypeLookup.setRenderLayer(Hakkou_Blocks.DASHI_bot_34, trans);
		RenderTypeLookup.setRenderLayer(Hakkou_Blocks.DASHI_bot_44, trans);
		RenderTypeLookup.setRenderLayer(Hakkou_Blocks.VANILLA_bot_14, cutout);
		RenderTypeLookup.setRenderLayer(Hakkou_Blocks.VANILLA_bot_24, cutout);
		RenderTypeLookup.setRenderLayer(Hakkou_Blocks.VANILLA_bot_34, cutout);
		RenderTypeLookup.setRenderLayer(Hakkou_Blocks.VANILLA_bot_44, cutout);
		...
		RenderTypeLookup.setRenderLayer(Harbor_Blocks.AMP, cutout);
		RenderTypeLookup.setRenderLayer(Harbor_Blocks.AMP_white, cutout);
		RenderTypeLookup.setRenderLayer(Harbor_Blocks.AMP_orange, cutout);
		RenderTypeLookup.setRenderLayer(Harbor_Blocks.AMP_magenta, cutout);
		RenderTypeLookup.setRenderLayer(Harbor_Blocks.AMP_lightb, cutout);
		RenderTypeLookup.setRenderLayer(Harbor_Blocks.AMP_yellow, cutout);
		RenderTypeLookup.setRenderLayer(Harbor_Blocks.AMP_lime, cutout);
		RenderTypeLookup.setRenderLayer(Harbor_Blocks.AMP_pink, cutout);
		RenderTypeLookup.setRenderLayer(Harbor_Blocks.AMP_gray, cutout);
		RenderTypeLookup.setRenderLayer(Harbor_Blocks.AMP_cyan, cutout);
		RenderTypeLookup.setRenderLayer(Harbor_Blocks.AMP_purple, cutout);
		RenderTypeLookup.setRenderLayer(Harbor_Blocks.AMP_blue, cutout);
		RenderTypeLookup.setRenderLayer(Harbor_Blocks.AMP_brown, cutout);
		RenderTypeLookup.setRenderLayer(Harbor_Blocks.AMP_green, cutout);
		RenderTypeLookup.setRenderLayer(Harbor_Blocks.AMP_red, cutout);
		RenderTypeLookup.setRenderLayer(Harbor_Blocks.AMP_black, cutout);
		...
		RenderTypeLookup.setRenderLayer(Unit_Blocks.FUDETRAY, cutout);
		RenderTypeLookup.setRenderLayer(Unit_Blocks.LETTERTRAY, cutout);
