...
public class RenderTypes_CM {
	...
	public static void register() {
		...
		ItemBlockRenderTypes.setRenderLayer(Chinjufu_Blocks.WAKE_WATER1.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Chinjufu_Blocks.WAKE_WATER2.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Chinjufu_Blocks.WAKE_WATER3.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Chinjufu_Blocks.AMMO_BOX.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Chinjufu_Blocks.BAUXITE_BOX.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_APPLE.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_BEEF.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_BEETROOT.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_BREAD.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_CARROT.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_CHICKEN.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_CHORUS.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_COD.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_EGG.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_FISH.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_MUTTON.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_PORK.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_POTATO.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_RABBIT.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_SALMON.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_SWBERRY.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_CABBAGE.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_HAKUSAI.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_CITRUS.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_CORN.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_GREENONION.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_GRAPE.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_ONION.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_ORIENTCLAM.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_SPINACH.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_SQUID.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_TOMATO.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_CHERRY.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Pantry_Blocks.BOX_H_TAKENOKO.get(), cutout);
		
		ItemBlockRenderTypes.setRenderLayer(Crop_Blocks.AZUKI.get(), cutout); /** 7.4.1 **/
		...
		ItemBlockRenderTypes.setRenderLayer(Crop_Blocks.GREENONION.get(), cutout);
		...
		ItemBlockRenderTypes.setRenderLayer(Crop_Blocks.VANILLA.get(), cutout);
		...
		ItemBlockRenderTypes.setRenderLayer(Crop_Blocks.TENGUSA.get(), cutout); /** 8.1 **/
		ItemBlockRenderTypes.setRenderLayer(Crop_Blocks.NORI.get(), cutout); /** 8.1 **/
		...
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.ZUNDOU_DASHI.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.ZUNDOU_RSOUP_nama.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.ZUNDOU_RSOUP.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.ZUNDOU_RAMEN.get(), trans);
		...
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.NABEGOHANTAKE_nama.get(), trans); /** 7.4.1 **/
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.NABEGOHANKURI_nama.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.NABESEKIHAN_nama.get(), trans); /** 7.4.1 **/
		...
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.NABEAZUKI_nama.get(), trans); /** 7.4.1 **/
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.NABEANKO_nama.get(), trans); /** 7.4.1 **/
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.NABEPUDDING_nama.get(), trans); /** 7.4.1 **/
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.NABEPUDDING_green.get(), trans); /** 7.4.1 **/
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.NABEPUDDING_red.get(), trans); /** 7.4.1 **/
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.NABEPUDDING_cacao.get(), trans); /** 7.4.1 **/
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.NABETENGUSA_nama.get(), cutout); /** 8.1 **/
		...
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.OSAUCE_bot_14.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.OSAUCE_bot_24.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.OSAUCE_bot_34.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.OSAUCE_bot_44.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.MAYO_bot_14.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.MAYO_bot_24.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.MAYO_bot_34.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.MAYO_bot_44.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.SOYOIL_bot_12.get(), trans); /** 7.4.1 **/
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.SOYOIL_bot_22.get(), trans); /** 7.4.1 **/
		ItemBlockRenderTypes.setRenderLayer(Dish_Blocks.TENGUSA_WASH.get(), cutout); /** 8.1 **/
		...
		ItemBlockRenderTypes.setRenderLayer(Hakkou_Blocks.VANILLA_TARU.get(), cutout);
		...
		ItemBlockRenderTypes.setRenderLayer(Hakkou_Blocks.SHOUYU_bot_14.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Hakkou_Blocks.SHOUYU_bot_24.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Hakkou_Blocks.SHOUYU_bot_34.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Hakkou_Blocks.SHOUYU_bot_44.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Hakkou_Blocks.KOMEZU_bot_12.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Hakkou_Blocks.KOMEZU_bot_22.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Hakkou_Blocks.DASHI_bot_14.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Hakkou_Blocks.DASHI_bot_24.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Hakkou_Blocks.DASHI_bot_34.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Hakkou_Blocks.DASHI_bot_44.get(), trans);
		ItemBlockRenderTypes.setRenderLayer(Hakkou_Blocks.VANILLA_bot_14.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Hakkou_Blocks.VANILLA_bot_24.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Hakkou_Blocks.VANILLA_bot_34.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Hakkou_Blocks.VANILLA_bot_44.get(), cutout);
		...
		ItemBlockRenderTypes.setRenderLayer(Harbor_Blocks.AMP.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Harbor_Blocks.AMP_white.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Harbor_Blocks.AMP_orange.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Harbor_Blocks.AMP_magenta.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Harbor_Blocks.AMP_lightb.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Harbor_Blocks.AMP_yellow.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Harbor_Blocks.AMP_lime.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Harbor_Blocks.AMP_pink.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Harbor_Blocks.AMP_gray.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Harbor_Blocks.AMP_cyan.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Harbor_Blocks.AMP_purple.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Harbor_Blocks.AMP_blue.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Harbor_Blocks.AMP_brown.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Harbor_Blocks.AMP_green.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Harbor_Blocks.AMP_red.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Harbor_Blocks.AMP_black.get(), cutout);
		...
		ItemBlockRenderTypes.setRenderLayer(Unit_Blocks.FUDETRAY.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(Unit_Blocks.LETTERTRAY.get(), cutout);
