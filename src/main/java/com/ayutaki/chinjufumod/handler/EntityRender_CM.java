...
public class EntityRender_CM {
	...
	public static void register() {
		...
		EntityRenderers.register(EntityTypes_CM.ZUIUN.get(), renderManager -> new RenderSB_Zuiun(renderManager, Minecraft.getInstance().getItemRenderer()));
		EntityRenderers.register(EntityTypes_CM.SEIRAN.get(), renderManager -> new RenderSB_Seiran(renderManager, Minecraft.getInstance().getItemRenderer()));
