...
public class LetterTray_CT extends IBR_Chinjufu {

	public LetterTray_CT(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (!hStack.isEmpty() && playerIn.canPlayerEdit(pos, facing, hStack) && worldIn.mayPlace(Unit_Blocks.LETTERTRAY, pos, false, facing, (Entity)null)) {

			IBlockState putSTATE = Unit_Blocks.LETTERTRAY.getDefaultState()
					.withProperty(TrayLetter.H_FACING, direction)
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> itemTip, ITooltipFlag advanced) {
		itemTip.add(I18n.format("tips.block_lettertray.name"));
	}
}
