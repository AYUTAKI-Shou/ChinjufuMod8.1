...
public class AmuBauxBox_CT extends IBR_Chinjufu {

	public AmuBauxBox_CT(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (!hStack.isEmpty() && playerIn.canPlayerEdit(pos, facing, hStack) && worldIn.mayPlace(Chinjufu_Blocks.AMUBAUX, pos, false, facing, (Entity)null)) {

			IBlockState putSTATE = Chinjufu_Blocks.AMUBAUX.getDefaultState()
