...
public class WallKawara_WT extends IBR_Wablock {

	public WallKawara_WT(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (!hStack.isEmpty() && playerIn.canPlayerEdit(pos, facing, hStack) && worldIn.mayPlace(JPBlock_Blocks.KAWARA_WALL, pos, false, facing, (Entity)null)) {

			IBlockState putSTATE = JPBlock_Blocks.KAWARA_WALL.getDefaultState()
					.withProperty(Base_WallKawara.STAGE_0_15, Integer.valueOf(k));
