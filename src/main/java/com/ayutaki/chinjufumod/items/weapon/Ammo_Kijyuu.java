...
public class Ammo_Kijyuu extends Item implements ProjectileItem {
	...
	public AbstractAmmo_Kijyuu createAmmo(Level worldIn, ItemStack hStack, LivingEntity shooter, @Nullable ItemStack eStack) {
		return new AmmoEntity_Kijyuu(worldIn, shooter, hStack.copyWithCount(1), eStack);
	}

	@Override
	public Projectile asProjectile(Level worldIn, Position pos, ItemStack hStack, Direction facing) {
		AmmoEntity_Kijyuu arrow = new AmmoEntity_Kijyuu(worldIn, pos.x(), pos.y(), pos.z(), hStack.copyWithCount(1), null);
