...
public class RensouHou203 extends AbstractRensouHou_M {
	...
	protected Projectile createProjectile(Level worldIn, LivingEntity entityLiving, ItemStack hStack, ItemStack projectile, boolean crit) {
		Ammo_Medium arrowItem = (Ammo_Medium)(projectile.getItem() instanceof Ammo_Medium arrowItem1 ? arrowItem1 : Items_Weapon.AMMUNITION_M.get());
	...
	public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> itemTip, TooltipFlag tipFlag) {
		itemTip.add(Component.translatable("tips.item_rensouhou_medium").withStyle(ChatFormatting.GRAY));
		itemTip.add(Component.translatable("tips.item_rensouhou203").withStyle(ChatFormatting.DARK_GREEN));
	}
}
