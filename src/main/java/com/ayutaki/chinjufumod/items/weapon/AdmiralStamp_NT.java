...
public class AdmiralStamp_NT extends NoGroup_noFuel {

	public AdmiralStamp_NT(Block blockIn, Item.Properties props) {
		super(blockIn, props);
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> itemTip, ITooltipFlag tipFlag) {
		itemTip.add(new TranslationTextComponent("tips.item_admiral_stamp").withStyle(TextFormatting.GRAY));
	}
}
