...
public class Ammo_Small extends Item implements ProjectileItem {
	...
	public AbstractAmmo_Entity createAmmo(Level worldIn, ItemStack hStack, LivingEntity shooter, @Nullable ItemStack eStack) {
		return new AmmoEntity_Small(worldIn, shooter, hStack.copyWithCount(1), eStack);
	}

	@Override
	public Projectile asProjectile(Level worldIn, Position pos, ItemStack hStack, Direction facing) {
		AmmoEntity_Small arrow = new AmmoEntity_Small(worldIn, pos.x(), pos.y(), pos.z(), hStack.copyWithCount(1), null);
