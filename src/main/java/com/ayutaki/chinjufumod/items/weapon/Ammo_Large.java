...
public class Ammo_Large extends Item implements ProjectileItem {
	...
	public AbstractAmmo_Entity createAmmo(Level worldIn, ItemStack stack, LivingEntity shooter) {
		return new AmmoEntity_Large(worldIn, shooter, stack.copyWithCount(1));
	}

	@Override
	public Projectile asProjectile(Level worldIn, Position pos, ItemStack stack, Direction facing) {
		AmmoEntity_Large arrow = new AmmoEntity_Large(worldIn, pos.x(), pos.y(), pos.z(), stack.copyWithCount(1));
