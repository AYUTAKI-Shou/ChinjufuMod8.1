...
public class RensouHou127 extends Abstract_RensouHou {

	public RensouHou127(String name, int max) {
		super(name, max);
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> itemTip, ITooltipFlag advanced) {
		...
		itemTip.add(TextFormatting.DARK_GREEN + I18n.format("tips.item_rensouhou127.name"));
	}
}
