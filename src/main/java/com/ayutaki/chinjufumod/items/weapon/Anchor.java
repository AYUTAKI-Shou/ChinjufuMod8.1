...
public class Anchor extends SwordItem {
	...
	public Anchor(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties props) {
	...
	public boolean hitEntity(ItemStack hStack, LivingEntity target, LivingEntity playerIn) {
		hStack.damageItem(1, playerIn, (user) -> { user.sendBreakAnimation(playerIn.getActiveHand()); } );
		return true;
	}
	...
	@Override
	public void inventoryTick(ItemStack hStack, World worldIn, Entity entity, int itemSlot, boolean isSelected) {
