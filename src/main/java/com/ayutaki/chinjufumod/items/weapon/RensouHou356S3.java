...
public class RensouHou356S3 extends AbstractRensouHou_L {
	...
	public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> itemTip, TooltipFlag tipFlag) {
		...
		itemTip.add(Component.translatable("tips.item_rensouhou356_s3").withStyle(ChatFormatting.DARK_GREEN));
	}
}
