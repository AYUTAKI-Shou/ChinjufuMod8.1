...
public class Shield_CM extends ShieldItem {
	...
	@Override
	public void releaseUsing(ItemStack hStack, World worldIn, LivingEntity entity, int timeLeft) {
	...
	public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> itemTip, ITooltipFlag tipFlag) {
		itemTip.add(new TranslationTextComponent("tips.item_shield").withStyle(TextFormatting.GRAY));
		itemTip.add(new TranslationTextComponent("tips.item_shield2").withStyle(TextFormatting.GRAY));
	}
}
