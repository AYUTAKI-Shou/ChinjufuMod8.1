...
public class RensouHou203SKC34 extends AbstractRensouHou_M {
	...
	public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> itemTip, TooltipFlag tipFlag) {
		...
		itemTip.add(Component.translatable("tips.item_rensouhou203_skc34").withStyle(ChatFormatting.DARK_GREEN));
	}
}
