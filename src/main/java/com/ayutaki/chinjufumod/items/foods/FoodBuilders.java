...
public class FoodBuilders {
	...
	public static final FoodProperties MOCHI = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new MobEffectInstance(MobEffects.DIG_SPEED, 500, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final FoodProperties MOCHI_ANKO = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new MobEffectInstance(MobEffects.DIG_SPEED, 750, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final FoodProperties MOCHI_SAKURA = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 750, 0), 1.0F).build();
	
	@SuppressWarnings("deprecation")
	public static final FoodProperties PAN_APPLE = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 800, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final FoodProperties PAN_CHERRY = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 800, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final FoodProperties PAN_CITRUS = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 800, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final FoodProperties PAN_GRAPE = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new MobEffectInstance(MobEffects.NIGHT_VISION, 800, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final FoodProperties PAN_TEA = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.6F)
	...
	public static final FoodProperties KURI_CHOCO = (new FoodProperties.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new MobEffectInstance(MobEffects.DIG_SPEED, 800, 0), 1.0F).alwaysEat().build();

	@SuppressWarnings("deprecation")
	public static final FoodProperties CHOCO = (new FoodProperties.Builder()).nutrition(1).saturationMod(0.3F)
			.effect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 800, 0), 1.0F).alwaysEat().build();
	@SuppressWarnings("deprecation")
	public static final FoodProperties CHOCO_apple = (new FoodProperties.Builder()).nutrition(1).saturationMod(0.3F)
			.effect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 1200, 0), 1.0F).alwaysEat().build();
	@SuppressWarnings("deprecation")
	public static final FoodProperties CHOCO_cherry = (new FoodProperties.Builder()).nutrition(1).saturationMod(0.3F)
			.effect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 1200, 0), 1.0F).alwaysEat().build();
	@SuppressWarnings("deprecation")
	public static final FoodProperties CHOCO_citrus = (new FoodProperties.Builder()).nutrition(1).saturationMod(0.3F)
			.effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 1200, 0), 1.0F).alwaysEat().build();
	@SuppressWarnings("deprecation")
	public static final FoodProperties CHOCO_grape = (new FoodProperties.Builder()).nutrition(1).saturationMod(0.3F)
			.effect(new MobEffectInstance(MobEffects.NIGHT_VISION, 1200, 0), 1.0F).alwaysEat().build();
	@SuppressWarnings("deprecation")
	public static final FoodProperties CHOCO_tea = (new FoodProperties.Builder()).nutrition(1).saturationMod(0.3F)
			.effect(new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 0), 1.0F).alwaysEat().build();
	@SuppressWarnings("deprecation")
	public static final FoodProperties CHOCO_heart = (new FoodProperties.Builder()).nutrition(1).saturationMod(0.3F)
