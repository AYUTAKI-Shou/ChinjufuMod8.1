...
public class FoodBuilders {
	...
	public static final Food ONIGIRI_TAKEKURI = (new Food.Builder()).hunger(4).saturation(0.6F)
			.effect(new EffectInstance(Effects.HASTE, 500, 0), 1.0F).build();
	
	@SuppressWarnings("deprecation")
	public static final Food MOCHI = (new Food.Builder()).hunger(4).saturation(0.6F)
			.effect(new EffectInstance(Effects.HASTE, 500, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final Food MOCHI_ANKO = (new Food.Builder()).hunger(4).saturation(0.6F)
			.effect(new EffectInstance(Effects.HASTE, 750, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final Food MOCHI_SAKURA = (new Food.Builder()).hunger(4).saturation(0.6F)
			.effect(new EffectInstance(Effects.STRENGTH, 750, 0), 1.0F).build();

	@SuppressWarnings("deprecation")
	public static final Food PAN_APPLE = (new Food.Builder()).hunger(4).saturation(0.6F)
			.effect(new EffectInstance(Effects.RESISTANCE, 800, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final Food PAN_CHERRY = (new Food.Builder()).hunger(4).saturation(0.6F)
			.effect(new EffectInstance(Effects.STRENGTH, 800, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final Food PAN_CITRUS = (new Food.Builder()).hunger(4).saturation(0.6F)
			.effect(new EffectInstance(Effects.FIRE_RESISTANCE, 800, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final Food PAN_GRAPE = (new Food.Builder()).hunger(4).saturation(0.6F)
			.effect(new EffectInstance(Effects.NIGHT_VISION, 800, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final Food PAN_TEA = (new Food.Builder()).hunger(4).saturation(0.6F)
			.effect(new EffectInstance(Effects.HASTE, 800, 0), 1.0F).build();
	...
	public static final Food CHOCO = (new Food.Builder()).hunger(1).saturation(0.3F)
			.effect(new EffectInstance(Effects.SPEED, 800, 0), 1.0F).setAlwaysEdible().build();
	@SuppressWarnings("deprecation")
	public static final Food CHOCO_apple = (new Food.Builder()).hunger(1).saturation(0.3F)
			.effect(new EffectInstance(Effects.RESISTANCE, 1200, 0), 1.0F).setAlwaysEdible().build();
	@SuppressWarnings("deprecation")
	public static final Food CHOCO_cherry = (new Food.Builder()).hunger(1).saturation(0.3F)
			.effect(new EffectInstance(Effects.STRENGTH, 1200, 0), 1.0F).setAlwaysEdible().build();
	@SuppressWarnings("deprecation")
	public static final Food CHOCO_citrus = (new Food.Builder()).hunger(1).saturation(0.3F)
			.effect(new EffectInstance(Effects.FIRE_RESISTANCE, 1200, 0), 1.0F).setAlwaysEdible().build();
	@SuppressWarnings("deprecation")
	public static final Food CHOCO_grape = (new Food.Builder()).hunger(1).saturation(0.3F)
			.effect(new EffectInstance(Effects.NIGHT_VISION, 1200, 0), 1.0F).setAlwaysEdible().build();
	@SuppressWarnings("deprecation")
	public static final Food CHOCO_tea = (new Food.Builder()).hunger(1).saturation(0.3F)
			.effect(new EffectInstance(Effects.HASTE, 1200, 0), 1.0F).setAlwaysEdible().build();
	@SuppressWarnings("deprecation")
	public static final Food CHOCO_heart = (new Food.Builder()).hunger(1).saturation(0.3F)
