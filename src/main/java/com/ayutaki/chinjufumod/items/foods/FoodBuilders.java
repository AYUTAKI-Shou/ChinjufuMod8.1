...
public class FoodBuilders {
	...
	public static final Food PC_PIZZAT = (new Food.Builder()).nutrition(6).saturationMod(0.6F)
			.effect(new EffectInstance(Effects.DIG_SPEED, 1400, 0), 1.0F)
			.effect(new EffectInstance(Effects.REGENERATION, 70, 1), 1.0F).build();
	@SuppressWarnings("deprecation")
	...
	public static final Food ONIGIRI_TAKEKURI = (new Food.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new EffectInstance(Effects.DIG_SPEED, 500, 0), 1.0F).build();

	@SuppressWarnings("deprecation")
	public static final Food MOCHI = (new Food.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new EffectInstance(Effects.DIG_SPEED, 500, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final Food MOCHI_ANKO = (new Food.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new EffectInstance(Effects.DIG_SPEED, 750, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final Food MOCHI_SAKURA = (new Food.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new EffectInstance(Effects.DAMAGE_BOOST, 750, 0), 1.0F).build();
	
	@SuppressWarnings("deprecation")
	public static final Food PAN_APPLE = (new Food.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new EffectInstance(Effects.DAMAGE_RESISTANCE, 800, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final Food PAN_CHERRY = (new Food.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new EffectInstance(Effects.DAMAGE_BOOST, 800, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final Food PAN_CITRUS = (new Food.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new EffectInstance(Effects.FIRE_RESISTANCE, 800, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final Food PAN_GRAPE = (new Food.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new EffectInstance(Effects.NIGHT_VISION, 800, 0), 1.0F).build();
	@SuppressWarnings("deprecation")
	public static final Food PAN_TEA = (new Food.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new EffectInstance(Effects.DIG_SPEED, 800, 0), 1.0F).build();
	...
	public static final Food KURI_CHOCO = (new Food.Builder()).nutrition(4).saturationMod(0.6F)
			.effect(new EffectInstance(Effects.DIG_SPEED, 800, 0), 1.0F).alwaysEat().build();

	@SuppressWarnings("deprecation")
	public static final Food CHOCO = (new Food.Builder()).nutrition(1).saturationMod(0.3F)
			.effect(new EffectInstance(Effects.MOVEMENT_SPEED, 800, 0), 1.0F).alwaysEat().build();
	@SuppressWarnings("deprecation")
	public static final Food CHOCO_apple = (new Food.Builder()).nutrition(1).saturationMod(0.3F)
			.effect(new EffectInstance(Effects.DAMAGE_RESISTANCE, 1200, 0), 1.0F).alwaysEat().build();
	@SuppressWarnings("deprecation")
	public static final Food CHOCO_cherry = (new Food.Builder()).nutrition(1).saturationMod(0.3F)
			.effect(new EffectInstance(Effects.DAMAGE_BOOST, 1200, 0), 1.0F).alwaysEat().build();
	@SuppressWarnings("deprecation")
	public static final Food CHOCO_citrus = (new Food.Builder()).nutrition(1).saturationMod(0.3F)
			.effect(new EffectInstance(Effects.FIRE_RESISTANCE, 1200, 0), 1.0F).alwaysEat().build();
	@SuppressWarnings("deprecation")
	public static final Food CHOCO_grape = (new Food.Builder()).nutrition(1).saturationMod(0.3F)
			.effect(new EffectInstance(Effects.NIGHT_VISION, 1200, 0), 1.0F).alwaysEat().build();
	@SuppressWarnings("deprecation")
	public static final Food CHOCO_tea = (new Food.Builder()).nutrition(1).saturationMod(0.3F)
			.effect(new EffectInstance(Effects.DIG_SPEED, 1200, 0), 1.0F).alwaysEat().build();
	@SuppressWarnings("deprecation")
	public static final Food CHOCO_heart = (new Food.Builder()).nutrition(1).saturationMod(0.3F)
