...
public class Candle_CT extends IBR_Chinjufu {

	public Candle_CT(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing,
		...
		if (!hStack.isEmpty() && playerIn.canPlayerEdit(pos, facing, hStack) && worldIn.mayPlace(Lamp_Blocks.CANDLE, pos, false, facing, (Entity)null)) {

			IBlockState putSTATE = Lamp_Blocks.CANDLE.getDefaultState().withProperty(Candle.STAGE_0_15, Integer.valueOf(k));
