...
public class GarasudoHalf_SN extends TN_SubSlideHalf {

	public GarasudoHalf_SN(String name) {
		super(name);
	}
	...
	public String getUnlocalizedName(ItemStack stack) {
		...
		case 0:
		default:
			return "item." + "block_garasudohalf_sakura";
		case 1:
			return "item." + "block_garasudohalf_kaede";
		case 2:
			return "item." + "block_garasudohalf_ichoh";
		}
	}
	...
	protected Block int2Block(int k) {
		if (k == 0) { return Slidedoor_Blocks.GARASUDOH_SAKU; }
		if (k == 1) { return Slidedoor_Blocks.GARASUDOH_KAE; }
		else { return Slidedoor_Blocks.GARASUDOH_ICH; }
	}
