...
public class Device_Radar extends Abstract_Device {
	...
	public Device_Radar(String name) {
		super(name);
	}
	...
	protected boolean waterCheck(EntityLiving entityLiving) {
		return !entityLiving.isInsideOfMaterial(Material.WATER) &&
				 !entityLiving.isInsideOfMaterial(Material.LAVA);
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> itemTip, ITooltipFlag advanced) {
		itemTip.add(I18n.format("tips.item_device_radar.name"));
		itemTip.add(TextFormatting.RED + I18n.format("tips.item_device_radar2.name"));
	}
}
