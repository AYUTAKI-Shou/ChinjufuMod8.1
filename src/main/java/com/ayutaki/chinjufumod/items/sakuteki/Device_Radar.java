...
public class Device_Radar extends Abstract_Device {
	...
	protected boolean waterCheck(LivingEntity entityLiving) {
		return !entityLiving.areEyesInFluid(FluidTags.WATER, true) &&
				 !entityLiving.areEyesInFluid(FluidTags.LAVA, true);
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> itemTip, ITooltipFlag tipFlag) {
		itemTip.add(new TranslationTextComponent("tips.item_device_radar").applyTextStyle(TextFormatting.GRAY));
		itemTip.add(new TranslationTextComponent("tips.item_device_radar2").applyTextStyle(TextFormatting.RED));
	}
}
