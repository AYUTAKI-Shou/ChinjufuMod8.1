...
public class Device_Radar extends Abstract_Device {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> itemTip, TooltipFlag tipFlag) {
		itemTip.add(new TranslatableComponent("tips.item_device_radar").withStyle(ChatFormatting.GRAY));
		itemTip.add(new TranslatableComponent("tips.item_device_radar2").withStyle(ChatFormatting.RED));
	}
}
