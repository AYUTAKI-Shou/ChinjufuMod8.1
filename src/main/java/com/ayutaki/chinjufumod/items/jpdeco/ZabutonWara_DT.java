...
public class ZabutonWara_DT extends IBR_Wadeco {

	public ZabutonWara_DT(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (!hStack.isEmpty() && playerIn.canPlayerEdit(pos, facing, hStack) && worldIn.mayPlace(JPDeco_Blocks.WARAZABUTON, pos, false, facing, (Entity)null)) {

			/** Put the Block. **/
			IBlockState putSTATE = JPDeco_Blocks.WARAZABUTON.getDefaultState().withProperty(WaraZabuton.STAGE_0_1, Integer.valueOf(0));
