...
public class Board_Eraser extends IG_Chinjufu {
	...
	public Board_Eraser(Properties props) {
		super(props.maxStackSize(1).maxDamage(32));
	}
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> itemTip, ITooltipFlag tipFlag) {
		itemTip.add(new TranslationTextComponent("tips.item_eraser").applyTextStyle(TextFormatting.GRAY));
		itemTip.add(new TranslationTextComponent("tips.item_eraser2").applyTextStyle(TextFormatting.GRAY));
	}
}
