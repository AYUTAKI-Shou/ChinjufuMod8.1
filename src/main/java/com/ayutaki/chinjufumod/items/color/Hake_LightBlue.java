...
public class Hake_LightBlue extends Abstract_Hake {
	...
	public ActionResultType useOn(ItemUseContext context) {
		...
		if (block == Blocks.WHITE_WOOL || block == Blocks.ORANGE_WOOL || block == Blocks.MAGENTA_WOOL ||
			...
			iworld.setBlock(pos, Blocks.LIGHT_BLUE_WOOL.defaultBlockState(), 3);
		...
		if (block == Blocks.WHITE_CONCRETE || block == Blocks.ORANGE_CONCRETE || block == Blocks.MAGENTA_CONCRETE ||
			...
			iworld.setBlock(pos, Blocks.LIGHT_BLUE_CONCRETE.defaultBlockState(), 3);
		...
		if (block == Blocks.WHITE_TERRACOTTA || block == Blocks.ORANGE_TERRACOTTA || block == Blocks.MAGENTA_TERRACOTTA ||
			...
			iworld.setBlock(pos, Blocks.LIGHT_BLUE_TERRACOTTA.defaultBlockState(), 3);
		...
		if (block instanceof ConcretePowderBlock && block != Blocks.LIGHT_BLUE_CONCRETE_POWDER) {
			...
			iworld.setBlock(pos, Blocks.LIGHT_BLUE_CONCRETE_POWDER.defaultBlockState(), 3);
		...
		if ((block instanceof StainedGlassBlock && block != Blocks.LIGHT_BLUE_STAINED_GLASS) || block == Blocks.GLASS) {
			...
			iworld.setBlock(pos, Blocks.LIGHT_BLUE_STAINED_GLASS.defaultBlockState(), 3);
		...
		if (block instanceof GlazedTerracottaBlock && block != Blocks.LIGHT_BLUE_GLAZED_TERRACOTTA) {
			...
			iworld.setBlock(pos, Blocks.LIGHT_BLUE_GLAZED_TERRACOTTA.defaultBlockState()
		...
		if ((block instanceof StainedGlassPaneBlock && block != Blocks.LIGHT_BLUE_STAINED_GLASS_PANE) || block == Blocks.GLASS_PANE) {
			...
			iworld.setBlock(pos, Blocks.LIGHT_BLUE_STAINED_GLASS_PANE.defaultBlockState()
		...
		if (block instanceof CarpetBlock && block != Blocks.LIGHT_BLUE_CARPET) {
			...
			iworld.setBlock(pos, Blocks.LIGHT_BLUE_CARPET.defaultBlockState(), 3);
		...
		if (block instanceof Full_Kawara && block != JP_Blocks.KAWARA_lightb) {
			...
			iworld.setBlock(pos, JP_Blocks.KAWARA_lightb.defaultBlockState()
		...
		if (block instanceof Full_Plaster && block != JP_Blocks.SHIKKUI_lightb && block != JP_Blocks.DIRTWALL) {
			...
			iworld.setBlock(pos, JP_Blocks.SHIKKUI_lightb.defaultBlockState()
					.setValue(Base_Full_JP.CRACK, state.getValue(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Full_Namako && block != JP_Blocks.NAMAKO_lightb) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKO_lightb.defaultBlockState()
					.setValue(Base_Full_JP.CRACK, state.getValue(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Full_Namako_B && block != JP_Blocks.NAMAKOB_lightb) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKOB_lightb.defaultBlockState()
					.setValue(Base_Full_JP.CRACK, state.getValue(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Stairs_Kawara && block != JP_Blocks.KAWARA_ST_lightb) {
			...
			iworld.setBlock(pos, JP_Blocks.KAWARA_ST_lightb.defaultBlockState()
		...
		if (block instanceof Stairs_Plaster && block != JP_Blocks.SHIKKUI_ST_lightb && block != JP_Blocks.DIRTWALL_stairs) {
			...
			iworld.setBlock(pos, JP_Blocks.SHIKKUI_ST_lightb.defaultBlockState()
					.setValue(StairsBlock.FACING, state.getValue(StairsBlock.FACING))
					.setValue(StairsBlock.HALF, state.getValue(StairsBlock.HALF))
					.setValue(StairsBlock.SHAPE, state.getValue(StairsBlock.SHAPE))
					.setValue(StairsBlock.WATERLOGGED, state.getValue(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Stairs_Namako && block != JP_Blocks.NAMAKO_ST_lightb) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKO_ST_lightb.defaultBlockState()
					.setValue(StairsBlock.FACING, state.getValue(StairsBlock.FACING))
					.setValue(StairsBlock.HALF, state.getValue(StairsBlock.HALF))
					.setValue(StairsBlock.SHAPE, state.getValue(StairsBlock.SHAPE))
					.setValue(StairsBlock.WATERLOGGED, state.getValue(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Stairs_Namako_B && block != JP_Blocks.NAMAKOB_ST_lightb) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKOB_ST_lightb.defaultBlockState()
					.setValue(StairsBlock.FACING, state.getValue(StairsBlock.FACING))
					.setValue(StairsBlock.HALF, state.getValue(StairsBlock.HALF))
					.setValue(StairsBlock.SHAPE, state.getValue(StairsBlock.SHAPE))
					.setValue(StairsBlock.WATERLOGGED, state.getValue(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Kawara && block != JP_Blocks.KAWARA_SH_lightb) {
			...
			iworld.setBlock(pos, JP_Blocks.KAWARA_SH_lightb.defaultBlockState()
		...
		if (block instanceof Slab_Plaster && block != JP_Blocks.SHIKKUI_SH_lightb && block != JP_Blocks.DIRTWALL_SH) {
			...
			iworld.setBlock(pos, JP_Blocks.SHIKKUI_SH_lightb.defaultBlockState()
					.setValue(Base_Slab_JP.TYPE, state.getValue(Base_Slab_JP.TYPE))
					.setValue(Base_Slab_JP.CRACK, state.getValue(Base_Slab_JP.CRACK))
					.setValue(Base_Slab_JP.WATERLOGGED, state.getValue(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Namako && block != JP_Blocks.NAMAKO_SH_lightb) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKO_SH_lightb.defaultBlockState()
					.setValue(Base_Slab_JP.TYPE, state.getValue(Base_Slab_JP.TYPE))
					.setValue(Base_Slab_JP.CRACK, state.getValue(Base_Slab_JP.CRACK))
					.setValue(Base_Slab_JP.WATERLOGGED, state.getValue(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Namako_B && block != JP_Blocks.NAMAKOB_SH_lightb) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKOB_SH_lightb.defaultBlockState()
					.setValue(Base_Slab_JP.TYPE, state.getValue(Base_Slab_JP.TYPE))
					.setValue(Base_Slab_JP.CRACK, state.getValue(Base_Slab_JP.CRACK))
					.setValue(Base_Slab_JP.WATERLOGGED, state.getValue(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Truss_Cable && block != Harbor_Blocks.TRUSS_lightb) {
			...
			iworld.setBlock(pos, Harbor_Blocks.TRUSS_lightb.defaultBlockState()
		...
		if (block instanceof Truss_Amp && block != Harbor_Blocks.AMP_lightb) {
			...
			iworld.setBlock(pos, Harbor_Blocks.AMP_lightb.defaultBlockState()
		...
		if (block instanceof CafeChair && block != Chair_Blocks.CAFECHAIR_lightb) {
			...
			iworld.setBlock(pos, Chair_Blocks.CAFECHAIR_lightb.defaultBlockState(), 3);
		...
		if (block instanceof Zabuton && block != JPChair_Blocks.ZABUTON_lightb && block != JPChair_Blocks.WARAZABUTON) {
			...
			iworld.setBlock(pos, JPChair_Blocks.ZABUTON_lightb.defaultBlockState()
		...
		if (block instanceof Candle && block != Furniture_Blocks.CANDLE_lightb) {
			...
			iworld.setBlock(pos, Furniture_Blocks.CANDLE_lightb.defaultBlockState()
		...
		if (block instanceof Andon && block != JPDeco_Blocks.ANDON_lightb) {
			...
			iworld.setBlock(pos, JPDeco_Blocks.ANDON_lightb.defaultBlockState()
		...
		if (block instanceof Sofa && block != Chair_Blocks.SOFA_lightb) {
			...
			iworld.setBlock(pos, Chair_Blocks.SOFA_lightb.defaultBlockState()
		...
		if (block instanceof Zaisu && block != JPChair_Blocks.ZAISU_lightb) {
			...
			iworld.setBlock(pos, JPChair_Blocks.ZAISU_lightb.defaultBlockState()
		...
		if (block instanceof Noren && block != Ranma_Blocks.NOREN_lightb) {
			...
			iworld.setBlock(pos, Ranma_Blocks.NOREN_lightb.defaultBlockState()
		...
		if (block instanceof Futon && block != JPDeco_Blocks.FUTON_lightb) {
			...
			iworld.setBlock(pos, JPDeco_Blocks.FUTON_lightb.defaultBlockState()
		...
		if (block instanceof Tatami && block != JPDeco_Blocks.TATAMI_H_lightb && block != JPDeco_Blocks.TATAMI_H) {
			...
			iworld.setBlock(pos, JPDeco_Blocks.TATAMI_H_lightb.defaultBlockState()
		...
		if (block instanceof Tatami_Y && block != JPDeco_Blocks.TATAMI_HY_lightb && block != JPDeco_Blocks.TATAMI_HY) {
			...
			iworld.setBlock(pos, JPDeco_Blocks.TATAMI_HY_lightb.defaultBlockState()
					.setValue(BaseTatami.TYPE, state.getValue(BaseTatami.TYPE))
					.setValue(BaseTatami.H_FACING, state.getValue(BaseTatami.H_FACING))
					.setValue(BaseTatami.WATERLOGGED, state.getValue(BaseTatami.WATERLOGGED)), 3);
		...
		if (block instanceof Wagasa && block != Unit_Blocks.KASA_lightb) {
			...
			iworld.setBlock(pos, Unit_Blocks.KASA_lightb.defaultBlockState()
		...
		if (block instanceof Fusuma && block != Slidedoor_Blocks.FUSUMA_lightb) {
			...
			if (state.getValue(BaseSlidedoor.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlock(pos, Slidedoor_Blocks.FUSUMA_lightb.defaultBlockState()
				...
				iworld.setBlock(pos.above(), Slidedoor_Blocks.FUSUMA_lightb.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, state.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, state.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, state.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, state.getValue(BaseSlidedoor.POWERED))
			...
			if (state.getValue(BaseSlidedoor.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlock(pos, Slidedoor_Blocks.FUSUMA_lightb.defaultBlockState()
						...
						.setValue(BaseSlidedoor.HALF, DoubleBlockHalf.UPPER)
						.setValue(BaseSlidedoor.WATERLOGGED, state.getValue(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlock(pos.below(), Slidedoor_Blocks.FUSUMA_lightb.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, state.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, state.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, state.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, state.getValue(BaseSlidedoor.POWERED))
		...
		if (block instanceof Fusuma_B && block != Slidedoor_Blocks.FUSUMAB_lightb) {
			...
			if (state.getValue(BaseSlidedoor.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlock(pos, Slidedoor_Blocks.FUSUMAB_lightb.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, state.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, state.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, state.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, state.getValue(BaseSlidedoor.POWERED))
						.setValue(BaseSlidedoor.HALF, DoubleBlockHalf.LOWER)
						.setValue(BaseSlidedoor.WATERLOGGED, state.getValue(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlock(pos.above(), Slidedoor_Blocks.FUSUMAB_lightb.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, state.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, state.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, state.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, state.getValue(BaseSlidedoor.POWERED))
			...
			if (state.getValue(BaseSlidedoor.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlock(pos, Slidedoor_Blocks.FUSUMAB_lightb.defaultBlockState()
						...
						.setValue(BaseSlidedoor.HALF, DoubleBlockHalf.UPPER)
						.setValue(BaseSlidedoor.WATERLOGGED, state.getValue(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlock(pos.below(), Slidedoor_Blocks.FUSUMAB_lightb.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, state.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, state.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, state.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, state.getValue(BaseSlidedoor.POWERED))
		...
		if (block instanceof KamoiPlaster_Oak && block != KamoiPlaster_Blocks.KAMOI_lightb_oak) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightb_oak.defaultBlockState()
		...
		if (block instanceof KamoiPlaster_Spruce && block != KamoiPlaster_Blocks.KAMOI_lightb_spru) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightb_spru.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Birch && block != KamoiPlaster_Blocks.KAMOI_lightb_bir) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightb_bir.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Jungle && block != KamoiPlaster_Blocks.KAMOI_lightb_jun) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightb_jun.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Acacia && block != KamoiPlaster_Blocks.KAMOI_lightb_aca) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightb_aca.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_DarkOak && block != KamoiPlaster_Blocks.KAMOI_lightb_doak) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightb_doak.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Sakura && block != KamoiPlaster_Blocks.KAMOI_lightb_sakura) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightb_sakura.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Kaede && block != KamoiPlaster_Blocks.KAMOI_lightb_kaede) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightb_kaede.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Ichoh && block != KamoiPlaster_Blocks.KAMOI_lightb_ichoh) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightb_ichoh.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof WallPane_Clay && block != WallPanel_Blocks.WP_CLAY_lightb) {
			...
			iworld.setBlock(pos, WallPanel_Blocks.WP_CLAY_lightb.defaultBlockState()
					.setValue(BaseFacingWater.H_FACING, state.getValue(BaseFacingWater.H_FACING))
					.setValue(BaseFacingWater.WATERLOGGED, state.getValue(BaseFacingWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Glass && block != WallPanel_Blocks.WP_GLASS_lightb) {
			...
			iworld.setBlock(pos, WallPanel_Blocks.WP_GLASS_lightb.defaultBlockState()
					.setValue(BaseFacingWater.H_FACING, state.getValue(BaseFacingWater.H_FACING))
					.setValue(BaseFacingWater.WATERLOGGED, state.getValue(BaseFacingWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Plaster && block != WallPanel_Blocks.WP_PLASTER_lightb) {
			...
			iworld.setBlock(pos, WallPanel_Blocks.WP_PLASTER_lightb.defaultBlockState()
					.setValue(BaseStage2_FaceWater.H_FACING, state.getValue(BaseStage2_FaceWater.H_FACING))
					.setValue(BaseStage2_FaceWater.STAGE_1_2, state.getValue(BaseStage2_FaceWater.STAGE_1_2))
					.setValue(BaseStage2_FaceWater.WATERLOGGED, state.getValue(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Namako && block != WallPanel_Blocks.WP_NAMAKO_lightb) {
			...
			iworld.setBlock(pos, WallPanel_Blocks.WP_NAMAKO_lightb.defaultBlockState()
					.setValue(BaseStage2_FaceWater.H_FACING, state.getValue(BaseStage2_FaceWater.H_FACING))
					.setValue(BaseStage2_FaceWater.STAGE_1_2, state.getValue(BaseStage2_FaceWater.STAGE_1_2))
					.setValue(BaseStage2_FaceWater.WATERLOGGED, state.getValue(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Namako_B && block != WallPanel_Blocks.WP_NAMAKOB_lightb) {
			...
			iworld.setBlock(pos, WallPanel_Blocks.WP_NAMAKOB_lightb.defaultBlockState()
					.setValue(BaseStage2_FaceWater.H_FACING, state.getValue(BaseStage2_FaceWater.H_FACING))
					.setValue(BaseStage2_FaceWater.STAGE_1_2, state.getValue(BaseStage2_FaceWater.STAGE_1_2))
					.setValue(BaseStage2_FaceWater.WATERLOGGED, state.getValue(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof Wall_Plaster && block != JP_Blocks.SHIKKUI_WALL_lightb && block != JP_Blocks.DIRTWALL_WALL) {
			...
			iworld.setBlock(pos, JP_Blocks.SHIKKUI_WALL_lightb.defaultBlockState()
		...
		if (block instanceof Wall_Sama && block != JP_Blocks.SHIKKUI_SAMA_lightb && block != JP_Blocks.DIRTWALL_SAMA) {
			...
			iworld.setBlock(pos, JP_Blocks.SHIKKUI_SAMA_lightb.defaultBlockState()
		...
		if (block instanceof Wall_Kawara && block != JP_Blocks.KAWARA_WALL_lightb) {
			...
			iworld.setBlock(pos, JP_Blocks.KAWARA_WALL_lightb.defaultBlockState()
		...
		if (block instanceof Wall_Namako && block != JP_Blocks.NAMAKO_WALL_lightb) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKO_WALL_lightb.defaultBlockState()
		...
		if (block instanceof Wall_NamakoB && block != JP_Blocks.NAMAKOB_WALL_lightb) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKOB_WALL_lightb.defaultBlockState()
		...
		if (block instanceof Curtain && block != Window_Blocks.CURTAIN_lightblue) {
			...
			iworld.setBlock(pos, Window_Blocks.CURTAIN_lightblue.defaultBlockState()
		...
		if (block instanceof CurtainTall && block != Window_Blocks.CURTAINTALL_lightblue) {
			...
			if (state.getValue(CurtainTall.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlock(pos, Window_Blocks.CURTAINTALL_lightblue.defaultBlockState()
				...
				iworld.setBlock(pos.above(), Window_Blocks.CURTAINTALL_lightblue.defaultBlockState()
						.setValue(CurtainTall.H_FACING, state.getValue(CurtainTall.H_FACING))
						.setValue(CurtainTall.OPEN, state.getValue(CurtainTall.OPEN))
						.setValue(CurtainTall.HINGE, state.getValue(CurtainTall.HINGE))
			...
			if (state.getValue(CurtainTall.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlock(pos, Window_Blocks.CURTAINTALL_lightblue.defaultBlockState()
						...
						.setValue(CurtainTall.HALF, DoubleBlockHalf.UPPER)
						.setValue(CurtainTall.WATERLOGGED, state.getValue(CurtainTall.WATERLOGGED)), 3);
				iworld.setBlock(pos.below(), Window_Blocks.CURTAINTALL_lightblue.defaultBlockState()
						.setValue(CurtainTall.H_FACING, state.getValue(CurtainTall.H_FACING))
						.setValue(CurtainTall.OPEN, state.getValue(CurtainTall.OPEN))
						.setValue(CurtainTall.HINGE, state.getValue(CurtainTall.HINGE))
						.setValue(CurtainTall.HALF, DoubleBlockHalf.LOWER)
		...
		if (block instanceof DeskCloth) {
			...
			if (block != Furniture_Blocks.DESKCLOTH_03 || color != 4) {
				...
				iworld.setBlock(pos, Furniture_Blocks.DESKCLOTH_03.defaultBlockState()
		...
		if (block instanceof BaseClothTable) {
			...
			if (color != 3) {
				iworld.setBlock(pos, state.setValue(BaseClothTable.STAGE_0_15, Integer.valueOf(3)), 3);//LIGHTBLUE
