...
public class Hake_Magenta extends Abstract_Hake {
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		if (block instanceof Truss_Amp && block != Harbor_Blocks.AMP_magenta) {
			...
			iworld.setBlockState(pos, Harbor_Blocks.AMP_magenta.getDefaultState()
		...
		if (block instanceof BaseClothTable) {
			...
			if (color != 2) {
				...
				iworld.setBlockState(pos, state.with(BaseClothTable.STAGE_0_15, Integer.valueOf(2)), 3);//MAGENTA
