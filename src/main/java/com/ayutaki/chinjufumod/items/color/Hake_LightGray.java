...
public class Hake_LightGray extends Abstract_Hake {
	...
	public ActionResultType useOn(ItemUseContext context) {
		...
		if (block == Blocks.WHITE_WOOL || block == Blocks.ORANGE_WOOL || block == Blocks.MAGENTA_WOOL ||
			...
			iworld.setBlock(pos, Blocks.LIGHT_GRAY_WOOL.defaultBlockState(), 3);
		...
		if (block == Blocks.WHITE_CONCRETE || block == Blocks.ORANGE_CONCRETE || block == Blocks.MAGENTA_CONCRETE ||
			...
			iworld.setBlock(pos, Blocks.LIGHT_GRAY_CONCRETE.defaultBlockState(), 3);
		...
		if (block == Blocks.WHITE_TERRACOTTA || block == Blocks.ORANGE_TERRACOTTA || block == Blocks.MAGENTA_TERRACOTTA ||
			...
			iworld.setBlock(pos, Blocks.LIGHT_GRAY_TERRACOTTA.defaultBlockState(), 3);
		...
		if (block instanceof ConcretePowderBlock && block != Blocks.LIGHT_GRAY_CONCRETE_POWDER) {
			...
			iworld.setBlock(pos, Blocks.LIGHT_GRAY_CONCRETE_POWDER.defaultBlockState(), 3);
		...
		if ((block instanceof StainedGlassBlock && block != Blocks.LIGHT_GRAY_STAINED_GLASS) || block == Blocks.GLASS) {
			...
			iworld.setBlock(pos, Blocks.LIGHT_GRAY_STAINED_GLASS.defaultBlockState(), 3);
		...
		if (block instanceof GlazedTerracottaBlock && block != Blocks.LIGHT_GRAY_GLAZED_TERRACOTTA) {
			...
			iworld.setBlock(pos, Blocks.LIGHT_GRAY_GLAZED_TERRACOTTA.defaultBlockState()
		...
		if ((block instanceof StainedGlassPaneBlock && block != Blocks.LIGHT_GRAY_STAINED_GLASS_PANE) || block == Blocks.GLASS_PANE) {
			...
			iworld.setBlock(pos, Blocks.LIGHT_GRAY_STAINED_GLASS_PANE.defaultBlockState()
		...
		if (block instanceof CarpetBlock && block != Blocks.LIGHT_GRAY_CARPET) {
			...
			iworld.setBlock(pos, Blocks.LIGHT_GRAY_CARPET.defaultBlockState(), 3);
		...
		if (block instanceof Full_Kawara && block != JP_Blocks.KAWARA_lightg) {
			...
			iworld.setBlock(pos, JP_Blocks.KAWARA_lightg.defaultBlockState()
		...
		if (block instanceof Full_Plaster && block != JP_Blocks.SHIKKUI_lightg && block != JP_Blocks.DIRTWALL) {
			...
			iworld.setBlock(pos, JP_Blocks.SHIKKUI_lightg.defaultBlockState()
					.setValue(Base_Full_JP.CRACK, state.getValue(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Full_Namako && block != JP_Blocks.NAMAKO_lightg) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKO_lightg.defaultBlockState()
					.setValue(Base_Full_JP.CRACK, state.getValue(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Full_Namako_B && block != JP_Blocks.NAMAKOB_lightg) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKOB_lightg.defaultBlockState()
					.setValue(Base_Full_JP.CRACK, state.getValue(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Stairs_Kawara && block != JP_Blocks.KAWARA_ST_lightg) {
			...
			iworld.setBlock(pos, JP_Blocks.KAWARA_ST_lightg.defaultBlockState()
		...
		if (block instanceof Stairs_Plaster && block != JP_Blocks.SHIKKUI_ST_lightg && block != JP_Blocks.DIRTWALL_stairs) {
			...
			iworld.setBlock(pos, JP_Blocks.SHIKKUI_ST_lightg.defaultBlockState()
					.setValue(StairsBlock.FACING, state.getValue(StairsBlock.FACING))
					.setValue(StairsBlock.HALF, state.getValue(StairsBlock.HALF))
					.setValue(StairsBlock.SHAPE, state.getValue(StairsBlock.SHAPE))
					.setValue(StairsBlock.WATERLOGGED, state.getValue(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Stairs_Namako && block != JP_Blocks.NAMAKO_ST_lightg) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKO_ST_lightg.defaultBlockState()
					.setValue(StairsBlock.FACING, state.getValue(StairsBlock.FACING))
					.setValue(StairsBlock.HALF, state.getValue(StairsBlock.HALF))
					.setValue(StairsBlock.SHAPE, state.getValue(StairsBlock.SHAPE))
					.setValue(StairsBlock.WATERLOGGED, state.getValue(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Stairs_Namako_B && block != JP_Blocks.NAMAKOB_ST_lightg) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKOB_ST_lightg.defaultBlockState()
					.setValue(StairsBlock.FACING, state.getValue(StairsBlock.FACING))
					.setValue(StairsBlock.HALF, state.getValue(StairsBlock.HALF))
					.setValue(StairsBlock.SHAPE, state.getValue(StairsBlock.SHAPE))
					.setValue(StairsBlock.WATERLOGGED, state.getValue(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Kawara && block != JP_Blocks.KAWARA_SH_lightg) {
			...
			iworld.setBlock(pos, JP_Blocks.KAWARA_SH_lightg.defaultBlockState()
		...
		if (block instanceof Slab_Plaster && block != JP_Blocks.SHIKKUI_SH_lightg && block != JP_Blocks.DIRTWALL_SH) {
			...
			iworld.setBlock(pos, JP_Blocks.SHIKKUI_SH_lightg.defaultBlockState()
					.setValue(Base_Slab_JP.TYPE, state.getValue(Base_Slab_JP.TYPE))
					.setValue(Base_Slab_JP.CRACK, state.getValue(Base_Slab_JP.CRACK))
					.setValue(Base_Slab_JP.WATERLOGGED, state.getValue(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Namako && block != JP_Blocks.NAMAKO_SH_lightg) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKO_SH_lightg.defaultBlockState()
					.setValue(Base_Slab_JP.TYPE, state.getValue(Base_Slab_JP.TYPE))
					.setValue(Base_Slab_JP.CRACK, state.getValue(Base_Slab_JP.CRACK))
					.setValue(Base_Slab_JP.WATERLOGGED, state.getValue(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Namako_B && block != JP_Blocks.NAMAKOB_SH_lightg) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKOB_SH_lightg.defaultBlockState()
					.setValue(Base_Slab_JP.TYPE, state.getValue(Base_Slab_JP.TYPE))
					.setValue(Base_Slab_JP.CRACK, state.getValue(Base_Slab_JP.CRACK))
					.setValue(Base_Slab_JP.WATERLOGGED, state.getValue(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Truss_Cable && block != Harbor_Blocks.TRUSS) {
			...
			iworld.setBlock(pos, Harbor_Blocks.TRUSS.defaultBlockState()
		...
		if (block instanceof Truss_Amp && block != Harbor_Blocks.AMP) {
			...
			iworld.setBlock(pos, Harbor_Blocks.AMP.defaultBlockState()
		...
		if (block instanceof CafeChair && block != Chair_Blocks.CAFECHAIR_lightg) {
			...
			iworld.setBlock(pos, Chair_Blocks.CAFECHAIR_lightg.defaultBlockState(), 3);
		...
		if (block instanceof Zabuton && block != JPChair_Blocks.ZABUTON_lightg && block != JPChair_Blocks.WARAZABUTON) {
			...
			iworld.setBlock(pos, JPChair_Blocks.ZABUTON_lightg.defaultBlockState()
		...
		if (block instanceof Candle && block != Furniture_Blocks.CANDLE_lightg) {
			...
			iworld.setBlock(pos, Furniture_Blocks.CANDLE_lightg.defaultBlockState()
		...
		if (block instanceof Andon && block != JPDeco_Blocks.ANDON_lightg) {
			...
			iworld.setBlock(pos, JPDeco_Blocks.ANDON_lightg.defaultBlockState()
		...
		if (block instanceof Sofa && block != Chair_Blocks.SOFA_lightg) {
			...
			iworld.setBlock(pos, Chair_Blocks.SOFA_lightg.defaultBlockState()
		...
		if (block instanceof Zaisu && block != JPChair_Blocks.ZAISU_lightg) {
			...
			iworld.setBlock(pos, JPChair_Blocks.ZAISU_lightg.defaultBlockState()
		...
		if (block instanceof Noren && block != Ranma_Blocks.NOREN_lightg) {
			...
			iworld.setBlock(pos, Ranma_Blocks.NOREN_lightg.defaultBlockState()
		...
		if (block instanceof Futon && block != JPDeco_Blocks.FUTON_lightg) {
			...
			iworld.setBlock(pos, JPDeco_Blocks.FUTON_lightg.defaultBlockState()
		...
		if (block instanceof Tatami && block != JPDeco_Blocks.TATAMI_H_lightg && block != JPDeco_Blocks.TATAMI_H) {
			...
			iworld.setBlock(pos, JPDeco_Blocks.TATAMI_H_lightg.defaultBlockState()
		...
		if (block instanceof Tatami_Y && block != JPDeco_Blocks.TATAMI_HY_lightg && block != JPDeco_Blocks.TATAMI_HY) {
			...
			iworld.setBlock(pos, JPDeco_Blocks.TATAMI_HY_lightg.defaultBlockState()
					.setValue(BaseTatami.TYPE, state.getValue(BaseTatami.TYPE))
					.setValue(BaseTatami.H_FACING, state.getValue(BaseTatami.H_FACING))
					.setValue(BaseTatami.WATERLOGGED, state.getValue(BaseTatami.WATERLOGGED)), 3);
		...
		if (block instanceof Wagasa && block != Unit_Blocks.KASA_lightg) {
			...
			iworld.setBlock(pos, Unit_Blocks.KASA_lightg.defaultBlockState()
		...
		if (block instanceof Fusuma && block != Slidedoor_Blocks.FUSUMA_lightg) {
			...
			if (state.getValue(BaseSlidedoor.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlock(pos, Slidedoor_Blocks.FUSUMA_lightg.defaultBlockState()
				...
				iworld.setBlock(pos.above(), Slidedoor_Blocks.FUSUMA_lightg.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, state.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, state.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, state.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, state.getValue(BaseSlidedoor.POWERED))
			...
			if (state.getValue(BaseSlidedoor.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlock(pos, Slidedoor_Blocks.FUSUMA_lightg.defaultBlockState()
						...
						.setValue(BaseSlidedoor.HALF, DoubleBlockHalf.UPPER)
						.setValue(BaseSlidedoor.WATERLOGGED, state.getValue(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlock(pos.below(), Slidedoor_Blocks.FUSUMA_lightg.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, state.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, state.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, state.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, state.getValue(BaseSlidedoor.POWERED))
		...
		if (block instanceof Fusuma_B && block != Slidedoor_Blocks.FUSUMAB_lightg) {
			...
			if (state.getValue(BaseSlidedoor.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlock(pos, Slidedoor_Blocks.FUSUMAB_lightg.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, state.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, state.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, state.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, state.getValue(BaseSlidedoor.POWERED))
						.setValue(BaseSlidedoor.HALF, DoubleBlockHalf.LOWER)
						.setValue(BaseSlidedoor.WATERLOGGED, state.getValue(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlock(pos.above(), Slidedoor_Blocks.FUSUMAB_lightg.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, state.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, state.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, state.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, state.getValue(BaseSlidedoor.POWERED))
			...
			if (state.getValue(BaseSlidedoor.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlock(pos, Slidedoor_Blocks.FUSUMAB_lightg.defaultBlockState()
						...
						.setValue(BaseSlidedoor.HALF, DoubleBlockHalf.UPPER)
						.setValue(BaseSlidedoor.WATERLOGGED, state.getValue(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlock(pos.below(), Slidedoor_Blocks.FUSUMAB_lightg.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, state.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, state.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, state.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, state.getValue(BaseSlidedoor.POWERED))
		...
		if (block instanceof KamoiPlaster_Oak && block != KamoiPlaster_Blocks.KAMOI_lightg_oak) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightg_oak.defaultBlockState()
		...
		if (block instanceof KamoiPlaster_Spruce && block != KamoiPlaster_Blocks.KAMOI_lightg_spru) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightg_spru.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Birch && block != KamoiPlaster_Blocks.KAMOI_lightg_bir) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightg_bir.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Jungle && block != KamoiPlaster_Blocks.KAMOI_lightg_jun) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightg_jun.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Acacia && block != KamoiPlaster_Blocks.KAMOI_lightg_aca) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightg_aca.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_DarkOak && block != KamoiPlaster_Blocks.KAMOI_lightg_doak) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightg_doak.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Sakura && block != KamoiPlaster_Blocks.KAMOI_lightg_sakura) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightg_sakura.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Kaede && block != KamoiPlaster_Blocks.KAMOI_lightg_kaede) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightg_kaede.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Ichoh && block != KamoiPlaster_Blocks.KAMOI_lightg_ichoh) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_lightg_ichoh.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof WallPane_Clay && block != WallPanel_Blocks.WP_CLAY_lightg) {
			...
			iworld.setBlock(pos, WallPanel_Blocks.WP_CLAY_lightg.defaultBlockState()
					.setValue(BaseFacingWater.H_FACING, state.getValue(BaseFacingWater.H_FACING))
					.setValue(BaseFacingWater.WATERLOGGED, state.getValue(BaseFacingWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Glass && block != WallPanel_Blocks.WP_GLASS_lightg) {
			...
			iworld.setBlock(pos, WallPanel_Blocks.WP_GLASS_lightg.defaultBlockState()
					.setValue(BaseFacingWater.H_FACING, state.getValue(BaseFacingWater.H_FACING))
					.setValue(BaseFacingWater.WATERLOGGED, state.getValue(BaseFacingWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Plaster && block != WallPanel_Blocks.WP_PLASTER_lightg) {
			...
			iworld.setBlock(pos, WallPanel_Blocks.WP_PLASTER_lightg.defaultBlockState()
					.setValue(BaseStage2_FaceWater.H_FACING, state.getValue(BaseStage2_FaceWater.H_FACING))
					.setValue(BaseStage2_FaceWater.STAGE_1_2, state.getValue(BaseStage2_FaceWater.STAGE_1_2))
					.setValue(BaseStage2_FaceWater.WATERLOGGED, state.getValue(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Namako && block != WallPanel_Blocks.WP_NAMAKO_lightg) {
			...
			iworld.setBlock(pos, WallPanel_Blocks.WP_NAMAKO_lightg.defaultBlockState()
					.setValue(BaseStage2_FaceWater.H_FACING, state.getValue(BaseStage2_FaceWater.H_FACING))
					.setValue(BaseStage2_FaceWater.STAGE_1_2, state.getValue(BaseStage2_FaceWater.STAGE_1_2))
					.setValue(BaseStage2_FaceWater.WATERLOGGED, state.getValue(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Namako_B && block != WallPanel_Blocks.WP_NAMAKOB_lightg) {
			...
			iworld.setBlock(pos, WallPanel_Blocks.WP_NAMAKOB_lightg.defaultBlockState()
					.setValue(BaseStage2_FaceWater.H_FACING, state.getValue(BaseStage2_FaceWater.H_FACING))
					.setValue(BaseStage2_FaceWater.STAGE_1_2, state.getValue(BaseStage2_FaceWater.STAGE_1_2))
					.setValue(BaseStage2_FaceWater.WATERLOGGED, state.getValue(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof Wall_Plaster && block != JP_Blocks.SHIKKUI_WALL_lightg && block != JP_Blocks.DIRTWALL_WALL) {
			...
			iworld.setBlock(pos, JP_Blocks.SHIKKUI_WALL_lightg.defaultBlockState()
		...
		if (block instanceof Wall_Sama && block != JP_Blocks.SHIKKUI_SAMA_lightg && block != JP_Blocks.DIRTWALL_SAMA) {
			...
			iworld.setBlock(pos, JP_Blocks.SHIKKUI_SAMA_lightg.defaultBlockState()
		...
		if (block instanceof Wall_Kawara && block != JP_Blocks.KAWARA_WALL_lightg) {
			...
			iworld.setBlock(pos, JP_Blocks.KAWARA_WALL_lightg.defaultBlockState()
		...
		if (block instanceof Wall_Namako && block != JP_Blocks.NAMAKO_WALL_lightg) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKO_WALL_lightg.defaultBlockState()
		...
		if (block instanceof Wall_NamakoB && block != JP_Blocks.NAMAKOB_WALL_lightg) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKOB_WALL_lightg.defaultBlockState()
		...
		if (block instanceof Curtain && block != Window_Blocks.CURTAIN_lightgray) {
			...
			iworld.setBlock(pos, Window_Blocks.CURTAIN_lightgray.defaultBlockState()
		...
		if (block instanceof CurtainTall && block != Window_Blocks.CURTAINTALL_lightgray) {
			...
			if (state.getValue(CurtainTall.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlock(pos, Window_Blocks.CURTAINTALL_lightgray.defaultBlockState()
				...
				iworld.setBlock(pos.above(), Window_Blocks.CURTAINTALL_lightgray.defaultBlockState()
						.setValue(CurtainTall.H_FACING, state.getValue(CurtainTall.H_FACING))
						.setValue(CurtainTall.OPEN, state.getValue(CurtainTall.OPEN))
						.setValue(CurtainTall.HINGE, state.getValue(CurtainTall.HINGE))
			...
			if (state.getValue(CurtainTall.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlock(pos, Window_Blocks.CURTAINTALL_lightgray.defaultBlockState()
						...
						.setValue(CurtainTall.HALF, DoubleBlockHalf.UPPER)
						.setValue(CurtainTall.WATERLOGGED, state.getValue(CurtainTall.WATERLOGGED)), 3);
				iworld.setBlock(pos.below(), Window_Blocks.CURTAINTALL_lightgray.defaultBlockState()
						.setValue(CurtainTall.H_FACING, state.getValue(CurtainTall.H_FACING))
						.setValue(CurtainTall.OPEN, state.getValue(CurtainTall.OPEN))
						.setValue(CurtainTall.HINGE, state.getValue(CurtainTall.HINGE))
						.setValue(CurtainTall.HALF, DoubleBlockHalf.LOWER)
		...
		if (block instanceof DeskCloth) {
			...
			if (block != Furniture_Blocks.DESKCLOTH_811 || color != 1) {
				...
				iworld.setBlock(pos, Furniture_Blocks.DESKCLOTH_811.defaultBlockState()
		...
		if (block instanceof BaseClothTable) {
			...
			if (color != 8) {
				iworld.setBlock(pos, state.setValue(BaseClothTable.STAGE_0_15, Integer.valueOf(8)), 3);//LIGHTGRAY
