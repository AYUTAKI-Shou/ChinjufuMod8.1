...
public class Hake_Purple extends Base_Hake {
	...
	public Hake_Purple(String name) {
		super(name);
	}
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (blockIn instanceof Plaster || blockIn instanceof Plaster_Crash ||
			...
			if (color != 10) {
				worldIn.setBlockState(pos, stateIn.withProperty(Base_Full_JP.STAGE_0_15, Integer.valueOf(10)), 11);
		...
		if (blockIn instanceof Truss_Cable2) {
			if (blockIn != Harbor_Blocks.TRUSS2_purple) {
				worldIn.setBlockState(pos, Harbor_Blocks.TRUSS2_purple.getDefaultState()
		...
		if (blockIn instanceof Truss_Amp) {
			if (blockIn != Harbor_Blocks.AMP_purple) {
				worldIn.setBlockState(pos, Harbor_Blocks.AMP_purple.getDefaultState()
		...
		if (blockIn instanceof Truss_Amp2) {
			if (blockIn != Harbor_Blocks.AMP2_purple) {
				worldIn.setBlockState(pos, Harbor_Blocks.AMP2_purple.getDefaultState()
		...
		if (blockIn instanceof Futon) {
			if (blockIn != JPDeco_Blocks.FUTON_purple) {
				worldIn.setBlockState(pos, JPDeco_Blocks.FUTON_purple.getDefaultState()
		...
		if (blockIn instanceof Tatami) {
			if (blockIn != JPDeco_Blocks.TATAMI_purple && blockIn != JPDeco_Blocks.TATAMI) {
				worldIn.setBlockState(pos, JPDeco_Blocks.TATAMI_purple.getDefaultState()
		...
		if (blockIn instanceof Tatami_Y) {
			if (blockIn != JPDeco_Blocks.TATAMIY_purple && blockIn != JPDeco_Blocks.TATAMIY) {
				worldIn.setBlockState(pos, JPDeco_Blocks.TATAMIY_purple.getDefaultState()
						.withProperty(BaseFacingSlabW.H_FACING, stateIn.getValue(BaseFacingSlabW.H_FACING))
						.withProperty(BaseFacingSlabW.DOUBLE, stateIn.getValue(BaseFacingSlabW.DOUBLE))
						.withProperty(BaseFacingSlabW.HALF, stateIn.getValue(BaseFacingSlabW.HALF)), 11);
		...
		if (blockIn instanceof BaseTatamiWood) {
			...
			if (color != 10) {
				worldIn.setBlockState(pos, stateIn.withProperty(BaseTatamiWood.STAGE_0_15, Integer.valueOf(10)), 11);
		...
		if (blockIn instanceof Wagasa) {
			if (blockIn != Garden_Blocks.KASA_purple) {
				worldIn.setBlockState(pos, Garden_Blocks.KASA_purple.getDefaultState()
		...
		if (blockIn instanceof KamoiPlaster_Oak) {
			if (blockIn != KamoiPlaster_Blocks.KAMOI_purple_oak) {
		...
		if (blockIn instanceof KamoiPlaster_Spruce) {
			if (blockIn != KamoiPlaster_Blocks.KAMOI_purple_spru) {
		...
		if (blockIn instanceof KamoiPlaster_Birch) {
			if (blockIn != KamoiPlaster_Blocks.KAMOI_purple_bir) {
		...
		if (blockIn instanceof KamoiPlaster_Jungle) {
			if (blockIn != KamoiPlaster_Blocks.KAMOI_purple_jun) {
		...
		if (blockIn instanceof KamoiPlaster_Acacia) {
			if (blockIn != KamoiPlaster_Blocks.KAMOI_purple_aca) {
		...
		if (blockIn instanceof KamoiPlaster_DarkOak) {
			if (blockIn != KamoiPlaster_Blocks.KAMOI_purple_doak) {
		...
		if (blockIn instanceof KamoiPlaster_Sakura) {
			if (blockIn != KamoiPlaster_Blocks.KAMOI_purple_sakura) {
		...
		if (blockIn instanceof KamoiPlaster_Kaede) {
			if (blockIn != KamoiPlaster_Blocks.KAMOI_purple_kaede) {
		...
		if (blockIn instanceof KamoiPlaster_Ichoh) {
			if (blockIn != KamoiPlaster_Blocks.KAMOI_purple_ichoh) {
		...
		if (blockIn instanceof WallPane_ClayColor) {
			if (blockIn != WallPanel_Blocks.WP_CLAY_purple) {
				worldIn.setBlockState(pos, WallPanel_Blocks.WP_CLAY_purple.getDefaultState()
						.withProperty(BaseFacingSapo.H_FACING, stateIn.getValue(BaseFacingSapo.H_FACING)), 11);
		...
		if (blockIn instanceof WallPane_GlassStained) {
			if (blockIn != WallPanel_Blocks.WP_GLASS_purple) {
				worldIn.setBlockState(pos, WallPanel_Blocks.WP_GLASS_purple.getDefaultState()
						.withProperty(BaseFacingSapo.H_FACING, stateIn.getValue(BaseFacingSapo.H_FACING)), 11);
		...
		if (blockIn instanceof WallPane_Plaster) {
			if (blockIn != WallPanel_JPBlocks.WP_PLASTER_purple && blockIn != WallPanel_JPBlocks.WP_DIRTWALL) {
				worldIn.setBlockState(pos, WallPanel_JPBlocks.WP_PLASTER_purple.getDefaultState()
		...
		if (blockIn instanceof WallPane_Namako) {
			if (blockIn != WallPanel_JPBlocks.WP_NAMAKO_purple) {
				worldIn.setBlockState(pos, WallPanel_JPBlocks.WP_NAMAKO_purple.getDefaultState()
						.withProperty(WallPane_Stage2.H_FACING, stateIn.getValue(WallPane_Stage2.H_FACING))
						.withProperty(WallPane_Stage2.STAGE_1_2, stateIn.getValue(WallPane_Stage2.STAGE_1_2)), 11);
		...
		if (blockIn instanceof WallPane_Namako_B) {
			if (blockIn != WallPanel_JPBlocks.WP_NAMAKOB_purple) {
				worldIn.setBlockState(pos, WallPanel_JPBlocks.WP_NAMAKOB_purple.getDefaultState()
						.withProperty(WallPane_Stage2.H_FACING, stateIn.getValue(WallPane_Stage2.H_FACING))
						.withProperty(WallPane_Stage2.STAGE_1_2, stateIn.getValue(WallPane_Stage2.STAGE_1_2)), 11);
		...
		if (blockIn instanceof Curtain) {
			if (blockIn != Window_Blocks.CURTAIN_purple) {
				worldIn.setBlockState(pos, Window_Blocks.CURTAIN_purple.getDefaultState()
		...
		if (blockIn instanceof CurtainTall) {
			if (blockIn != Window_Blocks.CURTAINTALL_purple) {
				
				if (stateIn.getValue(CurtainTall.HALF) == HalfState.LOWER) {
					worldIn.setBlockState(pos, Window_Blocks.CURTAINTALL_purple.getDefaultState()
					...
					worldIn.setBlockState(pos.up(), Window_Blocks.CURTAINTALL_purple.getDefaultState()
							.withProperty(CurtainTall.H_FACING, stateIn.getValue(CurtainTall.H_FACING))
							.withProperty(CurtainTall.OPEN, stateIn.getValue(CurtainTall.OPEN))
							.withProperty(CurtainTall.HINGE, upState.getValue(CurtainTall.HINGE))
				...
				if (stateIn.getValue(CurtainTall.HALF) == HalfState.UPPER) {
					worldIn.setBlockState(pos, Window_Blocks.CURTAINTALL_purple.getDefaultState()
							...
							.withProperty(CurtainTall.HALF, HalfState.UPPER), 11);
					worldIn.setBlockState(pos.down(), Window_Blocks.CURTAINTALL_purple.getDefaultState()
							.withProperty(CurtainTall.H_FACING, downState.getValue(CurtainTall.H_FACING))
							.withProperty(CurtainTall.OPEN, downState.getValue(CurtainTall.OPEN))
							.withProperty(CurtainTall.HINGE, stateIn.getValue(CurtainTall.HINGE))
							.withProperty(CurtainTall.HALF, HalfState.LOWER), 11); }
		...
		if (blockIn instanceof DeskCloth) {
			...
			if (blockIn != Chinjufu_Blocks.DESKCLOTH_811 || color != 3) {
		...
		if (blockIn instanceof BaseClothTable) {
			...
			if (color != 10) {
				worldIn.setBlockState(pos, stateIn.withProperty(BaseClothTable.STAGE_0_15, Integer.valueOf(10)), 11);//PURPLE
