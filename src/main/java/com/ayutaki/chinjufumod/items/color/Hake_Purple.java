...
public class Hake_Purple extends Abstract_Hake {
	...
	public ActionResultType useOn(ItemUseContext context) {
		...
		if (block == Blocks.WHITE_WOOL || block == Blocks.ORANGE_WOOL || block == Blocks.MAGENTA_WOOL ||
			...
			iworld.setBlock(pos, Blocks.PURPLE_WOOL.defaultBlockState(), 3);
		...
		if (block == Blocks.WHITE_CONCRETE || block == Blocks.ORANGE_CONCRETE || block == Blocks.MAGENTA_CONCRETE ||
			...
			iworld.setBlock(pos, Blocks.PURPLE_CONCRETE.defaultBlockState(), 3);
		...
		if (block == Blocks.WHITE_TERRACOTTA || block == Blocks.ORANGE_TERRACOTTA || block == Blocks.MAGENTA_TERRACOTTA ||
			...
			iworld.setBlock(pos, Blocks.PURPLE_TERRACOTTA.defaultBlockState(), 3);
		...
		if (block instanceof ConcretePowderBlock && block != Blocks.PURPLE_CONCRETE_POWDER) {
			...
			iworld.setBlock(pos, Blocks.PURPLE_CONCRETE_POWDER.defaultBlockState(), 3);
		...
		if ((block instanceof StainedGlassBlock && block != Blocks.PURPLE_STAINED_GLASS) || block == Blocks.GLASS) {
			...
			iworld.setBlock(pos, Blocks.PURPLE_STAINED_GLASS.defaultBlockState(), 3);
		...
		if (block instanceof GlazedTerracottaBlock && block != Blocks.PURPLE_GLAZED_TERRACOTTA) {
			...
			iworld.setBlock(pos, Blocks.PURPLE_GLAZED_TERRACOTTA.defaultBlockState()
		...
		if ((block instanceof StainedGlassPaneBlock && block != Blocks.PURPLE_STAINED_GLASS_PANE) || block == Blocks.GLASS_PANE) {
			...
			iworld.setBlock(pos, Blocks.PURPLE_STAINED_GLASS_PANE.defaultBlockState()
		...
		if (block instanceof CarpetBlock && block != Blocks.PURPLE_CARPET) {
			...
			iworld.setBlock(pos, Blocks.PURPLE_CARPET.defaultBlockState(), 3);
		...
		if (block instanceof Full_Kawara && block != JP_Blocks.KAWARA_purple) {
			...
			iworld.setBlock(pos, JP_Blocks.KAWARA_purple.defaultBlockState()
		...
		if (block instanceof Full_Plaster && block != JP_Blocks.SHIKKUI_purple && block != JP_Blocks.DIRTWALL) {
			...
			iworld.setBlock(pos, JP_Blocks.SHIKKUI_purple.defaultBlockState()
					.setValue(Base_Full_JP.CRACK, state.getValue(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Full_Namako && block != JP_Blocks.NAMAKO_purple) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKO_purple.defaultBlockState()
					.setValue(Base_Full_JP.CRACK, state.getValue(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Full_Namako_B && block != JP_Blocks.NAMAKOB_purple) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKOB_purple.defaultBlockState()
					.setValue(Base_Full_JP.CRACK, state.getValue(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Stairs_Kawara && block != JP_Blocks.KAWARA_ST_purple) {
			...
			iworld.setBlock(pos, JP_Blocks.KAWARA_ST_purple.defaultBlockState()
		...
		if (block instanceof Stairs_Plaster && block != JP_Blocks.SHIKKUI_ST_purple && block != JP_Blocks.DIRTWALL_stairs) {
			...
			iworld.setBlock(pos, JP_Blocks.SHIKKUI_ST_purple.defaultBlockState()
					.setValue(StairsBlock.FACING, state.getValue(StairsBlock.FACING))
					.setValue(StairsBlock.HALF, state.getValue(StairsBlock.HALF))
					.setValue(StairsBlock.SHAPE, state.getValue(StairsBlock.SHAPE))
					.setValue(StairsBlock.WATERLOGGED, state.getValue(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Stairs_Namako && block != JP_Blocks.NAMAKO_ST_purple) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKO_ST_purple.defaultBlockState()
					.setValue(StairsBlock.FACING, state.getValue(StairsBlock.FACING))
					.setValue(StairsBlock.HALF, state.getValue(StairsBlock.HALF))
					.setValue(StairsBlock.SHAPE, state.getValue(StairsBlock.SHAPE))
					.setValue(StairsBlock.WATERLOGGED, state.getValue(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Stairs_Namako_B && block != JP_Blocks.NAMAKOB_ST_purple) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKOB_ST_purple.defaultBlockState()
					.setValue(StairsBlock.FACING, state.getValue(StairsBlock.FACING))
					.setValue(StairsBlock.HALF, state.getValue(StairsBlock.HALF))
					.setValue(StairsBlock.SHAPE, state.getValue(StairsBlock.SHAPE))
					.setValue(StairsBlock.WATERLOGGED, state.getValue(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Kawara && block != JP_Blocks.KAWARA_SH_purple) {
			...
			iworld.setBlock(pos, JP_Blocks.KAWARA_SH_purple.defaultBlockState()
		...
		if (block instanceof Slab_Plaster && block != JP_Blocks.SHIKKUI_SH_purple && block != JP_Blocks.DIRTWALL_SH) {
			...
			iworld.setBlock(pos, JP_Blocks.SHIKKUI_SH_purple.defaultBlockState()
					.setValue(Base_Slab_JP.TYPE, state.getValue(Base_Slab_JP.TYPE))
					.setValue(Base_Slab_JP.CRACK, state.getValue(Base_Slab_JP.CRACK))
					.setValue(Base_Slab_JP.WATERLOGGED, state.getValue(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Namako && block != JP_Blocks.NAMAKO_SH_purple) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKO_SH_purple.defaultBlockState()
					.setValue(Base_Slab_JP.TYPE, state.getValue(Base_Slab_JP.TYPE))
					.setValue(Base_Slab_JP.CRACK, state.getValue(Base_Slab_JP.CRACK))
					.setValue(Base_Slab_JP.WATERLOGGED, state.getValue(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Namako_B && block != JP_Blocks.NAMAKOB_SH_purple) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKOB_SH_purple.defaultBlockState()
					.setValue(Base_Slab_JP.TYPE, state.getValue(Base_Slab_JP.TYPE))
					.setValue(Base_Slab_JP.CRACK, state.getValue(Base_Slab_JP.CRACK))
					.setValue(Base_Slab_JP.WATERLOGGED, state.getValue(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Truss_Cable && block != Harbor_Blocks.TRUSS_purple) {
			...
			iworld.setBlock(pos, Harbor_Blocks.TRUSS_purple.defaultBlockState()
		...
		if (block instanceof Truss_Amp && block != Harbor_Blocks.AMP_purple) {
			...
			iworld.setBlock(pos, Harbor_Blocks.AMP_purple.defaultBlockState()
		...
		if (block instanceof CafeChair && block != Chair_Blocks.CAFECHAIR_purple) {
			...
			iworld.setBlock(pos, Chair_Blocks.CAFECHAIR_purple.defaultBlockState(), 3);
		...
		if (block instanceof Zabuton && block != JPChair_Blocks.ZABUTON_purple && block != JPChair_Blocks.WARAZABUTON) {
			...
			iworld.setBlock(pos, JPChair_Blocks.ZABUTON_purple.defaultBlockState()
		...
		if (block instanceof Candle && block != Furniture_Blocks.CANDLE_purple) {
			...
			iworld.setBlock(pos, Furniture_Blocks.CANDLE_purple.defaultBlockState()
		...
		if (block instanceof Andon && block != JPDeco_Blocks.ANDON_purple) {
			...
			iworld.setBlock(pos, JPDeco_Blocks.ANDON_purple.defaultBlockState()
		...
		if (block instanceof Sofa && block != Chair_Blocks.SOFA_purple) {
			...
			iworld.setBlock(pos, Chair_Blocks.SOFA_purple.defaultBlockState()
		...
		if (block instanceof Zaisu && block != JPChair_Blocks.ZAISU_purple) {
			...
			iworld.setBlock(pos, JPChair_Blocks.ZAISU_purple.defaultBlockState()
		...
		if (block instanceof Noren && block != Ranma_Blocks.NOREN_purple) {
			...
			iworld.setBlock(pos, Ranma_Blocks.NOREN_purple.defaultBlockState()
		...
		if (block instanceof Futon && block != JPDeco_Blocks.FUTON_purple) {
			...
			iworld.setBlock(pos, JPDeco_Blocks.FUTON_purple.defaultBlockState()
		...
		if (block instanceof Tatami && block != JPDeco_Blocks.TATAMI_H_purple && block != JPDeco_Blocks.TATAMI_H) {
			...
			iworld.setBlock(pos, JPDeco_Blocks.TATAMI_H_purple.defaultBlockState()
		...
		if (block instanceof Tatami_Y && block != JPDeco_Blocks.TATAMI_HY_purple && block != JPDeco_Blocks.TATAMI_HY) {
			...
			iworld.setBlock(pos, JPDeco_Blocks.TATAMI_HY_purple.defaultBlockState()
					.setValue(BaseTatami.TYPE, state.getValue(BaseTatami.TYPE))
					.setValue(BaseTatami.H_FACING, state.getValue(BaseTatami.H_FACING))
					.setValue(BaseTatami.WATERLOGGED, state.getValue(BaseTatami.WATERLOGGED)), 3);
		...
		if (block instanceof Wagasa && block != Unit_Blocks.KASA_purple) {
			...
			iworld.setBlock(pos, Unit_Blocks.KASA_purple.defaultBlockState()
		...
		if (block instanceof Fusuma && block != Slidedoor_Blocks.FUSUMA_purple) {
			...
			if (state.getValue(BaseSlidedoor.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlock(pos, Slidedoor_Blocks.FUSUMA_purple.defaultBlockState()
				...
				iworld.setBlock(pos.above(), Slidedoor_Blocks.FUSUMA_purple.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, state.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, state.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, state.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, state.getValue(BaseSlidedoor.POWERED))
			...
			if (state.getValue(BaseSlidedoor.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlock(pos, Slidedoor_Blocks.FUSUMA_purple.defaultBlockState()
						...
						.setValue(BaseSlidedoor.HALF, DoubleBlockHalf.UPPER)
						.setValue(BaseSlidedoor.WATERLOGGED, state.getValue(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlock(pos.below(), Slidedoor_Blocks.FUSUMA_purple.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, state.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, state.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, state.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, state.getValue(BaseSlidedoor.POWERED))
		...
		if (block instanceof Fusuma_B && block != Slidedoor_Blocks.FUSUMAB_purple) {
			...
			if (state.getValue(BaseSlidedoor.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlock(pos, Slidedoor_Blocks.FUSUMAB_purple.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, state.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, state.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, state.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, state.getValue(BaseSlidedoor.POWERED))
						.setValue(BaseSlidedoor.HALF, DoubleBlockHalf.LOWER)
						.setValue(BaseSlidedoor.WATERLOGGED, state.getValue(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlock(pos.above(), Slidedoor_Blocks.FUSUMAB_purple.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, state.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, state.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, state.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, state.getValue(BaseSlidedoor.POWERED))
			...
			if (state.getValue(BaseSlidedoor.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlock(pos, Slidedoor_Blocks.FUSUMAB_purple.defaultBlockState()
						...
						.setValue(BaseSlidedoor.HALF, DoubleBlockHalf.UPPER)
						.setValue(BaseSlidedoor.WATERLOGGED, state.getValue(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlock(pos.below(), Slidedoor_Blocks.FUSUMAB_purple.defaultBlockState()
						.setValue(BaseSlidedoor.H_FACING, state.getValue(BaseSlidedoor.H_FACING))
						.setValue(BaseSlidedoor.OPEN, state.getValue(BaseSlidedoor.OPEN))
						.setValue(BaseSlidedoor.HINGE, state.getValue(BaseSlidedoor.HINGE))
						.setValue(BaseSlidedoor.POWERED, state.getValue(BaseSlidedoor.POWERED))
		...
		if (block instanceof KamoiPlaster_Oak && block != KamoiPlaster_Blocks.KAMOI_purple_oak) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_purple_oak.defaultBlockState()
		...
		if (block instanceof KamoiPlaster_Spruce && block != KamoiPlaster_Blocks.KAMOI_purple_spru) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_purple_spru.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Birch && block != KamoiPlaster_Blocks.KAMOI_purple_bir) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_purple_bir.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Jungle && block != KamoiPlaster_Blocks.KAMOI_purple_jun) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_purple_jun.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Acacia && block != KamoiPlaster_Blocks.KAMOI_purple_aca) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_purple_aca.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_DarkOak && block != KamoiPlaster_Blocks.KAMOI_purple_doak) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_purple_doak.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Sakura && block != KamoiPlaster_Blocks.KAMOI_purple_sakura) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_purple_sakura.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Kaede && block != KamoiPlaster_Blocks.KAMOI_purple_kaede) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_purple_kaede.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Ichoh && block != KamoiPlaster_Blocks.KAMOI_purple_ichoh) {
			...
			iworld.setBlock(pos, KamoiPlaster_Blocks.KAMOI_purple_ichoh.defaultBlockState()
					.setValue(Base_KamoiPlaster.H_FACING, state.getValue(Base_KamoiPlaster.H_FACING))
					.setValue(Base_KamoiPlaster.STAGE_1_4, state.getValue(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof WallPane_Clay && block != WallPanel_Blocks.WP_CLAY_purple) {
			...
			iworld.setBlock(pos, WallPanel_Blocks.WP_CLAY_purple.defaultBlockState()
					.setValue(BaseFacingWater.H_FACING, state.getValue(BaseFacingWater.H_FACING))
					.setValue(BaseFacingWater.WATERLOGGED, state.getValue(BaseFacingWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Glass && block != WallPanel_Blocks.WP_GLASS_purple) {
			...
			iworld.setBlock(pos, WallPanel_Blocks.WP_GLASS_purple.defaultBlockState()
					.setValue(BaseFacingWater.H_FACING, state.getValue(BaseFacingWater.H_FACING))
					.setValue(BaseFacingWater.WATERLOGGED, state.getValue(BaseFacingWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Plaster && block != WallPanel_Blocks.WP_PLASTER_purple) {
			...
			iworld.setBlock(pos, WallPanel_Blocks.WP_PLASTER_purple.defaultBlockState()
					.setValue(BaseStage2_FaceWater.H_FACING, state.getValue(BaseStage2_FaceWater.H_FACING))
					.setValue(BaseStage2_FaceWater.STAGE_1_2, state.getValue(BaseStage2_FaceWater.STAGE_1_2))
					.setValue(BaseStage2_FaceWater.WATERLOGGED, state.getValue(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Namako && block != WallPanel_Blocks.WP_NAMAKO_purple) {
			...
			iworld.setBlock(pos, WallPanel_Blocks.WP_NAMAKO_purple.defaultBlockState()
					.setValue(BaseStage2_FaceWater.H_FACING, state.getValue(BaseStage2_FaceWater.H_FACING))
					.setValue(BaseStage2_FaceWater.STAGE_1_2, state.getValue(BaseStage2_FaceWater.STAGE_1_2))
					.setValue(BaseStage2_FaceWater.WATERLOGGED, state.getValue(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Namako_B && block != WallPanel_Blocks.WP_NAMAKOB_purple) {
			...
			iworld.setBlock(pos, WallPanel_Blocks.WP_NAMAKOB_purple.defaultBlockState()
					.setValue(BaseStage2_FaceWater.H_FACING, state.getValue(BaseStage2_FaceWater.H_FACING))
					.setValue(BaseStage2_FaceWater.STAGE_1_2, state.getValue(BaseStage2_FaceWater.STAGE_1_2))
					.setValue(BaseStage2_FaceWater.WATERLOGGED, state.getValue(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof Wall_Plaster && block != JP_Blocks.SHIKKUI_WALL_purple && block != JP_Blocks.DIRTWALL_WALL) {
			...
			iworld.setBlock(pos, JP_Blocks.SHIKKUI_WALL_purple.defaultBlockState()
		...
		if (block instanceof Wall_Sama && block != JP_Blocks.SHIKKUI_SAMA_purple && block != JP_Blocks.DIRTWALL_SAMA) {
			...
			iworld.setBlock(pos, JP_Blocks.SHIKKUI_SAMA_purple.defaultBlockState()
		...
		if (block instanceof Wall_Kawara && block != JP_Blocks.KAWARA_WALL_purple) {
			...
			iworld.setBlock(pos, JP_Blocks.KAWARA_WALL_purple.defaultBlockState()
		...
		if (block instanceof Wall_Namako && block != JP_Blocks.NAMAKO_WALL_purple) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKO_WALL_purple.defaultBlockState()
		...
		if (block instanceof Wall_NamakoB && block != JP_Blocks.NAMAKOB_WALL_purple) {
			...
			iworld.setBlock(pos, JP_Blocks.NAMAKOB_WALL_purple.defaultBlockState()
		...
		if (block instanceof Curtain && block != Window_Blocks.CURTAIN_purple) {
			...
			iworld.setBlock(pos, Window_Blocks.CURTAIN_purple.defaultBlockState()
		...
		if (block instanceof CurtainTall && block != Window_Blocks.CURTAINTALL_purple) {
			...
			if (state.getValue(CurtainTall.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlock(pos, Window_Blocks.CURTAINTALL_purple.defaultBlockState()
				...
				iworld.setBlock(pos.above(), Window_Blocks.CURTAINTALL_purple.defaultBlockState()
						.setValue(CurtainTall.H_FACING, state.getValue(CurtainTall.H_FACING))
						.setValue(CurtainTall.OPEN, state.getValue(CurtainTall.OPEN))
						.setValue(CurtainTall.HINGE, state.getValue(CurtainTall.HINGE))
			...
			if (state.getValue(CurtainTall.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlock(pos, Window_Blocks.CURTAINTALL_purple.defaultBlockState()
						...
						.setValue(CurtainTall.HALF, DoubleBlockHalf.UPPER)
						.setValue(CurtainTall.WATERLOGGED, state.getValue(CurtainTall.WATERLOGGED)), 3);
				iworld.setBlock(pos.below(), Window_Blocks.CURTAINTALL_purple.defaultBlockState()
						.setValue(CurtainTall.H_FACING, state.getValue(CurtainTall.H_FACING))
						.setValue(CurtainTall.OPEN, state.getValue(CurtainTall.OPEN))
						.setValue(CurtainTall.HINGE, state.getValue(CurtainTall.HINGE))
						.setValue(CurtainTall.HALF, DoubleBlockHalf.LOWER)
		...
		if (block instanceof BaseClothTable) {
			...
			if (color != 10) {
				iworld.setBlock(pos, state.setValue(BaseClothTable.STAGE_0_15, Integer.valueOf(10)), 3);//PURPLE
