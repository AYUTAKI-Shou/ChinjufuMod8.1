...
public class Hake_Green extends Abstract_Hake {
	...
	public Hake_Green(Properties props) {
		super(props);
	}
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		if (block == Blocks.WHITE_WOOL || block == Blocks.ORANGE_WOOL || block == Blocks.MAGENTA_WOOL ||
			...
			iworld.setBlockState(pos, Blocks.GREEN_WOOL.getDefaultState(), 3);
		...
		if (block == Blocks.WHITE_CONCRETE || block == Blocks.ORANGE_CONCRETE || block == Blocks.MAGENTA_CONCRETE ||
			...
			iworld.setBlockState(pos, Blocks.GREEN_CONCRETE.getDefaultState(), 3);
		...
		if (block == Blocks.WHITE_TERRACOTTA || block == Blocks.ORANGE_TERRACOTTA || block == Blocks.MAGENTA_TERRACOTTA ||
			...
			iworld.setBlockState(pos, Blocks.GREEN_TERRACOTTA.getDefaultState(), 3);
		...
		if (block instanceof ConcretePowderBlock && block != Blocks.GREEN_CONCRETE_POWDER) {
			...
			iworld.setBlockState(pos, Blocks.GREEN_CONCRETE_POWDER.getDefaultState(), 3);
		...
		if ((block instanceof StainedGlassBlock && block != Blocks.GREEN_STAINED_GLASS) || block == Blocks.GLASS) {
			...
			iworld.setBlockState(pos, Blocks.GREEN_STAINED_GLASS.getDefaultState(), 3);
		...
		if (block instanceof GlazedTerracottaBlock && block != Blocks.GREEN_GLAZED_TERRACOTTA) {
			...
			iworld.setBlockState(pos, Blocks.GREEN_GLAZED_TERRACOTTA.getDefaultState()
		...
		if ((block instanceof StainedGlassPaneBlock && block != Blocks.GREEN_STAINED_GLASS_PANE) || block == Blocks.GLASS_PANE) {
			...
			iworld.setBlockState(pos, Blocks.GREEN_STAINED_GLASS_PANE.getDefaultState()
		...
		if (block instanceof CarpetBlock && block != Blocks.GREEN_CARPET) {
			...
			iworld.setBlockState(pos, Blocks.GREEN_CARPET.getDefaultState(), 3);
		...
		if (block instanceof Full_Kawara && block != JP_Blocks.KAWARA_green) {
			...
			iworld.setBlockState(pos, JP_Blocks.KAWARA_green.getDefaultState()
		...
		if (block instanceof Full_Plaster && block != JP_Blocks.SHIKKUI_green && block != JP_Blocks.DIRTWALL) {
			...
			iworld.setBlockState(pos, JP_Blocks.SHIKKUI_green.getDefaultState()
					.with(Base_Full_JP.CRACK, state.get(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Full_Namako && block != JP_Blocks.NAMAKO_green) {
			...
			iworld.setBlockState(pos, JP_Blocks.NAMAKO_green.getDefaultState()
					.with(Base_Full_JP.CRACK, state.get(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Full_Namako_B && block != JP_Blocks.NAMAKOB_green) {
			...
			iworld.setBlockState(pos, JP_Blocks.NAMAKOB_green.getDefaultState()
					.with(Base_Full_JP.CRACK, state.get(Base_Full_JP.CRACK)), 3);
		...
		if (block instanceof Stairs_Kawara && block != JP_Blocks.KAWARA_ST_green) {
			...
			iworld.setBlockState(pos, JP_Blocks.KAWARA_ST_green.getDefaultState()
		...
		if (block instanceof Stairs_Plaster && block != JP_Blocks.SHIKKUI_ST_green && block != JP_Blocks.DIRTWALL_stairs) {
			...
			iworld.setBlockState(pos, JP_Blocks.SHIKKUI_ST_green.getDefaultState()
					.with(StairsBlock.FACING, state.get(StairsBlock.FACING))
					.with(StairsBlock.HALF, state.get(StairsBlock.HALF))
					.with(StairsBlock.SHAPE, state.get(StairsBlock.SHAPE))
					.with(StairsBlock.WATERLOGGED, state.get(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Stairs_Namako && block != JP_Blocks.NAMAKO_ST_green) {
			...
			iworld.setBlockState(pos, JP_Blocks.NAMAKO_ST_green.getDefaultState()
					.with(StairsBlock.FACING, state.get(StairsBlock.FACING))
					.with(StairsBlock.HALF, state.get(StairsBlock.HALF))
					.with(StairsBlock.SHAPE, state.get(StairsBlock.SHAPE))
					.with(StairsBlock.WATERLOGGED, state.get(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Stairs_Namako_B && block != JP_Blocks.NAMAKOB_ST_green) {
			...
			iworld.setBlockState(pos, JP_Blocks.NAMAKOB_ST_green.getDefaultState()
					.with(StairsBlock.FACING, state.get(StairsBlock.FACING))
					.with(StairsBlock.HALF, state.get(StairsBlock.HALF))
					.with(StairsBlock.SHAPE, state.get(StairsBlock.SHAPE))
					.with(StairsBlock.WATERLOGGED, state.get(StairsBlock.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Kawara && block != JP_Blocks.KAWARA_SH_green) {
			...
			iworld.setBlockState(pos, JP_Blocks.KAWARA_SH_green.getDefaultState()
		...
		if (block instanceof Slab_Plaster && block != JP_Blocks.SHIKKUI_SH_green && block != JP_Blocks.DIRTWALL_SH) {
			...
			iworld.setBlockState(pos, JP_Blocks.SHIKKUI_SH_green.getDefaultState()
					.with(Base_Slab_JP.TYPE, state.get(Base_Slab_JP.TYPE))
					.with(Base_Slab_JP.CRACK, state.get(Base_Slab_JP.CRACK))
					.with(Base_Slab_JP.WATERLOGGED, state.get(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Namako && block != JP_Blocks.NAMAKO_SH_green) {
			...
			iworld.setBlockState(pos, JP_Blocks.NAMAKO_SH_green.getDefaultState()
					.with(Base_Slab_JP.TYPE, state.get(Base_Slab_JP.TYPE))
					.with(Base_Slab_JP.CRACK, state.get(Base_Slab_JP.CRACK))
					.with(Base_Slab_JP.WATERLOGGED, state.get(Base_Slab_JP.WATERLOGGED)), 3);
		...
		if (block instanceof Slab_Namako_B && block != JP_Blocks.NAMAKOB_SH_green) {
			...
			iworld.setBlockState(pos, JP_Blocks.NAMAKOB_SH_green.getDefaultState()
					.with(Base_Slab_JP.TYPE, state.get(Base_Slab_JP.TYPE))
					.with(Base_Slab_JP.CRACK, state.get(Base_Slab_JP.CRACK))
					.with(Base_Slab_JP.WATERLOGGED, state.get(Base_Slab_JP.WATERLOGGED)), 3);
		...
		///////////////////////
		/** トラス **/
		if (block instanceof Truss_Cable && block != Harbor_Blocks.TRUSS_green) {

			iworld.setBlockState(pos, Harbor_Blocks.TRUSS_green.getDefaultState()
		...
		if (block instanceof Truss_Amp && block != Harbor_Blocks.AMP_green) {

			iworld.setBlockState(pos, Harbor_Blocks.AMP_green.getDefaultState()
		...
		if (block instanceof CafeChair && block != Chair_Blocks.CAFECHAIR_green) {
			...
			iworld.setBlockState(pos, Chair_Blocks.CAFECHAIR_green.getDefaultState(), 3);
		...
		if (block instanceof Zabuton && block != JPChair_Blocks.ZABUTON_green && block != JPChair_Blocks.WARAZABUTON) {
			...
			iworld.setBlockState(pos, JPChair_Blocks.ZABUTON_green.getDefaultState()
		...
		if (block instanceof Candle && block != Furniture_Blocks.CANDLE_green) {
			...
			iworld.setBlockState(pos, Furniture_Blocks.CANDLE_green.getDefaultState()
		...
		if (block instanceof Andon && block != JPDeco_Blocks.ANDON_green) {
			...
			iworld.setBlockState(pos, JPDeco_Blocks.ANDON_green.getDefaultState()
		...
		if (block instanceof Sofa && block != Chair_Blocks.SOFA_green) {
			...
			iworld.setBlockState(pos, Chair_Blocks.SOFA_green.getDefaultState()
		...
		if (block instanceof Zaisu && block != JPChair_Blocks.ZAISU_green) {
			...
			iworld.setBlockState(pos, JPChair_Blocks.ZAISU_green.getDefaultState()
		...
		if (block instanceof Noren && block != Ranma_Blocks.NOREN_green) {
			...
			iworld.setBlockState(pos, Ranma_Blocks.NOREN_green.getDefaultState()
		...
		if (block instanceof Futon && block != JPDeco_Blocks.FUTON_green) {
			...
			iworld.setBlockState(pos, JPDeco_Blocks.FUTON_green.getDefaultState()
		...
		if (block instanceof Tatami && block != JPDeco_Blocks.TATAMI_H_green && block != JPDeco_Blocks.TATAMI_H) {
			...
			iworld.setBlockState(pos, JPDeco_Blocks.TATAMI_H_green.getDefaultState()
		...
		if (block instanceof Tatami_Y && block != JPDeco_Blocks.TATAMI_HY_green && block != JPDeco_Blocks.TATAMI_HY) {
			...
			iworld.setBlockState(pos, JPDeco_Blocks.TATAMI_HY_green.getDefaultState()
					.with(BaseTatami.TYPE, state.get(BaseTatami.TYPE))
					.with(BaseTatami.H_FACING, state.get(BaseTatami.H_FACING))
					.with(BaseTatami.WATERLOGGED, state.get(BaseTatami.WATERLOGGED)), 3);
		...
		if (block instanceof Wagasa && block != Unit_Blocks.KASA_green) {
			...
			iworld.setBlockState(pos, Unit_Blocks.KASA_green.getDefaultState()
		...
		if (block instanceof Fusuma && block != Slidedoor_Blocks.FUSUMA_green) {
			...
			if (state.get(BaseSlidedoor.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlockState(pos, Slidedoor_Blocks.FUSUMA_green.getDefaultState()
				...
				iworld.setBlockState(pos.up(), Slidedoor_Blocks.FUSUMA_green.getDefaultState()
						.with(BaseSlidedoor.H_FACING, state.get(BaseSlidedoor.H_FACING))
						.with(BaseSlidedoor.OPEN, state.get(BaseSlidedoor.OPEN))
						.with(BaseSlidedoor.HINGE, state.get(BaseSlidedoor.HINGE))
						.with(BaseSlidedoor.POWERED, state.get(BaseSlidedoor.POWERED))
			...
			if (state.get(BaseSlidedoor.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlockState(pos, Slidedoor_Blocks.FUSUMA_green.getDefaultState()
						...
						.with(BaseSlidedoor.HALF, DoubleBlockHalf.UPPER)
						.with(BaseSlidedoor.WATERLOGGED, state.get(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlockState(pos.down(), Slidedoor_Blocks.FUSUMA_green.getDefaultState()
						.with(BaseSlidedoor.H_FACING, state.get(BaseSlidedoor.H_FACING))
						.with(BaseSlidedoor.OPEN, state.get(BaseSlidedoor.OPEN))
						.with(BaseSlidedoor.HINGE, state.get(BaseSlidedoor.HINGE))
						.with(BaseSlidedoor.POWERED, state.get(BaseSlidedoor.POWERED))
		...
		if (block instanceof Fusuma_B && block != Slidedoor_Blocks.FUSUMAB_green) {
			...
			if (state.get(BaseSlidedoor.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlockState(pos, Slidedoor_Blocks.FUSUMAB_green.getDefaultState()
						.with(BaseSlidedoor.H_FACING, state.get(BaseSlidedoor.H_FACING))
						.with(BaseSlidedoor.OPEN, state.get(BaseSlidedoor.OPEN))
						.with(BaseSlidedoor.HINGE, state.get(BaseSlidedoor.HINGE))
						.with(BaseSlidedoor.POWERED, state.get(BaseSlidedoor.POWERED))
						.with(BaseSlidedoor.HALF, DoubleBlockHalf.LOWER)
						.with(BaseSlidedoor.WATERLOGGED, state.get(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlockState(pos.up(), Slidedoor_Blocks.FUSUMAB_green.getDefaultState()
						.with(BaseSlidedoor.H_FACING, state.get(BaseSlidedoor.H_FACING))
						.with(BaseSlidedoor.OPEN, state.get(BaseSlidedoor.OPEN))
						.with(BaseSlidedoor.HINGE, state.get(BaseSlidedoor.HINGE))
						.with(BaseSlidedoor.POWERED, state.get(BaseSlidedoor.POWERED))
			...
			if (state.get(BaseSlidedoor.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlockState(pos, Slidedoor_Blocks.FUSUMAB_green.getDefaultState()
						...
						.with(BaseSlidedoor.HALF, DoubleBlockHalf.UPPER)
						.with(BaseSlidedoor.WATERLOGGED, state.get(BaseSlidedoor.WATERLOGGED)), 3);
				iworld.setBlockState(pos.down(), Slidedoor_Blocks.FUSUMAB_green.getDefaultState()
						.with(BaseSlidedoor.H_FACING, state.get(BaseSlidedoor.H_FACING))
						.with(BaseSlidedoor.OPEN, state.get(BaseSlidedoor.OPEN))
						.with(BaseSlidedoor.HINGE, state.get(BaseSlidedoor.HINGE))
						.with(BaseSlidedoor.POWERED, state.get(BaseSlidedoor.POWERED))
		...
		if (block instanceof KamoiPlaster_Oak && block != KamoiPlaster_Blocks.KAMOI_green_oak) {
			...
			iworld.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_green_oak.getDefaultState()
		...
		if (block instanceof KamoiPlaster_Spruce && block != KamoiPlaster_Blocks.KAMOI_green_spru) {
			...
			iworld.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_green_spru.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, state.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, state.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Birch && block != KamoiPlaster_Blocks.KAMOI_green_bir) {
			...
			iworld.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_green_bir.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, state.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, state.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Jungle && block != KamoiPlaster_Blocks.KAMOI_green_jun) {
			...
			iworld.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_green_jun.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, state.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, state.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Acacia && block != KamoiPlaster_Blocks.KAMOI_green_aca) {
			...
			iworld.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_green_aca.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, state.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, state.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_DarkOak && block != KamoiPlaster_Blocks.KAMOI_green_doak) {
			...
			iworld.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_green_doak.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, state.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, state.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Sakura && block != KamoiPlaster_Blocks.KAMOI_green_sakura) {
			...
			iworld.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_green_sakura.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, state.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, state.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Kaede && block != KamoiPlaster_Blocks.KAMOI_green_kaede) {
			...
			iworld.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_green_kaede.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, state.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, state.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof KamoiPlaster_Ichoh && block != KamoiPlaster_Blocks.KAMOI_green_ichoh) {
			...
			iworld.setBlockState(pos, KamoiPlaster_Blocks.KAMOI_green_ichoh.getDefaultState()
					.with(Base_KamoiPlaster.H_FACING, state.get(Base_KamoiPlaster.H_FACING))
					.with(Base_KamoiPlaster.STAGE_1_4, state.get(Base_KamoiPlaster.STAGE_1_4)), 3);
		...
		if (block instanceof WallPane_Clay && block != WallPanel_Blocks.WP_CLAY_green) {
			...
			iworld.setBlockState(pos, WallPanel_Blocks.WP_CLAY_green.getDefaultState()
					.with(BaseFacingWater.H_FACING, state.get(BaseFacingWater.H_FACING))
					.with(BaseFacingWater.WATERLOGGED, state.get(BaseFacingWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Glass && block != WallPanel_Blocks.WP_GLASS_green) {
			...
			iworld.setBlockState(pos, WallPanel_Blocks.WP_GLASS_green.getDefaultState()
					.with(BaseFacingWater.H_FACING, state.get(BaseFacingWater.H_FACING))
					.with(BaseFacingWater.WATERLOGGED, state.get(BaseFacingWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Plaster && block != WallPanel_Blocks.WP_PLASTER_green) {
			...
			iworld.setBlockState(pos, WallPanel_Blocks.WP_PLASTER_green.getDefaultState()
					.with(BaseStage2_FaceWater.H_FACING, state.get(BaseStage2_FaceWater.H_FACING))
					.with(BaseStage2_FaceWater.STAGE_1_2, state.get(BaseStage2_FaceWater.STAGE_1_2))
					.with(BaseStage2_FaceWater.WATERLOGGED, state.get(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Namako && block != WallPanel_Blocks.WP_NAMAKO_green) {
			...
			iworld.setBlockState(pos, WallPanel_Blocks.WP_NAMAKO_green.getDefaultState()
					.with(BaseStage2_FaceWater.H_FACING, state.get(BaseStage2_FaceWater.H_FACING))
					.with(BaseStage2_FaceWater.STAGE_1_2, state.get(BaseStage2_FaceWater.STAGE_1_2))
					.with(BaseStage2_FaceWater.WATERLOGGED, state.get(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof WallPane_Namako_B && block != WallPanel_Blocks.WP_NAMAKOB_green) {
			...
			iworld.setBlockState(pos, WallPanel_Blocks.WP_NAMAKOB_green.getDefaultState()
					.with(BaseStage2_FaceWater.H_FACING, state.get(BaseStage2_FaceWater.H_FACING))
					.with(BaseStage2_FaceWater.STAGE_1_2, state.get(BaseStage2_FaceWater.STAGE_1_2))
					.with(BaseStage2_FaceWater.WATERLOGGED, state.get(BaseStage2_FaceWater.WATERLOGGED)), 3);
		...
		if (block instanceof Wall_Plaster && block != JP_Blocks.SHIKKUI_WALL_green && block != JP_Blocks.DIRTWALL_WALL) {
			...
			iworld.setBlockState(pos, JP_Blocks.SHIKKUI_WALL_green.getDefaultState()
		...
		if (block instanceof Wall_Sama && block != JP_Blocks.SHIKKUI_SAMA_green && block != JP_Blocks.DIRTWALL_SAMA) {
			...
			iworld.setBlockState(pos, JP_Blocks.SHIKKUI_SAMA_green.getDefaultState()
		...
		if (block instanceof Wall_Kawara && block != JP_Blocks.KAWARA_WALL_green) {
			...
			iworld.setBlockState(pos, JP_Blocks.KAWARA_WALL_green.getDefaultState()
		...
		if (block instanceof Wall_Namako && block != JP_Blocks.NAMAKO_WALL_green) {
			...
			iworld.setBlockState(pos, JP_Blocks.NAMAKO_WALL_green.getDefaultState()
		...
		if (block instanceof Wall_NamakoB && block != JP_Blocks.NAMAKOB_WALL_green) {
			...
			iworld.setBlockState(pos, JP_Blocks.NAMAKOB_WALL_green.getDefaultState()
		...
		///6.2.4////////////////////
		if (block instanceof Curtain && block != Window_Blocks.CURTAIN_green) {
			
			iworld.setBlockState(pos, Window_Blocks.CURTAIN_green.getDefaultState()
		...
		if (block instanceof CurtainTall && block != Window_Blocks.CURTAINTALL_green) {

			if (state.get(CurtainTall.HALF) == DoubleBlockHalf.LOWER) {
				iworld.setBlockState(pos, Window_Blocks.CURTAINTALL_green.getDefaultState()
				...
				iworld.setBlockState(pos.up(), Window_Blocks.CURTAINTALL_green.getDefaultState()
						.with(CurtainTall.H_FACING, state.get(CurtainTall.H_FACING))
						.with(CurtainTall.OPEN, state.get(CurtainTall.OPEN))
						.with(CurtainTall.HINGE, state.get(CurtainTall.HINGE))
			...
			if (state.get(CurtainTall.HALF) == DoubleBlockHalf.UPPER) {
				iworld.setBlockState(pos, Window_Blocks.CURTAINTALL_green.getDefaultState()
						...
						.with(CurtainTall.HALF, DoubleBlockHalf.UPPER)
						.with(CurtainTall.WATERLOGGED, state.get(CurtainTall.WATERLOGGED)), 3);
				iworld.setBlockState(pos.down(), Window_Blocks.CURTAINTALL_green.getDefaultState()
						.with(CurtainTall.H_FACING, state.get(CurtainTall.H_FACING))
						.with(CurtainTall.OPEN, state.get(CurtainTall.OPEN))
						.with(CurtainTall.HINGE, state.get(CurtainTall.HINGE))
						.with(CurtainTall.HALF, DoubleBlockHalf.LOWER)
		...
		if (block instanceof DeskCloth) {
			...
			if (block != Furniture_Blocks.DESKCLOTH_1215 || color != 2) {
		...
		if (block instanceof BaseClothTable) {
			...
			if (color != 13) {
				...
				iworld.setBlockState(pos, state.with(BaseClothTable.STAGE_0_15, Integer.valueOf(13)), 3);//GREEN
