...
public class SB_Zuiun extends Abstract_BowKansaiki {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> itemTip, TooltipFlag tipFlag) {
		...
		itemTip.add(new TranslatableComponent("tips.item_kk_7f").withStyle(ChatFormatting.GREEN));
		itemTip.add(new TranslatableComponent("tips.item_sb").withStyle(ChatFormatting.GRAY)); }
}
