...
public class Gyorai61cm extends IR_Armor {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, @Nonnull EnumHand hand) {
		...
		if(!playerIn.getCooldownTracker().hasCooldown(this)) {
			...
			if (!worldIn.isRemote) {
				Gyorai61cmEntity kansaiki = new Gyorai61cmEntity(worldIn, playerIn, hStack);
				...
				int j = EnchantmentHelper.getEnchantmentLevel(Enchantments.SHARPNESS, hStack);
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> itemTip, ITooltipFlag advanced) {
		itemTip.add(I18n.format("tips.item_gyorai.name"));
		itemTip.add(TextFormatting.DARK_GREEN + I18n.format("tips.item_gyorai2.name"));
	}
}
