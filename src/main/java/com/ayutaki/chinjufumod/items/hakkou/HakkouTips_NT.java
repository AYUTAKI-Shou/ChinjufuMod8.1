...
public class HakkouTips_NT extends NoGroup_noFuel {
	...
	public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> itemTip, ITooltipFlag tipFlag) {
		...
		if (this == Items_Teatime.SHOUYU_bot_14 || this == Items_Teatime.DASHI_bot_14 ||
			...
			itemTip.add(new TranslationTextComponent("tips.block_bot").withStyle(TextFormatting.GRAY)); }
		...
		if (this == Items_NoTab.SHOUYU_bot_24 || this == Items_NoTab.DASHI_bot_24 ||
			...
			itemTip.add(new TranslationTextComponent("tips.block_bot_2").withStyle(TextFormatting.GRAY)); }
		...
		if (this == Items_NoTab.SHOUYU_bot_34 || this == Items_NoTab.DASHI_bot_34 || 
			...
			itemTip.add(new TranslationTextComponent("tips.block_bot_3").withStyle(TextFormatting.GRAY)); }
		...
		if (this == Items_NoTab.SHOUYU_bot_44 || this == Items_NoTab.DASHI_bot_44 || 
			...
			itemTip.add(new TranslationTextComponent("tips.block_bot_4").withStyle(TextFormatting.GRAY)); }
		...
		if (this == Items_Teatime.OSAUCE_bot_14 || this == Items_NoTab.OSAUCE_bot_24 || 
			...
			itemTip.add(new TranslationTextComponent("tips.block_osauce_bot").withStyle(TextFormatting.GRAY)); }
	}
}
