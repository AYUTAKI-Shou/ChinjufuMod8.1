...
public class HakkouItem_Tips extends Not_Fuel {

	public HakkouItem_Tips(Block block, Item.Properties props) {
		super(block, props);
	}
	...
	public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> itemTip, TooltipFlag tipFlag) {
		...
		if (this == Items_NoTab.SHOUYU_bot_24.get() || this == Items_NoTab.DASHI_bot_24.get() ||
			...
			itemTip.add(Component.translatable("tips.block_bot_2").withStyle(ChatFormatting.GRAY)); }
