...
public class ZundouShioMizu_TT extends IBR_Teatime {

	public ZundouShioMizu_TT(String name) {
	...
	public EnumActionResult onItemUse(EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		if (!hStack.isEmpty() && playerIn.canPlayerEdit(pos, facing, hStack) && worldIn.mayPlace(Dish_Blocks.SHIOAKUNABE, pos, false, facing, (Entity)null)) {
			...
			IBlockState putSTATE = Dish_Blocks.SHIOAKUNABE.getDefaultState()
					...
					.withProperty(Zundou_ShioAku.STAGE_1_4, Integer.valueOf(1));
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> itemTip, ITooltipFlag advanced) {
		itemTip.add(I18n.format("tips.block_zundou_shiomizu.name"));
	}
}
