...
public class AddInfo_NT extends Item {
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> itemTip, ITooltipFlag tipFlag) {
		...
		if (this == Items_NoTab.RAW_ICE_VANILLA || this == Items_NoTab.RAW_ICE_GREEN ||
			...
			itemTip.add(new TranslationTextComponent("tips.item_raw_icecream").applyTextStyle(TextFormatting.GRAY)); }
		...
		if (this == Items_NoTab.RAW_KANTEN_APPLE || this == Items_NoTab.RAW_KANTEN_CHERRY ||
			...
			itemTip.add(new TranslationTextComponent("tips.item_raw_kanten").applyTextStyle(TextFormatting.GRAY)); }
		
		if (this == Items_NoTab.ROTTEN_FOOD) {
			itemTip.add(new TranslationTextComponent("tips.item_rotten_food").applyTextStyle(TextFormatting.GRAY)); }
		
		if (this == Items_Chinjufu.SHOUHOU_empty) {
			itemTip.add(new TranslationTextComponent("tips.item_shouhou_empty").applyTextStyle(TextFormatting.GRAY)); }
		if (this == Items_Chinjufu.SUMI) {
			itemTip.add(new TranslationTextComponent("tips.item_sumi").applyTextStyle(TextFormatting.GRAY)); }
		
		if (this == Items_Wadeco.HAKE) {
			itemTip.add(new TranslationTextComponent("tips.item_hake").applyTextStyle(TextFormatting.GRAY)); }
		if (this == Items_Wablock.SHOUSEKKAI) {
			itemTip.add(new TranslationTextComponent("tips.item_shousekkai_c").applyTextStyle(TextFormatting.GRAY)); }
		if (this == Items_Wablock.CLAYKAWARA) {
			itemTip.add(new TranslationTextComponent("tips.item_claykawara").applyTextStyle(TextFormatting.GRAY)); }
	}
}
