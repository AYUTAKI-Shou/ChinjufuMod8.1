...
public abstract class Abstract_WearItem extends ArmorItem {
	...
	public Abstract_WearItem(IArmorMaterial material, EquipmentSlotType slot, Properties props) {
		super(material, slot, props.group(ItemGroups_CM.SEASONAL));
	}
	
	/* Abstract */
	@OnlyIn(Dist.CLIENT)
	@Override
	public abstract <Armor extends BipedModel<?>> Armor getArmorModel(LivingEntity entityLiving, ItemStack stack, EquipmentSlotType slotType, Armor defModel);
