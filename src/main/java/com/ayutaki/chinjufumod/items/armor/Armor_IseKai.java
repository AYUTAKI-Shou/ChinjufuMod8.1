...
public class Armor_IseKai extends Base_BattleshipItem {
	...
	public Armor_IseKai(ArmorMaterial material, ArmorType slot, Item.Properties props) {
	...
	public static final class ArmorRender extends Base_ArmorItem.BaseRender {
		...
		public Model getHumanoidArmorModel(ItemStack stack, EquipmentClientInfo.LayerType type, Model original) {
			...
			ModelPart part = models.bakeLayer(leg? ArmorLayer_CM.ISE_INNER : ArmorLayer_CM.ISE_OUTER);
