...
public abstract class Base_CarrierItem extends Abstract_ArmorItem {
	...
	public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> itemTip, ITooltipFlag tipFlag) {
		itemTip.add(new TranslationTextComponent("tips.item_carrier").withStyle(TextFormatting.GRAY));
		itemTip.add(new TranslationTextComponent("tips.item_carrier2").withStyle(TextFormatting.GRAY));
	}
}
