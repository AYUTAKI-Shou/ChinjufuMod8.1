...
public class CMArmorMaterial {
	...
	/** 7.0.2 **/
	/* 0.42×77=32.34 */
	public static ArmorMaterial ISE = EnumHelper
			.addArmorMaterial("ISE", "chinjufumod:ise", 32, new int[]{ 3, 6, 8, 3 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2);
	/* 0.42×20=8.4 */
	public static ArmorMaterial I401 = EnumHelper
			.addArmorMaterial("I401", "chinjufumod:i401", 8, new int[] { 3, 4, 4, 3 }, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0);
