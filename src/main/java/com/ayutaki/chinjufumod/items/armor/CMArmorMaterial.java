...
public enum CMArmorMaterial implements IArmorMaterial {
	...
	/* 0.42×72=30.24 */
	KAGA("kaga", 30, new int[]{ 2, 6, 7, 3 }, 10, SoundEvents.ARMOR_EQUIP_IRON, 1.0F, 0.1F, () -> {
		return Ingredient.of(Items.IRON_INGOT); }),
	/* 0.42×69=28.98 */
	...
	/** 7.0.2 **/
	/* 0.42×77=32.34 */
	ISE("ise", 32, new int[]{ 3, 6, 8, 3 }, 10, SoundEvents.ARMOR_EQUIP_IRON, 2.0F, 0.1F, () -> {
		return Ingredient.of(Items.IRON_INGOT); }),
	/* 0.42×20=8.4 */
	I401("i401", 8, new int[]{ 3, 4, 4, 3 }, 15, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
		return Ingredient.of(Items.IRON_INGOT); }),
	
	AKASHISANTA("santaakashi", 6, new int[]{ 1, 2, 2, 1 }, 15, SoundEvents.ARMOR_EQUIP_LEATHER, 0.0F, 0.0F, () -> {
		return Ingredient.of(Items_NoTab.EMBLEM_C); }),
