...
public class Armor_ToneKai extends Base_CruiserItem {
	...
	public Armor_ToneKai(ArmorMaterial material, ArmorType slot, Item.Properties props) {
	...
	public static final class ArmorRender extends Base_ArmorItem.BaseRender {
		...
		public Model getHumanoidArmorModel(ItemStack stack, EquipmentClientInfo.LayerType type, Model original) {
			...
			ModelPart part = models.bakeLayer(leg? ArmorLayer_CM.TONE_INNER : ArmorLayer_CM.TONE_OUTER);
