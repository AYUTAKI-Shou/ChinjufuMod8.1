...
public class Armor_I401 extends Base_Submarine {
	...
	public Armor_I401(Holder<ArmorMaterial> material, ArmorItem.Type slot, Item.Properties props) {
	...
	public void initializeClient(Consumer<net.minecraftforge.client.extensions.common.IClientItemExtensions> consumer) {
		consumer.accept(new IClientItemExtensions() {
			...
			public HumanoidModel<?> getHumanoidArmorModel(LivingEntity entityIn, ItemStack stack, EquipmentSlot slot, HumanoidModel<?> defModel) {
				...
				ModelPart part = entityModel.bakeLayer(slot == EquipmentSlot.LEGS ? ArmorLayer_CM.I401_INNER : ArmorLayer_CM.I401_OUTER);
