...
public class Armor_I401 extends Base_Submarine {
	...
	public Armor_I401(ArmorMaterial material, ArmorType slot, Item.Properties props) {
	...
	public static final class ArmorRender extends Base_ArmorItem.BaseRender {
		...
		public Model getHumanoidArmorModel(ItemStack stack, EquipmentClientInfo.LayerType type, Model original) {
			...
			ModelPart part = models.bakeLayer(leg? ArmorLayer_CM.I401_INNER : ArmorLayer_CM.I401_OUTER);
