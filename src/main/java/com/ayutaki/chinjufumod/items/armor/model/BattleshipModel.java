...
public class BattleshipModel {
	...
	public static MeshDefinition createOuter() {
		...
		bipedLeftArm.addOrReplaceChild("kanpan", CubeListBuilder.create()
				.texOffs(46, 32)
				.addBox(1.1F, -2.25F, -3.0F, 2, 14, 6, new CubeDeformation(0.5F)),
				PartPose.offset(0.0F, 0.0F, 0.0F)); //KANPAN
		bipedLeftArm.addOrReplaceChild("kanpan_wa", CubeListBuilder.create()
				.texOffs(46, 52)
				.addBox(-1.0F, 3.75F, -2.0F, 4, 4, 4, new CubeDeformation(0.51F)),
				PartPose.offset(0.0F, 0.0F, 0.0F)); //KANPAN_WA
