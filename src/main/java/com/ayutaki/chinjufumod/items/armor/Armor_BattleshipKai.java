...
public class Armor_BattleshipKai extends Base_BattleshipItem {
	...
	public Armor_BattleshipKai(IArmorMaterial material, EquipmentSlotType slot, Properties props) {
	...
	public void inventoryTick(ItemStack stack, World worldIn, Entity entity, int slot, boolean selected) {
		if (entity instanceof PlayerEntity) {
			...
			if (playerIn.getItemStackFromSlot(EquipmentSlotType.FEET).getItem() instanceof Armor_BattleshipKai) {
