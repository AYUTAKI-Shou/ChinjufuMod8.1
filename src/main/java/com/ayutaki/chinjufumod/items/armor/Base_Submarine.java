...
public class Base_Submarine extends Base_ArmorItem {
	...
	public Base_Submarine(Holder<ArmorMaterial> material, ArmorItem.Type slot, Item.Properties props) {
		...
		if (entity != null && entity instanceof Player) {
			...
			if (!playerIn.getAbilities().instabuild) {
				...
				if (ShipTypes_CM.typeSubmarine(playerIn)) {
					boolean SENSUI = playerIn.isEyeInFluidType(ForgeMod.WATER_TYPE.get());
