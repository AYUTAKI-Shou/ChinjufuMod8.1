...
public class Costume_YUKATA extends Abstract_WearItem {
	...
	public Costume_YUKATA(ArmorMaterial material, EquipmentSlot slot, Item.Properties props) {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> itemTip, TooltipFlag tipFlag) {
		...
		itemTip.add(new TranslatableComponent("tips.item_ykt").withStyle(ChatFormatting.GRAY)); }
	}
}
