...
public class Costume_YUKATA extends Abstract_WearItem {

	public Costume_YUKATA(IArmorMaterial material, EquipmentSlotType slot, Properties props) {
	...
	public <Armor extends BipedModel<?>> Armor getArmorModel(LivingEntity entityLiving, ItemStack stack, EquipmentSlotType slot, Armor defModel) {
		return (Armor) (slot == EquipmentSlotType.LEGS ? new YUKATA_Inner(-0.1F) : new YUKATA_Outer(0.55F));
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> itemTip, ITooltipFlag tipFlag) {
		if (this != Items_Seasonal.YKTD_GETA && this != Items_Seasonal.YKTO_GETA &&
			...
			itemTip.add(new TranslationTextComponent("tips.item_ykt").withStyle(TextFormatting.GRAY)); }
	}
}
