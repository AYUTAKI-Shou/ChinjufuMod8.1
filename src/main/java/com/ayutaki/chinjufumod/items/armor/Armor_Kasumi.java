...
public class Armor_Kasumi extends Base_DestroyerItem {
	...
	public Armor_Kasumi(ArmorMaterial material, ArmorType slot, Item.Properties props) {
	...
	public static final class ArmorRender extends Base_ArmorItem.BaseRender {
		...
		public Model getHumanoidArmorModel(ItemStack stack, EquipmentClientInfo.LayerType type, Model original) {
			...
			ModelPart part = models.bakeLayer(leg? ArmorLayer_CM.GISOU_INNER : ArmorLayer_CM.KASUMI_OUTER);
