...
public class Armor_Kasumi extends Base_DestroyerItem {

	public Armor_Kasumi(IArmorMaterial material, EquipmentSlotType slot, Properties props) {
	...
	public <Armor extends BipedModel<?>> Armor getArmorModel(LivingEntity entityLiving, ItemStack stack, EquipmentSlotType slotType, Armor defModel) {
		return (Armor) (slotType == EquipmentSlotType.LEGS ? new GisouInner(0.4F) : new KasumiOuter(0.45F));
	}
}
