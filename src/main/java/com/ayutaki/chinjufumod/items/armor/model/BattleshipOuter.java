...
public class BattleshipOuter extends BaseArmor {
	...
	private ModelRenderer KANPAN_WA;
	...
	public BattleshipOuter(float scale) {
		...
		KANPAN.addBox(1.1F, -2.25F, -3.0F, 2, 14, 6, 0.5F);
		KANPAN.setRotationPoint(0F, 0F, 0F);
		KANPAN_WA = new ModelRenderer(this, 46, 52);
		KANPAN_WA.addBox(-1.0F, 3.75F, -2.0F, 4, 4, 4, 0.51F);
		KANPAN_WA.setRotationPoint(0F, 0F, 0F);
		...
		bipedLeftArm.addChild(KANPAN_WA);
