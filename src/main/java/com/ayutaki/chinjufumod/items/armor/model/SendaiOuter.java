...
public class SendaiOuter extends BaseArmor {
	...
	public SendaiOuter(float scale) {
		...
		SCARF_RIGHT.rotateAngleY = -25 * ag;
		...
		bipedBody.addChild(OBI2);
		
		bipedBody.addChild(KOSHIHIMO_1);
		bipedBody.addChild(KOSHIHIMO_2);
		bipedBody.addChild(KOSHIHIMO_3);
		
		bipedRightArm.addChild(RIGHT_SODE);
		bipedLeftArm.addChild(LEFT_SODE);
		bipedRightArm.addChild(RIGHT_KOTE);
		bipedLeftArm.addChild(LEFT_KOTE);
