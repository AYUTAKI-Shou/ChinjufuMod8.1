...
public class Armor_I13 extends Base_Submarine {
	...
	public Armor_I13(IArmorMaterial material, EquipmentSlotType slot, Properties props) {
	...
	public <Armor extends BipedModel<?>> Armor getArmorModel(LivingEntity entityLiving, ItemStack stack, EquipmentSlotType slot, Armor defModel) {
		return (Armor) (slot == EquipmentSlotType.LEGS ? new SubmarineInner(0.15F) : new SubmarineOuter(0.55F));
	}
}
