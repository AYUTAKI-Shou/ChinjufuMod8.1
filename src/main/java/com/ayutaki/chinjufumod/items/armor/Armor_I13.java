...
public class Armor_I13 extends Base_Submarine {
	...
	public Armor_I13(ArmorMaterial material, ArmorType slot, Item.Properties props) {
	...
	public static final class ArmorRender extends Base_ArmorItem.BaseRender {
		...
		public Model getHumanoidArmorModel(ItemStack stack, EquipmentClientInfo.LayerType type, Model original) {
			...
			ModelPart part = models.bakeLayer(leg? ArmorLayer_CM.SUBMARINE_INNER : ArmorLayer_CM.SUBMARINE_OUTER);
