...
public class Armor_CarrierKai extends Base_CarrierItem {
	...
	public Armor_CarrierKai(IArmorMaterial material, EquipmentSlotType slot, Properties props) {
	...
	public void inventoryTick(ItemStack stack, World worldIn, Entity entity, int slot, boolean selected) {
		if (entity instanceof PlayerEntity) {
			...
			if (playerIn.getItemStackFromSlot(EquipmentSlotType.FEET).getItem() instanceof Armor_CarrierKai) {
