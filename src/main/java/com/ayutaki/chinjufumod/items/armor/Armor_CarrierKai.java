...
public class Armor_CarrierKai extends Base_CarrierItem {
	...
	public Armor_CarrierKai(ArmorMaterial material, ArmorType slot, Item.Properties props) {
	...
	public static final class ArmorRender extends Base_ArmorItem.BaseRender {
		...
		public Model getHumanoidArmorModel(ItemStack stack, EquipmentClientInfo.LayerType type, Model original) {
			...
			ModelPart part = models.bakeLayer(leg? ArmorLayer_CM.IKKOU_INNER : ArmorLayer_CM.IKKOU_OUTER);
