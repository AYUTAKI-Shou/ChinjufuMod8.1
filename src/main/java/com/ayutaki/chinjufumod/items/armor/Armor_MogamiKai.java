...
public class Armor_MogamiKai extends Base_CruiserItem {

	public Armor_MogamiKai(ArmorMaterial material, ArmorType slot, Item.Properties props) {
	...
	public void inventoryTick(ItemStack stack, Level worldIn, Entity entity, int slot, boolean selected) {
		if (entity instanceof Player playerIn) {
			if (playerIn.getItemBySlot(EquipmentSlot.FEET).getItem() instanceof Armor_MogamiKai) {
