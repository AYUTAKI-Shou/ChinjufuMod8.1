...
public class Armor_MogamiKai extends Base_CruiserItem {
	...
	public Armor_MogamiKai(String name, ArmorMaterial a_material, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public void onArmorTick(World worldIn, EntityPlayer playerIn, ItemStack armor) {
		if (playerIn != null) {
			if (playerIn.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() instanceof Armor_MogamiKai) {
