...
public class Armor_NagatoKai extends Base_BattleshipItem {
	...
	public Armor_NagatoKai(ArmorMaterial material, ArmorType slot, Item.Properties props) {
	...
	public static final class ArmorRender extends Base_ArmorItem.BaseRender {
		...
		public Model getHumanoidArmorModel(ItemStack stack, EquipmentClientInfo.LayerType type, Model original) {
			...
			ModelPart part = models.bakeLayer(leg? ArmorLayer_CM.NAGATO_INNER : ArmorLayer_CM.NAGATO_OUTER);
