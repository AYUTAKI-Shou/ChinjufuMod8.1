...
public class Armor_NagatoKai extends Base_BattleshipItem {
	...
	public Armor_NagatoKai(IArmorMaterial material, EquipmentSlotType slot, Properties props) {
	...
	public void inventoryTick(ItemStack stack, World worldIn, Entity entity, int slot, boolean selected) {
		if (entity instanceof PlayerEntity) {
			...
			if (playerIn.getItemStackFromSlot(EquipmentSlotType.FEET).getItem() instanceof Armor_NagatoKai) {
