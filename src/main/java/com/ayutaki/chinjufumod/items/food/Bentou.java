...
public class Bentou extends Food_Teatime {

	public Bentou(String name, int amount, float saturation, boolean isWolfFood) {
	...
	public String getUnlocalizedName(ItemStack stack) {
		...
		case 6:
			return "item." + "item_bentou_sekihan";
		case 7:
			return "item." + "item_bentoushake_sekihan";
		}
	}
	...
	public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityLivingBase entityLiving) {
		...
		if (playerIn == null || !playerIn.capabilities.isCreativeMode) {
			ItemStack take = new ItemStack(Items_Teatime.Item_DISH, 1, 9);
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> itemTip, ITooltipFlag advanced) {
		itemTip.add(I18n.format("tips.item_bentou.name"));
	}
}
