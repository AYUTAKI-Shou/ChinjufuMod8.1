...
public class BottleOsauce_2 extends BaseBottle_2 {

	public BottleOsauce_2(Block block, Item.Properties props) {
		super(block, props.craftRemainder(Items_NoTab.OSAUCE_bot_34.get()));
	}
