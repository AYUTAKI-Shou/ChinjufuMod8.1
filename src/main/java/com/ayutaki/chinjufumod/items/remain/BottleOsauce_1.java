...
public class BottleOsauce_1 extends BaseBottle_1 {

	public BottleOsauce_1(Block block, Item.Properties props) {
		super(block, props.craftRemainder(Items_NoTab.OSAUCE_bot_24.get()));
	}
