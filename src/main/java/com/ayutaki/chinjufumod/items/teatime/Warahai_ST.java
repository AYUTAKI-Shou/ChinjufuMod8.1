...
public class Warahai_ST extends IG_Seasonal {

	public Warahai_ST(Item.Properties props) {
		super(props);
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		if (biome.is(BiomeKey_CM.SAKURA_FOREST_KEY) || biome.is(BiomeKey_CM.SAKURA_HILLS_KEY)) {
			...
			if (block instanceof SpreadingSnowyDirtBlock) {
				...
				if (playerIn instanceof ServerPlayer) {
					CriteriaTriggers.PLACED_BLOCK.trigger((ServerPlayer)playerIn, pos.above(), hStack); }
