...
public class MeasurecupFull_Item extends Item {

	public MeasurecupFull_Item(Item.Properties props) {
		super(props.craftRemainder(Items_Teatime.KEIRYO_CUP.get()));
	}
	...
	public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> itemTip, TooltipFlag tipFlag) {
		if (this == Items_Teatime.KEIRYO_CUP_full.get()) {
			itemTip.add(Component.translatable("tips.item_measurecup_full").withStyle(ChatFormatting.GRAY)); }
		if (this == Items_Teatime.KANSUI.get()) {
			itemTip.add(Component.translatable("tips.item_kansui").withStyle(ChatFormatting.GRAY)); }
	}
}
