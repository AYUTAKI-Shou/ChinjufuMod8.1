...
public class Kaihori_Item extends Item {
	...
	public Kaihori_Item(Item.Properties props) {
		super(props.repairable(Items.IRON_INGOT));
	}
	...
	public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> itemTip, TooltipFlag tipFlag) {
		itemTip.add(Component.translatable("tips.item_kaihori").withStyle(ChatFormatting.GRAY));
	}
}
