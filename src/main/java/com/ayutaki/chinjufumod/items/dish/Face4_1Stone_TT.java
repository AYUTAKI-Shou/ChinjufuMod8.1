...
public class Face4_1Stone_TT extends IBR_Teatime {

	public Face4_1Stone_TT(String name, Block putBlock) {
		super(name, putBlock);
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> itemTip, ITooltipFlag advanced) {
		if (this == Items_Teatime.CHICKEN) { itemTip.add(I18n.format("tips.take_plate.name")); }
		if (this == Items_Teatime.TEAPOT) { itemTip.add(I18n.format("tips.block_food_teapot_1.name")); }
		if (this == Items_Teatime.KYUSU) { itemTip.add(I18n.format("tips.block_food_kyusu_1.name")); }
	}
}
