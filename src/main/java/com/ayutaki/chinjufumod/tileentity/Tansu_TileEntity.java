...
public class Tansu_TileEntity extends TileEntityLockableLoot implements ITickable {
	...
	public static void registerFixesChest(DataFixer fixer) {
		fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(Tansu_TileEntity.class, new String[] {"Items"}));
	}
	...
	@Nullable
	protected Tansu_TileEntity getAdjacentChest(EnumFacing side) {
		...
		if (this.isChestAt(pos)) {
			...
			if (tileentity instanceof Tansu_TileEntity) {
				Tansu_TileEntity tileentitychest = (Tansu_TileEntity)tileentity;
	...
	public String getGuiID() {
		return ChinjufuMod.MOD_ID + ":tansu_45";
	}

	public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
		this.fillWithLoot(playerIn);
		return new TansuMenu(playerInventory, this, playerIn);
	}
