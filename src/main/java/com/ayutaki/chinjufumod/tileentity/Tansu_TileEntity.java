...
public class Tansu_TileEntity extends LockableLootTileEntity implements IChestLid, ITickableTileEntity, IInventory {
	...
	private net.minecraftforge.items.IItemHandlerModifiable createHandler() {
		...
		IInventory inv = Tansu.getContainer((Tansu) state.getBlock(), state, getWorld(), getPos(), true);
