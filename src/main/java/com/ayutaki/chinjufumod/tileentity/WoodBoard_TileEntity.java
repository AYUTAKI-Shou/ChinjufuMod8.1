...
public class WoodBoard_TileEntity extends TileEntity {
	private int MAX = 7;
	/** private final ITextComponent[] boardText -> public final ITextComponent[] boardText ... for Multi. **/
	...
	public WoodBoard_TileEntity() {
		super(TileEntity_CM.WOODBOARD);
	}
	...
	public CommandSource createCommandSourceStack(@Nullable ServerPlayerEntity playerIn) {
		...
		ITextComponent iText = (ITextComponent)(playerIn == null ? new StringTextComponent("WoodBoard") : playerIn.getDisplayName());
