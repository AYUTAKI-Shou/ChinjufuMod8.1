...
public class BlackBoard_TileEntity extends TileEntity {
	...
	public void readFromNBT(NBTTagCompound compound) {
		...
		ICommandSender icommandsender = new ICommandSender() {
			...
			public BlockPos getPosition() {
				return BlackBoard_TileEntity.this.pos; }
			
			public Vec3d getPositionVector() {
				return new Vec3d((double)BlackBoard_TileEntity.this.pos.getX() + 0.5D, (double)BlackBoard_TileEntity.this.pos.getY() + 0.5D, (double)BlackBoard_TileEntity.this.pos.getZ() + 0.5D); }
			
			public World getEntityWorld() {
				return BlackBoard_TileEntity.this.world; }
			
			public MinecraftServer getServer() {
				return BlackBoard_TileEntity.this.world.getMinecraftServer(); }
		};
	...
	public boolean executeCommand(final EntityPlayer playerIn) {
		ICommandSender icommandsender = new ICommandSender() {
			...
			public void setCommandStat(CommandResultStats.Type type, int amount) {
				if (BlackBoard_TileEntity.this.world != null && !BlackBoard_TileEntity.this.world.isRemote) {
					BlackBoard_TileEntity.this.stats.setCommandStatForSender(BlackBoard_TileEntity.this.world.getMinecraftServer(), this, type, amount); }
			}
			public MinecraftServer getServer() {
	...
	public void clearText() {
		...
		markUpdated();
		//ChinjufuMod.LOGGER.info("ChinjufuMod clear BlackBoard SERVER.");
	}
