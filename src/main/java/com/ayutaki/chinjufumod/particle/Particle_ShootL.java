...
@OnlyIn(Dist.CLIENT)
public class Particle_ShootL extends TextureSheetParticle {
	
	Particle_ShootL(ClientLevel worldIn, double xIn, double yIn, double zIn, double xSpeed, double ySpeed, double zSpeed) {
	...
	public static class Provider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double xIn, double yIn, double zIn, double xSpeed, double ySpeed, double zSpeed) {
			Particle_ShootL AmmoParticle = new Particle_ShootL(worldIn, xIn, yIn, zIn, xSpeed, ySpeed, zSpeed);
