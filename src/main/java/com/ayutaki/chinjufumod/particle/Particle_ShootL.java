...
@OnlyIn(Dist.CLIENT)
public class Particle_ShootL extends SpriteTexturedParticle {
	
	private Particle_ShootL(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeed, double ySpeed, double zSpeed) {
	...
	public static class Factory implements IParticleFactory<BasicParticleType> {
		...
		public Particle makeParticle(BasicParticleType typeIn, World worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			Particle_ShootL AmmoParticle = new Particle_ShootL(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
