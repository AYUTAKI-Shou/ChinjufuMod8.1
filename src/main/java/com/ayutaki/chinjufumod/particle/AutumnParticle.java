...
public class AutumnParticle extends SpriteTexturedParticle {
	...
	private AutumnParticle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeed, double ySpeed, double zSpeed) {
		super(worldIn, xCoordIn, yCoordIn, zCoordIn);

		this.particleScale *= 1.125F; //<- 0.75
