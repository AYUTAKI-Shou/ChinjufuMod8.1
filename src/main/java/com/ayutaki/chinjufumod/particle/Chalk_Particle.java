...
@OnlyIn(Dist.CLIENT)
public class Chalk_Particle extends SpriteTexturedParticle {
	
	private Chalk_Particle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, 
	...
	public static class Factory implements IParticleFactory<BasicParticleType> {
		...
		public Particle makeParticle(BasicParticleType typeIn, World worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			Chalk_Particle AmmoParticle = new Chalk_Particle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
