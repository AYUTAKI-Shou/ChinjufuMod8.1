...
@OnlyIn(Dist.CLIENT)
public class Chalk_Particle extends TextureSheetParticle {
	
	Chalk_Particle(ClientLevel worldIn, double xIn, double yIn, double zIn, double xSpeed, double ySpeed, double zSpeed) {
	...
	public static class Provider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double xIn, double yIn, double zIn, double xSpeed, double ySpeed, double zSpeed) {
			Chalk_Particle AmmoParticle = new Chalk_Particle(worldIn, xIn, yIn, zIn, xSpeed, ySpeed, zSpeed);
