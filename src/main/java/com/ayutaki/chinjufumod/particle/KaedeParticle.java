...
public class KaedeParticle extends SpriteTexturedParticle {
	...
	private KaedeParticle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeed, double ySpeed, double zSpeed) {
		super(worldIn, xCoordIn, yCoordIn, zCoordIn);

		this.particleScale *= 1.0F; //<- 0.5
