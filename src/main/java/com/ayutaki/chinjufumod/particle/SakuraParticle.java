...
public class SakuraParticle extends TextureSheetParticle {
	...
	public SakuraParticle(ClientLevel worldIn, double xIn, double yIn, double zIn, double xSpeed, double ySpeed, double zSpeed) {
		super(worldIn, xIn, yIn, zIn);

		this.quadSize *= 0.75F; //<- 0.5
	...
	public static class Provider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double xIn, double yIn, double zIn,
			...
			SakuraParticle particle = new SakuraParticle(worldIn, xIn, yIn, zIn, xSpeed, ySpeed, zSpeed);
