...
public class SakuraParticle extends SpriteTexturedParticle {
	...
	private SakuraParticle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeed, double ySpeed, double zSpeed) {
		super(worldIn, xCoordIn, yCoordIn, zCoordIn);

		this.particleScale *= 0.75F; //<- 0.5
