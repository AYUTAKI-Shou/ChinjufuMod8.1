...
public class RegisterHandler_CM {
	...
	public static class Blocks {
		...
		public static void registerBlocks(final RegistryEvent.Register<Block> event) {
			...
			KamoiPlaster_Blocks.init();
			KamoiPlaster_Blocks.register();
			KamoiPlanks_Blocks.init();
			KamoiPlanks_Blocks.register();
			WallBrick_Blocks.init();
			WallBrick_Blocks.register();
			WallPanel_Blocks.init();
			WallPanel_Blocks.register();
			WallPanel_JPBlocks.init();
			WallPanel_JPBlocks.register();
 ...
 /* ドロップ時やインベントリにおける, アイテムやアイテムブロックの描画を登録する【内部クラス】
	...
	public static class ItemModels {
		...
		public static void registerModels(ModelRegistryEvent event) {
			...
			/** 鎮守府MOD 扶桑 外壁パネル **/
			WallPanel_Blocks.registerRenders();
			WallPanel_JPBlocks.registerRenders();
