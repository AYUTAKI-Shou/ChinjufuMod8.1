...
public class Config_CM {
	...
	private static final Path CONFIG_PATH = Paths.get("config", ChinjufuMod.MOD_ID + "_15.2.toml");
	...
	public boolean chestnutsFall() { return chestnutsFall.get(); }
	public boolean lowSound() { return lowSound.get(); }
	...
	public void changeChestnutsFall(boolean newValue) { chestnutsFall.set(newValue); }
	public void changeLowSound(boolean newValue) { lowSound.set(newValue); }
